/- GID: D5/S0/Certificates/RationalMomentAmbiguityCertificate
   ...
   anchors: []
   utility: kind=checker; basis=consumer=D5/S3/ConceptDynamics/CausalMoments/BenefitMarginalToleranceSharp.benefit_marginal_tolerance_sharp; instance=D5/S3/ConceptDynamics/CausalMoments/BenefitMarginalToleranceSharp.benefitToleranceCertificate_accepted
