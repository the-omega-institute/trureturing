/- GID: D5/X_Frontier/FutureInstances
   generality: G
   mirror-B: none(waiver:pressure-gated-instantiation-ticket)
   mirror-E: none(waiver:no-instance-before-pressure)
   anchors: [golden-ledger-spec-v7.11-A1]
...
-- ci confirm(pure content exit-0)
