...
namespace D5.S3.ConceptDynamics.CausalMoments.FiniteMomentSparseLaw
...
noncomputable def _root_.D5.S3.ConceptDynamics.CausalMoments.FiniteMomentSupportReduction.MomentCompression.sparseLaw
...
theorem _root_.D5.S3.ConceptDynamics.CausalMoments.FiniteMomentSupportReduction.MomentCompression.sparseLaw_linearObjective_eq
    {Atom Feature : Type*} [Fintype Atom] [Fintype Feature] [DecidableEq Atom]
    {law : FiniteResponseLaw Atom} {feature : Atom → Feature → ℚ}
...
theorem _root_.D5.S3.ConceptDynamics.CausalMoments.FiniteMomentSupportReduction.MomentCompression.sparseLawLinearFeasible
...
query value. -/
theorem _root_.D5.S3.ConceptDynamics.CausalMoments.FiniteMomentSupportReduction.MomentCompression.sparseLawLinearObjective_eq
    {Constraint Atom : Type*}
    [Fintype Constraint] [Fintype Atom] [DecidableEq Atom]
...
end D5.S3.ConceptDynamics.CausalMoments.FiniteMomentSparseLaw
