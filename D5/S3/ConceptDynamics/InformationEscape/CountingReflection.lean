...
def __state_enumeration : Arena.StateEnumeration
  ...
  states := agendaStates
  nodup := by
    change agendaStates.Nodup
    decide
  complete := by
    letI := FirstThreeArenas.agendaFintype
    change agendaStates.toFinset = (Finset.univ : Finset Agenda)
    decide
...
def __state_enumeration : Arena.StateEnumeration FirstThreeArenas.residueArena.toArena where
  ...
  nodup := by
    change residueStates.Nodup
    decide
  complete := by
    change residueStates.toFinset = (Finset.univ : Finset ResidueState)
    decide
...
def __state_enumeration : Arena.StateEnumeration FirstThreeArenas.spectrumArena.toArena where
  ...
  nodup := by
    change spectrumStates.Nodup
    decide
  complete := by
    change spectrumStates.toFinset = (Finset.univ : Finset SpectrumAtom)
    decide
...
def __state_enumeration : Arena.StateEnumeration FourthFifthArenas.contextArena.toArena where
  ...
  nodup := by
    ...
    change contextStates.Nodup
    decide
  complete := by
    letI := FourthFifthArenas.contextFintype
    letI := FourthFifthArenas.contextDecidableEq
    change contextStates.toFinset =
      (Finset.univ : Finset BinaryInterpretationContext)
    decide
...
-- The explicit 16-table completeness certificate needs the acceptance heartbeat cap.
...
def __state_enumeration : Arena.StateEnumeration
  ...
  nodup := by
    ...
    change interventionStates.Nodup
    decide
  complete := by
    letI := FourthFifthArenas.modelFintype
    letI := FourthFifthArenas.modelDecidableEq
    change interventionStates.toFinset = (Finset.univ : Finset DeterministicBoolSCM)
    decide
...
def __state_enumeration : Arena.StateEnumeration
  ...
  nodup := by
    change observationStates.Nodup
    decide
  complete := by
    change observationStates.toFinset = (Finset.univ : Finset DeterministicBoolSCM)
    decide
...
def __state_enumeration : Arena.StateEnumeration
  ...
  complete := by
    change staticStates.toFinset = (Finset.univ : Finset (Fin 3))
    decide
...
def __state_enumeration : Arena.StateEnumeration
  ...
  nodup := by
    change completionStates.Nodup
    decide
  complete := by
    change completionStates.toFinset = (Finset.univ : Finset FourState)
    decide
...
def __state_enumeration : Arena.StateEnumeration
  ...
  states := gluingStates
  nodup := by
    change gluingStates.Nodup
    decide
  complete := by
    change gluingStates.toFinset = (Finset.univ : Finset (Bool × Bool × Bool))
    decide
...
def __state_enumeration : Arena.StateEnumeration
  ...
  nodup := by
    change preemptionStates.Nodup
    decide
  complete := by
    change preemptionStates.toFinset = (Finset.univ : Finset PreemptionTrace)
    decide
...
set_option maxHeartbeats 2000000 in
-- The 729-pair reduction also needs a deeper recursion budget.
set_option maxRecDepth 10000 in
-- The strict agenda fold checks all 729 ordered pairs within the acceptance cap.
example :
    (singletonSummary agendaPowerRealization
      agendaPowerArena.__state_enumeration).uniqueCaptureCount = 570 := by
  decide

set_option maxHeartbeats 2000000 in
-- The residue census evaluates the complete four-state carrier.
example :
    (singletonSummary residueRealization
      residueArena.__state_enumeration).uniqueCaptureCount = 12 := by
  decide

set_option maxHeartbeats 2000000 in
-- The spectrum census evaluates the complete five-state carrier.
example :
    (singletonSummary spectrumRealization
      spectrumArena.__state_enumeration).uniqueCaptureCount = 20 := by
  decide

set_option maxHeartbeats 2000000 in
-- The context census evaluates the complete eight-state carrier.
example :
    (singletonSummary contextRealization
      contextArena.__state_enumeration).uniqueCaptureCount = 56 := by
  decide

set_option maxHeartbeats 2000000 in
-- The explicit table reduction also needs a deeper recursion budget.
set_option maxRecDepth 10000 in
-- The intervention census evaluates all sixteen Boolean response tables.
example :
    (singletonSummary interventionRealization
      interventionArena.__state_enumeration).uniqueCaptureCount = 240 := by
  decide

set_option maxHeartbeats 2000000 in
-- The 1024-pair reduction also needs a deeper recursion budget.
set_option maxRecDepth 10000 in
-- The observation census evaluates both directions and all unary table pairs.
example :
    (singletonSummary observationInterventionRealization
      observationInterventionArena.__state_enumeration).uniqueCaptureCount = 968 := by
  decide

set_option maxHeartbeats 2000000 in
-- The static experiment census evaluates the complete three-state carrier.
example :
    (singletonSummary staticExactExperimentRealization
      staticExactExperimentArena.__state_enumeration).uniqueCaptureCount = 6 := by
  decide

set_option maxHeartbeats 2000000 in
-- The completion census evaluates the four named source states.
example :
    (singletonSummary commutingCompletionRealization
      commutingCompletionArena.__state_enumeration).uniqueCaptureCount = 12 := by
  decide

set_option maxHeartbeats 2000000 in
-- The gluing census evaluates all eight Boolean triples.
example :
    (singletonSummary localLawGluingRealization
      localLawGluingArena.__state_enumeration).uniqueCaptureCount = 48 := by
  decide

set_option maxHeartbeats 2000000 in
-- The function-state reduction also needs a deeper recursion budget.
set_option maxRecDepth 10000 in
-- The preemption census evaluates all nine two-position traces.
example :
    (singletonSummary endStateOmitsPreemptingCauseRealization
      endStateOmitsPreemptingCauseArena.__state_enumeration).uniqueCaptureCount = 60 := by
  decide

set_option maxHeartbeats 2000000 in
-- The system census evaluates both engine stages.
example :
    (singletonSummary SystemUnit.systemRealization
      SystemUnit.arena.__state_enumeration).uniqueCaptureCount = 2 := by
  decide
