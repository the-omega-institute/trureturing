...
def rayReadout (r : Fin 18) : RayCode :=
  Bool.rec
    (Bool.rec
      (Bool.rec
        (Bool.rec
          (Bool.rec
            (Bool.rec
              (Bool.rec
                (Bool.rec
                  (Bool.rec
                    (Bool.rec
                      (Bool.rec
                        (Bool.rec
                          (Bool.rec
                            (Bool.rec
                              (Bool.rec
                                (Bool.rec
                                  (Bool.rec
                                    ...
                                    (decide (r = (⟨16, (let h : Nat.lt 16 18 := (by change 16 < 18; omega); h)⟩ : Fin 18))))
                                  ...
                                  (decide (r = (⟨15, (let h : Nat.lt 15 18 := (by change 15 < 18; omega); h)⟩ : Fin 18))))
                                ...
                                (decide (r = (⟨14, (let h : Nat.lt 14 18 := (by change 14 < 18; omega); h)⟩ : Fin 18))))
                              ...
                              (decide (r = (⟨13, (let h : Nat.lt 13 18 := (by change 13 < 18; omega); h)⟩ : Fin 18))))
                            ...
                            (decide (r = (⟨12, (let h : Nat.lt 12 18 := (by change 12 < 18; omega); h)⟩ : Fin 18))))
                          ...
                          (decide (r = (⟨11, (let h : Nat.lt 11 18 := (by change 11 < 18; omega); h)⟩ : Fin 18))))
                        ...
                        (decide (r = (⟨10, (let h : Nat.lt 10 18 := (by change 10 < 18; omega); h)⟩ : Fin 18))))
                      ...
                      (decide (r = (⟨9, (let h : Nat.lt 9 18 := (by change 9 < 18; omega); h)⟩ : Fin 18))))
                    ...
                    (decide (r = (⟨8, (let h : Nat.lt 8 18 := (by change 8 < 18; omega); h)⟩ : Fin 18))))
                  ...
                  (decide (r = (⟨7, (let h : Nat.lt 7 18 := (by change 7 < 18; omega); h)⟩ : Fin 18))))
                ...
                (decide (r = (⟨6, (let h : Nat.lt 6 18 := (by change 6 < 18; omega); h)⟩ : Fin 18))))
              ...
              (decide (r = (⟨5, (let h : Nat.lt 5 18 := (by change 5 < 18; omega); h)⟩ : Fin 18))))
            ...
            (decide (r = (⟨4, (let h : Nat.lt 4 18 := (by change 4 < 18; omega); h)⟩ : Fin 18))))
          ...
          (decide (r = (⟨3, (let h : Nat.lt 3 18 := (by change 3 < 18; omega); h)⟩ : Fin 18))))
        ...
        (decide (r = (⟨2, (let h : Nat.lt 2 18 := (by change 2 < 18; omega); h)⟩ : Fin 18))))
      ...
      (decide (r = (⟨1, (let h : Nat.lt 1 18 := (by change 1 < 18; omega); h)⟩ : Fin 18))))
    ...
    (decide (r = (⟨0, (let h : Nat.lt 0 18 := (by change 0 < 18; omega); h)⟩ : Fin 18)))
