/- GID: D5/S3/ConceptDynamics/InterventionBounds/HarmedProbabilityBounds
   generality: G
   mirror-B: D5/B/S3/ConceptDynamics/InterventionBounds/HarmedProbabilityBounds
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   digest: The harmed potential-outcome probability satisfies the sharp Frechet lower and upper bounds determined by the two marginal probabilities. -/
...
namespace D5.S3.ConceptDynamics.InterventionBounds.HarmedProbabilityBounds
...
end D5.S3.ConceptDynamics.InterventionBounds.HarmedProbabilityBounds
