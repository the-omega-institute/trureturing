/- GID: D5/S3/ConceptDynamics/PartialIdentification/CovariateSharedParameterObstruction
   generality: G
   mirror-B: D5/B/S3/ConceptDynamics/PartialIdentification/CovariateSharedParameterObstruction
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Sharp stratum projections need not aggregate sharply when strata share an unidentified parameter. -/

import D5.S3.ConceptDynamics.PartialIdentification.CovariateSharpAggregation
...
namespace D5.S3.ConceptDynamics.PartialIdentification.CovariateSharedParameterObstruction

open D5.S3.ConceptDynamics.PartialIdentification.CovariateSharpAggregation
...
end D5.S3.ConceptDynamics.PartialIdentification.CovariateSharedParameterObstruction
