...
FAMILY-SSOT adjudication: formally interderivable with
`manifestation_excludes_noninterference_descent`, kept as a distinct owner because
the atom names forgetting (past distinguishes, future identifies), not manifestation. -/
