...
theorem totient_eq_prod_primeFactors_sub_one_of_squarefree {n : Nat}
    (_hn : n ≠ 0) (hsq : Squarefree n) :
    Nat.totient n = ∏ p ∈ n.primeFactors, (p - 1) := by
  exact LongGapsBetweenPrimes.totient_eq_prod_sub_one_of_squarefree hsq
...
/-- A composite number satisfying Lehmer's divisibility condition has at least three
prime factors. -/
