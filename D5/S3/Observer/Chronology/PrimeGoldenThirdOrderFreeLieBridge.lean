/- GID: D5/S3/Observer/Chronology/PrimeGoldenThirdOrderFreeLieBridge
   ...
   anchors: [mathlib/module/Mathlib.Algebra.Lie.Free]
...
open D5.S3.Observer.HiddenFlow
...
theorem free_lie_evaluation_third_order
  ...
  change
    -ProjectionCommutatorIdentity.commutator (observe left + observe right)
        (ProjectionCommutatorIdentity.commutator (observe left) (observe right)) =
...
theorem cubic_chronology_defect_e12_e21 :
  ...
  fin_cases i <;> fin_cases j <;>
    norm_num [e12, e21, cubicWitnessMatrix, ProjectionCommutatorIdentity.commutator,
