/- GID: D5/S3/Observer/Chronology/PrimeWordAntipodeParityStepBridge
   ...
   anchors: [mathlib/module/Mathlib.NumberTheory.ArithmeticFunction.Liouville, mathlib/module/Mathlib.NumberTheory.ArithmeticFunction.Moebius]
...
theorem step_frequency_zeckendorf_parity
  ...
  rw [D5.S3.Analytic.PrimeZeckendorf.PrimeZeckendorfFrequencyBridge.prime_layer_frequency_gap,
    gapLaw]
