/- GID: D5/S3/Observer/Linear/ObservationRankEquality
   generality: G
   mirror-B: D5/B/S3/Observer/Linear/ObservationRankEquality
...
namespace D5.S3.Observer.Linear.ObservationRankEquality
...
end D5.S3.Observer.Linear.ObservationRankEquality
