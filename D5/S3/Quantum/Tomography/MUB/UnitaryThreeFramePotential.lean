/- GID: D5/S3/Quantum/Tomography/MUB/UnitaryThreeFramePotential
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/UnitaryThreeFramePotential
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Three-by-three unitary fourth frame potential is at least one. -/
...
namespace D5.S3.Quantum.Tomography.MUB.UnitaryThreeFramePotential
...
end D5.S3.Quantum.Tomography.MUB.UnitaryThreeFramePotential
