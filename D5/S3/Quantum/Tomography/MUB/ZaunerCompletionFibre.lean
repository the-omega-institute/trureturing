/- GID: D5/S3/Quantum/Tomography/MUB/ZaunerCompletionFibre
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/ZaunerCompletionFibre
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Zauner relative Gram zeros obstruct nonzero flat moduli. -/
...
namespace D5.S3.Quantum.Tomography.MUB.ZaunerCompletionFibre
...
end D5.S3.Quantum.Tomography.MUB.ZaunerCompletionFibre
