/- GID: D5/S3/Quantum/Tomography/MUB/ZaunerFlatnessDefectCertificate
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/ZaunerFlatnessDefectCertificate
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Structural zeros certify positive Zauner flatness defects and exclude unbiasedness. -/

import D5.S3.Quantum.Tomography.MUB.ComplexHadamardEntrywiseDefect
import D5.S3.Quantum.Tomography.MUB.ZaunerCompletionFibre
...
namespace D5.S3.Quantum.Tomography.MUB.ZaunerFlatnessDefectCertificate

open Matrix
open D5.S3.Quantum.Tomography.MUB.ZaunerCompletionFibre
...
end D5.S3.Quantum.Tomography.MUB.ZaunerFlatnessDefectCertificate
