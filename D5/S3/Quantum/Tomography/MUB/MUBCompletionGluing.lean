/- GID: D5/S3/Quantum/Tomography/MUB/MUBCompletionGluing
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/MUBCompletionGluing
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: One relative Gram matrix determines fixed-edge double completions. -/

import D5.S3.Quantum.Tomography.MUB.MUBCubeCompatibility
...
namespace D5.S3.Quantum.Tomography.MUB.MUBCompletionGluing
...
end D5.S3.Quantum.Tomography.MUB.MUBCompletionGluing
