/- GID: D5/S3/Quantum/Tomography/MUB/ComplexHadamardEntrywiseDefect
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/ComplexHadamardEntrywiseDefect
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Entrywise unit norms are equivalent to a vanishing squared-deviation sum. -/
...
namespace D5.S3.Quantum.Tomography.MUB.ComplexHadamardEntrywiseDefect
...
end D5.S3.Quantum.Tomography.MUB.ComplexHadamardEntrywiseDefect
