/- GID: D5/S3/Quantum/Tomography/MUB/MUBCompletionConsistentRelativeGramEquivalence
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/MUBCompletionConsistentRelativeGramEquivalence
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Relative-Gram reduction retains transition consistency. -/

import D5.S3.Quantum.Tomography.MUB.MUBCompletionConsistencyTransport
...
namespace D5.S3.Quantum.Tomography.MUB.MUBCompletionConsistentRelativeGramEquivalence
...
open D5.S3.Quantum.Tomography.MUB.MUBCompletionConsistencyTransport
...
end D5.S3.Quantum.Tomography.MUB.MUBCompletionConsistentRelativeGramEquivalence
