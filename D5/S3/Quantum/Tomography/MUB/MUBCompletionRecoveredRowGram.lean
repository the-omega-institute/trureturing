/- GID: D5/S3/Quantum/Tomography/MUB/MUBCompletionRecoveredRowGram
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/MUBCompletionRecoveredRowGram
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Scaled-Hadamard relative Gram supplies both recovered row-Gram equations. -/

import D5.S3.Quantum.Tomography.MUB.MUBCompletionScalarDefect
...
namespace D5.S3.Quantum.Tomography.MUB.MUBCompletionRecoveredRowGram

open Matrix
open D5.S3.Quantum.Tomography.MUB.MUBHadamardCompatibility
open D5.S3.Quantum.Tomography.MUB.MUBCompletionRelativeGramEquivalence
open D5.S3.Quantum.Tomography.MUB.MUBCompletionScalarDefect
open D5.S3.Quantum.Tomography.MUB.ComplexHadamardEntrywiseDefect
open D5.S3.Quantum.Tomography.MUB.ComplexHadamardTwoSided
...
theorem doubleCompletion_iff_scaledRelativeGram_and_twoDefects
    ...
    (∃ X' Y' : ComplexSquare n,
      ...
      (D5.S3.Quantum.Tomography.MUB.MUBCubeCompatibility.factorizedCubeMatrix
          H X Y)ᴴ *
          D5.S3.Quantum.Tomography.MUB.MUBCubeCompatibility.factorizedCubeMatrix
            H X' Y' =
  ...
  rw [doubleCompletion_iff_oneRelativeGram
    H X Y hH hX hY]
  constructor
...
end D5.S3.Quantum.Tomography.MUB.MUBCompletionRecoveredRowGram
