/- GID: D5/S3/Quantum/Tomography/MUB/MUBCompletionScalarDefect
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/MUBCompletionScalarDefect
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Double completion reduces to flatness, row Grams and scalar defects. -/

import D5.S3.Quantum.Tomography.MUB.ComplexHadamardEntrywiseDefect
...
namespace D5.S3.Quantum.Tomography.MUB.MUBCompletionScalarDefect
...
end D5.S3.Quantum.Tomography.MUB.MUBCompletionScalarDefect
