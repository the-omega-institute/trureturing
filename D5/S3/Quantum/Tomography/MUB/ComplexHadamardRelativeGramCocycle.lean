/- GID: D5/S3/Quantum/Tomography/MUB/ComplexHadamardRelativeGramCocycle
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/ComplexHadamardRelativeGramCocycle
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Relative Grams form a square-root-free scaled transition cocycle. -/
...
namespace D5.S3.Quantum.Tomography.MUB.ComplexHadamardRelativeGramCocycle
...
end D5.S3.Quantum.Tomography.MUB.ComplexHadamardRelativeGramCocycle
