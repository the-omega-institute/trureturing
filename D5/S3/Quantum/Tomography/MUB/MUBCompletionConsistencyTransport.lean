/- GID: D5/S3/Quantum/Tomography/MUB/MUBCompletionConsistencyTransport
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/MUBCompletionConsistencyTransport
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Relative-Gram recovery preserves multiplicative transition consistency. -/

import D5.S3.Quantum.Tomography.MUB.MUBCompletionRelativeGramEquivalence
...
namespace D5.S3.Quantum.Tomography.MUB.MUBCompletionConsistencyTransport
...
end D5.S3.Quantum.Tomography.MUB.MUBCompletionConsistencyTransport
