/- GID: D5/S3/Quantum/Tomography/MUB/ComplexHadamardCocycleGauge
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/ComplexHadamardCocycleGauge
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Coherent unitary vertex gauges preserve scaled relative-Gram cocycles. -/

import D5.S3.Quantum.Tomography.MUB.ComplexHadamardRelativeGramCocycle
...
namespace D5.S3.Quantum.Tomography.MUB.ComplexHadamardCocycleGauge

open Matrix
open D5.S3.Quantum.Tomography.MUB.MUBHadamardCompatibility
open D5.S3.Quantum.Tomography.MUB.ComplexHadamardRelativeGramCocycle
...
end D5.S3.Quantum.Tomography.MUB.ComplexHadamardCocycleGauge
