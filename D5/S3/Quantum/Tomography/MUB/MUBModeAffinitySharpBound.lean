/- GID: D5/S3/Quantum/Tomography/MUB/MUBModeAffinitySharpBound
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/MUBModeAffinitySharpBound
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Rowwise collision thresholds constrain MUB affinity and double completions. -/

import D5.S3.Quantum.Tomography.MUB.MUBModeSymmetryBudget
...
namespace D5.S3.Quantum.Tomography.MUB.MUBModeAffinitySharpBound

open D5.S3.Quantum.Tomography.MUB.MUBModeSymmetryBudget
...
end D5.S3.Quantum.Tomography.MUB.MUBModeAffinitySharpBound
