/- GID: D5/S3/Quantum/Tomography/MUB/ComplexHadamardTwoSided
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/ComplexHadamardTwoSided
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Complex Hadamards have two-sided Gram laws and scaled relative Grams. -/

import D5.S3.Quantum.Tomography.MUB.MUBCompletionGluing
...
namespace D5.S3.Quantum.Tomography.MUB.ComplexHadamardTwoSided
...
end D5.S3.Quantum.Tomography.MUB.ComplexHadamardTwoSided
