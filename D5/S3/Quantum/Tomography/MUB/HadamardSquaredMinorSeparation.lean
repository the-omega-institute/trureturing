/- GID: D5/S3/Quantum/Tomography/MUB/HadamardSquaredMinorSeparation
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/HadamardSquaredMinorSeparation
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Squared minors obstruct equivalence to squared row or column pairs. -/
...
namespace D5.S3.Quantum.Tomography.MUB.HadamardSquaredMinorSeparation
...
end D5.S3.Quantum.Tomography.MUB.HadamardSquaredMinorSeparation
