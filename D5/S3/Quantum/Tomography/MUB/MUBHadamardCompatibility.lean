/- GID: D5/S3/Quantum/Tomography/MUB/MUBHadamardCompatibility
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/MUBHadamardCompatibility
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Exact Hadamard atlases retain relative gauges for four-MUB compatibility. -/
...
namespace D5.S3.Quantum.Tomography.MUB.MUBHadamardCompatibility
...
end D5.S3.Quantum.Tomography.MUB.MUBHadamardCompatibility
