/- GID: D5/S3/Quantum/Tomography/MUB/MUBCompletionSingleRelativeGram
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/MUBCompletionSingleRelativeGram
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Fixed-edge double completions yield one scaled-Hadamard relative Gram system. -/

import D5.S3.Quantum.Tomography.MUB.ComplexHadamardTwoSided
...
namespace D5.S3.Quantum.Tomography.MUB.MUBCompletionSingleRelativeGram
...
end D5.S3.Quantum.Tomography.MUB.MUBCompletionSingleRelativeGram
