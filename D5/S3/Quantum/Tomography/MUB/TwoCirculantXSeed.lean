/- GID: D5/S3/Quantum/Tomography/MUB/TwoCirculantXSeed
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/TwoCirculantXSeed
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Opposite unit-phase triples construct an order-six Hadamard seed. -/
...
namespace D5.S3.Quantum.Tomography.MUB.TwoCirculantXSeed
...
#print axioms twoCirculantSeed
#print axioms twoCirculantSeed_hadamard_of_opposite_phase_triples

end D5.S3.Quantum.Tomography.MUB.TwoCirculantXSeed
