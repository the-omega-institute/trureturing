/- GID: D5/S3/Quantum/Tomography/MUB/MUBModeSymmetryBudget
   generality: G
   mirror-B: D5/B/S3/Quantum/Tomography/MUB/MUBModeSymmetryBudget
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Three-mode collision, mixing, and centered-affinity identities. -/
...
namespace D5.S3.Quantum.Tomography.MUB.MUBModeSymmetryBudget
...
end D5.S3.Quantum.Tomography.MUB.MUBModeSymmetryBudget
