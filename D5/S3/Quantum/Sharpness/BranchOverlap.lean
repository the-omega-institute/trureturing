/- GID: D5/S3/Quantum/Sharpness/BranchOverlap
   generality: G
   mirror-B: D5/B/S3/Quantum/Sharpness/BranchOverlap
...
namespace D5.S3.Quantum.Sharpness.BranchOverlap

/-- The two explicit right-eigenvector branches of the PT block `kappa X - i delta Z`.
The real-radical form is used before the spectral transition and the imaginary-radical form after
it. -/
...
theorem pt_branch_overlap (delta kappa : Real)
...
#print axioms pt_branch_overlap

end D5.S3.Quantum.Sharpness.BranchOverlap
