/- GID: D5/S3/Quantum/Algebra/Unitary/BalancedUnitarySum
   generality: G
   mirror-B: D5/B/S3/Quantum/Algebra/Unitary/BalancedUnitarySum
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   utility: none
   digest: Balanced unitary sums have cancelling cross terms and a skew-adjoint relative product. -/
...
namespace D5.S3.Quantum.Algebra.Unitary.BalancedUnitarySum
...
end D5.S3.Quantum.Algebra.Unitary.BalancedUnitarySum
