/- GID: D5/S3/Midline/Cayley/PositiveExactRealizationFiber
   ...
   anchors: []
   digest: A positive exact Cayley realization exists exactly when every nontrivial zeta zero lies on the critical line. -/
...
/- Library-search and duplication audit (2026-09-03):
   * Searches for positive exact realization fibers, zero-mode defects, Cayley
     ...
     realization-fiber declaration in D5 or its digestion receipts.
