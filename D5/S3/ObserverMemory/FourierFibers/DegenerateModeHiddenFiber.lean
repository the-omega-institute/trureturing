/- GID: D5/S3/ObserverMemory/FourierFibers/DegenerateModeHiddenFiber
   ...
   anchors: []
   digest: Equal modal multipliers leave an antisymmetric amplitude invisible at every observation time. -/
...
theorem all_time_trace_not_injective (z : ℂ) :
  ...
  funext time
  show
    crystalTimeSample (degenerateModes z) antisymmetricAmplitude time =
      crystalTimeSample (degenerateModes z) 0 time
