/- GID: D5/S3/Combinatorics/Geometry/CrownOrderPolytopeDimension
   ...
   anchors: [D5/S3/Combinatorics/Geometry/CrownOrderPolytopeCCP, mathlib/module/Mathlib/Analysis/Normed/Affine/AddTorsorBases]
   utility: none
...
open Classical in
private theorem partitionPoint_coordinate {n : ℕ} (P : CrownConnectedCompatiblePartition n)
...
private theorem freeVariation_injective {n : ℕ} (P : CrownConnectedCompatiblePartition n)
...
private theorem strictParameters_isOpen {n : ℕ} (P : CrownConnectedCompatiblePartition n) :
...
private theorem strictParameters_mem_face {n : ℕ} (P : CrownConnectedCompatiblePartition n)
    (hendpoints : crownPartitionBottomBlock P ≠ crownPartitionTopBlock P)
