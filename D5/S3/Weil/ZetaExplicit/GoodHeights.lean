/- GID: D5/S3/Weil/ZetaExplicit/GoodHeights
   generality: G
   mirror-B: D5/B/S3/Weil/ZetaExplicit/GoodHeights
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   digest: Port the Zeta23 good-height construction. -/
...
-/
import D5.S3.Weil.ZetaExplicit.Landau
import D5.S3.Weil.ZetaRvm.LocalCount
import D5.S3.Weil.ZetaTail.Tail
