/- GID: D5/S3/Weil/ZetaExplicit/Contour
   generality: G
   mirror-B: D5/B/S3/Weil/ZetaExplicit/Contour
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   digest: Port the Zeta23 finite-contour explicit formula. -/
...
-/
import D5.S3.Weil.ZetaExplicit.VerticalLine
import D5.S3.Weil.ZetaExplicit.GoodHeights
