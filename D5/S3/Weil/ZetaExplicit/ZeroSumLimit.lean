/- GID: D5/S3/Weil/ZetaExplicit/ZeroSumLimit
   generality: G
   mirror-B: D5/B/S3/Weil/ZetaExplicit/ZeroSumLimit
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   digest: Port the Zeta23 zero-sum limit theorem. -/
...
-/
import D5.S3.Weil.ZetaExplicit.Contour
