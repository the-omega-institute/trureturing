/- GID: D5/S3/Weil/ZetaExplicit/VerticalLine
   generality: G
   mirror-B: D5/B/S3/Weil/ZetaExplicit/VerticalLine
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   digest: Port the Zeta23 vertical-line explicit-formula limit. -/
...
-/
import D5.S3.Weil.ZetaExplicit.XiLogDeriv
...
import D5.S3.Weil.ZetaExplicit.GammaRBracket
