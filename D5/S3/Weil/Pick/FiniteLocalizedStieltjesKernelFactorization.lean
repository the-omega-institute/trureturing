...
theorem finite_mass_gram_factorization {n : ℕ}
  ...
  classical
  ext i j
  simp [HermitianKernel.gramMatrix, finiteMassKernel,
    cauchyFeatureMatrix, massWeightMatrix, atomicMassKernel,
...
theorem finite_support_gram_factorization {n : ℕ}
  ...
  classical
  ext i j
  simp [HermitianKernel.gramMatrix, finiteSupportKernel,
    cauchyFeatureMatrix, supportWeightMatrix, atomicSupportKernel,
    Matrix.mul_apply, Matrix.conjTranspose_apply,
    mul_comm, mul_left_comm, mul_assoc]
