...
theorem hankel_moment_matrix_factorization
  ...
  classical
  ext i j
  unfold hankelMomentMatrix atomicMoment atomicWeightMatrix
  rw [Matrix.mul_apply]
  apply Finset.sum_congr rfl
  intro a _
  rw [Matrix.mul_diagonal]
  simp only [vandermondeFeatureMatrix, Matrix.transpose_apply]
  rw [pow_add]
  ring
...
theorem shifted_hankel_moment_matrix_factorization
  ...
  classical
  ext i j
  unfold shiftedHankelMomentMatrix atomicMoment shiftedAtomicWeightMatrix
  rw [Matrix.mul_apply]
  apply Finset.sum_congr rfl
  intro a _
  rw [Matrix.mul_diagonal]
...
theorem hankel_moment_pencil_factorization
  ...
  classical
  ext i j
  unfold hankelMomentPencil atomicPencilWeightMatrix
  rw [Matrix.mul_apply]
  apply Finset.sum_congr rfl
  intro a _
  rw [Matrix.mul_diagonal]
