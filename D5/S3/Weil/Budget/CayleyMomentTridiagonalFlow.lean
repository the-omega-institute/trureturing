...
private theorem coordinate_hasDerivAt (xi a : Real) (ha : 0 < a) :
...
private theorem density_flow_identity (xi a : Real) (ha : 0 < a) :
...
private theorem density_integrand_hasDerivAt (xi a : Real) (ha : 0 < a) :
    HasDerivAt
      (fun scale : Real => 1 /
...
private theorem successor_integrand_hasDerivAt (xi a : Real) (n : Nat) (ha : 0 < a) :
    HasDerivAt
      (fun scale : Real =>
...
private theorem successor_derivative_norm_le
...
private theorem density_derivative_norm_le
...
private theorem density_integral_hasDerivAt
    (source : Measure Real)
...
private theorem canonical_nat_moment_eq_source
...
private theorem canonical_inverse_moment_eq_source
...
private theorem source_inverse_first_eq_first
    (source : Measure Real)
...
private theorem canonical_zero_moment_eq_budget
    (source : Measure Real) (scale : Real) (hscale : 0 < scale) :
...
private theorem successor_integral_hasDerivAt
    (source : Measure Real)
    (hIntegrable : ∀ scale : Real, 0 < scale →
      Integrable (fun xi : Real => 1 / (xi ^ 2 + scale ^ 2)) source)
    (n : Nat) (a : Real) (ha : 0 < a) :
