/- GID: D5/S3/Weil/ZetaRvm/MainTerm
   generality: G
   mirror-B: none(waiver:formal-unit-only)
   mirror-E: none(waiver:upstream-proof-complete-port)
   anchors: []
   digest: Prove the Riemann-von Mangoldt dyadic main term. -/
...
-/
import D5.S3.Weil.ZetaRvm.Defs
...
import D5.S3.Weil.ZetaRvm.GammaSide
import D5.S3.Weil.ZetaRvm.Backlund
import D5.S3.Weil.ZetaRvm.Fold
