/- GID: D5/S3/Weil/ZetaRvm/Backlund
   generality: G
   mirror-B: none(waiver:formal-unit-only)
   mirror-E: none(waiver:upstream-proof-complete-port)
   anchors: []
   digest: Port the horizontal Backlund and vertical-line bounds. -/
...
import D5.S3.Weil.ZetaRvm.BacklundDefs
import D5.S3.Weil.ZetaRvm.ReZeroCount
