/- GID: D5/S3/Weil/ZetaCore/Hypotheses
   generality: G
   mirror-B: D5/B/S3/Weil/ZetaCore/Hypotheses
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   digest: Port the Zeta23 explicit paper-input structures. -/
...
Lean axioms are not declared anywhere in this project: hypotheses are fields of the Prop-valued structure
