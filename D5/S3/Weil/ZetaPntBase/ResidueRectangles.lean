/- GID: D5/S3/Weil/ZetaPntBase/ResidueRectangles
   generality: G
   mirror-B: D5/B/S3/Weil/ZetaPntBase/ResidueRectangles
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   digest: Port the PrimeNumberTheoremAnd rectangle residue foundations. -/
...
import D5.S3.Weil.ZetaPntBase.AdditiveCombination
