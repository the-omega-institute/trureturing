/- GID: D5/S3/Weil/ZetaPntBase/EulerMaclaurin
   generality: G
   mirror-B: D5/B/S3/Weil/ZetaPntBase/EulerMaclaurin
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   digest: Port the PrimeNumberTheoremAnd Euler-Maclaurin identities. -/
