/- GID: D5/S3/Weil/ZetaPntBase/AdditiveCombination
   generality: G
   mirror-B: D5/B/S3/Weil/ZetaPntBase/AdditiveCombination
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   digest: Port the PrimeNumberTheoremAnd additive-combination tactic. -/
...
example (a b qc : ℚ) (hqc : qc = 2*qc) (h : ∀ p q : ℚ, p = q) :
    3*a + qc = 3*b + 2*qc := by
