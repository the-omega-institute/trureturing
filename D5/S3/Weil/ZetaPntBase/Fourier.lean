/- GID: D5/S3/Weil/ZetaPntBase/Fourier
   generality: G
   mirror-B: D5/B/S3/Weil/ZetaPntBase/Fourier
   mirror-E: none(waiver:evidence-not-specified-by-formal-manifest)
   anchors: []
   digest: Port the PrimeNumberTheoremAnd Fourier estimates. -/
...
import D5.S3.Weil.ZetaPntBase.Sobolev
