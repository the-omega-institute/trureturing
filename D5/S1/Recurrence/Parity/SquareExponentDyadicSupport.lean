/- GID: D5/S1/Recurrence/Parity/SquareExponentDyadicSupport
   generality: G
   mirror-B: D5/B/S1/Recurrence/Parity/SquareExponentDyadicSupport
...
namespace D5.S1.Recurrence.Parity.SquareExponentDyadicSupport
...
private theorem coeff_power_divisible (F : PowerSeries ℤ) (n e : ℕ) (hn : 0 < n)
...
private theorem square_exponent_divisible (F : PowerSeries ℤ) (n : ℕ) (hn : 0 < n) :
...
theorem integer_exists_unique : ∃! F : PowerSeries ℤ,
    constantCoeff F = 1 ∧ ∀ n, 0 < n → row F n = 0 := by
  refine ⟨solution, ⟨solution_zero, ?_⟩, ?_⟩
  · intro n hn
    exact (integer_normalized_iff _ n hn).mp (solution_normalized n hn)
  · intro F hF
