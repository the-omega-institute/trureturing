...
Direct unfrozen dependencies: the nine source providers ending in
  PositivePairExactDeckUpperBound. Source acceptance is not freeze status.
...
namespace D5.S1.Words.Complexity.PositivePairExactDeckAsymptotics
...
open D5.S1.Words.Complexity.PositivePairExactDeckGrowth
open D5.S1.Words.Complexity.PositivePairExactDeckUpperBound
...
end D5.S1.Words.Complexity.PositivePairExactDeckAsymptotics
