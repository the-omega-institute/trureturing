/- GID: D5/S1/Words/Expansions/BasePhiNegativePrefixTridentSupport
   generality: I
   mirror-B: none(waiver:negative-base-phi-frontier-support)
   mirror-E: none(waiver:kernel-support-in-formal-module)
   anchors: []
   digest: Canonical bridge, tail-fiber lift, phase machine, and Lucas-growth support for the negative-prefix trident frontier. -/
...
theorem prefix_occurs_of_same_tail {w : List Bool} {M N : Nat}
    (hsame : SameNegativeTail M N)
