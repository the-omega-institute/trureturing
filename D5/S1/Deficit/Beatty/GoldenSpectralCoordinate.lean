...
/- Library-search audit trail (2026-09-02):
   ...
   * `GoldenObserverRoute` is the same-stratum owner of the public `phi` used
     here. Pinned Mathlib supplies `Real.one_lt_goldenRatio`, complex component
...
/- `structuralZero` is transcribed verbatim from `Hearts.lean:57` because
   `X_Frontier` cannot be imported. Hearts is an OPEN X_Frontier source; the
   same-stratum public `phi` comes from `GoldenObserverRoute`. -/
