...
/-- The even recurrence, including its valid zero-index extension. -/
theorem R_even (n : Nat) :
...
private theorem E_at_degree (k : Nat) : E (wt k + 1) k = D (R (2 * k)) := by
