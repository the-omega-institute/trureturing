...
When this delivery adds a newly authored public theorem or lemma, compile its D5 target and the mirrored Reg target together through the governed entry (the plain root `lake build Reg...` form is not valid):
