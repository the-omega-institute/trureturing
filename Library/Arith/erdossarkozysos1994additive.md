...
authors: Paul Erdős and András Sárközy and Vera T. Sós
year: 1994
...
- DOI: https://doi.org/10.1016/0012-365X(94)00108-U
- Discrete Mathematics 136 (1994), 75-99.
...
which asks whether a maximal Sidon set of size O(N^(1/3)) exists and records that
the greedy construction of a maximal Sidon set has size at least of order
N^(1/3). Ruzsa, Acta Arithmetica 85 (1998), constructed a maximal Sidon set of
size at most of order (N log N)^(1/3).
