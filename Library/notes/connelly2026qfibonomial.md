...
receipts are recorded in [archived report](https://github.com/the-omega-institute/trureturing/blob/6c97ad12ce/docs/reports/qfib-refutation/implementation.md).
