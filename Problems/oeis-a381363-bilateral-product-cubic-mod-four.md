---
slug: oeis-a381363-bilateral-product-cubic-mod-four
...
# The A381363 bilateral product coefficient congruence
...
This dossier resolves A381363, the `c = 3` instance, and cites its own Library note
`Library/ArithSums/hanna2025a381363.md`. The sibling quote records the shared family.
...
A positive index `n` for the normalized A381363 series with `a(n) % 4 ≠ 2`
...
- Main instance theorem: `hanna_conjecture_a381363` (`c = 3`).
