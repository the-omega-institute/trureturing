---
slug: oeis-a381365-scaled-bilateral-product-quadratic-mod-nine
bibkey: hanna2025a381365
doi: null
...
# The A381365 scaled bilateral product congruence

## Problem

This dossier cites its own Library note,
`Library/ArithSums/hanna2025a381365.md`, for the A381365 conjecture.
...
A positive index `n` in the normalized integer solution for A381365
(`c = 2`) whose coefficient is not congruent to 6 modulo 9 would falsify this
...
- Entry theorem: `hanna_conjecture_a381365`; the general escape theorem is
...
at `c = 2`. Its source identification is subject to the provenance boundary below.
