...
`firstReturnEquiv` is the peak-respecting first-return bijection; its injective
case is discharged by the private `first_return_unique`. `T_first_return_recurrence`
