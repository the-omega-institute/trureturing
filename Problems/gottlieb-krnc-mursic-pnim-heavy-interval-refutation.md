...
triage: theorem
motivation_gids:
  - D5/S0/Certificates/Games/PnimHeavyIntervalRefutation.result
---
...
The result concerns the printed conjecture and its explicit counterexample;
...
partition. The recursive evaluation imports the frozen
`CrimGrundyRefutation.mex` function rather than restating it.
...
records; no exhaustive search or priority claim is made. Non-arXiv and journal
settlements are not exhaustively checked.
