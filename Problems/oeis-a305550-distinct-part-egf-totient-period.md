---
slug: oeis-a305550-distinct-part-egf-totient-period
...
# Bala's OEIS A305550 totient-period conjecture
...
A positive modulus `m` and an index `n ≥ m` with
`a(n + φ(m)) ≢ a(n) (mod m)` would refute the proved bound. To refute only the
...
- Own Library note: `Library/ArithSums/bala2022a305550.md` (bibkey `bala2022a305550`),
...
- Main theorem: `bala_conjecture_a305550`.
