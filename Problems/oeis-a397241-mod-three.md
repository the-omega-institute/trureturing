...
# OEIS A397241 coefficients modulo 3
...
It is NOT re-claimed here. This dossier claims only the modulo-3 conjecture.
...
`a n % 3 ≠ 2` would refute this claim. The orchestrator's exact numerical
...
- Public theorem and sole resolution claim: `hanna_conjecture_mod_three`.
...
`theorem`. The formal statement resolves the quoted modulo-3 conjecture
