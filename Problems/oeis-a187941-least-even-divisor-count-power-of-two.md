...
The literal offset-0 reading of the comment fails at `n = 0`, since
`a(0) = 1 = 2^0` while 0 is neither prime nor 1; this endpoint is disclosed
here and not formalized. The intended positive-index implication remains a
distinct universal problem. Proving that form resolves the conjectural
direction without asserting its converse.
