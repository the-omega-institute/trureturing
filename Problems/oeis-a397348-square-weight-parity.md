---
slug: oeis-a397348-square-weight-parity
...
# A397348: square-weight congruence

## Problem

Paul D. Hanna's OEIS A397348 NAME is the formal equation
A(x)=exp(x+Sum_{n>=2}(3*n^2-1)*a(n)*x^n/(3*n^2)).
...
Lean: D5/S1/Recurrence/Residue/ParametricExponentialSquareCongruence.parity_q3.
