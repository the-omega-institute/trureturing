...
Gaussian prefactor. It is a motivation reference already frozen at protected
base 635de30f53cb34c16eddd4166d8874564a4f0f18. The seven binomial modules
are new admissions relative to that base.
The entropy expression is directly reused from the already-frozen
D5/S0/Diagonal/MarginBound.bernoulliKL; it is not a new definition admission.

## Gap

The complete weighted denominator asymptotic is classical:
D5/L/Analytic/abel2013binomial, Theorem 3.1, gives it for l>=2,
and l=1 is exact. D5/L/Analytic/ouimet2020precise, Theorem 2.1, supplies
local Gaussian estimates; arXiv:2001.08512v4 PDF page 5, equations
(3.6)–(3.7), supplies the l=2,3 normalizations. These inputs do not alone
evaluate the maximum of the truncated ratio.
...
Independent review of this candidate, required remote CI, ordinary merge
and an independent completion audit remain outside the evidence asserted
here. Local formal admission confers no completed-delivery or KPI credit.
