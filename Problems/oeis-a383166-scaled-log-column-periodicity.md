---
slug: oeis-a383166-scaled-log-column-periodicity
bibkey: bala2026a383166
doi: null
url: https://oeis.org/A383166
triage: theorem
motivation_gids:
  - D5/S1/Recurrence/Periodic/ScaledLogColumnPeriodicity
---

# Eventual periodicity of OEIS A383166

## Problem

The entry-specific Library note `Library/ArithSums/bala2026a383166.md`
...
`n ≥ N` with unequal residues `a 3 (n+p)` and `a 3 n` falsifies that
...
- Entry-specific public theorem: `bala_conjecture_a383166`.
...
- The named theorem specializes the general theorem at `r = 3`.
