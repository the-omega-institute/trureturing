...
triage: theorem
motivation_gids:
  - D5/S3/Combinatorics/Splines/MiroRoigTranStrictSign.result
---
...
`D5/S3/Combinatorics/Splines/MiroRoigTranStrictSign.result`. Its definition
...
```text
D5/S3/Analytic/Curvature/CardinalSplineRecurrence.T
D5/S3/Analytic/Curvature/CardinalSplineRecurrence.D
D5/S3/Analytic/Curvature/CardinalSplineRecurrence.C
D5/S3/Analytic/Curvature/CardinalSplineRecurrence.s
D5/S3/Analytic/Curvature/CardinalSplineRecurrence.Q
D5/S3/Analytic/Curvature/CardinalSplineRecurrence.T_hasDerivAt
D5/S3/Analytic/Curvature/CardinalSplineRecurrence.D_succ_eq_integral
D5/S3/Analytic/Curvature/CardinalSplineRecurrence.Q_succ_eq_integral
D5/S3/Analytic/Curvature/CardinalSplineStrictCurvature.cardinalSpline_strict_curvature
D5/S3/Combinatorics/Splines/MiroRoigTranStrictSign.coefficient
D5/S3/Combinatorics/Splines/MiroRoigTranStrictSign.result
```
...
`admission_basis: open-problem-resolution`; `question_answered: the exact displayed
strict integer coefficient inequality for every n>=2`.

| Declaration | proof_shape | computational_content.kind | admission_basis |
| --- | --- | --- | --- |
| `coefficient` | N/A (definition) | none | N/A (definition) |
| `result` | content | none | open-problem-resolution |

The same-candidate content providers are the global cardinal-spline curvature
theorem together with the positive normalization from the literal integer sum
to the curvature value. They keep `result` at `proof_shape: content`; its
prospective admission basis is the preregistered open-problem resolution, not
baseline-frozen provider status. The curvature proof propagates facts not
supplied by an existing frozen theorem or direct normalization: global
reflected-difference nonnegativity, strict half-offset positivity, and strict
closed-core curvature.
