...
- The module's own `aK 3` was evaluated in a scratch file by Lean's evaluator (`#eval`, runtime
  evaluation rather than kernel reduction) and returned 1, 2, 21, 472, 17165, 885696, 60160723 at indices 1 through 7, matching the published terms. The
