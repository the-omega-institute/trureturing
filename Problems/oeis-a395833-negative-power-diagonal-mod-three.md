---
slug: oeis-a395833-negative-power-diagonal-mod-three
...
# A395833: the mod-three congruence clause

## Problem

From [Library/ArithSums/hanna2026a395833.md](../Library/ArithSums/hanna2026a395833.md),
OEIS A395833, Paul D. Hanna, May 07 2026:
...
This is a first-tier OEIS conjecture from the 2026 entry. KPI = open problems
...
The separate divisibility clause of A395833, `(2*n-1) divides a(n)`, remains **OPEN**
...
An index `n ≥ 2` in the normalized A395833 sequence for which `3` does not
...
- Main theorem for this dossier: `hanna_conjecture_a395833`.
...
`theorem`. The formal result proves only the quoted congruence clause of A395833.
