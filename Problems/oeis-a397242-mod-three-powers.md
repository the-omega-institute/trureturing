---
slug: oeis-a397242-mod-three-powers
...
# The residue-one conjecture of OEIS A397242
...
> Conjecture: for n > 0, a(n) == 1 (mod 3) iff n+2 is of the form 3^k or 2*3^k.
...
A positive counterexample index n for which a(n) % 3 = 1 and n+2 is neither 3^k nor 2*3^k, or n+2 has one of those forms and a(n) % 3 is not 1 would falsify this
...
- Public theorem (sole claimed resolution): `hanna_conjecture_one`.
