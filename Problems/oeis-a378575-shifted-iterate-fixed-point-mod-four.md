---
slug: oeis-a378575-shifted-iterate-fixed-point-mod-four
...
# The A378575 shifted-iterate fixed-point congruence

## Problem

OEIS A378575, Paul D. Hanna, Dec 01 2024, states the following NAME and
COMMENT, reproduced verbatim from `Library/Recurrence/hanna2024a378575.md`:
...
The anchor `hanna_conjecture_five` specialises this result to `r = 5, m = 4`.
OEIS A378576 is the sibling instance `r = 6, m = 5`, proved by
`hanna_conjecture_six` and recorded with its own resolution claim in
`Problems/oeis-a378576-shifted-iterate-fixed-point-mod-five.md`.
...
A positive index n whose coefficient in the normalised five-fold solution
has remainder other than 1 modulo 4 would falsify the assertion. The
...
- Public theorem and sole resolution anchor: `hanna_conjecture_five`.
...
`theorem`. The instance proves the universal assertion recorded by OEIS A378575.
