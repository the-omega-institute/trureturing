...
.PHONY: help dotnet test lean-cache-ensure lean lean-report build clean-lanes emit ingest echo-residual-summary selftest gate perf-report deliver-check receipts-stage derived-refresh deposit cover show-atom worktree pr-open refactor-p0-0-gate-authority
