...
scratch-sweep:
	@find "$${TMPDIR:-/private/tmp}" /private/tmp -maxdepth 1 -type d -name 'stratalint-*' -mtime +0 -exec rm -rf {} + 2>/dev/null || true
