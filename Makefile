...
.PHONY: help dotnet test lean-cache-ensure lean lean-report build clean-lanes emit ingest echo-residual-summary selftest scratch-sweep gate perf-report deliver-check receipts-stage derived-refresh deposit cover show-atom worktree pr-open pr-update refactor-p0-0-gate-authority
