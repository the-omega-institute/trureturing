...
ledger-append:
	@dotnet run --project tools/StrataLint.Cli/StrataLint.Cli.csproj --configuration Release -- ledger-append --candidate-lean-report "$(LEAN_REPORT)"
