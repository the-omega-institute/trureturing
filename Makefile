...
theory-candidates:
	@dotnet run --no-build --project tools/StrataLint.Cli/StrataLint.Cli.csproj --configuration Release -- theory-candidates $(if $(strip $(OWNER_OVERRIDE)),--owner-override "$(OWNER_OVERRIDE)",)
