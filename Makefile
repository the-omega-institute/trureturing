...
c0-verify: scratch-sweep
	@dotnet run --project Meta/StrataLint/StrataLint.Cli/StrataLint.Cli.csproj --configuration Release -- c0-verify --base "$(BASE)"

c0-reconcile-trust-root:
	@dotnet run --project Meta/StrataLint/StrataLint.Cli/StrataLint.Cli.csproj --configuration Release -- c0-reconcile-trust-root
