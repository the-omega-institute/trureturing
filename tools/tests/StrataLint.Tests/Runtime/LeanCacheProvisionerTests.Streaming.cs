...
public sealed partial class LeanCacheProvisionerTests
{
    ...
    private static Process StartStreamingReader(SharedLakeFixture fixture, int childExit, string? commandBody = null)
    {
    ...
    private static void WaitForReaderOutput(SharedLakeFixture fixture, Process process)
    {
