...
{
    [Fact]
    public void UpstreamChildClosesBothChainPredicates()
    {
    ...
    [Fact]
    public void IngestAndAlignPreserveUpstreamReceipt()
    {
        var fixture = AtomContextFixture.Create("## Claim\n\nProse.\n");
        ...
        Assert.Contains("conflicting upstream", Assert.Throws<FormatException>(() =>
