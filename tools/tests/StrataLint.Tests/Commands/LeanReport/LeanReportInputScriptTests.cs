...
public sealed class LeanReportInputScriptTests
{
    ...
    public void RegisteredJudgeLibraryLeanSourceChangesProducerButUnrelatedFileDoesNot(string repositoryName)
    {
        ...
        Assert.Equal(2, fixture.Plan(before, after)["recheck"]!.AsArray().Count);
    }
