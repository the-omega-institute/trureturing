...
//
// 2026-08-14 实测(PR #1829):scope 步骤把 2215 条改动路径逐条累加进一个标量再导出,
// 该值 319756 字节,是上限的 2.44 倍;`Summarize candidate engineering scope` 因此
// 整步无输出而红,两条还账本的 PR(#1829/#1839)由此永远合不进 dev。
//
