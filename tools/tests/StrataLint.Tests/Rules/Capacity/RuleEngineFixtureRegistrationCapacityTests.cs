...
public sealed class RuleEngineFixtureRegistrationCapacityTests
{
    ...
    private static RuleFixture Fixture()
    {
        ...
        const string registry = "tools/tests/StrataLint.Configuration.Tests/Fixtures/fixture-registry.yaml";
    ...
    private const string AddedCases = """"
            ...
            {
                const string path = "tools/tests/StrataLint.Configuration.Tests/Fixtures/fixture-registry.yaml";
    ...
    private const string FixtureRegistration = """"
        [[files]]
        pattern = "tools/tests/StrataLint.Configuration.Tests/Fixtures/fixture-registry.yaml"
        kind = "data"
        admission_plane = "judge"
        produced_by = "none"
