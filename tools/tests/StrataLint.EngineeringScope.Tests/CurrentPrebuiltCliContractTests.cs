...
public sealed class CurrentPrebuiltCliContractTests
{
    ...
    public void CurrentHandsOnlyValidatedCliToProducerWithoutRepeatingEngineering(string scenario, string? buildBudget, string? lockBudget, string leanThreads)
    {
        ...
        var originalColdBuild = Environment.GetEnvironmentVariable("STRATALINT_ACCEPT_COLD_BUILD");
        try
        {
            ...
            WriteExecutable("build/bin/make", """
                ...
                [[ "${STRATALINT_ACCEPT_COLD_BUILD:-}" == 1 ]] || exit 95
            ...
            Environment.SetEnvironmentVariable("STRATALINT_ACCEPT_COLD_BUILD", "0");
            ...
            Assert.Equal("0", Environment.GetEnvironmentVariable("STRATALINT_ACCEPT_COLD_BUILD"));
        ...
        finally
        {
            ...
            Environment.SetEnvironmentVariable("STRATALINT_ACCEPT_COLD_BUILD", originalColdBuild);
