...
public sealed class ReleaseConsumerContractTests
{
    ...
    public void OriginalProducerEnvironmentVerifiesButCannotSupplyLocalReuse()
    {
        ...
        TransportFixture.Capture(fixture.Root, "producer-environment", result);
        ...
        TransportFixture.Capture(fixture.Root, "local-reuse", reuse);
        ...
        TransportFixture.Capture(fixture.Root, "compatible-local-reuse", compatible);
    ...
    public void BoundMalformedProducerEvidenceCannotVerify(string damage)
    {
        ...
        TransportFixture.Capture(fixture.Root, "malformed-" + damage, result);
