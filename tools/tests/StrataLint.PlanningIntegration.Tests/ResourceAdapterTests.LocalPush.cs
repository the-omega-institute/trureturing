...
public sealed partial class ResourceAdapterTests
{
    ...
    private static ResourceFixture LocalFixture()
    {
        ...
        PreflightFixture.Configure(fixture);
        var map = File.ReadAllText(Path.Combine(fixture.Root, "Meta/FILEMAP.toml"));
    ...
    {
        var environment = required ? PreflightFixture.EnvironmentFor(fixture) : EnvironmentFor(fixture);
    ...
    {
        TransportFixture.Capture(fixture.Root, "dirty-" + scenario, result);
