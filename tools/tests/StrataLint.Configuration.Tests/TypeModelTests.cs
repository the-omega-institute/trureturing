...
public sealed class TypeModelTests
{
    ...
    public void RuleAndCaseIdsAreClosedByGrammar()
    {
        ...
        Assert.True(RuleId.TryCreate("SL-032", out _));
        Assert.True(RuleId.TryCreate("SL-033", out _));
        Assert.True(RuleId.TryCreate("SL-034", out _));
    ...
    [InlineData("D5/E/values/k44352f53796e746865746963.value--json", "Evidence/D5/values/k44352f53796e746865746963.value.json")]
    ...
    [Theory]
    [InlineData("tools/TestSupport/StrataLint.ConfigurationTestSupport/TestFileMap.cs")]
