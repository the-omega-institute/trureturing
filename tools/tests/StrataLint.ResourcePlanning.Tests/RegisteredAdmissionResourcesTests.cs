    ...
    : IClassFixture<RegisteredAdmissionResourcesTests.RegisteredBase>
{
    ...
    [Theory]
    [InlineData("StrataLint.Cli", "StrataLint.ArchitectureTests,StrataLint.CliIntegration.Tests,StrataLint.RepositoryTopology.Tests,StrataLint.SourceAtomizer.Tests,StrataLint.Tests")]
    ...
    [InlineData("StrataLint.Scribe", "StrataLint.ArchitectureTests,StrataLint.CliIntegration.Tests,StrataLint.FileMap.Tests,StrataLint.RepositoryTopology.Tests,StrataLint.Scribe.Documents.Tests,StrataLint.Scribe.Tests,StrataLint.SourceAtomizer.Tests,StrataLint.Tests")]
    [InlineData("StrataLint.Scribe.Documents", "StrataLint.ArchitectureTests,StrataLint.CliIntegration.Tests,StrataLint.RepositoryTopology.Tests,StrataLint.Scribe.Documents.Tests,StrataLint.SourceAtomizer.Tests,StrataLint.Tests")]
    ...
    public void ProductionAndTestChangesKeepBothRegisteredConsumerSets()
    {
        ...
        Assert.Equal(new[] { "StrataLint.ArchitectureTests", "StrataLint.CliIntegration.Tests", "StrataLint.Engine.Tests", "StrataLint.RepositoryTopology.Tests", "StrataLint.SourceAtomizer.Tests", "StrataLint.Tests" }
            .Select(name => $"tools/tests/{name}/{name}.csproj"), Strings(plan["execution"]!["tests"]!));
        Assert.DoesNotContain("engineering", Strings(plan["resources"]!));
    }
    ...
    public void SharedConfigurationFixtureSelectsItsConsumers()
    {
        ...
        Assert.Equal(new[] { "StrataLint.CliIntegration.Tests", "StrataLint.Configuration.Tests", "StrataLint.DeclaredTemplate.Tests", "StrataLint.Digestion.Tests", "StrataLint.Rules.Tests", "StrataLint.Tests" }
            .Select(name => $"tools/tests/{name}/{name}.csproj"), Strings(plan["execution"]!["tests"]!));
    }
