    ...
    : IClassFixture<RegisteredAdmissionResourcesTests.RegisteredBase>
{
    ...
    public void CachePathChangesRunOnlyRegisteredCacheConsumers(string mode)
    {
        ...
        Assert.Equal(new[] { "StrataLint.BuildIntegration.Tests", "StrataLint.Cache.Release.Tests", "StrataLint.Cache.Tests", "StrataLint.PlanningIntegration.Tests", "StrataLint.RepositoryFileMap.Tests", "StrataLint.TransportIntegration.Tests" }.Select(name => $"tools/tests/{name}/{name}.csproj"), Strings(plan["execution"]!["tests"]!));
        Assert.Empty(plan["execution"]!["lean_targets"]!.AsArray());
        Assert.Equal(new[] { "filemap" }, Strings(plan["execution"]!["checks"]!));
        Assert.Equal(mode == "push" ? new[] { "filemap" } : ["lean-report", "filemap"],
            Strings(plan["execution"]!["steps"]!));
    ...
    [Theory]
    [InlineData("StrataLint.Cli", "StrataLint.ArchitectureTests,StrataLint.CliIntegration.Tests,StrataLint.RepositoryFileMap.Tests,StrataLint.Tests")]
    ...
    public void ProductionAndTestChangesKeepBothRegisteredConsumerSets()
    {
        ...
        Assert.Equal(new[] { "StrataLint.ArchitectureTests", "StrataLint.CliIntegration.Tests", "StrataLint.Engine.Tests", "StrataLint.RepositoryFileMap.Tests", "StrataLint.Tests" }
            .Select(name => $"tools/tests/{name}/{name}.csproj"), Strings(plan["execution"]!["tests"]!));
        Assert.DoesNotContain("engineering", Strings(plan["resources"]!));
    }

    [Theory]
    [InlineData("tools/StrataLint.ReleaseSelection/TruthReleaseSelection.cs", "StrataLint.ArchitectureTests,StrataLint.ReleaseIntegration.Tests,StrataLint.ReleaseSelection.Tests,StrataLint.RepositoryFileMap.Tests")]
    [InlineData("tools/tests/StrataLint.ReleaseSelection.Tests/TruthReleaseSelectionTests.cs", "StrataLint.ArchitectureTests,StrataLint.ReleaseSelection.Tests,StrataLint.RepositoryFileMap.Tests")]
    [InlineData("tools/tests/StrataLint.ReleaseIntegration.Tests/ReleaseCommandTests.cs", "StrataLint.ArchitectureTests,StrataLint.ReleaseIntegration.Tests,StrataLint.RepositoryFileMap.Tests")]
    ...
    [InlineData("StrataLint.NativeReportTestSupport/NativeReportFixture.cs", "StrataLint.ArchitectureTests,StrataLint.NativeTransportIntegration.Tests,StrataLint.RepositoryFileMap.Tests")]
    [InlineData("StrataLint.RuleTestSupport/RuleFixture.cs", "StrataLint.ArchitectureTests,StrataLint.CliIntegration.Tests,StrataLint.DeclaredTemplate.Tests,StrataLint.Digestion.Tests,StrataLint.RepositoryFileMap.Tests,StrataLint.Rules.Tests,StrataLint.Tests")]
    ...
    {
        var plan = Plan(path, "");
        Assert.Equal(new[] { "tools/tests/StrataLint.ArchitectureTests/StrataLint.ArchitectureTests.csproj", "tools/tests/StrataLint.RepositoryFileMap.Tests/StrataLint.RepositoryFileMap.Tests.csproj" }, Strings(plan["execution"]!["tests"]!));
