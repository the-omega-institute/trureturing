...
public sealed partial class RegisteredAdmissionResourcesTests
{
    ...
    [InlineData("Golden/Projection/statement-projection-expansion-v1.json", "pr", "StrataLint.RepositoryFileMap.Tests,StrataLint.Tests,StrataLint.TruthRelease.Tests")]
    ...
    [InlineData("tools/tests/StrataLint.RepositoryFileMap.Tests/FileMapPolicyTests.cs", "push", "StrataLint.ArchitectureTests,StrataLint.RepositoryFileMap.Tests,StrataLint.RepositoryTopology.Tests")]
    [InlineData("tools/tests/StrataLint.RepositoryFileMap.Tests/FileMapPolicyTests.cs", "pr", "StrataLint.ArchitectureTests,StrataLint.RepositoryFileMap.Tests,StrataLint.RepositoryTopology.Tests")]
    [InlineData("tools/tests/StrataLint.RepositoryFileMap.Tests/StrataLint.RepositoryFileMap.Tests.csproj", "push", "StrataLint.ArchitectureTests,StrataLint.RepositoryFileMap.Tests,StrataLint.RepositoryTopology.Tests")]
    [InlineData("tools/tests/StrataLint.RepositoryFileMap.Tests/StrataLint.RepositoryFileMap.Tests.csproj", "pr", "StrataLint.ArchitectureTests,StrataLint.RepositoryFileMap.Tests,StrataLint.RepositoryTopology.Tests")]
