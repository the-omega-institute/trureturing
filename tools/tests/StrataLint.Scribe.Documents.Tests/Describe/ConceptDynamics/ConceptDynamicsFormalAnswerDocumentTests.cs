...
public sealed class ConceptDynamicsFormalAnswerDocumentTests
{
    ...
    [Fact]
    public void AssertionSettlementCeilingConstructsTenDeclarations()
    {
        ...
        Assert.Equal(
            ...
            document.Header.Gid.Value);
        Assert.Equal(10, describes.Length);
        ...
        var disclosure = LatexWriter.WriteStatement(describes[8].StatementFormula!);
