...
public sealed class TrajectorySourceEvidenceTests
{
    ...
    [SkippableFact]
    public void original_trajectory_pass_production_materials_join_and_reject_corruption()
    {
        var directory = Environment.GetEnvironmentVariable("TRAJECTORY_SOURCE_ARTIFACTS");
        Skip.If(string.IsNullOrEmpty(directory), "Focused trajectory :report artifacts were not supplied.");
        ...
        var cases = new[] {
            (Source: "D5/S3/Observer/ProbabilisticClosure/TrajectoryLaws/HasLawTrajectory.lean",
                Name: "D5.S3.Observer.ProbabilisticClosure.TrajectoryLaws.HasLawTrajectory.has_law_traj_measure",
                Telescope: 14, State: 14, Scope: 15, Levels: 2, Coordinates: new[] { 0, 3, 10 }),
            (Source: "D5/S3/Observer/ProbabilisticClosure/TrajectoryLaws/MarkovPrefixMass.lean",
                Name: "D5.S3.Observer.ProbabilisticClosure.TrajectoryLaws.MarkovPrefixMass.markov_chain_law_map_prefix_apply_singleton",
                Telescope: 9, State: 9, Scope: 10, Levels: 1, Coordinates: new[] { 0, 7 }),
        };
