...
public sealed class DeclaredTemplateEscapeRecordTests
{
    ...
    {
        var findings = DeclaredTemplateBindingRule.Evaluate(Slots(DeclaredTemplateUnregisteredFixture.Build(binding: "mirror"), "old"));
    ...
    {
        var findings = DeclaredTemplateBindingRule.Evaluate(Slots(DeclaredTemplateUnregisteredFixture.Build(binding: "mirror"), "full"));
    ...
    {
        var findings = DeclaredTemplateBindingRule.Evaluate(Slots(DeclaredTemplateUnregisteredFixture.Build(binding: "mirror"), "two"));
    ...
    {
        var findings = DeclaredTemplateBindingRule.Evaluate(Slots(DeclaredTemplateUnregisteredFixture.Build(binding: "mirror"), "malformed"));
    ...
    {
        var findings = DeclaredTemplateBindingRule.Evaluate(Slots(
            DeclaredTemplateUnregisteredFixture.Build(binding: "mirror"), kind));
