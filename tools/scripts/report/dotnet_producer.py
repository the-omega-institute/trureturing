...
def seed_targets(root, sdk, projects, task):
    ...
    # Metadata-only SDK calls must not reconcile or seal emitted compilation seeds.
    enabled = "(" + enabled + ") And '$(SkipCompilerExecution)' != 'true'"
...
if __name__ == "__main__":
    ...
    if command == "export":
        export_ci_inputs(pathlib.Path(path))
