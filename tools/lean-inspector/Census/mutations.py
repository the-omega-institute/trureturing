...
def main():
    ...
    cases = [
        ...
        ("drop-over-bound-diagnostic", incremental, "test_over_bound_owner_is_recorded_while_other_owner_splits",
         '    return batches, skipped', '    return batches, []',
         [sys.executable, "-m", "unittest", "tests.test_incremental.IncrementalTests.test_over_bound_owner_is_recorded_while_other_owner_splits"]),
        ("skip-claims-query-complete", python_root / "validation.py", "test_skipped_owner_receipt_and_accounting_survive_cache_warmth",
         '"query_completed": False, "candidates": [], "note": skipped["diagnostic"]',
         '"query_completed": True, "candidates": [], "note": skipped["diagnostic"]',
         [sys.executable, "-m", "unittest", "tests.test_incremental.IncrementalTests.test_skipped_owner_receipt_and_accounting_survive_cache_warmth"]),
