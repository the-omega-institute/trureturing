...
/--
info: node-count rejected IE-C042 KernelProjectionCertificateMismatch root=LeanInformationAudit.Tests.Projection.V3Seal catalog=importedBool component=node:K_:escape_count expected=2 actual=3
edge-omission rejected IE-C040 InvalidGeneratorTransition root=LeanInformationAudit.Tests.Projection.V3Seal catalog=importedBool from=K_ to=K_0 theorem=LeanInformationAudit.Tests.ImportClosureProducer.importedTheorem.«LeanInformationAudit.Tests.Projection.V3Seal/LeanInformationAudit.Tests.ImportClosureProducer.objectArena/importedBool».__information_unit reason=missing-certified-transition
edge-certificate rejected IE-C042 KernelProjectionCertificateMismatch root=LeanInformationAudit.Tests.Projection.V3Seal catalog=importedBool component=edge:K_:K_0:LeanInformationAudit.Tests.ImportClosureProducer.importedTheorem.«LeanInformationAudit.Tests.Projection.V3Seal/LeanInformationAudit.Tests.ImportClosureProducer.objectArena/importedBool».__information_unit:certificate expected="EmissionMutations.K__add_0" actual="Nat.zero_lt_one"
cover-flag rejected IE-C040 InvalidGeneratorTransition root=LeanInformationAudit.Tests.Projection.V3Seal catalog=importedBool from=K_ to=K_0 theorem=LeanInformationAudit.Tests.ImportClosureProducer.importedTheorem.«LeanInformationAudit.Tests.Projection.V3Seal/LeanInformationAudit.Tests.ImportClosureProducer.objectArena/importedBool».__information_unit reason=cover-classification-mismatch
layer-inclusion rejected IE-C031 InvalidLayerChain root=LeanInformationAudit.Tests.Projection.V3Seal catalog=importedBool chain=canonical layer=0 reason=certified-snapshot-mismatch
refinement-proof rejected IE-C027 UncertifiedKernelRefinement root=LeanInformationAudit.Tests.Projection.V3Seal catalog=importedBool finer=LeanInformationAudit.Tests.ImportClosureProducer.importedTheorem.«LeanInformationAudit.Tests.Projection.V3Seal/LeanInformationAudit.Tests.ImportClosureProducer.objectArena/importedBool».__information_unit coarser=LeanInformationAudit.Tests.ImportClosureProducer.importedTheorem.«LeanInformationAudit.Tests.Projection.V3Seal/LeanInformationAudit.Tests.ImportClosureProducer.objectArena/importedBool».__information_unit missing=proof
-/
#guard_msgs in
run_cmd do
