...
/--
info: native_decide rejected IE-C028 AnalysisCertificateMismatch root=LeanInformationAudit.Tests.Projection.V3Seal catalog=importedBool component=proof-method expected=certified-catalog actual=different
invented-route rejected IE-C028 AnalysisCertificateMismatch root=LeanInformationAudit.Tests.Projection.V3Seal catalog=importedBool component=proof-method expected=certified-catalog actual=different
reflected-fused-counts rejected IE-C028 AnalysisCertificateMismatch root=LeanInformationAudit.Tests.Projection.V3Seal catalog=importedBool component=proof-method expected=certified-catalog actual=different
-/
#guard_msgs in
run_cmd do
  ...
  for route in #["native_decide", "invented-route", "reflected-fused-counts"] do
    ...
    let result ← try
      let _ ← liftTermElabM <| serializeV3Artifact root #[candidate]
        (root.str "__system_catalog_irredundant")
      pure "ACCEPTED"
