...
Build it with `make lean LEAN_TARGETS=@reg/LeanInformationAuditRegAnalysis`.
Use `../LeanInformationAuditAnalysis/run-analysis-fixtures.sh OUTPUT_DIRECTORY production` to rebuild
...
namespace LeanInformationAuditRegAnalysis.FrozenRootAnalysis
...
run_cmd do
  ...
  unless Sha256.hex sealArtifact.toUTF8 ==
      Reg.Support.InformationRootContract.expectedSealDigest do
...
end LeanInformationAuditRegAnalysis.FrozenRootAnalysis
