...
internal static class RendererCorpusFixture
{
    internal static void AssertRendererVocabularyCoverage(
    ...
    internal static IReadOnlyList<ScribeDocument> FixedDocumentCorpus()
    {
    ...
    internal static DocumentHeader Header(string gid, string digest) => DocumentHeader.Create(
        GidRef.Create(gid),
        Generality.Instance,
    ...
    internal static IReadOnlyList<Formula> FixedFormulaCorpus()
    {
    ...
    internal static void AddRendererContextCorpus(
    ...
    internal static IReadOnlySet<string> RendererVocabulary(
    ...
    internal static void VisitBlocks(BlockSequence blocks, ISet<string> vocabulary)
    {
    ...
    internal static string FormulaContext(string parent, string role, Formula child) =>
        $"formula-context:{parent}.{role}={FormulaRenderingTraits(child)}";

    internal static string FormulaRenderingTraits(Formula formula) =>
    ...
    internal static string FormulaPrecedence(Formula formula) => formula switch
    {
    ...
    internal static bool ProducesScript(Formula formula) =>
        formula is Formula.Subscript or Formula.Power or Formula.Sequence;

    internal static bool StartsWithNegation(Formula formula) => formula switch
    {
        Formula.Negate => true,
    ...
    internal static string FormulaKey(Formula formula) => formula switch
    {
    ...
    internal static void AppendLengthPrefixed(IncrementalHash aggregate, byte[] value)
    {
