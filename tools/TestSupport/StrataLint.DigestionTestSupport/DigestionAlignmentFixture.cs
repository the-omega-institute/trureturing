...
internal static class DigestionAlignmentFixture
{
    ...
    internal static DigestionLedgerEntry CasEntry(
        string _,
        DigestionAtom atom,
        string casRef) =>
        EntryWithFingerprints(AtomId(atom), atom.Fingerprints) with { CasRef = casRef };

    internal static DigestionLedgerEntry EntryWithFingerprints(
        string atomId,
