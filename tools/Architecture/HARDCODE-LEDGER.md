...
| `tools/TestSupport/StrataLint.CliTestSupport/RuleFixture.cs` and `tools/tests/StrataLint.Tests/Fixtures/fixture-registry.yaml` | The conservative corpus is an explicit synthetic fixture for the sole instantiated M0 theory. Those D5 examples remain valid fixtures after another theory is admitted. |
