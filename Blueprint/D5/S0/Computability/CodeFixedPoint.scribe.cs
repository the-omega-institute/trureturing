        ...
        DocumentDefinition.Create(ScribeDocument.Create(
            ...
            Blocks(
                DocumentBlock.Describe.Theorem(
                    ...
                    LeanTheorem(
                        "D5/S0/Computability/CodeFixedPoint.code_fixed_point"),
                    Disp(Seq(
                    ...
                    DescribeProvenance.LiteratureAttested(Kleene),
                    Blocks(
                        Paragraph(Text(
                ...
                DocumentBlock.Describe.Theorem(
                    ...
                    LeanTheorem(
                        "D5/S0/Computability/CodeFixedPoint.exists_consecutive_codes_equal_behavior"),
                    Disp(Seq(
                        Exists, Sp, F.Id("e"), Comma, Sp,
                        Operatorname, Grp(F.Id("eval")), Open, F.Id("e"), Close,
                        Sp, Eq, Sp,
