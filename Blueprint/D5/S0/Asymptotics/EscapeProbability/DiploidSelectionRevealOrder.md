...
For nonzero s, complete recessivity has the displayed exact change, a cubic remainder after its quadratic leading term, and analytic order two. Under h greater than zero, the exposed change has a quadratic remainder after its linear leading term and analytic order one.
