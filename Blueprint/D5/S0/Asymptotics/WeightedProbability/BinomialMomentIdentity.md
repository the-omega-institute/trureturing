...
$$\sum_{0\leq j\leq \lvert A \rvert} \operatorname{choose}(j,r) \operatorname{eventProbability}\left(q, \lvert C(f) \rvert = j\right) = \sum_{T\subseteq A, \lvert T \rvert= r} \operatorname{setCaptureProbability}\left(q, f, T\right).$$
