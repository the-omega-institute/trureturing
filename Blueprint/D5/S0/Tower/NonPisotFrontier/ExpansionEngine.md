...
$$\left(\forall p \in R, q \in R,\; \mathit{betaThirteen} \cdot \left(p + q \cdot \mathit{betaThirteen}\right) = 3 \cdot q + \left(p + q\right) \cdot \mathit{betaThirteen} \land \left(2 < \mathit{betaThirteen} \land \mathit{betaThirteen} < 3\right)\right) \land \left(\left(0 < \mathit{betaThirteen} - 2 \land \mathit{betaThirteen} - 2 < 1\right) \land \left(0 < 3 - \mathit{betaThirteen} \land 3 - \mathit{betaThirteen} < 1\right)\right)$$
