        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            Blocks(
                ...
                Describe.Lean(
                    ...
                    StatementSource.FromAuthor(Equal(Call("fibWord", q), criterion)),
                ...
                Describe.Lean(
                    ...
                    DeclarationHandle.Create("D5/S0/Tower/GoldenGapZeckendorf.goldenGapWord_eq_zeckendorf_word"),
                    H("The frozen gap word is the least-digit test"),
                    StatementSource.FromAuthor(Equal(Call("goldenGapWord", q), criterion)),
                    AssessedProvenance.FromRepo(),
                    Blocks(
                        Paragraph(Text(
