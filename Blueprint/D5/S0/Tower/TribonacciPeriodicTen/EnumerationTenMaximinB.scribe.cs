...
internal sealed class EnumerationTenMaximinBDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create()
    {
        ...
        const string declarationPrefix =
            "D5/S0/Tower/TribonacciPeriodicTen/EnumerationTenMaximinB.";

        return DocumentDefinition.Create(ScribeNode.Create(
            "Period-ten orbits 15 through 28 have a low arm below the champion.",
            H("Enumeration Ten Maximin B"),
            Blocks(
                Paragraph(Text(
                ...
                Describe.Lean(
                    DescribeId.Create("period-ten-orbit-15-has-a-low-arm"),
                    DeclarationHandle.Create(declarationPrefix + "tribonacci_period_ten_orbit_15_low_arm"),
                    H("Enumeration Ten Maximin B"),
