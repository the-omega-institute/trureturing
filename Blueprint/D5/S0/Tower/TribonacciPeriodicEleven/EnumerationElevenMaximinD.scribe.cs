...
internal sealed class EnumerationElevenMaximinDDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create()
    {
        ...
        const string declarationPrefix =
            "D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenMaximinD.";

        return DocumentDefinition.Create(ScribeNode.Create(
            "Period-eleven Tribonacci certificates, part MaximinD.",
            H("Enumeration Eleven MaximinD"),
            Blocks(
                Paragraph(Text(
                    "The enumerator was calibrated against all three committed levels before "
                        ...
                        + "exactly.")),
                Describe.Lean(
                    DescribeId.Create("period-eleven-orbit-46-has-a-low-arm"),
                    DeclarationHandle.Create(declarationPrefix + "tribonacci_period_eleven_orbit_46_low_arm"),
                    H("Enumeration Eleven MaximinD"),
