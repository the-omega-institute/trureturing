# Enumeration Eleven ValidA

## Abstract

Period-eleven Tribonacci certificates, part ValidA.
...
**Theorem 1.1 (Enumeration Eleven ValidA).**
...
*Proof.* Machine-checked in Lean as `D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenValidA.tribonacci_period_eleven_orbits_01_02_valid_and_nodup` (`✓ std3`). ∎
...
- Truth anchor: `D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenValidA.tribonacci_period_eleven_orbits_01_02_valid_and_nodup`
- Dependency: [D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenData](EnumerationElevenData.md)
