...
internal sealed class EnumerationElevenMaximinCDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create()
    {
        ...
        const string declarationPrefix =
            "D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenMaximinC.";

        return DocumentDefinition.Create(ScribeNode.Create(
            "Period-eleven Tribonacci certificates, part MaximinC.",
            H("Enumeration Eleven MaximinC"),
            Blocks(
                Paragraph(Text(
                    "The enumerator was calibrated against all three committed levels before "
                        ...
                        + "exactly.")),
                Describe.Lean(
                    DescribeId.Create("period-eleven-orbit-31-has-a-low-arm"),
                    DeclarationHandle.Create(declarationPrefix + "tribonacci_period_eleven_orbit_31_low_arm"),
                    H("Enumeration Eleven MaximinC"),
