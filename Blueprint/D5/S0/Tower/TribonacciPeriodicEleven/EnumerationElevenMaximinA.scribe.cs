...
internal sealed class EnumerationElevenMaximinADocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create()
    {
        ...
        const string declarationPrefix =
            "D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenMaximinA.";

        return DocumentDefinition.Create(ScribeNode.Create(
            "Period-eleven Tribonacci certificates, part MaximinA.",
            H("Enumeration Eleven MaximinA"),
            Blocks(
                Paragraph(Text(
                    "The enumerator was calibrated against all three committed levels before "
                        ...
                        + "exactly.")),
                Describe.Lean(
                    DescribeId.Create("period-eleven-orbit-01-has-a-low-arm"),
                    DeclarationHandle.Create(declarationPrefix + "tribonacci_period_eleven_orbit_01_low_arm"),
                    H("Enumeration Eleven MaximinA"),
