# Enumeration Eleven MaximinC

## Abstract

Period-eleven Tribonacci certificates, part MaximinC.
...
**Theorem 1.1 (Enumeration Eleven MaximinC).**
...
*Proof.* Machine-checked in Lean as `D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenMaximinC.tribonacci_period_eleven_orbit_31_low_arm` (`✓ std3`). ∎
...
- Truth anchor: `D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenMaximinC.tribonacci_period_eleven_orbit_31_low_arm`
- Dependency: [D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenMaximinB](EnumerationElevenMaximinB.md)
