...
internal sealed class EnumerationElevenValidCDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create()
    {
        ...
        const string declarationPrefix =
            "D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenValidC.";

        return DocumentDefinition.Create(ScribeNode.Create(
            "Period-eleven Tribonacci certificates, part ValidC.",
            H("Enumeration Eleven ValidC"),
            Blocks(
                Paragraph(Text(
                    "The enumerator was calibrated against all three committed levels before "
                        ...
                        + "exactly.")),
                Describe.Lean(
                    DescribeId.Create("period-eleven-orbits-41-42-are-valid"),
                    DeclarationHandle.Create(declarationPrefix + "tribonacci_period_eleven_orbits_41_42_valid_and_nodup"),
                    H("Enumeration Eleven ValidC"),
