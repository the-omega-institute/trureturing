# Enumeration Eleven MaximinA

## Abstract

Period-eleven Tribonacci certificates, part MaximinA.
...
**Theorem 1.1 (Enumeration Eleven MaximinA).**
...
*Proof.* Machine-checked in Lean as `D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenMaximinA.tribonacci_period_eleven_orbit_01_low_arm` (`✓ std3`). ∎
...
- Truth anchor: `D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenMaximinA.tribonacci_period_eleven_orbit_01_low_arm`
- Dependency: [D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenValidD](EnumerationElevenValidD.md)
