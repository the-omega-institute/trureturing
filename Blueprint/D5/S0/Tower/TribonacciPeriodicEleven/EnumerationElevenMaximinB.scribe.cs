...
internal sealed class EnumerationElevenMaximinBDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create()
    {
        ...
        const string declarationPrefix =
            "D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenMaximinB.";

        return DocumentDefinition.Create(ScribeNode.Create(
            "Period-eleven Tribonacci certificates, part MaximinB.",
            H("Enumeration Eleven MaximinB"),
            Blocks(
                Paragraph(Text(
                    "The enumerator was calibrated against all three committed levels before "
                        ...
                        + "exactly.")),
                Describe.Lean(
                    DescribeId.Create("period-eleven-orbit-16-has-a-low-arm"),
                    DeclarationHandle.Create(declarationPrefix + "tribonacci_period_eleven_orbit_16_low_arm"),
                    H("Enumeration Eleven MaximinB"),
