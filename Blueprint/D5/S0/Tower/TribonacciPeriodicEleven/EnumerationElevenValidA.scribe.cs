...
internal sealed class EnumerationElevenValidADocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create()
    {
        ...
        const string declarationPrefix =
            "D5/S0/Tower/TribonacciPeriodicEleven/EnumerationElevenValidA.";

        return DocumentDefinition.Create(ScribeNode.Create(
            "Period-eleven Tribonacci certificates, part ValidA.",
            H("Enumeration Eleven ValidA"),
            Blocks(
                Paragraph(Text(
                    "The enumerator was calibrated against all three committed levels before "
                        ...
                        + "exactly.")),
                Describe.Lean(
                    DescribeId.Create("period-eleven-orbits-01-02-are-valid"),
                    DeclarationHandle.Create(declarationPrefix + "tribonacci_period_eleven_orbits_01_02_valid_and_nodup"),
                    H("Enumeration Eleven ValidA"),
