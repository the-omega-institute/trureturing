...
internal sealed class EnumerationNineMaximinADocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create()
    {
        ...
        const string declarationPrefix =
            "D5/S0/Tower/TribonacciPeriodicNine/EnumerationNineMaximinA.";

        return DocumentDefinition.Create(ScribeNode.Create(
            "Period-nine orbits A through M have a low arm at or below the champion value.",
            H("Enumeration Nine Maximin A"),
            Blocks(
                Paragraph(Text(
                ...
                Describe.Lean(
                    DescribeId.Create("period-nine-orbit-a-has-a-low-arm"),
                    DeclarationHandle.Create(declarationPrefix + "tribonacci_period_nine_orbit_a_low_arm"),
                    H("Enumeration Nine Maximin A"),
