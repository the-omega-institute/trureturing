...
$$\forall A \in \mathit{Type}, Y \in \mathit{Type}, f \in Y \to Y, g \in A \to \left(A \to Y\right),\; \left(\forall y \in Y,\; \operatorname{f}\left(y\right) \ne y\right) \Rightarrow \operatorname{IsEscaped}\left(f, g\right)$$
