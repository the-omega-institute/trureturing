...
$$\forall y \in Y,\; \operatorname{f}\left(y\right) \ne y \Rightarrow \operatorname{IsEscaped}\left(f, g\right)$$
...
$$\left(\forall y \in Y,\; \operatorname{f}\left(y\right) \ne y \Rightarrow \operatorname{IsEscaped}\left(f, g\right)\right) \land \exists f \in \mathit{Y0}, g \in \mathit{L0},\; \neg \operatorname{IsEscaped}\left(f, g\right)$$
