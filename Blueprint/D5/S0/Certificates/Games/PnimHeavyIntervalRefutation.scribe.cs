    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Definition("grundy", "Grundy evaluation by cell count", GrundyFormula(),
                "mex is the frozen least-excluded-value function of CrimGrundyRefutation, "
                    + "imported rather than restated. The Lean definition uses well-founded "
                    + "recursion on cell count; the termination measure is discharged inside "
                    + "the definition and is not part of the mathematical statement. The "
                    + "terminal empty list has value zero."),
