...
internal sealed class RationalSTCutCertificateDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        "Exact flow conservation and capacity checks certify a global minimum cut.", H("RationalSTCutCertificate"), Blocks(
            ...
            Describe.Lean(DescribeId.Create("st-cut-value"), DeclarationHandle.Create(Prefix + "stCutValue"),
            ...
            Describe.Lean(DescribeId.Create("stcut-certificate"), DeclarationHandle.Create(Prefix + "STCutCertificate"),
            ...
            Describe.Lean(DescribeId.Create("flow-value"), DeclarationHandle.Create(Prefix + "flowValue"),
            ...
            Describe.Lean(DescribeId.Create("valid-stcut-certificate"), DeclarationHandle.Create(Prefix + "ValidSTCutCertificate"),
            ...
            Describe.Lean(DescribeId.Create("check-stcut-certificate"), DeclarationHandle.Create(Prefix + "checkSTCutCertificate"),
            ...
            Describe.Lean(DescribeId.Create("check-stcut-certificate-eq-true-iff"), DeclarationHandle.Create(Prefix + "checkSTCutCertificate_eq_true_iff"),
            ...
            Describe.Lean(DescribeId.Create("flow-cut-accounting"), DeclarationHandle.Create(Prefix + "flow_cut_accounting"),
            ...
            Describe.Lean(DescribeId.Create("flow-value-le-every-cut"), DeclarationHandle.Create(Prefix + "flowValue_le_every_cut"),
            ...
            Describe.Lean(DescribeId.Create("check-stcut-certificate-sound"), DeclarationHandle.Create(Prefix + "checkSTCutCertificate_sound"),
