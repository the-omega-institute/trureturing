...
Lean statement: `D5/S0/Certificates/FiniteSublevelCover.sublevel_mem_target_of_local_steps`

*Proof.* Machine-checked in Lean as `D5/S0/Certificates/FiniteSublevelCover.sublevel_mem_target_of_local_steps` (`✓ std3`). ∎
...
- Truth anchor: `D5/S0/Certificates/FiniteSublevelCover.sublevel_mem_target_of_local_steps`
