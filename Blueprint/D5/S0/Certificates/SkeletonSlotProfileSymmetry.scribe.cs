...
internal sealed class SkeletonSlotProfileSymmetryDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Describe.Lean(DescribeId.Create("skeletonslotprofilesymmetry-relabel-gap"),
            ...
            Describe.Lean(DescribeId.Create("skeletonslotprofilesymmetry-relabel-readout"),
            ...
            Describe.Lean(DescribeId.Create("skeletonslotprofilesymmetry-orderedfive"),
                ...
                DescribeRole.Definition),
            Describe.Lean(DescribeId.Create("skeletonslotprofilesymmetry-orderedfive-profiles"),
                ...
                DescribeRole.Theorem),
            Describe.Lean(DescribeId.Create("skeletonslotprofilesymmetry-orderedfive-anchor"),
            ...
            Describe.Lean(DescribeId.Create("skeletonslotprofilesymmetry-fiveoutputcases"),
                ...
                DescribeRole.Definition),
            Describe.Lean(DescribeId.Create("skeletonslotprofilesymmetry-fiveoutputcases-card"),
                ...
                DescribeRole.Theorem),
            Describe.Lean(DescribeId.Create("skeletonslotprofilesymmetry-fiveoutputcases-cover"),
