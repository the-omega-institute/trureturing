...
Lean statement: `D5/S0/Certificates/CheckedRationalBoxCover.Step`

*Formalization.* `D5/S0/Certificates/CheckedRationalBoxCover.Step` (`✓ std3`).
...
Lean statement: `D5/S0/Certificates/CheckedRationalBoxCover.checkForest`

*Formalization.* `D5/S0/Certificates/CheckedRationalBoxCover.checkForest` (`✓ std3`).
...
Lean statement: `D5/S0/Certificates/CheckedRationalBoxCover.checked_forest_covers_sublevel`

*Proof.* Machine-checked in Lean as `D5/S0/Certificates/CheckedRationalBoxCover.checked_forest_covers_sublevel` (`✓ std3`). ∎
...
- Truth anchor: `D5/S0/Certificates/CheckedRationalBoxCover.Step`
- Truth anchor: `D5/S0/Certificates/CheckedRationalBoxCover.checkForest`
- Truth anchor: `D5/S0/Certificates/CheckedRationalBoxCover.checked_forest_covers_sublevel`
- Dependency: [D5/S0/Certificates/FiniteSublevelCover](FiniteSublevelCover.md)
- Dependency: [D5/S0/Certificates/RationalIntervalExpression](RationalIntervalExpression.md)
