            ...
            Describe.Lean(
                ...
                Blocks(Paragraph(Text(
                    "The operator is defined by equation 2.1 at D = 0. Section 5.1 on "
                        ...
                        + "point. Admission basis is escape-witness, section 3.2 form (2): "
                        + "the result is produced by its live numerical computation. "
                        + "The refutes edge supplies the separate computational-use condition. "
