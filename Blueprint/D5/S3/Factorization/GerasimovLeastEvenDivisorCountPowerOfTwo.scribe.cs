...
internal sealed class GerasimovLeastEvenDivisorCountPowerOfTwoDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        "The positive-index form of Gerasimov's A187941 conjecture. The literal offset-0 "
            + "reading of the comment fails at n = 0, since a(0) = 1 = 2^0 while 0 is neither "
            + "prime nor 1; this endpoint is disclosed here and not formalized.",
