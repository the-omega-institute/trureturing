...
$$\begin{gathered}\forall Y: \operatorname{Type}, O: \operatorname{Type},\\{}[\operatorname{Finite} Y], [\operatorname{Nonempty} Y],\\{}\tau: Y \to Y, q: Y \to O, \operatorname{Surjective}(q),\\{}(\forall K: O \to \operatorname{PMF}(O), \operatorname{Eff}(K) \iff (\forall \mu: \operatorname{PMF}(Y), q_{*}(\tau_{*}(\mu)) = K_{*}(q_{*}(\mu)))),\\{}(\forall \Sigma: O \to O, \operatorname{Fac}(\Sigma) \iff (\forall y: Y, q(\tau(y)) = \Sigma(q(y)))),\\{}(\exists K: O \to \operatorname{PMF}(O), \operatorname{Eff}(K) \iff \exists \Sigma: O \to O, \operatorname{Fac}(\Sigma)) \land\\{}(\exists \Sigma: O \to O, \operatorname{Fac}(\Sigma) \iff \operatorname{observationStabilityDepth}(\tau, q) = 0) \land\\{}(\forall K: O \to \operatorname{PMF}(O), \operatorname{Eff}(K) \Rightarrow \exists! \Sigma: O \to O, \operatorname{Fac}(\Sigma) \land \forall o: O, K(o) = \delta_{\Sigma(o)}) \land\\{}(\exists K: O \to \operatorname{PMF}(O), \operatorname{Eff}(K) \Rightarrow \exists! K: O \to \operatorname{PMF}(O), \operatorname{Eff}(K)).\end{gathered}$$
