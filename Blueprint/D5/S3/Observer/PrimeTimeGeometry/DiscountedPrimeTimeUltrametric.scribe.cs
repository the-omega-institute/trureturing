                ...
                Blocks(
                    Paragraph(Text(
                        "The source standing carrier clause requires strictly positive weight "
                            ...
                            + "clauses of the source volume, cited here so the claim can be "
                            + "checked against the source rather than taken on this document's "
                            + "word. The opening setup of Section 32, at source line 2016, "
                            + "assigns a positive weight to every coordinate, and Definition "
                            + "33.1 reuses that same weight family; Theorems 32.1 and 32.2 sit "
                            + "in between, so that setup is inherited rather than immediately "
                            + "adjacent. The opening clause of Section 33 sets 0 < gamma <= 1 "
                            + "and is the only place the upper bound appears. The preamble to "
                            + "Theorem 33.2 at line 2083 separately reiterates positive weights "
                            + "and the lower bound gamma > 0 only. The source states these in "
                            + "LaTeX; they are transcribed to plain text here because Scribe "
                            + "text runs carry no raw LaTeX delimiters, and the verbatim "
                            + "quotations are kept in the Lean docstring instead. They are "
                            + "therefore not premises introduced here; the atom for Theorem "
                            + "33.1 is a slice that does not carry them. The proof only invokes "
                            + "that positivity on the selected finite budget J, but the public "
