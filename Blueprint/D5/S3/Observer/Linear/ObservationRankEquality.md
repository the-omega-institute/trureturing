...
*Proof.* Machine-checked in Lean as `D5/S3/Observer/Linear/ObservationRankEquality.observation_rank_equality` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/Observer/Linear/ObservationRankEquality.observation_rank_equality`
