    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeDocument.Create(
        ...
        Blocks(
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem("D5/S3/Observer/Conditioning.recordWeight_sum"),
                RecordWeightSumFormula(),
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem("D5/S3/Observer/Conditioning.unreadState_trace"),
                UnreadTraceFormula(),
                DescribeProvenance.RepoDerived(),
                Blocks(Paragraph(Text(
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem("D5/S3/Observer/Conditioning.unreadState_idempotent"),
                UnreadIdempotentFormula(),
                DescribeProvenance.RepoDerived(),
                Blocks(Paragraph(Text(
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem("D5/S3/Observer/Conditioning.unreadState_fixed_iff"),
                UnreadFixedFormula(),
                DescribeProvenance.RepoDerived(),
                Blocks(Paragraph(Text(
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem("D5/S3/Observer/Conditioning.conditionalState_isState"),
                ConditionalStateFormula(),
                DescribeProvenance.RepoDerived(),
                Blocks(Paragraph(Text(
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem("D5/S3/Observer/Conditioning.unread_eq_weighted_ensemble"),
