        ...
        Blocks(
            Describe.Lean(
                ...
                StatementSource.FromAuthor(Disp(Seq(
                    Operatorname, Grp(F.Id("let")), Sp, F.Id("HiddenAddress"), Sp,
                    Colon, Eq, Sp, Prod, Underscore,
                    Grp(F.Id("p"), Sp, InMacro, Sp, Mathbb, Grp(F.Id("P"))), Sp,
                    Mathbb, Grp(F.Id("Z")), Underscore, Grp(F.Id("p")), Comma, Esc,
                    Forall, Sp, F.Id("jump"), Sp,
                    InMacro, Sp, Operatorname, Grp(F.Id("AddHom")), Open,
                    Mathbb, Grp(F.Id("Z")), Comma, Sp,
                    F.Id("HiddenAddress"), Close,
