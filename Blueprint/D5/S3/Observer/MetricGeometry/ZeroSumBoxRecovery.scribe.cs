...
internal sealed class ZeroSumBoxRecoveryDocument : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Observer/MetricGeometry/ZeroSumBoxRecovery.";
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        H("Sharp Zero-Sum Box Recovery"),
        Blocks(
            Describe.Lean(
                DescribeId.Create("zero-sum-box-data"),
                DeclarationHandle.Create(Prefix + "Data"),
                H("Observation space"),
            ...
            Describe.Lean(
                DescribeId.Create("zero-sum-box-state"),
                ...
                DescribeRole.Definition),
            Describe.Lean(
                DescribeId.Create("zero-sum-box-coefficients"),
                DeclarationHandle.Create(Prefix + "coefficientCosts"),
                H("Signed scalar representation costs"),
                StatementSource.WithoutFormula(),
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                ...
                DescribeRole.Definition),
            Describe.Lean(
                DescribeId.Create("zero-sum-box-risk"),
                DeclarationHandle.Create(Prefix + "recoveryRisk"),
                H("Worst-case risk of an arbitrary estimator"),
                StatementSource.WithoutFormula(),
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
            ...
            Describe.Lean(
                ...
                DeclarationHandle.Create(Prefix + "meanProjection"),
                H("A legal reconstruction"),
                StatementSource.WithoutFormula(),
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                ...
                DescribeRole.Definition),
            Describe.Lean(
                DescribeId.Create("zero-sum-box-sharp-recovery"),
                DeclarationHandle.Create(Prefix + "zero_sum_box_recovery_sharp"),
                H("Scalar cost one and attained joint risk four thirds"),
                StatementSource.WithoutFormula(),
                AssessedProvenance.FromRepo(),
                Blocks(
                    Paragraph(Text(
