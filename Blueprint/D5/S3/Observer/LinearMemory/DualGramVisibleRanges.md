...
*Proof.* Machine-checked in Lean as `D5/S3/Observer/Linear/DualGramVisibleRanges.dual_gram_visible_ranges` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/Observer/Linear/DualGramVisibleRanges.dual_gram_visible_ranges`
