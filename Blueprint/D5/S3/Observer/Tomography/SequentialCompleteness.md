...
$$\forall d\in \mathbb{N}, \operatorname{NeZero}\left(d\right), A: \operatorname{Type},\\{}E: A \to \operatorname{Herm}_{d}^{0},\\{}V_{0} = span\left(\mathbb{R}, (E_{i}: i\in A)\right), V = \mathbb{R}I + V_{0},\\{}N = V^{\perp},\\{}\operatorname{Injective}\left((\rho: DensityState\left(Fin\left(d\right)\right) \mapsto (i: A \mapsto \Re Tr\left(matrix\left(\rho\right) E_{i}\right)))\right) \iff N = \{0\} \iff V = \operatorname{Herm}_{d}.$$
