...
*Proof.* Machine-checked in Lean as `D5/S3/Observer/Tomography/ObserverInnovationEquation.observer_innovation_equation` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/Observer/Tomography/ObserverInnovationEquation.observer_innovation_equation`
