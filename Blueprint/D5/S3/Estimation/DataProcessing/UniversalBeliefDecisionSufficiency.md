# Universal Belief Decision Sufficiency
...
*Proof.* Machine-checked in Lean as `D5/S3/Estimation/DataProcessing/UniversalBeliefDecisionSufficiency.task_independent_belief_sufficiency` (`✓ std3`). ∎
...
A terminal decision may depend on the entire future transcript. The displayed infimum explicitly ranges over rules d from F to A.
...
- Truth anchor: `D5/S3/Estimation/DataProcessing/UniversalBeliefDecisionSufficiency.task_independent_belief_sufficiency`
- Dependency: [D5/S3/Estimation/SequentialDecisionRisk/TaskIndependentBeliefSufficiency](../SequentialDecisionRisk/TaskIndependentBeliefSufficiency.md)
