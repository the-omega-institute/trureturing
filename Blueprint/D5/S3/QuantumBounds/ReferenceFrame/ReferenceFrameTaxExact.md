...
$$\begin{gathered} N \in \mathbb{N},\quad2\leq N\longrightarrow \\ U_{N}^{*} U_{N} = I,\quad n(exchange(x)) = n(x), \\ \forall c \in \mathbb{R}^{N},\quad \mathcal{E}_{c}(\rho) = \sum_{r \in \operatorname{Fin}(N)} K_{r} \rho K_{r}^{*}, \\ \forall c \in \mathbb{R}^{N},\quad F_{e}(c) = Q_{N}(c) = \lvert Jc\rvert_{2}^{2}, \\ F_{e}^{\mathrm{opt}}(N):=\max_{c \in \mathbb{R}^{N}, \sum_{i} c_{i}^{2}=1} F_{e}(c) = \operatorname{cos}(\frac{\pi}{N+1})^{2}, \\ 1-F_{e}^{\mathrm{opt}}(N) = \sin(\frac{\pi}{N+1})^{2}, \\ 2\leq N \longrightarrow 1-Q_{N}((\frac{1}{\sqrt{N}})_{m \in \operatorname{Fin}(N)}) = \frac{3}{2N}, \\ \operatorname{squaredTopEigenspace}_{\mathbb{R}}(N) = \operatorname{topModeSpace}_{\mathbb{R}}(N),\quad\operatorname{finrank}_{\mathbb{R}}(\operatorname{squaredTopEigenspace}_{\mathbb{R}}(N)) = 2 \end{gathered}$$
