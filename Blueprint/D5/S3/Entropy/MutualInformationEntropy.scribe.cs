...
internal sealed class MutualInformationEntropyDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeDocument.Create(
        Header(
            "D5/S3/Entropy/MutualInformationEntropy",
            "Finite mutual information in nats decomposes into marginal and joint Shannon entropies, yielding entropy subadditivity."),
        H("Mutual Information as an Entropy Balance"),
        Blocks(
            DocumentBlock.Describe.Theorem(
                DescribeId.Create("mutual-information-is-the-entropy-balance"),
                H("Mutual information is the entropy balance"),
                LeanTheorem(
                ...
                Blocks(
                    ...
                    Paragraph(Text(
                        ...
                        "excluded.")))),
            DocumentBlock.Describe.Theorem(
                DescribeId.Create("joint-entropy-is-subadditive"),
                H("Joint entropy is subadditive"),
                LeanTheorem(
