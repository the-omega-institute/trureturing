...
internal sealed class ConditionalEntropyEqualityDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeDocument.Create(
        Header(
            "D5/S3/Entropy/ConditionalEntropyEquality",
        ...
        Blocks(
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/Entropy/ConditionalEntropyEquality.conditional_entropy_eq_zero_of_point_mass_on_support"),
                Disp(Seq(
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/Entropy/ConditionalEntropyEquality.point_mass_on_support_of_conditional_entropy_eq_zero"),
                Disp(Seq(
                    Begin, Grp(F.Id("gathered")),
                    Forall, Sp, Iota, Comma, Sp, Kappa, Esc,
                    OpenBracket,
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/Entropy/ConditionalEntropyEquality.conditional_entropy_eq_zero_iff_point_mass_on_support"),
                Disp(Seq(
                    Begin, Grp(F.Id("gathered")),
                    Forall, Sp, Iota, Comma, Sp, Kappa, Esc,
                    OpenBracket,
