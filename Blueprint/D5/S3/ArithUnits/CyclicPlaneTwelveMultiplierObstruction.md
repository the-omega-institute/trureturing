...
$$\forall R \in Type, D \in Finset\left(R\right), m \in R, shift \in R, center \in R,\; \left(CommRing\left(R\right) \land \left(m \cdot center = center + shift \land imageMul\left(D, m\right) = imageAdd\left(D, shift\right)\right)\right) \Rightarrow imageMul\left(imageSub\left(D, center\right), m\right) = imageSub\left(D, center\right)$$
