    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeDocument.Create(
        ...
        Blocks(
            DocumentBlock.Describe.Theorem(
                ...
                Disp(Seq(Begin, Grp(F.Id("gathered")), Nl, F.Id("m"), Gt, D(0), Comma, Quad, Sp, F.Id("H"), Leq, Sp, Mathbb, Grp(F.Id("Z")), Slash, F.Id("m"), Mathbb, Grp(F.Id("Z")), Comma, Quad, Nl, F.Id("H"), Caret, Perp, Eq, OpenBrace, F.Id("k"), Colon, Forall, Sp, F.Id("h"), InMacro, Sp, F.Id("H"), Comma, Esc, F.Id("e"), Caret, Grp(D(2), Pi, Sp, F.Id("i"), Sp, F.Id("kh"), Slash, F.Id("m")), Eq, D(1), CloseBrace, Comma, RowBreak, Nl, Widehat, Sp, F.Id("f"), Open, F.Id("k"), Close, Eq, Sum, Underscore, Grp(F.Id("x"), InMacro, Mathbb, Grp(F.Id("Z")), Slash, F.Id("m"), Mathbb, Grp(F.Id("Z"))), F.Id("f"), Open, F.Id("x"), Close, F.Id("e"), Caret, Grp(Minus, D(2), Pi, Sp, F.Id("i"), Sp, F.Id("kx"), Slash, F.Id("m")), Nl, Quad, Rightarrow, Quad, Nl, Sum, Underscore, Grp(F.Id("h"), InMacro, Sp, F.Id("H")), F.Id("f"), Open, F.Id("h"), Close, Eq, Frac, Grp(Bar, F.Id("H"), Bar), Grp(F.Id("m")), Sum, Underscore, Grp(F.Id("k"), InMacro, Sp, F.Id("H"), Caret, Perp), Widehat, Sp, F.Id("f"), Open, F.Id("k"), Close, Dot, Nl, End, Grp(F.Id("gathered")))),
