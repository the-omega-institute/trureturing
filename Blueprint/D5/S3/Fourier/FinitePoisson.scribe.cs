    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(
                ...
                DeclarationHandle.Create("D5/S3/Fourier/FinitePoisson.finite_poisson_summation"),
            ...
            Describe.Lean(
                ...
                DeclarationHandle.Create("D5/S3/Fourier/FinitePoisson.finite_poisson_mod_four_even_delta"),
                H("The even subgroup has an explicit Poisson witness"),
                StatementSource.FromAuthor(Disp(Seq(F.Id("H"), Eq, OpenBrace, D(0), Comma, D(2), CloseBrace, Comma, Quad, Sp, F.Id("f"), Open, F.Id("x"), Close, Eq, Mathbf, Grp(D(1)), Underscore, Grp(F.Id("x"), Eq, D(0)), Nl, Quad, Rightarrow, Quad, Nl, Sum, Underscore, Grp(F.Id("h"), InMacro, Sp, F.Id("H")), F.Id("f"), Open, F.Id("h"), Close, Eq, D(1), Eq, Frac, Grp(Bar, F.Id("H"), Bar), Grp(D(4)), Sum, Underscore, Grp(F.Id("k"), InMacro, Sp, F.Id("H"), Caret, Perp), Widehat, Sp, F.Id("f"), Open, F.Id("k"), Close, Dot))),
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
