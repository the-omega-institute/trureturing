        ...
        Blocks(
            DocumentBlock.Describe.Theorem(
                ...
                Disp(Seq(
                    ...
                    F.Id("D"), Open, F.Id("a"), Vert, Vert, F.Id("b"), Close,
                    Colon, Eq,
                    ...
                    F.Id("W"), Colon, Sp,
                    F.Id("X"), To, F.Id("Y"), To, Mathbb, Grp(F.Id("R")),
                    Comma, RowBreak,
                    Open,
                    ...
                    Eq, D(1), Close,
                    Close, Sp, Rightarrow, RowBreak,
                    F.Id("D"), Open, F.Id("p"), Vert, Vert, F.Id("q"), Close,
                    Eq,
                    F.Id("D"), Open,
                    F.Id("W"), F.Id("p"), Vert, Vert, F.Id("W"), F.Id("q"), Close,
                    Plus,
                    Sum, Underscore, Grp(F.Id("y")),
