...
*Proof.* Machine-checked in Lean as `D5/S3/Weil/TestFunctions/TruncatedCircleMomentBridge.truncated_circle_moment_of_posSemidef` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/Weil/TestFunctions/TruncatedCircleMomentBridge.truncated_circle_moment_of_posSemidef`
