...
*Proof.* Machine-checked in Lean as `D5/S3/Weil/Scattering/PoissonSemigroup.coarse_poisson_semigroup` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/Weil/Scattering/PoissonSemigroup.coarse_poisson_semigroup`
