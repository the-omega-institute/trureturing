    ...
    : IScribeDocumentDefinition
{
    ...
    private static Formula SupportSumFormula()
    {
        ...
        var w = F.Id("w");
        return Disp(Equal(
            Call("Ksupport", m, x, z, w),
            Call("supportWeightedMassKernelSum", m, x, z, w)));
    }
    ...
    private static Formula MassFactorizationFormula()
    {
        ...
        return Disp(Equal(
            Call("GramMass", m, x, p),
            Multiply(
                Multiply(Call("C", x, p), Call("Dmass", m)),
                Call("Cadjoint", x, p))));
    }
    ...
    private static Formula SupportFactorizationFormula()
    {
        ...
        var p = F.Id("p");
        return Disp(Equal(
            Call("GramSupport", m, x, p),
            Multiply(
                Multiply(Call("C", x, p), Call("DmassSupport", m, x)),
                Call("Cadjoint", x, p))));
    }
}
