    ...
    : IScribeDocumentDefinition
{
    ...
    private static Formula PencilFactorizationFormula()
    {
        ...
        return Disp(Equal(
            Call("P", m, x, p, lambda),
            Multiply(
                Multiply(Call("C", x, p), Call("D_shift", m, x, lambda)),
                Call("C_adjoint", x, p))));
    }
    ...
    private static Formula EigenrelationFormula()
    {
        ...
        return Disp(Seq(
            ...
            Equal(
                Call("K_support_v", m, x, p, v),
                Multiply(Call("support", x, a), Call("K_mass_v", m, x, p, v)))));
    }
    ...
    private static Formula PencilAnnihilationFormula()
    {
        ...
        return Disp(Seq(
            Call("IsCauchyDual", x, p, a, v), Sp, Rightarrow, Sp,
            Equal(Call("P_support_a_v", m, x, p, a, v), D(0))));
    }
    ...
    private static Formula MassActionNonzeroFormula()
    {
        ...
        return Disp(Seq(
            ...
            Rightarrow, Sp,
            Call("K_mass_v", m, x, p, v), Sp, Neq, Sp, D(0)));
    }
