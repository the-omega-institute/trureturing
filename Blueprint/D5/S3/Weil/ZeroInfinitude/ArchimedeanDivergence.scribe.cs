    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Under the profile's integrability, nonnegativity, local lower bound, and "
                        + "quadratic decay hypotheses, the weighted packet is integrable. On "
                        + "the interval from T-delta to T+delta, one translated copy contributes "
                        + "at least one half and the other remains nonnegative. Monotonicity of "
                        + "mu then yields the displayed delta-over-two lower bound."))),
                DescribeRole.Theorem),
            Describe.Lean(
