...
## Proposition: Mirror fixed points lie on the critical line
...
## Theorem: The mirror reverses every scaling entry

Provenance: `repo-derived`

Statement: `D5/S3/Weil/ReflectionLedger.mirror_reversal_spec` `✓ std3`
...
## Remark: A symmetry channel is not a location force
...
## Remark: Symmetry does not force fixed points
...
## Remark: Fixed line versus orbit collapse
...
## Remark: Set invariance versus pointwise invariance
...
## Remark: Antilinear reflection produces a line
...
## Remark: An invariant set need not lie in the fixed locus
