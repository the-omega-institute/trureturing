    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeDocument.Create(
        ...
        Blocks(
            ...
            DocumentBlock.Describe.Theorem(
                ...
                Disp(Seq(Forall, Sp, F.Id("A"), Esc, OpenBracket, Operatorname, Grp(F.Id("AddMonoid")), Open, F.Id("A"), Close, CloseBracket, Comma, Esc, Forall, Sp, Ell, Colon, F.Id("A"), To, Underscore, Grp(Plus), Mathbb, Grp(F.Id("R")), Comma, Esc, Open, Exists, Sp, F.Id("a"), Comma, Ell, Open, F.Id("a"), Close, Neq, Sp, D(0), Close, Sp, Rightarrow, Sp, Forall, Sp, F.Id("s"), InMacro, Mathbb, Grp(F.Id("C")), Comma, Esc, Open, F.Id("s"), Eq, Operatorname, Grp(F.Id("mirror")), Open, F.Id("s"), Close, Leftrightarrow, Re, Open, F.Id("s"), Close, Eq, Frac, Grp(D(1)), Grp(D(2)), Close, Sp, Land, Sp, Open, Open, Forall, Sp, F.Id("a"), Comma, Vert, Operatorname, Grp(F.Id("halfDensityReading")), Open, Ell, Comma, F.Id("s"), Comma, F.Id("a"), Close, Vert, Eq, D(1), Close, Leftrightarrow, Re, Open, F.Id("s"), Close, Eq, Frac, Grp(D(1)), Grp(D(2)), Close, Sp, Land, Sp, Open, F.Id("s"), Plus, Overline, Grp(F.Id("s")), Eq, D(1), Leftrightarrow, Re, Open, F.Id("s"), Close, Eq, Frac, Grp(D(1)), Grp(D(2)), Close, Sp, Land, Sp, Open, Operatorname, Grp(F.Id("MemLp")), Open, Operatorname, Grp(F.Id("labeledZetaCoefficient")), Open, F.Id("s"), Close, Comma, D(2), Close, Leftrightarrow, Frac, Grp(D(1)), Grp(D(2)), Lt, Re, Open, F.Id("s"), Close, Close)),
                DescribeProvenance.RepoDerived(),
                Blocks(Paragraph(Text(
