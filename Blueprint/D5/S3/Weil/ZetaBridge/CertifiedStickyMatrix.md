...
*Proof.* Machine-checked in Lean as `D5/S3/Weil/ZetaBridge/CertifiedStickyMatrix.certified_sticky_matrix` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/Weil/ZetaBridge/CertifiedStickyMatrix.certified_sticky_matrix`
