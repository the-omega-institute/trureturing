    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Theorem(
                ...
                "For a positive real exponent, every adjacent eta pair is positive, so "
                    + "their summable series has positive real part. The continuation "
                    + "identity then prevents zeta from vanishing on the interval."),
            Theorem(
