...
internal sealed class InstantiatedSparseCertificateDocument : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Weil/BurnolGram/InstantiatedSparseCertificate.";
