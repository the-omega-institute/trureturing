...
**Theorem 1.1 (Each vertical phase has unit modulus).**

$$\Vert\operatorname{verticalPhase}(t,a)\Vert=1$$

*Proof.* Machine-checked in Lean as `D5/S3/Weil/SpectralDynamics.verticalPhase_norm` (`✓ std3`). ∎
...
For every real time t and prime-axis address a, the vertical phase has norm one. Its base is the positive integer encoded by a and its exponent is purely imaginary. This is the coordinate identity underlying norm preservation of vertical evolution.

**Theorem 1.2 (Vertical evolution is a norm-preserving group).**
...
**Theorem 1.3 (Forward horizontal evolution is a contraction semigroup).**
...
**Theorem 1.4 (Labeled zeta vectors follow the coordinate evolutions).**
...
**Theorem 1.5 (Zero symmetries form the kernel-resonant cross-pairs).**
...
**Remark 1.7 (Diagonal flow and the generator boundary).**
...
**Remark 1.8 (Two regimes and two directions).**
...
**Remark 1.9 (Phase delay is not address delay).**
...
**Remark 1.10 (Off-line pairs remain conditional).**
...
**Remark 1.11 (Counting does not locate real parts).**
...
**Remark 1.12 (Equalities do not supply positivity).**
...
**Remark 1.13 (Speculative off-line effects are not formalized).**
...
**Remark 1.14 (Thermal time is a meta-time, not a physical history).**
...
**Remark 1.15 (Causal direction requires irreversible bookkeeping).**
...
- Truth anchor: `D5/S3/Weil/SpectralDynamics.verticalPhase_norm`
