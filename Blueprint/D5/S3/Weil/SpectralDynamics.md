...
## Theorem: Vertical evolution is a norm-preserving group
...
## Theorem: Forward horizontal evolution is a contraction semigroup

Provenance: `literature-attested` via `D5/L/hedenmalm1997hilbert` (`lit/hedenmalm1997hilbert`)

Statement: `D5/S3/Weil/SpectralDynamics.horizontal_evolution_contraction_semigroup` `✓ std3`
...
## Theorem: Labeled zeta vectors follow the coordinate evolutions

Provenance: `literature-attested` via `D5/L/hedenmalm1997hilbert` (`lit/hedenmalm1997hilbert`)

Statement: `D5/S3/Weil/SpectralDynamics.labeled_zeta_evolution_spec` `✓ std3`
...
## Theorem: Zero symmetries form the kernel-resonant cross-pairs
...
## Theorem: Critical-line predicates use one abscissa
...
## Remark: Thermal time is a meta-time, not a physical history
...
## Remark: Causal direction requires irreversible bookkeeping
