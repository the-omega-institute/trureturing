...
*Proof.* Machine-checked in Lean as `D5/S3/ObserverMemory/WindowRegisterCRT.window_register_crt_decomposition` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/ObserverMemory/WindowRegisterCRT.window_register_crt_decomposition`
