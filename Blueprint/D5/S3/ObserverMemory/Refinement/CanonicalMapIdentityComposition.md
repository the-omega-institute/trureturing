...
$$(\forall q, kappa_{q, q} = id) \land\ (\forall q, r, s,\ \operatorname{Refines}\left(q, r\right) \land \operatorname{Refines}\left(r, s\right) \Rightarrow kappa_{q, s} = kappa_{r, s} \circ kappa_{q, r}).$$
