...
*Proof.* Machine-checked in Lean as `D5/S3/ObserverMemory/FiniteForgettingCertificate.cognitive_state_card` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S3/ObserverMemory/FiniteForgettingCertificate.remember_forget_recall_certificate` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S3/ObserverMemory/FiniteForgettingCertificate.access_revoked_terminal` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S3/ObserverMemory/FiniteForgettingCertificate.misremember_cannot_recall_directly` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S3/ObserverMemory/FiniteForgettingCertificate.finite_history_certificate` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/ObserverMemory/FiniteForgettingCertificate.access_revoked_terminal`
- Truth anchor: `D5/S3/ObserverMemory/FiniteForgettingCertificate.cognitive_state_card`
- Truth anchor: `D5/S3/ObserverMemory/FiniteForgettingCertificate.finite_history_certificate`
- Truth anchor: `D5/S3/ObserverMemory/FiniteForgettingCertificate.misremember_cannot_recall_directly`
- Truth anchor: `D5/S3/ObserverMemory/FiniteForgettingCertificate.remember_forget_recall_certificate`
