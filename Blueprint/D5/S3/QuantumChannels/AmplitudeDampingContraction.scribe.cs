...
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create("For amplitude damping on the Bloch axis, the SLD coherence contraction ratio is the constant one minus gamma, while the RLD ratio is bounded by one in the open Bloch interval and tends to one at the pure-state boundary.",
        ...
        Blocks(
            ...
            Describe.Lean(
                ...
                DeclarationHandle.Create("D5/S3/QuantumChannels/AmplitudeDampingContraction.amplitude_damping_sld_rld_endpoints"),
