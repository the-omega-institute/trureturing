...
internal sealed class ZeroGeometryDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeDocument.Create(
        ...
        H("Zero Geometry Beneath Weil Positivity"),
        Blocks(
            DocumentBlock.Describe.Theorem(
                DescribeId.Create("projected-zero-does-not-erase-the-labeled-vector"),
                H("A projected zero does not erase the labeled vector"),
                LeanTheorem(
                    "D5/S3/Zeros/ZeroGeometry.projection_zero_labeled_vector_spec"),
                Disp(Seq(Forall, Sp, F.Id("A"), Esc, OpenBracket, Operatorname, Grp(F.Id("AddMonoid")), Open, F.Id("A"), Close, CloseBracket, Comma, Esc, Forall, Sp, Ell, Colon, F.Id("A"), To, Underscore, Grp(Plus), Mathbb, Grp(F.Id("R")), Comma, Esc, Forall, Sp, Rho, InMacro, Mathbb, Grp(F.Id("C")), Comma, Esc, Operatorname, Grp(F.Id("classicalZeta")), Open, Rho, Close, Eq, D(0), Sp, Rightarrow, Sp, Operatorname, Grp(F.Id("classicalZeta")), Open, Rho, Close, Eq, D(0), Sp, Land, Sp, Operatorname, Grp(F.Id("labeledZeta")), Open, Ell, Comma, Rho, Close, Neq, Sp, D(0))),
            ...
            DocumentBlock.Describe.Theorem(
                DescribeId.Create("positive-length-entries-detect-off-line-displacement"),
                H("Positive-length entries detect off-line displacement"),
                LeanTheorem(
                    "D5/S3/Zeros/ZeroGeometry.off_line_scaling_entry_spec"),
                Disp(Seq(Forall, Sp, F.Id("A"), Esc, OpenBracket, Operatorname, Grp(F.Id("AddMonoid")), Open, F.Id("A"), Close, CloseBracket, Comma, Esc, Forall, Sp, Ell, Colon, F.Id("A"), To, Underscore, Grp(Plus), Mathbb, Grp(F.Id("R")), Comma, Esc, Forall, Sp, F.Id("s"), InMacro, Mathbb, Grp(F.Id("C")), Comma, Esc, Forall, Sp, F.Id("a"), InMacro, Sp, F.Id("A"), Comma, Esc, D(0), Lt, Ell, Open, F.Id("a"), Close, Sp, Rightarrow, Sp, Operatorname, Grp(F.Id("scalingLedger")), Open, Ell, Comma, F.Id("s"), Comma, F.Id("a"), Close, Eq, Open, Re, Open, F.Id("s"), Close, Minus, Operatorname, Grp(F.Id("criticalAbscissa")), Close, Ell, Open, F.Id("a"), Close, Sp, Land, Sp, Open, Operatorname, Grp(F.Id("scalingLedger")), Open, Ell, Comma, F.Id("s"), Comma, F.Id("a"), Close, Neq, Sp, D(0), Sp, Leftrightarrow, Sp, Re, Open, F.Id("s"), Close, Neq, Operatorname, Grp(F.Id("criticalAbscissa")), Close, Sp, Land, Sp, Open, D(0), Lt, Operatorname, Grp(F.Id("scalingLedger")), Open, Ell, Comma, F.Id("s"), Comma, F.Id("a"), Close, Sp, Leftrightarrow, Sp, Operatorname, Grp(F.Id("criticalAbscissa")), Lt, Re, Open, F.Id("s"), Close, Close, Sp, Land, Sp, Open, Operatorname, Grp(F.Id("scalingLedger")), Open, Ell, Comma, F.Id("s"), Comma, F.Id("a"), Close, Lt, D(0), Sp, Leftrightarrow, Sp, Re, Open, F.Id("s"), Close, Lt, Operatorname, Grp(F.Id("criticalAbscissa")), Close)),
                DescribeProvenance.RepoDerived(),
                Blocks(Paragraph(Text(
            ...
            DocumentBlock.Describe.Theorem(
                DescribeId.Create("a-global-factor-cannot-clear-off-line-scaling"),
            ...
            DocumentBlock.Describe.Theorem(
                DescribeId.Create("zero-data-symmetries-form-the-mirror-quartet"),
                H("ZeroData symmetries form the mirror quartet"),
                LeanTheorem(
                    "D5/S3/Zeros/ZeroGeometry.zero_quartet_scaling_spec"),
                Disp(Seq(Forall, Sp, F.Id("Z"), Colon, Operatorname, Grp(F.Id("ZeroData")), Comma, Esc, Forall, Sp, F.Id("n"), InMacro, Mathbb, Grp(F.Id("N")), Comma, Esc, Forall, Sp, F.Id("A"), Esc, OpenBracket, Operatorname, Grp(F.Id("AddMonoid")), Open, F.Id("A"), Close, CloseBracket, Comma, Esc, Forall, Sp, Ell, Colon, F.Id("A"), To, Underscore, Grp(Plus), Mathbb, Grp(F.Id("R")), Comma, Esc, F.Id("Z"), Underscore, Grp(F.Id("C"), Open, F.Id("n"), Close), Eq, Overline, Grp(F.Id("Z"), Underscore, Grp(F.Id("n"))), Sp, Land, Sp, F.Id("Z"), Underscore, Grp(F.Id("R"), Open, F.Id("n"), Close), Eq, D(1), Minus, F.Id("Z"), Underscore, Grp(F.Id("n")), Sp, Land, Sp, F.Id("Z"), Underscore, Grp(F.Id("C"), Open, F.Id("R"), Open, F.Id("n"), Close, Close), Eq, Operatorname, Grp(F.Id("mirror")), Open, F.Id("Z"), Underscore, Grp(F.Id("n")), Close, Sp, Land, Sp, Open, Forall, Sp, F.Id("a"), Comma, Esc, Operatorname, Grp(F.Id("scalingLedger")), Open, Ell, Comma, F.Id("Z"), Underscore, Grp(F.Id("C"), Open, F.Id("R"), Open, F.Id("n"), Close, Close), Comma, F.Id("a"), Close, Eq, Minus, Operatorname, Grp(F.Id("scalingLedger")), Open, Ell, Comma, F.Id("Z"), Underscore, Grp(F.Id("n")), Comma, F.Id("a"), Close, Close)),
                DescribeProvenance.RepoDerived(),
                Blocks(Paragraph(Text(
            ...
            DocumentBlock.Describe.Theorem(
                DescribeId.Create("mirror-partners-cancel-across-distinct-positions"),
                H("Mirror partners cancel across distinct positions"),
                LeanTheorem(
                    "D5/S3/Zeros/ZeroGeometry.mirror_pair_distinct_iff_off_line_and_cancels"),
                Disp(Seq(Forall, Sp, F.Id("A"), Esc, OpenBracket, Operatorname, Grp(F.Id("AddMonoid")), Open, F.Id("A"), Close, CloseBracket, Comma, Esc, Forall, Sp, Ell, Colon, F.Id("A"), To, Underscore, Grp(Plus), Mathbb, Grp(F.Id("R")), Comma, Esc, Forall, Sp, F.Id("s"), InMacro, Mathbb, Grp(F.Id("C")), Comma, Esc, Open, F.Id("s"), Neq, Operatorname, Grp(F.Id("mirror")), Open, F.Id("s"), Close, Sp, Leftrightarrow, Sp, Re, Open, F.Id("s"), Close, Neq, Operatorname, Grp(F.Id("criticalAbscissa")), Close, Sp, Land, Sp, Open, Forall, Sp, F.Id("a"), Comma, Esc, Operatorname, Grp(F.Id("scalingLedger")), Open, Ell, Comma, F.Id("s"), Comma, F.Id("a"), Close, Plus, Operatorname, Grp(F.Id("scalingLedger")), Open, Ell, Comma, Operatorname, Grp(F.Id("mirror")), Open, F.Id("s"), Close, Comma, F.Id("a"), Close, Eq, D(0), Close)),
                DescribeProvenance.RepoDerived(),
                Blocks(Paragraph(Text(
            ...
            DocumentBlock.Describe.Definition(
                DescribeId.Create("ontological-zero-records-projection-balance-and-closure"),
                H("An ontological zero records projection, balance, and closure"),
                LeanDefinition(
            ...
            DocumentBlock.Describe.Theorem(
                DescribeId.Create("ontological-local-balance-forces-the-critical-line"),
                H("Ontological local balance forces the critical line"),
                LeanTheorem(
                    "D5/S3/Zeros/ZeroGeometry.ontological_zero_re_eq_critical"),
                Disp(Seq(Forall, Sp, F.Id("A"), Esc, OpenBracket, Operatorname, Grp(F.Id("AddMonoid")), Open, F.Id("A"), Close, CloseBracket, Comma, Esc, Forall, Sp, Ell, Colon, F.Id("A"), To, Underscore, Grp(Plus), Mathbb, Grp(F.Id("R")), Comma, Esc, Open, Exists, Sp, F.Id("a"), Comma, Ell, Open, F.Id("a"), Close, Neq, Sp, D(0), Close, Sp, Rightarrow, Sp, Forall, Sp, Mathrm, Grp(F.Id("closedAt")), Colon, Mathbb, Grp(F.Id("C")), To, Operatorname, Grp(F.Id("Prop")), Comma, Esc, Forall, Sp, Rho, InMacro, Mathbb, Grp(F.Id("C")), Comma, Esc, Operatorname, Grp(F.Id("IsOntologicalZero")), Open, Ell, Comma, Mathrm, Grp(F.Id("closedAt")), Comma, Rho, Close, Sp, Rightarrow, Sp, Re, Open, Rho, Close, Eq, Operatorname, Grp(F.Id("criticalAbscissa")))),
                DescribeProvenance.RepoDerived(),
                Blocks(Paragraph(Text(
