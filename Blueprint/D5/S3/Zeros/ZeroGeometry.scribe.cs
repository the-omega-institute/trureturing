    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeDocument.Create(
        ...
        Blocks(
            DocumentBlock.Describe.Theorem(
                ...
                LatexStatement.Create(@"$$\forall A\ [\operatorname{AddMonoid}(A)],\ \forall \ell:A\to_{+}\mathbb{R},\ \forall \rho\in\mathbb{C},\ \operatorname{classicalZeta}(\rho)=0 \Rightarrow \operatorname{classicalZeta}(\rho)=0 \land \operatorname{labeledZeta}(\ell,\rho)\neq 0$$"),
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LatexStatement.Create(@"$$\forall A\ [\operatorname{AddMonoid}(A)],\ \forall \ell:A\to_{+}\mathbb{R},\ \forall s\in\mathbb{C},\ \forall a\in A,\ 0<\ell(a) \Rightarrow \operatorname{scalingLedger}(\ell,s,a)=(\Re(s)-\operatorname{criticalAbscissa})\ell(a) \land (\operatorname{scalingLedger}(\ell,s,a)\neq 0 \Leftrightarrow \Re(s)\neq\operatorname{criticalAbscissa}) \land (0<\operatorname{scalingLedger}(\ell,s,a) \Leftrightarrow \operatorname{criticalAbscissa}<\Re(s)) \land (\operatorname{scalingLedger}(\ell,s,a)<0 \Leftrightarrow \Re(s)<\operatorname{criticalAbscissa})$$"),
                DescribeProvenance.RepoDerived(),
                Blocks(Paragraph(Text(
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LatexStatement.Create(@"$$\forall Z:\operatorname{ZeroData},\ \forall n\in\mathbb{N},\ \forall A\ [\operatorname{AddMonoid}(A)],\ \forall \ell:A\to_{+}\mathbb{R},\ Z_{C(n)}=\overline{Z_{n}} \land Z_{R(n)}=1-Z_{n} \land Z_{C(R(n))}=\operatorname{mirror}(Z_{n}) \land (\forall a,\ \operatorname{scalingLedger}(\ell,Z_{C(R(n))},a)=-\operatorname{scalingLedger}(\ell,Z_{n},a))$$"),
                DescribeProvenance.RepoDerived(),
                Blocks(Paragraph(Text(
