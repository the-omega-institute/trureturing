    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeDocument.Create(
        ...
        Blocks(
            Describe.Lean(
                ...
                DeclarationHandle.Create("D5/S3/Zeros/EulerWindows.primeAxisHeatTrace"),
            ...
            Describe.Lean(
                ...
                DeclarationHandle.Create("D5/S3/Zeros/EulerWindows.prime_axis_heat_trace_eq_zeta"),
                H("The prime-axis heat trace equals classical zeta in the absolute half-plane"),
                StatementSource.FromAuthor(In(Seq(Forall, Sp, F.Id("s"), InMacro, Mathbb, Grp(F.Id("C")), Comma, Esc, D(1), Lt, Re, Open, F.Id("s"), Close, Sp, Rightarrow, Sp, Operatorname, Grp(F.Id("primeAxisHeatTrace")), Open, F.Id("s"), Close, Eq, Operatorname, Grp(F.Id("classicalZeta")), Open, F.Id("s"), Close))),
            ...
            Describe.Lean(
                ...
                DeclarationHandle.Create("D5/S3/Zeros/EulerWindows.finite_euler_window_ne_zero"),
                H("Finite prime windows have no zeros at positive abscissa"),
                StatementSource.FromAuthor(Disp(Seq(Forall, Sp, F.Id("S"), Subset, Underscore, Grp(Operatorname, Grp(F.Id("fin"))), Mathbb, Grp(F.Id("N")), Comma, Esc, Open, Forall, Sp, F.Id("p"), InMacro, Sp, F.Id("S"), Comma, Esc, Operatorname, Grp(F.Id("Prime")), Open, F.Id("p"), Close, Close, Sp, Rightarrow, Sp, Forall, Sp, F.Id("s"), InMacro, Mathbb, Grp(F.Id("C")), Comma, Esc, D(0), Lt, Re, Open, F.Id("s"), Close, Sp, Rightarrow, Sp, Operatorname, Grp(F.Id("finiteEulerProduct")), Open, F.Id("S"), Comma, F.Id("s"), Close, Neq, Sp, D(0)))),
                AssessedProvenance.FromLiterature(ApostolEuler),
                Blocks(Paragraph(Text(
