...
[
                    DocumentEdge.TruthAnchor.Create(
                        LeanDeclarationRef.Create("D5/S3/Zeros/CompletedZeta.analytic_continuation_unique")),
                    DocumentEdge.TruthAnchor.Create(
                        LeanDeclarationRef.Create("D5/S3/Zeros/CompletedZeta.completedZetaReading")),
                    DocumentEdge.TruthAnchor.Create(
                        LeanDeclarationRef.Create("D5/S3/Zeros/CompletedZeta.xiReading")),
                    DocumentEdge.TruthAnchor.Create(
                        LeanDeclarationRef.Create("D5/S3/Zeros/CompletedZeta.xi_reading_differentiable")),
                    DocumentEdge.TruthAnchor.Create(
                        LeanDeclarationRef.Create("D5/S3/Zeros/CompletedZeta.xi_reading_eq_completed_zeta")),
                    DocumentEdge.TruthAnchor.Create(
                        LeanDeclarationRef.Create("D5/S3/Zeros/CompletedZeta.xi_reading_reflection")),
                    DocumentEdge.TruthAnchor.Create(
                        LeanDeclarationRef.Create("D5/S3/Zeros/CompletedZeta.zero_quartet_scaling_spec")),
