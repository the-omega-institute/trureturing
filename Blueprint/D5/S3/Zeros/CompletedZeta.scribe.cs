    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Describe.Lean(
                ...
                DeclarationHandle.Create("D5/S3/Zeros/CompletedZeta.completedZetaReading"),
            ...
            Describe.Lean(
                ...
                DeclarationHandle.Create("D5/S3/Zeros/CompletedZeta.xiReading"),
            ...
            Describe.Lean(
                ...
                DeclarationHandle.Create("D5/S3/Zeros/CompletedZeta.xi_reading_eq_completed_zeta"),
                H("Away from the endpoints xi has the classical product form"),
                StatementSource.FromAuthor(In(Seq(Forall, Sp, F.Id("s"), InMacro, Mathbb, Grp(F.Id("C")), Comma, Esc, F.Id("s"), Neq, Sp, D(0), Sp, Land, Sp, F.Id("s"), Neq, Sp, D(1), Sp, Rightarrow, Sp, Operatorname, Grp(F.Id("xiReading")), Open, F.Id("s"), Close, Eq, Frac, Grp(D(1)), Grp(D(2)), F.Id("s"), Open, F.Id("s"), Minus, D(1), Close, Operatorname, Grp(F.Id("completedZetaReading")), Open, F.Id("s"), Close))),
                AssessedProvenance.FromLiterature(CoffeyXi),
                Blocks(Paragraph(Text(
            ...
            Describe.Lean(
                ...
                DeclarationHandle.Create("D5/S3/Zeros/CompletedZeta.xi_reading_differentiable"),
                H("The xi reading is entire"),
                StatementSource.FromAuthor(In(Seq(Operatorname, Grp(F.Id("Differentiable")), Underscore, Grp(Mathbb, Grp(F.Id("C"))), Open, Operatorname, Grp(F.Id("xiReading")), Close))),
                AssessedProvenance.FromLiterature(CoffeyXi),
                Blocks(Paragraph(Text(
            ...
            Describe.Lean(
                ...
                DeclarationHandle.Create("D5/S3/Zeros/CompletedZeta.xi_reading_reflection"),
                H("The xi reading is reflection invariant"),
                StatementSource.FromAuthor(In(Seq(Forall, Sp, F.Id("s"), InMacro, Mathbb, Grp(F.Id("C")), Comma, Esc, Operatorname, Grp(F.Id("xiReading")), Open, D(1), Minus, F.Id("s"), Close, Eq, Operatorname, Grp(F.Id("xiReading")), Open, F.Id("s"), Close))),
                AssessedProvenance.FromLiterature(CoffeyXi),
                Blocks(Paragraph(Text(
            ...
            Describe.Lean(
                ...
                DeclarationHandle.Create("D5/S3/Zeros/CompletedZeta.zero_quartet_scaling_spec"),
                H("Supplied symmetries generate a zero orbit and reverse scaling"),
                StatementSource.FromAuthor(Disp(Seq(Forall, Sp, F.Id("H"), Colon, Mathbb, Grp(F.Id("C")), To, Mathbb, Grp(F.Id("C")), Comma, Esc, Open, Forall, Sp, F.Id("s"), Comma, Esc, F.Id("H"), Open, Overline, Grp(F.Id("s")), Close, Eq, Overline, Grp(F.Id("H"), Open, F.Id("s"), Close), Close, Sp, Land, Sp, Open, Forall, Sp, F.Id("s"), Comma, Esc, F.Id("H"), Open, D(1), Minus, F.Id("s"), Close, Eq, F.Id("H"), Open, F.Id("s"), Close, Close, Sp, Rightarrow, Sp, Forall, Sp, F.Id("A"), Esc, OpenBracket, Operatorname, Grp(F.Id("AddMonoid")), Open, F.Id("A"), Close, CloseBracket, Comma, Esc, Forall, Sp, Ell, Colon, F.Id("A"), To, Underscore, Grp(Plus), Mathbb, Grp(F.Id("R")), Comma, Esc, Forall, Sp, Rho, InMacro, Mathbb, Grp(F.Id("C")), Comma, Esc, F.Id("H"), Open, Rho, Close, Eq, D(0), Sp, Rightarrow, Sp, F.Id("H"), Open, Rho, Close, Eq, D(0), Sp, Land, Sp, F.Id("H"), Open, Overline, Grp(Rho), Close, Eq, D(0), Sp, Land, Sp, F.Id("H"), Open, D(1), Minus, Rho, Close, Eq, D(0), Sp, Land, Sp, F.Id("H"), Open, D(1), Minus, Overline, Grp(Rho), Close, Eq, D(0), Sp, Land, Sp, Open, Forall, Sp, F.Id("a"), Comma, Esc, Operatorname, Grp(F.Id("scalingLedger")), Open, Ell, Comma, D(1), Minus, Overline, Grp(Rho), Comma, F.Id("a"), Close, Eq, Minus, Operatorname, Grp(F.Id("scalingLedger")), Open, Ell, Comma, Rho, Comma, F.Id("a"), Close, Close))),
