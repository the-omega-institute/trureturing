...
$$\forall n \in \mathbb{N}, M \in \mathbb{N}, gamma \in \operatorname{Fin}\left(n\right) \to \mathbb{R},\; 1 \le M \Rightarrow \operatorname{E}\left(M, \gamma\right) = \sum_{k \in \mathbb{Z} \land \left|k\right| < M} \left(1 - \frac{\left|k\right|}{M}\right) \cdot \left\lVert \sum_{i \in \operatorname{Fin}\left(n\right)} \operatorname{phase}\left(k \cdot \gamma_{i}\right) \right\rVert^{2}$$
...
$$\forall n \in \mathbb{N}, M \in \mathbb{N}, gamma \in \operatorname{Fin}\left(n\right) \to \mathbb{R},\; 1 \le M \Rightarrow \operatorname{card}\left(\operatorname{N}\left(M, \gamma\right)\right) \le \frac{\pi^{2}}{4 \cdot M} \cdot \operatorname{E}\left(M, \gamma\right)$$
...
$$\forall n \in \mathbb{N}, M \in \mathbb{N}, gamma \in \operatorname{Fin}\left(n\right) \to \mathbb{R},\; 1 \le M \Rightarrow M \cdot \sum_{v \in \operatorname{image}\left(\gamma\right)} \operatorname{mult}\left(\gamma, v\right)^{2} \le \operatorname{E}\left(M, \gamma\right)$$
