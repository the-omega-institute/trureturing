...
## Definition: A backward shift pulls coefficients along address addition

Provenance: `repo-derived`

Statement: `D5/S3/Zeros/SpectralShift.backwardShift` `✓ std3`
...
## Theorem: Labeled-zeta coefficients are pointwise shift eigenfamilies

Provenance: `repo-derived`

Statement: `D5/S3/Zeros/SpectralShift.labeled_zeta_backward_shift_eigen` `✓ std3`
...
## Theorem: The square-summable labeled vector has the same pointwise eigen-action

Provenance: `repo-derived`

Statement: `D5/S3/Zeros/SpectralShift.labeled_zeta_vector_backward_shift_eigen` `✓ std3`
