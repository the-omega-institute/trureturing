...
$$\forall x3 \in \left(\forall x3 \in \mathrm{Complex},\; \forall x4 \in \mathord{\cdot},\; \mathrm{Complex}\right),\; \forall x4 \in \mathrm{TotalCode},\; \left(\forall x5 \in \mathord{\cdot},\; \forall x6 \in \mathrm{Complex},\; \mathrm{TotalCodedata}\left(\mathit{x4}, \mathit{x5}, \mathit{x6}\right) \ne 0\right) \Rightarrow \left(\left(\exists x6 \in \mathrm{Complex},\; \exists x7 \in \mathord{\cdot},\; \mathit{x3}\left(\mathit{x6}, \mathit{x7}\right) \ne 1\right) \Rightarrow \mathrm{applyRegister}\left(\mathit{x3}, \mathit{x4}\right) \ne \mathit{x4}\right)$$
