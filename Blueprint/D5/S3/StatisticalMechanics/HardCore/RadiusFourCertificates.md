...
**Definition 1.10 (A radius-three controller matching radius four).**

Lean statement: `D5/S3/StatisticalMechanics/HardCore/RadiusFourCertificates.SomeRadiusThreeControllerMatchesRadiusFour`

*Formalization.* `D5/S3/StatisticalMechanics/HardCore/RadiusFourCertificates.SomeRadiusThreeControllerMatchesRadiusFour` (`✓ std3`).

*Source.* Repository-derived.

*Commentary.*

The claim asks whether some history-dependent radius-three policy has at most the fixed-SRL radius-four descendant count at depth seven hundred.

**Theorem 1.11 (No radius-three controller matches radius four).**

Lean statement: `D5/S3/StatisticalMechanics/HardCore/RadiusFourCertificates.no_radiusThree_controller_matches_radiusFour`

*Proof.* Machine-checked in Lean as `D5/S3/StatisticalMechanics/HardCore/RadiusFourCertificates.no_radiusThree_controller_matches_radiusFour` (`✓ std3`). ∎

*Source.* Repository-derived.

*Commentary.*

The universal strict separation refutes this existential claim, including every history-dependent radius-three controller.

## References

- Truth anchor: `D5/S3/StatisticalMechanics/HardCore/RadiusFourCertificates.SomeRadiusThreeControllerMatchesRadiusFour`
- Truth anchor: `D5/S3/StatisticalMechanics/HardCore/RadiusFourCertificates.no_radiusThree_controller_matches_radiusFour`
