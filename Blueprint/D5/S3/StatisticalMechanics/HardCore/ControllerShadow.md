...
**Definition 1.5 (The current projection claim).**

Lean statement: `D5/S3/StatisticalMechanics/HardCore/ControllerShadow.CoarseShadowIsCurrentProjection`

*Formalization.* `D5/S3/StatisticalMechanics/HardCore/ControllerShadow.CoarseShadowIsCurrentProjection` (`✓ std3`).

*Source.* Repository-derived.

*Commentary.*

The claim quantifies over every state-dependent controller, initial blocker set and newest-first history: the radius-three trace equals the radius-four trace filtered by Manhattan distance at most three.

**Theorem 1.6 (Refutation of current projection).**

Lean statement: `D5/S3/StatisticalMechanics/HardCore/ControllerShadow.coarse_shadow_refutes_current_projection`

*Proof.* Machine-checked in Lean as `D5/S3/StatisticalMechanics/HardCore/ControllerShadow.coarse_shadow_refutes_current_projection` (`✓ std3`). ∎

*Source.* Repository-derived.

*Commentary.*

Instantiate the claim at the constant-zero controller, the parent-blocked initial set and history [1, 1, 0, 0]. The existing legal witness places (2,-1) in the filtered fine trace and outside the coarse trace, contradicting equality.
...
- Truth anchor: `D5/S3/StatisticalMechanics/HardCore/ControllerShadow.CoarseShadowIsCurrentProjection`
- Truth anchor: `D5/S3/StatisticalMechanics/HardCore/ControllerShadow.coarse_shadow_is_not_current_projection`
- Truth anchor: `D5/S3/StatisticalMechanics/HardCore/ControllerShadow.coarse_shadow_refutes_current_projection`
