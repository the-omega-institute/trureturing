    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Describe.Lean(
                ...
                DescribeRole.Theorem),
            Describe.Lean(
                DescribeId.Create("hard-core-radiusfourcertificates-someradiusthreecontrollermatchesradiusfour"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/RadiusFourCertificates.SomeRadiusThreeControllerMatchesRadiusFour"),
                H("A radius-three controller matching radius four"),
                StatementSource.WithoutFormula(), AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text("The claim asks whether some history-dependent radius-three policy has at most the fixed-SRL radius-four descendant count at depth seven hundred."))),
                DescribeRole.Definition),
            Describe.Lean(
                DescribeId.Create("hard-core-radiusfourcertificates-no-radiusthree-controller-matches-radiusfour"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/RadiusFourCertificates.no_radiusThree_controller_matches_radiusFour"),
                H("No radius-three controller matches radius four"),
                StatementSource.WithoutFormula(), AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text("The universal strict separation refutes this existential claim, including every history-dependent radius-three controller."))),
                DescribeRole.Theorem))));
}
