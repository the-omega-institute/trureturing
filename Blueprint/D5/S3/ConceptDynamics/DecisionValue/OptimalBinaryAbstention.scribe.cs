        ...
        Blocks(
            Describe.Lean(
                ...
                StatementSource.FromAuthor(Disp(Seq(
                    ...
                    Forall, Sp, F.Id("p"), InMacro, Sp, OpenBracket, D(0), Comma, Sp, D(1),
                    CloseBracket, Comma, Sp, D(0), Sp, Lt, Sp, LambdaLower, Sp, Lt, Sp,
                    Frac, Grp(D(1)), Grp(D(2)), Comma, RowBreak, Grp(),
                    F.Id("a"), Caret, Grp(Star), Open, F.Id("p"), Comma, Sp, LambdaLower,
                    Close, Sp, Eq, Sp, Begin, Grp(F.Id("cases")),
