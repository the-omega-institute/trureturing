    ...
    : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(Describe.Lean(
            DescribeId.Create("experiment-design-prefix-equivalence-completion-singularity"),
            ...
            Blocks(
                ...
                Paragraph(Text(
                    "On completed transcripts, the canonical empirical-mean event has "
                        + "probability zero in the lower state and one in the upper state, "
                        + "directly witnessing mutual singularity."))),
