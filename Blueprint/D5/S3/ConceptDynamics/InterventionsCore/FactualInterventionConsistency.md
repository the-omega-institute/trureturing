...
*Proof.* Machine-checked in Lean as `D5/S3/ConceptDynamics/InterventionsCore/FactualInterventionConsistency.factual_intervention_consistency` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/ConceptDynamics/InterventionsCore/FactualInterventionConsistency.factual_intervention_consistency`
