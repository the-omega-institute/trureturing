...
*Proof.* Machine-checked in Lean as `D5/S3/ConceptDynamics/NormativeStructure/RoleSwapOrbitFactorization.role_swap_full_invariance_orbit_factorization` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/ConceptDynamics/NormativeStructure/RoleSwapOrbitFactorization.role_swap_full_invariance_orbit_factorization`
