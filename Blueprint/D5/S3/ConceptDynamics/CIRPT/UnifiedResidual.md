...
**Theorem 1.8 (CUT residual is the canonical defect relation).**
...
**Theorem 1.9 (Absolute escape removes the diagonal).**
...
**Theorem 1.10 (Residual extensionality).**
...
**Theorem 1.11 (Joint-target residual is a union).**
...
**Theorem 1.12 (Four-role residual union).**
...
**Theorem 1.13 (Target postprocessing contracts residuals).**
