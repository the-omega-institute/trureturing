...
internal sealed class PrimitiveBundleDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            DefinitionNode("bundle-agrees", "PrimitiveBundle.agrees", "Bundle agreement",
                "Two states agree when every indexed atom kernel relates them."),
            DefinitionNode("bundle-agrees-boolean", "PrimitiveBundle.agreesB",
                "Boolean bundle agreement",
                "A commutative finite-set fold computes the executable Boolean conjunction."),
            DefinitionNode("bundle-to-kernel", "PrimitiveBundle.toKernel", "Joint bundle kernel",
                "Logical agreement and its Boolean reflection are packaged as a decidable kernel."),
            DefinitionNode("bundle-nonempty", "PrimitiveBundle.Nonempty", "Nonempty bundle",
            ...
            DefinitionNode("packed-observer-to-atom", "PackedObserver.toPrimitiveAtom",
                "Packed observer atom",
                "A packed readout becomes a CUT kernel while retaining the supplied role label."),
            TheoremNode("boolean-agreement-reflection", "PrimitiveBundle.agreesB_eq_true_iff",
            ...
            TheoremNode("bundle-agreement-equivalence", "PrimitiveBundle.agrees_equivalence",
            ...
            TheoremNode("primitive-bundle-joint-kernel",
                "PrimitiveBundle.primitive_bundle_joint_kernel", "Bundle joint-kernel law",
                JointKernelFormula(),
            ...
            TheoremNode("bundle-canonical-joint-kernel",
                "PrimitiveBundle.bundle_agrees_iff_jointKernel_quotientCuts",
            ...
            TheoremNode("primitive-bundle-kernel-invariance",
                "PrimitiveBundle.primitive_bundle_kernel_invariance",
            ...
            TheoremNode("packed-observer-atom-reflection",
                "PackedObserver.toPrimitiveAtom_relation_iff", "Packed observer reflection",
