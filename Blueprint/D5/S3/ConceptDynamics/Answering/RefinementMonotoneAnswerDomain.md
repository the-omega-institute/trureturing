...
$$\forall X \in Type, C \in Type, D \in Type, Y \in Type, A \in X \to Prop, qC \in X \to C, qD \in X \to D, T \in X \to Y, x \in X, y \in Y,\; \left(\operatorname{Refines}\left(qC, qD\right) \land \left(A\left(x\right) \land \operatorname{canonicalSafeAnswer}\left(A, qC, T, qC\left(x\right)\right) = \operatorname{some}\left(y\right)\right)\right) \Rightarrow \operatorname{canonicalSafeAnswer}\left(A, qD, T, qD\left(x\right)\right) = \operatorname{some}\left(y\right)$$
...
$$\forall X \in Type, C \in Type, D \in Type, Y \in Type, A \in X \to Prop, qC \in X \to C, qD \in X \to D, T \in X \to Y,\; \operatorname{Refines}\left(qC, qD\right) \Rightarrow \operatorname{answerDomain}\left(A, qC, T\right) \subseteq \operatorname{answerDomain}\left(A, qD, T\right)$$
