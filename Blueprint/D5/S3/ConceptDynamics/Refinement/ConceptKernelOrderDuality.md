...
$$\begin{gathered}\forall X: \operatorname{Type},\\{}\operatorname{Bijective}(\operatorname{conceptClassKernel}(X)) \land\\{}(\forall C, D \in \operatorname{EffectiveConcept}(X), \operatorname{Refines}(q_{C}, q_{D}) \iff \operatorname{ker}(q_{D}) \subseteq \operatorname{ker}(q_{C})) \land\\{}(\forall q_{C}, q_{D}, \operatorname{ker}(\operatorname{conceptJoin}(q_{C}, q_{D})) = \operatorname{intersection}(\operatorname{ker}(q_{C}), \operatorname{ker}(q_{D}))) \land\\{}(\forall q_{C}, q_{D}, \operatorname{ker}(\operatorname{commonCoarsening}(q_{C}, q_{D})) = \operatorname{EqvClosure}(\operatorname{union}(\operatorname{ker}(q_{C}), \operatorname{ker}(q_{D})))).\end{gathered}$$
