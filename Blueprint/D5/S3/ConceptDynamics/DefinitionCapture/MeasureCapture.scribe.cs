                ...
                Blocks(
                    ...
                    Paragraph(Text(
                        "The compiled constructors countingCaptureWeight, "
                            ...
                            + "infinite counting. This refutes only that infinite-value bridge; "
                            + "it does not refute captured-mass submodularity itself. Its state "
                            + "space is Nat times Bool; its residual "
