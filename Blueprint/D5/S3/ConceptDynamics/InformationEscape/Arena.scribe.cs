...
internal sealed class ArenaDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            DefinitionNode("arena-cardinality", "card", "Arena cardinality",
                "The arena cardinality is computed from its stored finite enumeration."),
            DefinitionNode("arena-nondegeneracy", "Nondegenerate", "Arena nondegeneracy",
                "Nondegeneracy is the separately decidable requirement that the state cardinality is at least two."),
            DefinitionNode("arena-from-fintype", "ofFintype", "Arena from a finite type",
            ...
            Describe.Lean(
                ...
                DeclarationHandle.Create(Prefix + "exists_ne_of_nondegenerate"),
