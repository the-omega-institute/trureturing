# Shared Canonical Arena Peers

## Abstract

Five frozen causal peers reuse the separation template on two existing canonical arenas.

The intervention catalog contains four new peers and its gold shadow; the observation-intervention catalog contains one new peer and its gold shadow. Each occurrence uses exactly the two readouts of the canonical law. No anchors, carrier copies, or theorem-truth readouts enter the bundles.
...
The catalog uses FourthFifthArenas.interventionArena and its complete registry vector.
...
The catalog uses ObservationIntervention.observationInterventionArena and its complete registry vector.

**Theorem 1.3 (Counterfactual kernel strictness).**

Lean statement: `D5/S3/ConceptDynamics/InformationEscape/SharedArenaPeers.finer_bridge`

*Proof.* Machine-checked in Lean as `D5/S3/ConceptDynamics/InformationEscape/SharedArenaPeers.finer_bridge` (`✓ std3`). ∎
...
**Theorem 1.4 (Variation on a coupling fiber).**

Lean statement: `D5/S3/ConceptDynamics/InformationEscape/SharedArenaPeers.fiber_bridge`

*Proof.* Machine-checked in Lean as `D5/S3/ConceptDynamics/InformationEscape/SharedArenaPeers.fiber_bridge` (`✓ std3`). ∎
...
**Theorem 1.5 (Failure of identifiability).**

Lean statement: `D5/S3/ConceptDynamics/InformationEscape/SharedArenaPeers.not_identifiable_bridge`

*Proof.* Machine-checked in Lean as `D5/S3/ConceptDynamics/InformationEscape/SharedArenaPeers.not_identifiable_bridge` (`✓ std3`). ∎
...
**Theorem 1.6 (Target-relative sufficiency).**

Lean statement: `D5/S3/ConceptDynamics/InformationEscape/SharedArenaPeers.target_bridge`

*Proof.* Machine-checked in Lean as `D5/S3/ConceptDynamics/InformationEscape/SharedArenaPeers.target_bridge` (`✓ std3`). ∎
...
**Theorem 1.7 (Full intervention profile strictness).**

Lean statement: `D5/S3/ConceptDynamics/InformationEscape/SharedArenaPeers.profile_bridge`

*Proof.* Machine-checked in Lean as `D5/S3/ConceptDynamics/InformationEscape/SharedArenaPeers.profile_bridge` (`✓ std3`). ∎
...
**Theorem 1.8 (Intervention law sensitivity).**

Lean statement: `D5/S3/ConceptDynamics/InformationEscape/SharedArenaPeers.intervention_law_sensitive`

*Proof.* Machine-checked in Lean as `D5/S3/ConceptDynamics/InformationEscape/SharedArenaPeers.intervention_law_sensitive` (`✓ std3`). ∎
...
**Theorem 1.9 (Observation law sensitivity).**

Lean statement: `D5/S3/ConceptDynamics/InformationEscape/SharedArenaPeers.observation_law_sensitive`

*Proof.* Machine-checked in Lean as `D5/S3/ConceptDynamics/InformationEscape/SharedArenaPeers.observation_law_sensitive` (`✓ std3`). ∎
