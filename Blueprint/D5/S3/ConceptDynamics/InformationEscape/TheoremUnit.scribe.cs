...
internal sealed class TheoremUnitDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            DefinitionNode("catalog-from-vector", "ofVector", "Catalog from a vector",
                "A Fin-indexed vector is the canonical fixed-length catalog constructor."),
            DefinitionNode("catalog-full-index-set", "fullIndexSet", "Full index set",
                "The full catalog selection is the universal finite set."),
            DefinitionNode("catalog-without-index", "without", "Leave-one-out set",
                "The leave-one-out set erases one theorem from the full selection."),
            TheoremNode("catalog-without-membership", "mem_without_iff",
            ...
            TheoremNode("catalog-without-cardinality", "without_card",
            ...
            TheoremNode("catalog-vector-lookup", "theoremAt_ofVector",
