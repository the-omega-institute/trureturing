...
internal sealed class MembershipRegistrationsDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Paragraph(Text("These registrations retain classical annihilator membership. Finite sealing requires a computable readout and is not supplied; the registration diagnostics remain visible.")),
            ...
            Node("twoRealization", "The original annihilator membership predicate is retained with anchor two, using classical decidability without theorem-based reduction.", DescribeRole.Definition),
