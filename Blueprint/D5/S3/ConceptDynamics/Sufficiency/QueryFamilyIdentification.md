...
**Theorem 1.1 (Identification is query-kernel inclusion).**
...
**Lemma 1.2 (The dependent joint connects to single-interface sufficiency).**
...
**Lemma 1.3 (Nonempty models are necessary for global joint refinement).**
...
**Lemma 1.4 (Factorization through the query quotient is unique).**
...
**Theorem 1.5 (Identification is unique query-quotient factorization).**
