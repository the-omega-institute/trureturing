...
$$\begin{aligned}\forall X, Y, Z, B_{C}, B_{D}, B_{E}: \operatorname{Type},\\{}[\operatorname{AddGroup}\left(B_{D}\right)], [\operatorname{AddGroup}\left(B_{E}\right)],\\F: X \to Y, G: Y \to Z,\\q_{C}: \operatorname{Concept}\left(X, B_{C}\right), q_{D}: \operatorname{Concept}\left(Y, B_{D}\right), q_{E}: \operatorname{Concept}\left(Z, B_{E}\right),\\\overline{F}: B_{C} \to B_{D}, \overline{G}: \operatorname{AddMonoidHom}\left(B_{D}, B_{E}\right),\\epsilon_{F} = (q_{D} \circ F - \overline{F} \circ q_{C}),\\epsilon_{G} = (q_{E} \circ G - \overline{G} \circ q_{D}),\\epsilon_{GF} = (q_{E} \circ G \circ F - \overline{G} \circ \overline{F} \circ q_{C}),\\\forall u, v\in B_{D}, \overline{G}(u+v) = \overline{G}(u)+\overline{G}(v),\\epsilon_{GF} = epsilon_{G} \circ F + \overline{G} \circ epsilon_{F}.\end{aligned}$$
