...
{
    private const string Prefix = "D5/S3/ConceptDynamics/PartialIdentification/BipartiteMediatorPricing.";
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        "Actual complete-mediator pricing is reduced to a checked minimum cut, and the same certificate closes the full outcome-marginal master problem.", H("BipartiteMediatorPricing"), Blocks(
            ...
            Describe.Lean(DescribeId.Create("OffDiagonalBipartite"), DeclarationHandle.Create(Prefix + "OffDiagonalBipartite"),
            ...
            Describe.Lean(DescribeId.Create("flipTable"), DeclarationHandle.Create(Prefix + "flipTable"),
            ...
            Describe.Lean(DescribeId.Create("flipTable_involutive"), DeclarationHandle.Create(Prefix + "flipTable_involutive"),
            ...
            Describe.Lean(DescribeId.Create("offDiagonalMass"), DeclarationHandle.Create(Prefix + "offDiagonalMass"),
            ...
            Describe.Lean(DescribeId.Create("pricingField"), DeclarationHandle.Create(Prefix + "pricingField"),
            ...
            Describe.Lean(DescribeId.Create("switchedField"), DeclarationHandle.Create(Prefix + "switchedField"),
            ...
            Describe.Lean(DescribeId.Create("pricingCapacity"), DeclarationHandle.Create(Prefix + "pricingCapacity"),
            ...
            Describe.Lean(DescribeId.Create("pricingSourceCapacity"), DeclarationHandle.Create(Prefix + "pricingSourceCapacity"),
            ...
            Describe.Lean(DescribeId.Create("pricingSinkCapacity"), DeclarationHandle.Create(Prefix + "pricingSinkCapacity"),
            ...
            Describe.Lean(DescribeId.Create("pricingOffset"), DeclarationHandle.Create(Prefix + "pricingOffset"),
            ...
            Describe.Lean(DescribeId.Create("pricing_cut_identity"), DeclarationHandle.Create(Prefix + "pricing_cut_identity"),
            ...
            Describe.Lean(DescribeId.Create("checkBipartitePricing"), DeclarationHandle.Create(Prefix + "checkBipartitePricing"),
                H("Check the graph contract and optimal flow"), StatementSource.FromAuthor(Disp(All("Mediator coupling color multiplier certificate",B(C("checkBipartitePricing",Pi,Color,Mult,K),Eq,C("Bool.and",C("decide",Bipartite),C("checkSTCutCertificate",Cap,Src,Snk,K)))))), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("certifiedPricingValue"), DeclarationHandle.Create(Prefix + "certifiedPricingValue"),
            ...
            Describe.Lean(DescribeId.Create("checked_pricing_isGreatest"), DeclarationHandle.Create(Prefix + "checked_pricing_isGreatest"),
                H("A real column and a global maximum"), StatementSource.FromAuthor(Disp(All("Mediator coupling color multiplier certificate",B(Checked,Rightarrow,And(B(Price(Flip(C("side",K))),Eq,Best),C("IsGreatest",C("Set.range",C("completeMediatorPricingScore",Pi,Mult)),Best)))))), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("checked_no_improving_column_iff"), DeclarationHandle.Create(Prefix + "checked_no_improving_column_iff"),
            ...
            Describe.Lean(DescribeId.Create("completeMediatorBenefit_eq_pricing_expectation"), DeclarationHandle.Create(Prefix + "completeMediatorBenefit_eq_pricing_expectation"),
            ...
            Describe.Lean(DescribeId.Create("pricing_bound_implies_causal_bound"), DeclarationHandle.Create(Prefix + "pricing_bound_implies_causal_bound"),
            ...
            Describe.Lean(DescribeId.Create("checked_restricted_master_isGreatest"), DeclarationHandle.Create(Prefix + "checked_restricted_master_isGreatest"),
