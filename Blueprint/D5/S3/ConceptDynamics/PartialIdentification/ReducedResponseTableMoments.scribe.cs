    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(
                ...
                H("Actual nonzero support"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(
                ...
                H("Pushforward cannot enlarge support"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(
                ...
                H("Original-carrier feature preservation"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(
                ...
                H("Three indicators per row"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(
                ...
                H("Recover the omitted fourth cell"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(
                ...
                H("Bind moments to actual row distributions"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(
                ...
                H("Preserve all complete row laws"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(
                ...
                H("At most 3k+1 atoms for all row laws"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(
                ...
                H("At most 3k+2 atoms with an additional query"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
