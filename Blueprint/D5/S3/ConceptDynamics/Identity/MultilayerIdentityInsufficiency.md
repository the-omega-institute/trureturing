...
$$\operatorname{Nonempty}\left(\operatorname{CompatibleFamily}\left(twoLayerState, twoLayerProjection\right)\right) \land \exists x \in \operatorname{CompatibleFamily}\left(twoLayerState, twoLayerProjection\right), y \in \operatorname{CompatibleFamily}\left(twoLayerState, twoLayerProjection\right),\; x_{0} = y_{0} \land x_{1} \ne y_{1}$$
...
$$\forall Sj \in Type, Si \in Type, Norm \in Type, p \in Sj \to Si, n1 \in Norm, n2 \in Norm,\; \left(\left(\neg \operatorname{Injective}\left(p\right)\right) \land n1 \ne n2\right) \Rightarrow \left(\left(\neg \exists r \in Si \to Sj,\; \operatorname{LeftInverse}\left(r, p\right)\right) \land \exists q1 \in Sj \to Norm, q2 \in Sj \to Norm,\; \operatorname{FiberConstant}\left(p, q1\right) \land \left(\operatorname{FiberConstant}\left(p, q2\right) \land q1 \ne q2\right)\right)$$
