...
The discrete frequency obstruction applies to the stable-rank measurement-design question of Eftekhari et al. (2018), recorded in `D5/L/ConceptDynamics/eftekhari2018embedology`, when the sensor class is restricted to paired circle harmonics at a pi/6 delay. It does not by itself assert the analytic stable-rank formula or a dimension bound for arbitrary smooth sensors.
