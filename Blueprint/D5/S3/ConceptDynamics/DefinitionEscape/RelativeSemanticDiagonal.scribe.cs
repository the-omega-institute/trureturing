...
internal sealed class RelativeSemanticDiagonalDocument : IScribeDocumentDefinition
{
 ...
 private static Formula Formula(){var g=F.Id("Gamma");var c=F.Id("current");var twist=F.Id("twist");var catalog=F.Id("decoderCatalog");var t=Call("relativeSemanticDiagonal",twist,Call("languageExtension",c,Call("familyReadout",g)),catalog);return Disp(Seq(Call("Nonempty",F.Id("X")),Sp,Land,Sp,Call("FixedPointFree",twist),Sp,Land,Sp,Call("Surjective",catalog),Sp,Rightarrow,Sp,Call("Nonempty",Call("blindResidual",g,c,t)),Dot));}
}
