...
internal sealed class TruthfulnessSufficiencyIndependenceDocument : IScribeDocumentDefinition
{
    ...
    private static Formula TheoremFormula()
    {
        ...
        Formula profileType = Call("ReportProfile", state, message, targetType);
        Formula target = Member(profile, "target"), decoder = Member(profile, "decode");
        Formula sent = Member(profile, "sentReport");
        Formula truthful = Member(profile, "trueReport");
        ...
        return Disp(Seq(
            ...
            profile, Colon, Sp, profileType, Comma, RowBreak, Grp(),
            honest, Sp, Rightarrow, Sp, sufficient, Sp, Rightarrow, Sp,
    ...
    private static Formula Member(Formula owner, string name) =>
