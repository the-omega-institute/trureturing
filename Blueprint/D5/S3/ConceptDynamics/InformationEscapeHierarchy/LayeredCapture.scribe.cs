...
internal sealed class LayeredCaptureDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Definition("layered-capture-pairs", "LayerChain.layeredCapturePairs",
            ...
            Definition("layered-capture-count", "LayerChain.layeredCaptureCount",
                "Layered capture count", "The count is the cardinality of one layered capture set."),
            Definition("layered-capture-spectrum", "LayerChain.layeredCaptureSpectrum",
                "Layered capture spectrum", "The spectrum lists the capture count at every ordered layer."),
            Definition("layered-capture-rate", "LayerChain.layeredCaptureRate",
                "Layered capture rate",
                "Each exact rate divides its layer count by the arena's off-diagonal denominator."),
            Definition("unresolved-pairs", "LayerChain.unresolvedPairs", "Unresolved pairs",
                "The unresolved set contains off-diagonal pairs related by the final kernel."),
            Definition("unresolved-count", "LayerChain.unresolvedCount", "Unresolved count",
                "The unresolved count is the cardinality of the final unresolved set."),
            Definition("unresolved-rate", "LayerChain.unresolvedRate", "Unresolved rate",
                "The exact unresolved rate uses the same arena denominator as every layer."),
            Theorem("initial-layer-nonempty-criterion", "LayerChain.layeredCapture_zero_nonempty_iff",
            ...
            Theorem("layered-capture-partition", "LayerChain.layeredCapture_partition",
            ...
            Theorem("cumulative-coarse-member-has-zero-unique-capture",
                "Catalog.cumulativeChain_coarser_uniqueCapture_zero",
            ...
            Definition("designated-root-catalog-suite", "DesignatedRootCatalogSuite",
                ...
                "A finite dependent family lists every maximal catalog owned by one sealing root."),
            ...
            Definition("schedule-to-layer-chain", "GeneratorSchedule.toLayerChain",
            ...
            Theorem("generated-layer-capture-is-schedule-increment",
                "GeneratorSchedule.toLayerChain_layeredCapture_succ_eq_increment",
