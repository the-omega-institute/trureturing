...
Unresolved source gaps: section 43 also names operation-family and definition-language changes, but supplies no mechanism by which either one alters the readout or residual. This formalization covers only the object-domain, target, and precision triggers.
