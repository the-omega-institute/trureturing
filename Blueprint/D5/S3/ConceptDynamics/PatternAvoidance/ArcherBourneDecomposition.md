...
**Theorem 1.10 (Cube avoidance criterion for compositions).**

$$\forall n \in \mathbb{N}, \forall c \in Composition\left(n\right), \neg \left(Contains_{2143}\right)\left(rotationSumComposition\left(c\right)^{3}\right) \Leftrightarrow card\left(\{i \in Fin\left(length\left(blocks\left(c\right)\right)\right) : blocks\left(c\right)_{i} \neq 1 \land blocks\left(c\right)_{i} \neq 3\}\right) \leq 1.$$

*Proof.* Machine-checked in Lean as `D5/S3/ConceptDynamics/PatternAvoidance/ArcherBourneDecomposition.rotationSumComposition_cube_avoids_2143_iff` (`✓ std3`). ∎
...
**Theorem 1.11 (The Archer-Bourne counting equality).**
...
- Truth anchor: `D5/S3/ConceptDynamics/PatternAvoidance/ArcherBourneDecomposition.rotationSumComposition_cube_avoids_2143_iff`
