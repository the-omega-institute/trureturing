...
internal sealed class MatrixDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        "Licensed Foundation.Vorspiel.Matrix source for the concrete first-order pair extension.",
        H("Matrix"),
        Blocks(
            Paragraph(Text("Source-command excerpt selected from Foundation.Vorspiel.Matrix, lines 1-341, at Foundation revision 30a16ffa93d79d73ab4d02427fa00f50e039bf29. Only commands with live proof or source-elaboration consumers for the Kuratowski pair extension are retained.")),
