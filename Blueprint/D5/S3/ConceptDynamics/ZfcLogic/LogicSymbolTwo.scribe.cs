...
internal sealed class LogicSymbolTwoDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        "Licensed Foundation.Logic.LogicSymbol source for the concrete first-order pair extension.",
        H("LogicSymbolTwo"),
        Blocks(
            Paragraph(Text("Source-command excerpt selected from Foundation.Logic.LogicSymbol, lines 320-638, at Foundation revision 30a16ffa93d79d73ab4d02427fa00f50e039bf29. Only commands with live proof or source-elaboration consumers for the Kuratowski pair extension are retained.")),
