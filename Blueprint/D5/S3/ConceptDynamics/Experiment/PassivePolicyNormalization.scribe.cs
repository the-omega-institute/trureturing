...
internal sealed class PassivePolicyNormalizationDocument : IScribeDocumentDefinition
{
    ...
    private static Formula StatementFormula()
    {
        ...
        return Disp(new Formula.Aligned([
            Seq(Call("Finite", F.Id("Q")), Land, c, Neq, Emptyset, Land,
            ...
            Seq(Forall, Sp, x, InMacro, c, Comma, Sp, decoded, Eq, label, Land,
            ...
            Seq(newCandidates, Eq, oldCandidates, Land,
                ...
                newCost, Le, oldCost, Le, b, Comma),
            Seq(Forall, Sp, x, Comma, z, InMacro, c, Comma, Sp,
                Open, trace, Eq, At(F.Tau, z), Leftrightarrow,
                oldTrace, Eq, At(F.Id("t"), z), Close, Semi),
            Seq(value, Eq, Call("V", b, depth, c), Comma),
            Seq(eligible, Eq, OpenBrace, q, InMacro, F.Id("Q"), Mid,
                D(2), Le, Call("card", replies), Land, price, Le, b, CloseBrace, Comma),
            ...
            Seq(Forall, Sp, q, InMacro, F.Id("Q"), Comma, Sp,
