    ...
    : IScribeDocumentDefinition
{
    ...
    private static readonly LibraryNoteRef Kotzig =
        LibraryNoteRef.Create("D5/L/Arith/kotzig1964perfectonefactorization");
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromLiterature(Kotzig),
                Blocks(Paragraph(Text(
                    "The factor indexed by a pairs infinity with a. Every other finite vertex "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromLiterature(Kotzig),
                Blocks(Paragraph(Text(
                    "The factor graph is exactly SimpleGraph.fromRel applied to the relation "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromLiterature(Kotzig),
                Blocks(Paragraph(Text(
                    "Two alternating partner reflections translate a finite residue by exactly "
                        + "2(b-a) in ZMod p."))),
                DescribeRole.Definition),
            Describe.Lean(
                ...
                AssessedProvenance.FromLiterature(Kotzig),
                Blocks(Paragraph(Text(
                    "When a and b are distinct, the two partner vertices are distinct, so every "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromLiterature(Kotzig),
                Blocks(Paragraph(Text(
                    "For distinct a and b and odd prime p, 2(b-a) is nonzero in ZMod p. Its "
    ...
    private static Formula PerfectOneFactorizationFormula()
    {
        ...
        Formula perfectMatching = Seq(
            ...
            Call("IsPerfectMatching", Call("topSubgraph", Factor(a))));
