    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Node("jaco-dom-path-diameter-refuted", "Conjecture 2.9 is false", "result",
                ResultFormula(),
                "At n = 33, kernel-decided positive entries in powers of the adjacency matrix "
                    + "give a walk of length at most seven between every two vertices through "
                    + "Mathlib's walk-counting identity. Four disjoint closed neighborhoods "
                    + "force every dominating set to contain at least four vertices, while a "
