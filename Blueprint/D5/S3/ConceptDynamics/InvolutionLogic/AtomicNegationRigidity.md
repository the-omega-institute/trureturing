...
$$\forall negation: \operatorname{AtomicNegation}\left(X\right), (\operatorname{Fintype}\left(X\right) \land \operatorname{Nonempty}\left(X\right)) \Rightarrow \operatorname{card}\left(X\right) = 2.$$
