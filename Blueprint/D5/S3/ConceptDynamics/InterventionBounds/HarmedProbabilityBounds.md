...
*Proof.* Machine-checked in Lean as `D5/S3/ConceptDynamics/InterventionBounds/HarmedProbabilityBounds.harmed_probability_frechet_bound` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/ConceptDynamics/InterventionBounds/HarmedProbabilityBounds.harmed_probability_frechet_bound`
