...
The Lean predicate MutuallyUnbiased strengthens the atom's overlap-only wording by including orthonormality of both bases. Therefore the third conjunct proves those two identities in addition to, and in particular implies, the overlap clause stated in the source atom.
