...
internal sealed class MubDimensionSixTensorDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(
                ...
                H("Coordinate tensor products preserve orthonormality and mutual unbiasedness"),
                ...
                Blocks(
                    ...
                    Paragraph(Text(
                        "The Lean predicate MutuallyUnbiased strengthens the atom's overlap-only "
                            + "wording by including orthonormality of both bases. Therefore the "
                            + "third conjunct proves those two identities in addition to, and in "
                            + "particular implies, the overlap clause stated in the source atom."))),
    ...
    private static Formula TensorPackageFormula()
    {
        ...
        return Disp(Seq(
            Open, Forall, Sp, alpha, Comma, Sp, beta, Sp, F.Text, Grp(Sp, F.Id("finite")),
    ...
    private static Formula DimensionSixFormula()
    {
        ...
        return Disp(Seq(
            Call("PairwiseMUB", bases), Sp, Land, Sp, Open,
            Open, Forall, Sp, r, Colon, Sp, Call("Fin", D(3)), Comma, Sp,
            Call("CoordinateOrthonormalBasis", Call("dimensionSixBases", r)), Close,
            Sp, Land, RowBreak,
            Open, Forall, Sp, r, Comma, Sp, s, Colon, Sp, Call("Fin", D(3)),
            ...
            Frac, Grp(D(1)), Grp(D(6)), Close, Close, Dot));
    }
