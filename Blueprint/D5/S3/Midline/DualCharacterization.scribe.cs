    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(
                ...
                DeclarationHandle.Create("D5/S3/Midline/DualCharacterization.midline_dual_characterization"),
                H("Mirror fixed points and unitary parameters define the critical midline"),
                StatementSource.FromAuthor(Disp(Seq(Forall, Sp, F.Id("A"), Esc, OpenBracket, Operatorname, Grp(F.Id("AddMonoid")), Open, F.Id("A"), Close, CloseBracket, Comma, Esc, Forall, Sp, Ell, Colon, F.Id("A"), To, Underscore, Grp(Plus), Mathbb, Grp(F.Id("R")), Comma, Esc, Open, Exists, Sp, F.Id("a"), Comma, Ell, Open, F.Id("a"), Close, Neq, Sp, D(0), Close, Sp, Rightarrow, Sp, Open, OpenBrace, F.Id("s"), InMacro, Mathbb, Grp(F.Id("C")), Colon, Operatorname, Grp(F.Id("mirror")), Open, F.Id("s"), Close, Eq, F.Id("s"), CloseBrace, Eq, OpenBrace, F.Id("s"), InMacro, Mathbb, Grp(F.Id("C")), Colon, Forall, Sp, F.Id("a"), Comma, Vert, Operatorname, Grp(F.Id("halfDensityReading")), Open, Ell, Comma, F.Id("s"), Comma, F.Id("a"), Close, Vert, Eq, D(1), CloseBrace, Esc, Land, Esc, OpenBrace, F.Id("s"), InMacro, Mathbb, Grp(F.Id("C")), Colon, Operatorname, Grp(F.Id("mirror")), Open, F.Id("s"), Close, Eq, F.Id("s"), CloseBrace, Eq, OpenBrace, F.Id("s"), InMacro, Mathbb, Grp(F.Id("C")), Colon, Re, Open, F.Id("s"), Close, Eq, Frac, Grp(D(1)), Grp(D(2)), CloseBrace, Close))),
