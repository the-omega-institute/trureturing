    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(
                ...
                Blocks(
                    Paragraph(Text(
                        "The 31 canonical projective directions over F5 are classified by the "
                            + "source quadratic form. The fivefold class is the isotropic locus, "
                            + "the threefold class has form value 2 or 3, and the twofold class "
                            + "has form value 1 or 4.")),
                    Paragraph(Text(
                        "These three concrete classes are pairwise disjoint and their union is "
                            + "the full projective chart. Their cardinalities are respectively "
                            + "6, 10, and 15.")),
                    Paragraph(Text(
                        "Under the explicit A5 action generated by the two source matrices, the "
                            + "orbit of every member of each class is exactly that entire class. "
                            + "The corresponding stabilizer cardinalities are 10, 6, and 4.")),
                    Paragraph(Text(
