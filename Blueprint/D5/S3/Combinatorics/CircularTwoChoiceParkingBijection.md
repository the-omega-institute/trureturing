...
Lean statement: `D5/S3/Combinatorics/CircularTwoChoiceParkingBijection.ClassicalPF`

*Formalization.* `D5/S3/Combinatorics/CircularTwoChoiceParkingBijection.ClassicalPF` (`✓ std3`).
...
Lean statement: `D5/S3/Combinatorics/CircularTwoChoiceParkingBijection.oneChoiceClassicalEquiv`

*Formalization.* `D5/S3/Combinatorics/CircularTwoChoiceParkingBijection.oneChoiceClassicalEquiv` (`✓ std3`).
...
Lean statement: `D5/S3/Combinatorics/CircularTwoChoiceParkingBijection.fixedFiberEquiv`

*Formalization.* `D5/S3/Combinatorics/CircularTwoChoiceParkingBijection.fixedFiberEquiv` (`✓ std3`).
...
*Formalization.* `D5/S3/Combinatorics/CircularTwoChoiceParkingBijection.globalParkingEquiv` (`✓ std3`).
...
- Truth anchor: `D5/S3/Combinatorics/CircularTwoChoiceParkingBijection.ClassicalPF`
