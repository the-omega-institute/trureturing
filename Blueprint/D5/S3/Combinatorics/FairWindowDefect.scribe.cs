    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Node("fair-window-lower-bound", "Every table obeys the lower bound",
                ...
                + "is uniquely forced by parity: the product at the other positions is "
                + "one or minus one, and exactly one bit makes the full product minus one. "
                + "Permuting coordinates preserves the odd "
