...
internal sealed class CrownOrderPolytopeLogConcavityDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Paragraph(Text("Conjecture 3.7 concerns the full geometric face vector, including the empty face and the whole polytope. The published face-count formula supplies the starting coefficients; the auxiliary Chebyshev factorization and corrected Newton inequalities establish their log-concavity.")),
            Describe.Lean(
