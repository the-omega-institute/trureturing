...
internal sealed class ZeroForcingThreeGapCover8G4Document : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapCover8G4.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            H("Layer Codes 4096 to 5119"),
            Blocks(
            Node("covers", "Exact layer-code interval", "covers",
                Disp(Q(Imp(And(Le(Num(4096), code), Lt(code, Num(5120))), Eq(Call("exactRow", Name("positions8"), code), True())), ("code", Nat()))),
