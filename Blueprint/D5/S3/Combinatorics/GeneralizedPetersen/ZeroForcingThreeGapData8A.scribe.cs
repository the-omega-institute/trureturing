...
internal sealed class ZeroForcingThreeGapData8ADocument : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapData8A.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            H("Bounded Gap Roots"),
            Blocks(
            Node("roots-8-1-4", "8 gaps with root 1 to 4", "roots8",
                Disp(Q(Imp(And(Le(Num(1), q), Le(q, Num(4))), Eq(Call("maskCheck", Num(8), Num(7), q, ListOf(q)), True())), ("q", Nat()))),
