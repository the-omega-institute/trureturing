...
internal sealed class ZeroForcingThreeGapCover8G1Document : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapCover8G1.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            Node("covers", "Exact layer-code interval", "covers",
                Disp(Q(Imp(And(Le(Num(1024), code), Lt(code, Num(2048))), Eq(Call("exactRow", Name("positions8"), code), True())), ("code", Nat()))),
