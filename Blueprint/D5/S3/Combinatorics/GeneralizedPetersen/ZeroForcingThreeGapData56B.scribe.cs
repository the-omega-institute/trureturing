...
internal sealed class ZeroForcingThreeGapData56BDocument : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapData56B.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            H("Bounded Gap Roots"),
            Blocks(
            Node("roots-6-6-7", "6 gaps with root 6 to 7", "roots6",
                Disp(Q(Imp(And(Le(Num(6), q), Le(q, Num(7))), Eq(Call("maskCheck", Num(6), Num(5), q, ListOf(q)), True())), ("q", Nat()))),
