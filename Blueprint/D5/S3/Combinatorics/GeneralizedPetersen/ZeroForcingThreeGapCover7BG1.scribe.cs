...
internal sealed class ZeroForcingThreeGapCover7BG1Document : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapCover7BG1.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            H("Layer Codes 1024 to 2047"),
            Blocks(
            Node("covers", "Exact layer-code interval", "covers",
                Disp(Q(Imp(And(Le(Num(1024), code), Lt(code, Num(2048))), Eq(Call("exactRow", Name("positions7b"), code), True())), ("code", Nat()))),
