...
internal sealed class ZeroForcingThreeGapCover8G5Document : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapCover8G5.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            H("Layer Codes 5120 to 6143"),
            Blocks(
            Node("covers", "Exact layer-code interval", "covers",
                Disp(Q(Imp(And(Le(Num(5120), code), Lt(code, Num(6144))), Eq(Call("exactRow", Name("positions8"), code), True())), ("code", Nat()))),
