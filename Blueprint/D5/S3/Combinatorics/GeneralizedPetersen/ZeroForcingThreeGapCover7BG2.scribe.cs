...
internal sealed class ZeroForcingThreeGapCover7BG2Document : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapCover7BG2.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            Node("covers", "Exact layer-code interval", "covers",
                Disp(Q(Imp(And(Le(Num(2048), code), Lt(code, Num(2187))), Eq(Call("exactRow", Name("positions7b"), code), True())), ("code", Nat()))),
