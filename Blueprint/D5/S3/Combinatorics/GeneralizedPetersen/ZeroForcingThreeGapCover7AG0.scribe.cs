...
internal sealed class ZeroForcingThreeGapCover7AG0Document : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapCover7AG0.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            H("Layer Codes 0 to 1023"),
            Blocks(
            Node("covers", "Exact layer-code interval", "covers",
                Disp(Q(Imp(And(Le(Num(0), code), Lt(code, Num(1024))), Eq(Call("exactRow", Name("positions7a"), code), True())), ("code", Nat()))),
