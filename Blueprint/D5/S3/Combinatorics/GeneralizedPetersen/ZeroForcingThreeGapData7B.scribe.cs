...
internal sealed class ZeroForcingThreeGapData7BDocument : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapData7B.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            H("Bounded Gap Roots"),
            Blocks(
            Node("roots-7-5-6", "7 gaps with root 5 to 6", "roots7",
                Disp(Q(Imp(And(Le(Num(5), q), Le(q, Num(6))), Eq(Call("maskCheck", Num(7), Num(6), q, ListOf(q)), True())), ("q", Nat()))),
