...
internal sealed class ZeroForcingThreeGapCover6G0Document : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapCover6G0.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            H("Layer Codes 0 to 728"),
            Blocks(
            Node("covers", "Exact layer-code interval", "covers",
                Disp(Q(Imp(And(Le(Num(0), code), Lt(code, Num(729))), Eq(Call("exactRow", Name("positions6"), code), True())), ("code", Nat()))),
