...
internal sealed class ZeroForcingThreeGapCover7BG0Document : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapCover7BG0.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            Node("covers", "Exact layer-code interval", "covers",
                Disp(Q(Imp(And(Le(Num(0), code), Lt(code, Num(1024))), Eq(Call("exactRow", Name("positions7b"), code), True())), ("code", Nat()))),
