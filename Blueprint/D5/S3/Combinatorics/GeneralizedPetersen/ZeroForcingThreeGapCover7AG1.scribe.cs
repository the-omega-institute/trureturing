...
internal sealed class ZeroForcingThreeGapCover7AG1Document : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapCover7AG1.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            Node("covers", "Exact layer-code interval", "covers",
                Disp(Q(Imp(And(Le(Num(1024), code), Lt(code, Num(2048))), Eq(Call("exactRow", Name("positions7a"), code), True())), ("code", Nat()))),
