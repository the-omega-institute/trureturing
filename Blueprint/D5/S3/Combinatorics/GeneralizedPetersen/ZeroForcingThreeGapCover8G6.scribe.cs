...
internal sealed class ZeroForcingThreeGapCover8G6Document : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapCover8G6.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            H("Layer Codes 6144 to 6560"),
            Blocks(
            Node("covers", "Exact layer-code interval", "covers",
                Disp(Q(Imp(And(Le(Num(6144), code), Lt(code, Num(6561))), Eq(Call("exactRow", Name("positions8"), code), True())), ("code", Nat()))),
