...
**Theorem 1.1 (8 gaps with root 5).**

$$\forall q \in \mathrm{Nat},\; \left(5 \le q \land q \le 5\right) \Rightarrow \operatorname{maskCheck}\left(8, 7, q, [q]\right) = \mathrm{true}$$

*Proof.* Machine-checked in Lean as `D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapData8B.roots8` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapData8B.roots8`
