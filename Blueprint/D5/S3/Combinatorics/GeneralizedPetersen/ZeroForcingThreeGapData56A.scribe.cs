...
internal sealed class ZeroForcingThreeGapData56ADocument : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapData56A.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            H("Bounded Gap Roots"),
            Blocks(
            Node("roots-5-1-7", "5 gaps with root 1 to 7", "roots5",
                Disp(Q(Imp(And(Le(Num(1), q), Le(q, Num(7))), Eq(Call("maskCheck", Num(5), Num(4), q, ListOf(q)), True())), ("q", Nat()))),
            ...
            Node("roots-6-1-5", "6 gaps with root 1 to 5", "roots6",
                Disp(Q(Imp(And(Le(Num(1), q), Le(q, Num(5))), Eq(Call("maskCheck", Num(6), Num(5), q, ListOf(q)), True())), ("q", Nat()))),
