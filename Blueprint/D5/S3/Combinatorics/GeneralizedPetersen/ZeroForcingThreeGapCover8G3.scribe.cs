...
internal sealed class ZeroForcingThreeGapCover8G3Document : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapCover8G3.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            H("Layer Codes 3072 to 4095"),
            Blocks(
            Node("covers", "Exact layer-code interval", "covers",
                Disp(Q(Imp(And(Le(Num(3072), code), Lt(code, Num(4096))), Eq(Call("exactRow", Name("positions8"), code), True())), ("code", Nat()))),
