...
internal sealed class ZeroForcingThreeGapCover8G2Document : IScribeDocumentDefinition
{
    private const string Prefix = "D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapCover8G2.";
    ...
    public DocumentDefinition Create()
    {
        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            H("Layer Codes 2048 to 3071"),
            Blocks(
            Node("covers", "Exact layer-code interval", "covers",
                Disp(Q(Imp(And(Le(Num(2048), code), Lt(code, Num(3072))), Eq(Call("exactRow", Name("positions8"), code), True())), ("code", Nat()))),
