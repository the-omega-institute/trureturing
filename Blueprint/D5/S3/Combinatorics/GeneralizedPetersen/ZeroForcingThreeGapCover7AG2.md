...
$$\forall code \in \mathrm{Nat},\; \left(2048 \le code \land code < 2187\right) \Rightarrow \operatorname{exactRow}\left(\mathrm{positions7a}, code\right) = \mathrm{true}$$

*Proof.* Machine-checked in Lean as `D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapCover7AG2.covers` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/Combinatorics/GeneralizedPetersen/ZeroForcingThreeGapCover7AG2.covers`
