    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeDocument.Create(
        ...
        Blocks(
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/TotalVariation/Metric.total_variation_nonneg"),
                Disp(Seq(
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/TotalVariation/Metric.total_variation_eq_zero_iff"),
                Disp(Seq(
                    Begin, Grp(F.Id("gathered")),
                    Forall, Sp, Iota, Esc,
                    OpenBracket,
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/TotalVariation/Metric.total_variation_comm"),
                Disp(Seq(
                    Begin, Grp(F.Id("gathered")),
                    Forall, Sp, Iota, Esc,
                    OpenBracket,
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/TotalVariation/Metric.total_variation_triangle"),
                Disp(Seq(
                    Begin, Grp(F.Id("gathered")),
                    Forall, Sp, Iota, Esc,
                    OpenBracket,
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/TotalVariation/Metric.total_variation_le_one"),
                Disp(Seq(
                    Begin, Grp(F.Id("gathered")),
                    Forall, Sp, Iota, Esc,
                    OpenBracket,
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/TotalVariation/Metric.total_variation_eq_sup_event_gap"),
                Disp(Seq(
                    Begin, Grp(F.Id("gathered")),
                    Forall, Sp, Iota, Esc,
                    OpenBracket,
