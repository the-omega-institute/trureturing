    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeDocument.Create(
        ...
        Blocks(
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/TotalVariation/HellingerDivergence.hellinger_sq_le_kl_divergence"),
                Disp(Seq(
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/TotalVariation/HellingerDivergence.hellinger_sq_lt_kl_divergence_witness"),
                Disp(Seq(
                    Begin, Grp(F.Id("gathered")),
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/TotalVariation/HellingerDivergence.hellinger_sq_nonneg"),
                Disp(Seq(
                    Begin, Grp(F.Id("gathered")),
                    Forall, Sp, Iota, Esc,
                    OpenBracket,
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/TotalVariation/HellingerDivergence.hellinger_sq_comm"),
                Disp(Seq(
                    Begin, Grp(F.Id("gathered")),
                    Forall, Sp, Iota, Esc,
                    OpenBracket,
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/TotalVariation/HellingerDivergence.hellinger_sq_eq_zero_iff_sqrt_eq"),
                Disp(Seq(
                    Begin, Grp(F.Id("gathered")),
                    Forall, Sp, Iota, Esc,
                    OpenBracket,
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem(
                    "D5/S3/TotalVariation/HellingerDivergence.sqrt_hellinger_sq_triangle"),
                Disp(Seq(
                    Begin, Grp(F.Id("gathered")),
                    Forall, Sp, Iota, Esc,
                    OpenBracket,
