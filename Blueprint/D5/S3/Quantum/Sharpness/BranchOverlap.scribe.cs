...
internal sealed class BranchOverlapDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(
                DescribeId.Create("pt-branch-overlap"),
                DeclarationHandle.Create(
                    "D5/S3/Quantum/Sharpness/BranchOverlap.pt_branch_overlap"),
