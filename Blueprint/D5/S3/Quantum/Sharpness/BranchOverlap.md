...
*Proof.* Machine-checked in Lean as `D5/S3/Quantum/Sharpness/BranchOverlap.pt_branch_overlap` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/Quantum/Sharpness/BranchOverlap.pt_branch_overlap`
