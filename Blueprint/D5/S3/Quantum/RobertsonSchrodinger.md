...
*Proof.* Machine-checked in Lean as `D5/S3/Quantum/RobertsonSchrodinger.robertson_schrodinger` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/Quantum/RobertsonSchrodinger.robertson_schrodinger`
