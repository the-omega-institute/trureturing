            ...
            Describe.Lean(
                ...
                Blocks(
                    ...
                    Paragraph(Text(
                        ...
                        "exactly the described blocks, including their off-diagonal entries.")),
                    Paragraph(Text(
                    ...
                    Paragraph(Text(
                        ...
                        "already span the whole memory. Choose a coordinate equivalence e from " +
                        "K(a,head) to Fin(N), where N is the rank above, and write phiFin for the " +
                        "transported vectors. There exist one isometry V from this memory to " +
                        "alphabet tensor the same memory, and one unitary U on the " +
                        "alphabet-memory register. The identity V=tensorCoordinates(N) composed with " +
                        ...
                        "in transported coordinates at every legal nonzero residual and sends " +
                        "phiFin(0) to head tensor phiFin(0). The Gram matrix of phiFin is G. " +
                        "If A>0, then phiFin(0)=phiFin(one copy of head), and the nonterminal " +
                        "phiFin vectors span the whole finite memory.")),
                    Paragraph(Text(
                        "Initialize the memory at phiFin(a), blank all output registers with head, " +
                        ...
                        "phiFin(0)(k)/sqrt(M(a)) when the occupation is a and is zero otherwise. " +
                        "Both the initial vector and common final vector phiFin(0) are unit vectors. " +
