...
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create("Bounds for the real inverse hyperbolic tangent on the open unit interval.",
        H("Double Artanh Bounds"),
        Blocks(
            Describe.Lean(
                DescribeId.Create("double-artanh-bounds"),
                DeclarationHandle.Create("D5/S3/Quantum/DoubleArtanhBounds.double_artanh_bounds"),
                H("Double artanh bounds"),
