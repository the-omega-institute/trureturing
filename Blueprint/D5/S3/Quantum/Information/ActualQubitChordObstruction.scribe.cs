...
internal sealed class ActualQubitChordObstructionDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        H("Two signal probes force a qubit chord"),
        Blocks(
    ...
    private static Formula ResultFormula() => Lines(
        Seq(Forall, Sp, Id("a"), InMacro, Sp, Real, Comma, Sp, Num(0), Lt, Id("a"), Lt, Num(1), Comma, Sp,
            Forall, Sp, Id("G"), InMacro, Sp, Call("CPTP", Seq(Call("Fin", Num(3)), Times, Call("Fin", Num(2))), Call("Fin", Num(3))), Comma),
        Seq(Forall, Sp, Rho, Colon, Real, To, Cmat(2), Comma, Sp,
        ...
        Seq(Land, Sp, Open, Forall, Sp, Id("u"), InMacro, Sp, Id("J"), Comma, Sp, Forall, Sp, Id("k"), Comma, Sp,
            Call("L", Id("k"), RhoAt(Id("u"))), Eq, Call("Y", Id("k"), Id("a"), Id("u")), Close),
        Seq(Longrightarrow, Sp, Open, Forall, Sp, Id("k"), Comma, Sp, Call("Density", Sub("W", Id("k"))), Close, Land, Sp,
            Exists, Sp, Id("c"), Comma, Id("v"), InMacro, Sp, Real, Caret, Num(3), Comma, Sp, Exists, Sp, Id("b"), InMacro, Sp, Real, Comma),
        ...
        Seq(Land, Num(0), Le, Id("s"), Le, Fr(Seq(Num(1), Plus, Id("b")), 2), Land, Id("s"), Lt, Num(1)));
}
