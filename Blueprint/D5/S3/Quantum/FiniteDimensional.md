...
## Theorem: The standard qubit Weyl pair has the Pauli star skeleton

Provenance: `literature-attested` via `D5/L/schwinger1960unitary` (`lit/schwinger1960unitary`)

Statement: `D5/S3/Quantum/FiniteDimensional.qubit_weyl_star` `✓ std3`
...
## Theorem: The qubit matrix algebra has no complex-algebra character

Provenance: `literature-attested` via `D5/L/murphy1990calgebras` (`lit/murphy1990calgebras`)

Statement: `D5/S3/Quantum/FiniteDimensional.qubit_matrix_algebra_has_no_character` `✓ std3`
...
## Theorem: Positive trace-one matrices give nonnegative projection weights

Provenance: `literature-attested` via `D5/L/gleason1957measures` (`lit/gleason1957measures`)

Statement: `D5/S3/Quantum/FiniteDimensional.born_probability_skeleton` `✓ std3`
