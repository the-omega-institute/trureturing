...
*Proof.* Machine-checked in Lean as `D5/S3/Quantum/Tomography/PovmOutcomeLowerBound.povm_outcome_lower_bound` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/Quantum/Tomography/PovmOutcomeLowerBound.povm_outcome_lower_bound`
...
- Dependency: [D5/S3/Quantum/Tomography/InformationalCompletenessEquivalence](InformationalCompletenessEquivalence.md)
