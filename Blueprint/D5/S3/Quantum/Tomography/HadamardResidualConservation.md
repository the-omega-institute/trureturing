...
Lean statement: `D5/S3/Quantum/Tomography/HadamardResidualConservation.hadamard_residual_box_dual`

*Proof.* Machine-checked in Lean as `D5/S3/Quantum/Tomography/HadamardResidualConservation.hadamard_residual_box_dual` (`✓ std3`). ∎
...
Lean statement: `D5/S3/Quantum/Tomography/HadamardResidualConservation.balanced_hadamard_sublevel_row_enclosure`

*Proof.* Machine-checked in Lean as `D5/S3/Quantum/Tomography/HadamardResidualConservation.balanced_hadamard_sublevel_row_enclosure` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/Quantum/Tomography/HadamardResidualConservation.balanced_hadamard_sublevel_row_enclosure`
- Truth anchor: `D5/S3/Quantum/Tomography/HadamardResidualConservation.hadamard_residual_box_dual`
