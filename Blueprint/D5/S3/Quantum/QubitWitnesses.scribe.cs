    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeDocument.Create(
        ...
        Blocks(
            new DocumentBlock.Describe(
                ...
                LatexStatement.Create(@"$$\forall \psi\in\mathbb{C}^{2},\ \forall x,z\in\mathbb{C},\ (X\psi=x\psi \land Z\psi=z\psi) \Rightarrow \psi=0$$")),
            new DocumentBlock.Describe(
            ...
            new DocumentBlock.Describe(
                ...
                LatexStatement.Create(@"$$\forall c\in[0,1],\ \forall N\in\mathbb{N},\ \rho_{N}:=\operatorname{phaseDampingIterate}(c,N,\operatorname{equalSuperpositionDensity}),\ (\rho_{N})_{00}=\frac{1}{2} \land (\rho_{N})_{11}=\frac{1}{2} \land (\rho_{N})_{01}=\frac{1}{2}c^{N} \land (\rho_{N})_{10}=\frac{1}{2}c^{N}$$")))));
}
