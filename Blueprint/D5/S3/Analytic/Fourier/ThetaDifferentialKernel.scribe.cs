    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Describe.Lean(
                ...
                StatementSource.WithoutFormula(),
                AssessedProvenance.FromRepo(LibraryNoteRef.Create("D5/L/Analytic/romik2021orthogonal")),
                Blocks(Paragraph(Text("For t > 0, thetaSeries 0 t equals (theta t - 1)/2, where theta is the even Hurwitz kernel at parameter zero."))),
                DescribeRole.Theorem),
            Describe.Lean(
                ...
                StatementSource.WithoutFormula(),
                AssessedProvenance.FromRepo(LibraryNoteRef.Create("D5/L/Analytic/romik2021orthogonal")),
                Blocks(Paragraph(Text("For t > 0, omega(t) equals 2*pi^2*t^2*thetaSeries 4 t - 3*pi*t*thetaSeries 2 t. Its definition is the positive-integer Gaussian series in Romik (1.7)."))),
                DescribeRole.Theorem),
            Describe.Lean(
            ...
            Describe.Lean(
                ...
                StatementSource.WithoutFormula(),
                AssessedProvenance.FromRepo(LibraryNoteRef.Create("D5/L/Analytic/romik2021orthogonal")),
                Blocks(Paragraph(Text("For every real x, romikPhi(-x)=romikPhi(x). The original definition contains no absolute value; the reflection defects in psi and its second derivative cancel."))),
                DescribeRole.Theorem),
            Describe.Lean(
