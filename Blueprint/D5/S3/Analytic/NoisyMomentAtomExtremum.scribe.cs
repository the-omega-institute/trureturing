    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Describe.Lean(
                ...
                StatementSource.WithoutFormula(),
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text("For arbitrary distinct real nodes and an off-node point y, form Lagrange extrapolation coefficients c, their positive-sign 0/1 interpolant p, P=p(y), and the nonconstant coefficient cost L. A computed positive noise radius preserves the signs of c after a worst-direction moment perturbation. The proof constructs both probability vectors, verifies their normalization and saturated moment errors, and proves that the maximum atom at y equals (1+epsilon L)/P. The IsGreatest upper bound ranges over all feasible probability pairs on the specified supports. Chebyshev continuum specialization, the all-time log-squared minimax rate and cyclic Jacobi realizations have ordinary proofs in the theory; they are not claimed as consequences already checked by this Lean module."))),
