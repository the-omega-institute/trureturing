...
The first three conjuncts state positivity, the exact normalized weighted integer expansion, and the induced seminorm-square identity. The state value is displayed through its real part, which equals the real nonnegative weighted series.
