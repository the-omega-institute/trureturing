...
$$\forall t \in \operatorname{Real}\left(\right),\; (\left|\operatorname{Gamma}\left(\frac{1}{4} + i \times \frac{t}{2}\right)\right|)^{2} \times (\left|\operatorname{Gamma}\left(\frac{3}{4} + i \times \frac{t}{2}\right)\right|)^{2} = \frac{2 \times (\pi)^{2}}{\operatorname{cosh}\left(\pi \times t\right)} \land \left(\frac{1}{\operatorname{cosh}\left(\pi \times t\right)} = \frac{2 \times \operatorname{exp}\left(-\pi \times \left|t\right|\right)}{1 + \operatorname{exp}\left(-2 \times \pi \times \left|t\right|\right)} \land (\left|\operatorname{Gamma}\left(\frac{1}{4} + i \times \frac{t}{2}\right)\right|)^{2} \times (\left|\operatorname{Gamma}\left(\frac{3}{4} + i \times \frac{t}{2}\right)\right|)^{2} = 2 \times (\pi)^{2} \times \frac{2 \times \operatorname{exp}\left(-\pi \times \left|t\right|\right)}{1 + \operatorname{exp}\left(-2 \times \pi \times \left|t\right|\right)}\right)$$
