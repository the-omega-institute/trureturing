    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(Describe.Lean(
            ...
            Blocks(
                ...
                Paragraph(Text(
                    "This is distinct from ToroidalCommonZeroLocus, whose conclusion is a "
                        + "global set equality quantified over all indices. "
                        + "ToroidalObserverSetCover, ToroidalTemperednessCriterion, and "
                        + "ToroidalJetDepth supply the neighbouring observer and jet context.")),
                Paragraph(Text(
