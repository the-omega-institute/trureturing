# Two-point grid row bounds

## Abstract

Logarithmic secant estimates control positive pairs, fractional rows and ordered two-item fills.

**Theorem 1.1 (Increasing the mean).**

Lean statement: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.psiTwo_mono_mean`

*Proof.* Machine-checked in Lean as `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.psiTwo_mono_mean` (`✓ std3`). ∎
...
**Theorem 1.2 (Decreasing the spread).**

Lean statement: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.pair_value_spread`

*Proof.* Machine-checked in Lean as `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.pair_value_spread` (`✓ std3`). ∎
...
**Theorem 1.3 (The quadratic moments of the inner secant).**

Lean statement: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.inner_secant_quadratic_moments`

*Proof.* Machine-checked in Lean as `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.inner_secant_quadratic_moments` (`✓ std3`). ∎
...
**Theorem 1.4 (The logarithmic inner secant).**

Lean statement: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.inner_secant_bound`

*Proof.* Machine-checked in Lean as `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.inner_secant_bound` (`✓ std3`). ∎
...
**Theorem 1.5 (A positive pair and a variance parameter).**

Lean statement: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.pair_bound`

*Proof.* Machine-checked in Lean as `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.pair_bound` (`✓ std3`). ∎
...
**Theorem 1.6 (Contracting a secant interval).**

Lean statement: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.secant_contract`

*Proof.* Machine-checked in Lean as `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.secant_contract` (`✓ std3`). ∎
...
**Theorem 1.7 (A row meeting the upper budget).**

Lean statement: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.fractional_row_bound`

*Proof.* Machine-checked in Lean as `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.fractional_row_bound` (`✓ std3`). ∎
...
**Theorem 1.8 (An actual positive pair).**

Lean statement: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.actual_pair_bound`

*Proof.* Machine-checked in Lean as `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.actual_pair_bound` (`✓ std3`). ∎
...
**Theorem 1.9 (An ordered two-item fill).**

Lean statement: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.ordered_fill_bound`

*Proof.* Machine-checked in Lean as `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.ordered_fill_bound` (`✓ std3`). ∎
...
- Truth anchor: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.actual_pair_bound`
- Truth anchor: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.fractional_row_bound`
- Truth anchor: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.inner_secant_bound`
- Truth anchor: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.inner_secant_quadratic_moments`
- Truth anchor: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.ordered_fill_bound`
- Truth anchor: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.pair_bound`
- Truth anchor: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.pair_value_spread`
- Truth anchor: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.psiTwo_mono_mean`
- Truth anchor: `D5/S3/Analytic/Interpolation/TwoPointGridDominanceBound.secant_contract`
