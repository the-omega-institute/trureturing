...
$$\left|\pi - piApprox\right| < \frac{1}{10^{19}}$$
...
$$\forall a \in \mathbb{Q}, b \in \mathbb{Q}, theta \in \mathbb{R},\; \left(a \le theta \land \left(theta \le b \land \left(\left|a\right| \le 10^{7} \land \left|a - \operatorname{phaseIndex}\left(a\right) \cdot (2 \cdot piApprox)\right| + b - a \le \frac{99}{100}\right)\right)\right) \Rightarrow \left(\exists r \in \mathbb{R},\; theta = r + \operatorname{phaseIndex}\left(a\right) \cdot (2 \cdot \pi) \land \left(\left|r\right| \le 1 \land \left(\operatorname{cos}\left(theta\right) = \operatorname{cos}\left(r\right) \land \operatorname{sin}\left(theta\right) = \operatorname{sin}\left(r\right)\right)\right)\right)$$
...
$$\forall a \in \mathbb{Q}, b \in \mathbb{Q}, theta \in \mathbb{R},\; \left(a \le theta \land \left(theta \le b \land \left(\left|a\right| \le 10^{7} \land \left|a - \operatorname{phaseIndexPi}\left(a\right) \cdot piApprox\right| + b - a \le \frac{99}{100}\right)\right)\right) \Rightarrow \left(\exists r \in \mathbb{R},\; theta = r + \operatorname{phaseIndexPi}\left(a\right) \cdot \pi \land \left(\left|r\right| \le 1 \land \left(\operatorname{cos}\left(theta\right) = (-1)^{\operatorname{phaseIndexPi}\left(a\right)} \cdot \operatorname{cos}\left(r\right) \land \operatorname{sin}\left(theta\right) = (-1)^{\operatorname{phaseIndexPi}\left(a\right)} \cdot \operatorname{sin}\left(r\right)\right)\right)\right)$$
...
- Truth anchor: `D5/S3/Analytic/Certified/TrigEnvelopePhaseReduction.abs_pi_sub_piApprox_lt`
...
- Truth anchor: `D5/S3/Analytic/Certified/TrigEnvelopePhaseReduction.exists_reduced_phase_of_rat`
- Truth anchor: `D5/S3/Analytic/Certified/TrigEnvelopePhaseReduction.exists_reduced_phase_pi_of_rat`
