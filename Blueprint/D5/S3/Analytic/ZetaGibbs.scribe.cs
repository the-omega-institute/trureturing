    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeDocument.Create(
        ...
        Blocks(
            DocumentBlock.Describe.Definition(
                ...
                LeanDefinition("D5/S3/Analytic/ZetaGibbs.weight"),
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem("D5/S3/Analytic/ZetaGibbs.partition_function_pos"),
                In(Seq(D(0), Lt, F.Id("Z"), Open, F.Id("s"), Close)),
                DescribeProvenance.RepoDerived(),
                Blocks(Paragraph(Text(
            ...
            DocumentBlock.Describe.Definition(
                ...
                LeanDefinition("D5/S3/Analytic/ZetaGibbs.zetaDist"),
                DescribeProvenance.RepoDerived(),
                Blocks(Paragraph(Text(
                ...
                Disp(Seq(
                    ...
                    Operatorname, Grp(F.Id("normalize")), Open,
                    F.Id("w"), Underscore, Grp(F.Id("s")), Close, Comma, Quad,
                    D(1), Lt, F.Id("s")))
            ),
            DocumentBlock.Describe.Theorem(
                DescribeId.Create("the-zeta-pmf-has-the-gibbs-value-formula"),
                H("The zeta PMF has the Gibbs value formula"),
                LeanTheorem("D5/S3/Analytic/ZetaGibbs.zeta_dist_apply"),
                Disp(Seq(
                    D(1), Lt, F.Id("s"), Sp, Rightarrow, Sp,
            ...
            DocumentBlock.Describe.Theorem(
                ...
                LeanTheorem("D5/S3/Analytic/ZetaGibbs.weight_one_tsum_eq_top"),
                Disp(Seq(
