                ...
                Blocks(
                    ...
                    Paragraph(Text(
                        "The continuation also has residue c at s=1, expressed as the exact "
                            ...
                            + "continuation and residue clauses reuse the frozen owner theorem; "
                            + "the new proof supplies only the previously private convergence "
                            + "witness."))),
