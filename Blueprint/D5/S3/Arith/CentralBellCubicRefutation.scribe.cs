...
internal sealed class CentralBellCubicRefutationDocument : IScribeDocumentDefinition
{
    ...
    private static readonly LibraryNoteRef Khan2026 =
        LibraryNoteRef.Create("D5/L/Arith/khan2026centralbell");

    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        "Rational double-root certificates refute the two distinct-root claims for the printed "
            + "n = 3, lambda = 3 central Bell cosine cubics. The proposed D5/S1/Polynomial bucket "
            + "does not exist; D5/S3/Arith is the nearest existing integer/polynomial-arithmetic "
            + "owner, and capacity was checked.",
        ...
        Blocks(
            Describe.Lean(
                ...
                AssessedProvenance.FromLiterature(Khan2026),
                ...
                Blocks(
                    ...
                    Paragraph(Text(
                        "Provenance correction: the atom bracket's lambda=1 is an orchestrator typo "
                            + "corrected by 评注 27.847 (PR #5860). This module refutes the paper's "
