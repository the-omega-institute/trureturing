        ...
        Blocks(
            Describe.Lean(
                ...
                AssessedProvenance.FromLiterature(
                    LibraryNoteRef.Create("D5/L/Arith/filaseta2007sieving")),
                Blocks(
                    Paragraph(Text(
                    ...
                    Paragraph(Text(
                        "This is a quantitative form of the classical necessary condition "
                            + "that the reciprocal sum of covering moduli is at least one "
                            + "(Erdos's covering-system setting, 1950). Literature attestation "
                            + "is supplied by the cited survey's introduction, which also states "
                            + "that distinct nontrivial divisor moduli can cover only if "
                            + "sigma(L)/L > 2. The note attests those necessary conditions; "
                            + "the displayed two-prime bound L/8 is the quantitative "
                            + "specialization proved here, not a formula quoted from that survey.")),
                    Paragraph(Text(
                ...
                Blocks(
                    Paragraph(Text(
                        "Under the same prime, exponent, modulus, and residue hypotheses, it is "
                            ...
                            + "density theorem. Its literature attribution is to the necessary "
                            + "covering conditions scoped in the cited note."))),
