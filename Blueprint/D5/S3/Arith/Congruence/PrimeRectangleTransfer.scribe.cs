    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(Describe.Lean(
            ...
            Blocks(
                ...
                Paragraph(Text(
                    "Assume the zero layer's mu-weighted second moment is at most G(0). "
                    ...
                    + "is at most G(t). Choose arbitrary natural residues b(e,i). The new "
                    + "load sums A(e,i,x) over those pairs whose residue condition "
                    + "y mod p^e = b(e,i) mod p^e holds. Its squared expectation under "
                    + "mu(x)K(x,y) is at most G(0) plus the sum, for t from one through H, "
                    + "of (2t+1)G(t).")),
                Paragraph(Text(
                    ...
                    + "without distortion. An induction counts exactly 2t+1 ordered "
                    + "exponent pairs with maximum t.")),
                Paragraph(Text(
