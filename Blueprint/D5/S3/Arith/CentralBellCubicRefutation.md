...
Rational double-root certificates refute the two distinct-root claims for the printed n = 3, lambda = 3 central Bell cosine cubics.
...
$$\forall f \in \mathbb{C} \to \mathbb{C},\; HasThreeDistinctRoots\left(f\right) \Leftrightarrow (\exists a \in \mathbb{C}, b \in \mathbb{C}, c \in \mathbb{C},\; \left(\left(\left(\left(f\left(a\right) = 0 \land f\left(b\right) = 0\right) \land f\left(c\right) = 0\right) \land a \ne b\right) \land a \ne c\right) \land b \ne c)$$
...
$$\left((\exists y \in \mathbb{Q}, z \in \mathbb{Q},\; \left(\left(y = \frac{1}{2} \land z = 8\right) \land (\forall x \in \mathbb{C},\; eulerCubic\left(x, ofReal\left(val\left(y\right)\right), ofReal\left(val\left(z\right)\right)\right) = 0 \Leftrightarrow (x = -7 \lor x = -10))\right) \land \left(\neg HasThreeDistinctRoots\left(x \mapsto eulerCubic\left(x, ofReal\left(val\left(y\right)\right), ofReal\left(val\left(z\right)\right)\right)\right)\right)) \land -7 \ne -10\right) \land \left(\neg (\forall y \in \mathbb{R}, z \in \mathbb{R},\; HasThreeDistinctRoots\left(x \mapsto eulerCubic\left(x, ofReal\left(y\right), ofReal\left(z\right)\right)\right))\right)$$
...
Provenance correction: the atom bracket's lambda=1 is an orchestrator typo corrected by PZG remark 27.844 / PR #5820. This module refutes the paper's printed n = 3, lambda = 3 cubics; the existing 4.105 and 4.106 atoms remain the coverage targets.
...
$$\left((\exists y \in \mathbb{Q}, z \in \mathbb{Q},\; \left(\left(y = \frac{2}{3} \land z = \frac{125}{27}\right) \land (\forall x \in \mathbb{C},\; bernoulliCubic\left(x, ofReal\left(val\left(y\right)\right), ofReal\left(val\left(z\right)\right)\right) = 0 \Leftrightarrow (x = -\frac{205}{54} \lor x = -\frac{170}{27}))\right) \land \left(\neg HasThreeDistinctRoots\left(x \mapsto bernoulliCubic\left(x, ofReal\left(val\left(y\right)\right), ofReal\left(val\left(z\right)\right)\right)\right)\right)) \land -\frac{205}{54} \ne -\frac{170}{27}\right) \land \left(\neg (\forall y \in \mathbb{R}, z \in \mathbb{R},\; HasThreeDistinctRoots\left(x \mapsto bernoulliCubic\left(x, ofReal\left(y\right), ofReal\left(z\right)\right)\right))\right)$$
