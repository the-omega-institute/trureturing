...
Fix a prime p, a positive natural precision k, and distinct integers x and y. The precision reading is the residue modulo p^k. The two readings agree exactly when k does not exceed the p-adic valuation of x - y.
