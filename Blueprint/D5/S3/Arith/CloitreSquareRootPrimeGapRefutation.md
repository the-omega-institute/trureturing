...
*Formalization.* `D5/S3/Arith/CloitreSquareRootPrimeGapRefutation.a` (`✓ std3`).
...
*Formalization.* `D5/S3/Arith/CloitreSquareRootPrimeGapRefutation.claim` (`✓ std3`).
...
- Truth anchor: `D5/S3/Arith/CloitreSquareRootPrimeGapRefutation.a`
- Truth anchor: `D5/S3/Arith/CloitreSquareRootPrimeGapRefutation.claim`
- Truth anchor: `D5/S3/Arith/CloitreSquareRootPrimeGapRefutation.result`
