    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Node("odd_totativeSum_iff", "The odd totative-sum classification",
                ...
                "The totative sums at one and two are odd. Above them, oddness forces a "
                    + "single odd prime factor, and the pairing of each reduced residue k "
                    + "with n-k (twice the totative sum equals n times the Euler totient) "
                    + "excludes primes congruent to one modulo four. Conversely, every positive power of a "
