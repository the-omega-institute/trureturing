    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Describe.Lean(
                ...
                Blocks(
                    Paragraph(Text(
                        "Clauses (i)-(ii) are Miska's valuation identity "
                        + "(DOI 10.1016/j.jnt.2015.11.014; arXiv:1508.01987, Section 6.1, "
                        + "proof of Proposition 25, printed page 48) and its parity law. "
