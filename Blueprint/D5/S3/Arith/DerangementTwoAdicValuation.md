...
Clauses (i)-(ii) are Miska's valuation identity (DOI 10.1016/j.jnt.2015.11.014; arXiv:1508.01987, Section 6.1, proof of Proposition 25, printed page 48) and its parity law. Clause (iii) is a repository corollary: if D_n = b^k, the power rule makes k divide v_2(D_n). The whole conjunction is repository-derived because the source attribution applies only to clauses (i)-(ii).
