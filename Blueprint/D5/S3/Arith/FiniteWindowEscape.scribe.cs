        ...
        Blocks(
            Describe.Lean(
                ...
                StatementSource.FromAuthor(Disp(Seq(
                    ...
                    Prod, Underscore, Grp(F.Id("r"), InMacro, Sp, F.Id("S")), F.Id("r"), Comma, Esc,
                    ...
                    InMacro, Sp, F.Id("S"), Close, Sp, Land, Sp,
                    Left, Open, Exists, Sp, F.Id("q"), InMacro, Mathbb, Grp(F.Id("N")), Comma, Esc,
                    Operatorname, Grp(F.Id("Prime")), Open, F.Id("q"), Close, Sp, Land, Sp,
                    F.Id("q"), Mid, Sp, F.Id("E"), Underscore, Grp(F.Id("S")), Sp, Land, Sp,
                    Neg, Open, F.Id("q"), InMacro, Sp, F.Id("S"), Close, Right, Close, Sp, Land, Sp,
                    Left, Open, Forall, Sp, F.Id("q"), InMacro, Mathbb, Grp(F.Id("N")), Comma, Esc,
                    Operatorname, Grp(F.Id("Prime")), Open, F.Id("q"), Close, Sp, Land, Sp,
                    F.Id("q"), Mid, Sp, F.Id("E"), Underscore, Grp(F.Id("S")), Sp, Rightarrow, Sp,
                    Neg, Open, F.Id("q"), InMacro, Sp, F.Id("S"), Close, Right, Close, Sp, Land, Sp,
                    ...
                    F.Id("additive"), Sp, F.Id("group")), Comma, Esc,
                    Forall, Sp, F.Id("R"), Colon, F.Id("G"), To, Sp, F.Id("A"),
                    F.Text, Grp(Sp, F.Id("additive")), Comma, Esc,
                    Exists, Sp, F.Id("x"), Comma, F.Id("y"), InMacro, Sp, F.Id("G"), Comma, Esc,
                    F.Id("x"), Neq, Sp, F.Id("y"), Sp, Land, Sp,
