...
**Definition 1.3 (The integer root index).**

$$\forall k \in \mathbb{N},\; \forall n \in \mathbb{N},\; \operatorname{R}\left(k, n\right) = \operatorname{root}\left(3, \operatorname{div}\left(6 \cdot n, k - 2\right)\right)$$

*Formalization.* `D5/S3/Arith/WuPyramidalComplement.rootIndex` (`✓ std3`).

*Source.* Repository-derived.

*Commentary.*

R(k,n) is the greatest natural h whose cube is at most the natural quotient 6n divided by k-2.

**Definition 1.4 (The upper threshold).**
...
**Definition 1.5 (The lower threshold).**
...
**Definition 1.6 (The ordered source branches).**
...
**Definition 1.7 (The three branch adjustments).**
...
- Truth anchor: `D5/S3/Arith/WuPyramidalComplement.rootIndex`
