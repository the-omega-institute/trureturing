...
The Stirling expansion directly reuses the already-frozen Bernoulli relative entropy definition `D5/S0/Diagonal/MarginBound.bernoulliKL`.

**Theorem 1.2 (Uniform relative approximation on a growing window).**
...
**Theorem 1.3 (Powered tails beat every fixed polynomial scale).**
...
**Theorem 1.4 (Gaussian lattice sum with a moving real center).**
