...
A supplement strategy is feasible at budget L when its cost is at most L. Its escape value is the mass assigned to the canonical target-defect relation of the joined base and supplement readout, divided by M0, which is required to equal the positive mass of the base target-defect relation. The budgeted escape rate is the real infimum of these feasible normalized values.
