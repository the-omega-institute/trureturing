    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(Describe.Lean(
            ...
            StatementSource.FromAuthor(F.Disp(
                F.Seq(F.Forall, F.Sp, F.Id("k"), F.Comma, F.Id("B"), F.InMacro, F.Sp, F.Id("Nat"), F.Comma, Call("DHLTwoNat", F.Id("k")), F.Land, F.Sp, Call("AdmissibleWindowWitness", F.Id("k"), F.Id("B")), F.Rightarrow, Call("ArbitrarilyLateConsecutiveGap", F.Id("B"))))),
