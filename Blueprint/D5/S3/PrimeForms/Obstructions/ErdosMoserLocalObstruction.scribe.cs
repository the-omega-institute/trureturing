        ...
        Blocks(
            Describe.Lean(
                ...
                AssessedProvenance.FromLiterature(LibraryNoteRef.Create(
                    "D5/L/Arith/moree2013moser")),
                Blocks(
                    Paragraph(Text(
                        "Moser (1953); literature attestation via Moree (2013), Theorem 2, "
                            + "which records Moser's proof.")),
                    Paragraph(Text(
                    ...
                    Paragraph(Text(
                        "The proof partitions the power sum into q complete residue blocks in "
                            + "ZMod p, explicitly transports the Finset.range p natural indices "
                            + "to ZMod p and then to its unit group, and applies the finite-field "
                            + "power-sum dichotomy. The zero branch is impossible, while the "
                            + "minus-one branch gives p dividing q + 1.")),
                    Paragraph(Text(
