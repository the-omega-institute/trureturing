...
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create("The prime two refutes the unqualified quadratic-residue equivalence.",
        H("Quadratic-Residue Counterexample at Two"),
        Blocks(
            Describe.Lean(
                DescribeId.Create("two-refutes-unqualified-quadratic-residue-equivalence"),
                DeclarationHandle.Create("D5/S3/PrimeForms/QuadraticResidueCounterexample.two_refutes_unqualified_quadratic_residue_equivalence"),
                H("The prime two refutes the unqualified equivalence"),
                StatementSource.FromAuthor(Disp(Seq(Neg, Open,
