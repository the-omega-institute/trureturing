...
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create("A crossing slot propagates three square-root-of-three legs and reduces its discriminant to a Pythagorean spectral line.",
        H("Propagation Identity"),
        Blocks(
            Describe.Lean(
                DescribeId.Create("three-propagated-legs-and-spectral-line"),
                DeclarationHandle.Create("D5/S3/PrimeForms/PropagationLegs.propagation_identity"),
