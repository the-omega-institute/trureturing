...
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create("No rational lies within one over root-five den squared plus den of the golden ratio.",
        H("The Effective Hurwitz Bound at the Golden Ratio"),
        Blocks(
            Describe.Lean(DescribeId.Create("golden-hurwitz-bound"),
                DeclarationHandle.Create("D5/S1/Depth/GoldenHurwitzBound.golden_hurwitz_bound"),
