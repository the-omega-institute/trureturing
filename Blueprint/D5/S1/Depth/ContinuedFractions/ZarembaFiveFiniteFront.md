...
$$\forall A, a, q \in \mathbb{N},\ \operatorname{zarembaCheck}\left(A, a, q\right) = (\operatorname{decide}\left(\operatorname{Coprime}\left(a, q\right)\right) && (\operatorname{decide}\left(0 < a\right) && (\operatorname{decide}\left(a < q\right) && \operatorname{digitsBounded}\left(A, \operatorname{cfDigits}\left(a, q\right)\right)))).$$
