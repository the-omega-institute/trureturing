...
internal sealed class ZarembaFiveFiniteFrontDocument : IScribeDocumentDefinition
{
    ...
    private static Formula CheckFormula()
    {
        ...
        var checkerBody = Parenthesized(Seq(
            Parenthesized(Call("decide", Call("Coprime", a, q))), Sp, Land, Sp,
            Parenthesized(Call("decide", Seq(D(0), Sp, Lt, Sp, a))), Sp, Land, Sp,
            Parenthesized(Call("decide", Seq(a, Sp, Lt, Sp, q))), Sp, Land, Sp,
            Parenthesized(Call("digitsBounded", A, CfDigits(a, q)))));
