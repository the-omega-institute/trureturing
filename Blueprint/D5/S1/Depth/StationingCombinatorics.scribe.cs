...
internal sealed class StationingCombinatoricsDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create() =>
        DocumentDefinition.Create(ScribeNode.Create("Record exact support and occupancy counts for labeled Boolean stationings.",
H("Stationing Counts"),
Blocks(
                Paragraph(Text(
                ...
                Describe.Lean(
                    ...
                    DeclarationHandle.Create("D5/S1/Depth/StationingCombinatorics.stationing_count"),
                    H("All labeled stationings have power-of-two cardinality"),
                    StatementSource.FromAuthor(In(Seq(Forall, Sp, F.Id("n"), InMacro, Mathbb, Grp(F.Id("N")), Comma, Esc, Operatorname, Grp(F.Id("card")), Open, Operatorname, Grp(F.Id("Stationing")), Open, F.Id("n"), Close, Close, Eq, D(2), Caret, F.Id("n")))),
                ...
                Describe.Lean(
                    ...
                    DeclarationHandle.Create("D5/S1/Depth/StationingCombinatorics.occupied_stations_mirror"),
                    H("Mirroring complements the occupied support"),
                    StatementSource.FromAuthor(In(Seq(Forall, Sp, F.Id("s"), InMacro, Operatorname, Grp(F.Id("Stationing")), Open, F.Id("n"), Close, Comma, Esc, Operatorname, Grp(F.Id("Occ")), Open, F.Id("M"), Open, F.Id("s"), Close, Close, Eq, Operatorname, Grp(F.Id("Fin")), Open, F.Id("n"), Close, Setminus, Operatorname, Grp(F.Id("Occ")), Open, F.Id("s"), Close))),
                    AssessedProvenance.FromRepo(),
                    Blocks(Paragraph(Text(
                ...
                Describe.Lean(
                    ...
                    DeclarationHandle.Create("D5/S1/Depth/StationingCombinatorics.mirror_occupied_count"),
                    H("Mirror occupancy is the complementary count"),
                    StatementSource.FromAuthor(In(Seq(Forall, Sp, F.Id("s"), InMacro, Operatorname, Grp(F.Id("Stationing")), Open, F.Id("n"), Close, Comma, Esc, Bar, Operatorname, Grp(F.Id("Occ")), Open, F.Id("M"), Open, F.Id("s"), Close, Close, Bar, Eq, F.Id("n"), Minus, Bar, Operatorname, Grp(F.Id("Occ")), Open, F.Id("s"), Close, Bar))),
                    AssessedProvenance.FromRepo(),
                    Blocks(Paragraph(Text(
                ...
                Describe.Lean(
                    ...
                    DeclarationHandle.Create("D5/S1/Depth/StationingCombinatorics.mirror_stationing_ne_self"),
                    H("Boolean mirroring has no fixed nonempty stationing"),
                    StatementSource.FromAuthor(In(Seq(Forall, Sp, F.Id("n"), Gt, D(0), Comma, Esc, Forall, Sp, F.Id("s"), InMacro, Operatorname, Grp(F.Id("Stationing")), Open, F.Id("n"), Close, Comma, Esc, F.Id("M"), Open, F.Id("s"), Close, Neq, Sp, F.Id("s")))),
                    AssessedProvenance.FromRepo(),
                    Blocks(Paragraph(Text(
                ...
                Describe.Lean(
                    ...
                    DeclarationHandle.Create("D5/S1/Depth/StationingCombinatorics.occupied_count_stationing_count"),
                    H("A prescribed occupancy has binomial cardinality"),
                    StatementSource.FromAuthor(In(Seq(Forall, Sp, F.Id("n"), Comma, F.Id("k"), InMacro, Mathbb, Grp(F.Id("N")), Comma, Esc, Operatorname, Grp(F.Id("card")), OpenBrace, F.Id("s"), InMacro, Operatorname, Grp(F.Id("Stationing")), Open, F.Id("n"), Close, Colon, Bar, Operatorname, Grp(F.Id("Occ")), Open, F.Id("s"), Close, Bar, Eq, F.Id("k"), CloseBrace, Eq, Operatorname, Grp(F.Id("choose")), Open, F.Id("n"), Comma, F.Id("k"), Close))),
                    AssessedProvenance.FromRepo(),
                    Blocks(Paragraph(Text(
