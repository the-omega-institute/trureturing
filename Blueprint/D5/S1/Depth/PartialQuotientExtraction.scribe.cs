...
internal sealed class PartialQuotientExtractionDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create() =>
        DocumentDefinition.Create(ScribeNode.Create("Extract a rational continued-fraction maximum and instantiate the exact twelve-scale floor.",
...
Blocks(
                ...
                Describe.Lean(
                    ...
                    DeclarationHandle.Create("D5/S1/Depth/PartialQuotientExtraction.partialQuotients_nonempty"),
                    H("A nonintegral rational has a nonempty extracted tail"),
                    StatementSource.FromAuthor(Disp(Seq(Forall, Sp, F.Id("q"), InMacro, Mathbb, Grp(F.Id("Q")), Setminus, Mathbb, Grp(F.Id("Z")), Comma, Esc, F.Id("C"), Open, F.Id("q"), Close, Neq, Varnothing))),
                    AssessedProvenance.FromRepo(),
                    Blocks(Paragraph(Text(
                ...
                Describe.Lean(
                    ...
                    DeclarationHandle.Create("D5/S1/Depth/PartialQuotientExtraction.aMax_pos"),
                    H("The extracted maximum is positive off the integers"),
                    StatementSource.FromAuthor(Disp(Seq(Forall, Sp, F.Id("q"), InMacro, Mathbb, Grp(F.Id("Q")), Setminus, Mathbb, Grp(F.Id("Z")), Comma, Esc, F.Id("A"), Open, F.Id("q"), Close, Gt, D(0)))),
                    AssessedProvenance.FromRepo(),
                    Blocks(Paragraph(Text(
                ...
                Describe.Lean(
                    ...
                    DeclarationHandle.Create("D5/S1/Depth/PartialQuotientExtraction.twelve_scale_is_extracted_normalized_sample_minimum"),
                    H("The finite-sample floor uses the extracted maximum partial quotient"),
                    StatementSource.FromAuthor(Disp(Seq(Forall, Sp, F.Id("q"), InMacro, Mathbb, Grp(F.Id("Q")), Setminus, Mathbb, Grp(F.Id("Z")), Comma, Esc, Forall, Sp, F.Id("S"), Subset, Underscore, Grp(Mathrm, Grp(F.Id("fin"))), Mathbb, Grp(F.Id("Z")), Comma, Esc, Open, Forall, Psi, InMacro, Sp, F.Id("S"), Comma, Esc, D(1, 2), Mid, Psi, Land, Psi, Neq, D(0), Close, Land, Open, Exists, Psi, Underscore, D(0), InMacro, Sp, F.Id("S"), Comma, Esc, Bar, Psi, Underscore, D(0), Bar, Eq, D(1, 2), Close, Rightarrow, Min, Left, OpenBrace, Frac, Grp(Bar, Psi, Bar), Grp(F.Id("A"), Open, F.Id("q"), Close), Colon, Psi, InMacro, Sp, F.Id("S"), Right, CloseBrace, Eq, Frac, Grp(D(1, 2)), Grp(F.Id("A"), Open, F.Id("q"), Close), Comma, Qquad, Sp, F.Id("A"), Open, F.Id("q"), Close, Eq, Max, Sp, F.Id("C"), Open, F.Id("q"), Close))),
                    AssessedProvenance.FromRepo(),
                    Blocks(Paragraph(Text(
