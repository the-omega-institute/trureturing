...
Block induction propagates the pair (a(3m+1), a(3m+2)) = (3*8^m, 2*8^m). The reduced-numerator steps use coprimality of 12*8^m with 5 and of 24*8^m with 7. The exponent m-1 uses natural-number subtraction.
