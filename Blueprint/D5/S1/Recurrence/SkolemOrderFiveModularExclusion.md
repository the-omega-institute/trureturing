...
$$\begin{aligned}\forall a: \operatorname{Fin}(5) \to \mathbb{Z}, u: \mathbb{N} \to \mathbb{Z},\\(\operatorname{IsSolution}(\operatorname{intRecurrence}(a) , u)) \Rightarrow\\((\operatorname{cast}(a_{0} , \operatorname{ZMod}(2)) , \operatorname{cast}(a_{1} , \operatorname{ZMod}(2)) , \operatorname{cast}(a_{2} , \operatorname{ZMod}(2)) , \operatorname{cast}(a_{3} , \operatorname{ZMod}(2)) , \operatorname{cast}(a_{4} , \operatorname{ZMod}(2))) = (1 , 0 , 0 , 1 , 0)) \Rightarrow\\\forall n \in \mathbb{N}, \operatorname{red}(u , n + 1) = \operatorname{step}(\operatorname{red}(u , n)).\end{aligned}$$
...
For E_a of order five with coefficients a, red_u(n) is the five-tuple of terms u_n through u_(n+4), each cast to ZMod(2). Under the displayed coefficient congruence, the IsSolution equation reduces its final coordinate to x_0+x_3, uniformly for every integer lift.
