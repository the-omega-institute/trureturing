            ...
            Describe.Lean(
                ...
                Blocks(Paragraph(Text(
                    "For every natural total n, classicalMaximumProduct(n) is attained by "
                        ...
                        + "The theorem is stated publicly for reuse because neither the "
                        + "existing formal results nor the pinned mathematical library "
                        + "contained this unconstrained extremal statement."))),
