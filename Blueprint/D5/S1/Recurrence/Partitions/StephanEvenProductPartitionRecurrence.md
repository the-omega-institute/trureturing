...
For every natural total n, classicalMaximumProduct(n) is attained by a partition of n and bounds the product of every partition of n. The theorem is stated publicly for reuse because neither the existing formal results nor the pinned mathematical library contained this unconstrained extremal statement.
