...
The public statement retains the solution-space dimension, golden scalar identities, shift eigenlaws, nonzero Binet coefficients, least invariant carrier, its dimension, and two independently premised unique component-scalar classifications.
