...
*Formalization.* `D5/S1/Recurrence/Algebraic/KurkovReversedQBellRowPolynomial.kurkovR` (`✓ std3`).
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/Algebraic/KurkovReversedQBellRowPolynomial.result` (`✓ std3`). ∎

*Resolves.* `Problems/oeis-a126347-kurkov-reversed-qbell-row-polynomial` (proved) by `D5/S1/Recurrence/Algebraic/KurkovReversedQBellRowPolynomial.result`.

<!-- scribe-open-problem-resolution-v1 {"problem_slug":"oeis-a126347-kurkov-reversed-qbell-row-polynomial","declaration_gid":"D5/S1/Recurrence/Algebraic/KurkovReversedQBellRowPolynomial.result","resolution_kind":"proved"} -->
...
- Truth anchor: `D5/S1/Recurrence/Algebraic/KurkovReversedQBellRowPolynomial.kurkovR`
- Truth anchor: `D5/S1/Recurrence/Algebraic/KurkovReversedQBellRowPolynomial.qBell`
- Truth anchor: `D5/S1/Recurrence/Algebraic/KurkovReversedQBellRowPolynomial.result`
