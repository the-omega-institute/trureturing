...
internal sealed class PerrierPeriodicGeneratingFunctionsDocument : IScribeDocumentDefinition
{
    ...
    private static readonly LibraryNoteRef Source =
        LibraryNoteRef.Create("D5/L/Recurrence/perrier2026periodicgeneratingfunctions");
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Paragraph(Text(
                "Let K be any field and d any natural number, including zero. Set k=d+1. "
                ...
                + "All series lie in K[[X]], C embeds a field element as a constant series, "
            ...
            Node("result", "The two rational generating functions", ResultFormula(),
                ...
                + "In the notation above these are P(m,a) times the inverse of D(m), "
                + "and Q(a) times the same inverse. Both identities hold for every "
                + "sequence satisfying Recurrence(m,a,r), over every field and every d. "
                ...
                + "R(r,0)D(m)=P(m,a). The constant coefficient one permits division. "
    ...
    private static Formula Context(Formula body) => Seq(
        Bound("K", Seq(Operatorname, Grp(F.Id("Type")))), Call("Field", K), Sp, Implies, Sp,
    ...
    private static Formula ResultFormula() => Disp(Context(Seq(
        ...
        AndF(EqF(Call("R", Rr, D(0)), Mul(Call("P", M, A), Pow(Call("D", M), new Formula.Negate(D(1))))),
            EqF(Call("R", Rr, Call("last", Dim)), Mul(Call("Q", A), Pow(Call("D", M), new Formula.Negate(D(1)))))))));
