...
$$\forall m \in \mathrm{Nat},\; (2 \le m) \Rightarrow (((b\left(m - 1\right)).den^{2} \mid (b\left(m\right)).den^{3}) \land ((b\left(m + 1\right)).den = (b\left(m\right)).den^{2} + (b\left(m\right)).den^{3} / (b\left(m - 1\right)).den^{2} - (b\left(m\right)).den \cdot (b\left(m - 1\right)).den^{2}))$$
