            ...
            Blocks(
                DocumentBlock.Describe.Theorem(
                    ...
                    LatexStatement.Create(
                        @"$$\Sigma=\left\{\theta:\mathbb{N}_{>0}\to\mathbb{R}/\mathbb{Z}\ "
                        + @"\middle|\ \forall m,n\in\mathbb{N}_{>0},\ "
                        + @"n\theta_{mn}=\theta_m\right\},\quad "
                        + @"\pi(\theta)=\theta_1,\quad K_{\infty}=\ker\pi"
                        + @"=\{\theta\in\Sigma\mid\theta_1=0\}:\quad "
                        + @"K_{\infty}\ \text{is closed}\ \land\ "
                        + @"K_{\infty}\ \text{is compact}\ \land\ "
                        + @"\forall (x_j)_{j\in\mathbb{N}}\subseteq K_{\infty},\ "
                        + @"\exists x\in K_{\infty},\ \exists \phi:\mathbb{N}\to\mathbb{N},\ "
                        + @"\phi\ \text{strictly increasing}\ \land\ "
                        + @"\forall m\in\mathbb{N}_{>0},\ "
                        + @"x_{\phi(j),m}\longrightarrow x_m.$$"),
