...
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create("Continuous universal-solenoid characters are exactly rational coordinate characters.",
        H("Characters of the Universal Solenoid"),
        Blocks(
            Describe.Lean(DescribeId.Create("continuous-solenoid-characters-are-rational"),
