...
*Proof.* Machine-checked in Lean as `D5/S1/Phase/Basic.goldenPhase_zero` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Phase/Basic.goldenPhase_add` (`✓ std3`). ∎
...
$\forall n \in \mathbb{Z},\ \operatorname{goldenPhase}(-n)=-\operatorname{goldenPhase}(n)$

*Proof.* Machine-checked in Lean as `D5/S1/Phase/Basic.goldenPhase_neg` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Phase/Basic.goldenPhase_injective` (`✓ std3`). ∎
