...
internal sealed class AlternatingGoldenContractionDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeDocument.Create(
        Header(
            "D5/S1/Phase/AlternatingGoldenContraction",
            "Golden negative-axis steps alternate and contract toward the center minus one."),
        H("Alternating Golden Contraction"),
        Blocks(
            DocumentBlock.Describe.Theorem(
                DescribeId.Create("alternating-golden-contraction-tends-to-minus-one"),
                H("Every alternating golden orbit tends to minus one"),
                LeanTheorem(
                    "D5/S1/Phase/AlternatingGoldenContraction.alternating_golden_contraction_tendsto"),
                Disp(Seq(
