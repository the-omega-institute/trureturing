...
internal sealed class AlternatingFloorSqrtZeroBlocksDocument : IScribeDocumentDefinition
{
        ...
        Blocks(
            Describe.Lean(
                ...
                Blocks(Paragraph(Text(
                    "The function is defined on natural n and l. Here isqrt is Nat.sqrt, "
                    + "the natural square root. Every subtraction in this formula is "
            ...
            Describe.Lean(
                ...
                Blocks(Paragraph(Text(
                    ...
                    + "and the subtraction of isqrt are "
    ...
    private static Formula Root(Formula x) => Call("isqrt", x);
