        ...
        return DocumentDefinition.Create(ScribeNode.Create(
            ...
            Blocks(
                ...
                Node("R_even", "row-even", "Even rows",
                    ...
                    + "as scope-matched context. Conjectures 1 and 9 are stated there as conjectures; "
                    + "the proofs are this repository's.",
                    AssessedProvenance.FromRepo()),
                ...
                Node("e_recurrence", "accumulator-step", "Pascal recurrence on the support",
                    All(Seq(r, Comma, Sp, k, Comma, Sp, q), Naturals(),
                        ImpliesFormula(LessEqual(D(2), r),
                            ImpliesFormula(Supported(r, q),
                ...
                Node("E", "accumulator-polynomial", "Accumulator polynomial",
                    ...
                    AssessedProvenance.FromRepo(),
                    DescribeRole.Definition),
                Node("E_at_degree", "accumulator-at-degree", "Accumulator at the degree bound",
                    All(k, Naturals(),
                        Equal(Call("E", Add(w, D(1)), k), Call("D", Call("R", twoK)))),
                    "Put P=R(2k) and d=wt(k)+1. The identities P.coeff(0)=0 and "
                    + "natDegree(P)<=d recover P at d and give E(d,k)=D(P).",
                    AssessedProvenance.FromRepo()),
