...
internal sealed class GoldenBase4TwentyStatePrefixBarrierDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(DescribeId.Create("phi4-prefix-state-type"),
            ...
            Describe.Lean(DescribeId.Create("phi4-prefix-zero-target"),
            ...
            Describe.Lean(DescribeId.Create("phi4-prefix-one-target"),
