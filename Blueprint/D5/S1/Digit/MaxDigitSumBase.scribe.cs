        ...
        Blocks(
            ...
            Node("the-conjecture-holds", "The conjecture holds", "result", ResultFormula(),
                "The ceiling of the quotient of the number plus one by two is the least base exceeding half of the "
                    ...
                    + "to be at most eight. In either case twice the digit sum is below the number, so "
                    + "the digit sum itself is below the number minus its floor half, which is the "
                    + "value at the first base above half. The only case of "
