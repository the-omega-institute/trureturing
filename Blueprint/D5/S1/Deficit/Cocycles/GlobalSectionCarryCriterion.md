...
$$\forall X, B, q, r, hsection, \operatorname{AddCommGroup}\left(X\right) \land \operatorname{AddCommGroup}\left(B\right) \land q: \operatorname{AddMonoidHom}\left(X, B\right) \land r: B \to X \land hsection: \operatorname{RightInverse}\left(r, q\right) \land \operatorname{r}(0) = 0 \Rightarrow \left(\exists s': \operatorname{AddMonoidHom}\left(B, X\right), \operatorname{RightInverse}\left(s', q\right) \Leftrightarrow \exists beta: B \to \operatorname{ker}(q), \forall a, b\in B, \operatorname{kernelCarry}(q, r, hsection, a, b) + \operatorname{sectionCarry}(beta, a, b) = 0\right) \land \left(\left(\neg \exists beta: B \to \operatorname{ker}(q), \forall a, b\in B, \operatorname{kernelCarry}(q, r, hsection, a, b) + \operatorname{sectionCarry}(beta, a, b) = 0\right) \Rightarrow \left(\neg \exists s': \operatorname{AddMonoidHom}\left(B, X\right), \operatorname{RightInverse}\left(s', q\right)\right)\right).$$
