...
internal sealed class GoldenBandOrderDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(Describe.Lean(
            ...
            Blocks(
                Paragraph(Text(
                    "The module binds structuralZero from the frozen S1 "
                        + "GoldenSpectralCoordinate and phi from the frozen S1 "
                        + "GoldenObserverRoute through that module's import. It transcribes "
                        + "only structuralPole=1/phi^3 from Hearts. Hearts is an OPEN "
                        + "X_Frontier source and is not imported.")),
                Paragraph(Text(
