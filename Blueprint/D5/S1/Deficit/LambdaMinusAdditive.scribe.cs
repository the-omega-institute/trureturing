...
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create("The contraction reading is additive over coprime factors.",
        H("Additivity of the Contraction Reading over Coprimes"),
        Blocks(
            Describe.Lean(DescribeId.Create("the-contraction-reading-is-additive-over-coprimes"),
                DeclarationHandle.Create("D5/S1/Deficit/LambdaMinusAdditive.lambdaMinus_coprime_add"),
