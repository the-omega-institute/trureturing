...
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create("The normalized beta deficit of golden addition is an integer counting bottom carries.",
        H("The Normalized Beta Deficit Is an Integer Counting Bottom Carries"),
        Blocks(
            Describe.Lean(DescribeId.Create("the-normalized-beta-deficit-is-an-integer-counting-bottom-carries"),
                DeclarationHandle.Create("D5/S1/Deficit/DeficitInteger.deficit_integer"),
                H("The normalized beta deficit is an integer counting bottom carries"),
