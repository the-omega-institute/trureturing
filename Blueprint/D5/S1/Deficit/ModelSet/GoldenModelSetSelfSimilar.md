...
*Proof.* Machine-checked in Lean as `D5/S1/Deficit/ModelSet/GoldenModelSetSelfSimilar.golden_window_volume` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Deficit/ModelSet/GoldenModelSetSelfSimilar.golden_model_set_self_similar` (`✓ std3`). ∎
...
- Truth anchor: `D5/S1/Deficit/ModelSet/GoldenModelSetSelfSimilar.golden_model_set_self_similar`
- Truth anchor: `D5/S1/Deficit/ModelSet/GoldenModelSetSelfSimilar.golden_window_volume`
