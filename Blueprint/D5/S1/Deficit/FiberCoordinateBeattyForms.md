...
*Proof.* Machine-checked in Lean as `D5/S1/Deficit/FiberCoordinateBeattyForms.fiber_coordinates_eq_displacement_forms` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Deficit/FiberCoordinateBeattyForms.mem_goldenFiber_iff` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Deficit/FiberCoordinateBeattyForms.ceiling_start_formula_fails_at_one` (`✓ std3`). ∎
...
- Truth anchor: `D5/S1/Deficit/FiberCoordinateBeattyForms.ceiling_start_formula_fails_at_one`
- Truth anchor: `D5/S1/Deficit/FiberCoordinateBeattyForms.fiber_coordinates_eq_displacement_forms`
- Truth anchor: `D5/S1/Deficit/FiberCoordinateBeattyForms.mem_goldenFiber_iff`
