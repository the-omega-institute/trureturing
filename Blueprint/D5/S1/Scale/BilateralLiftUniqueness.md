...
*Proof.* Machine-checked in Lean as `D5/S1/Scale/BilateralLiftUniqueness.bilateral_lift_uniqueness` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Scale/BilateralLiftUniqueness.fibonacci_solution_space_eq_span` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Scale/BilateralLiftUniqueness.shift_golden_eigenvectors` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Scale/BilateralLiftUniqueness.fibonacci_weight_binet` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Scale/BilateralLiftUniqueness.fibonacci_cyclic_span_minimal` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Scale/BilateralLiftUniqueness.fibonacci_weight_residual` (`✓ std3`). ∎
