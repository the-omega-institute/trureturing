...
internal sealed class BarkerEvenLengthModFourObstructionDocument : IScribeDocumentDefinition
{
    ...
    private static Formula CorrelationCongruencesFormula()
    {
        ...
        return Disp(Seq(
            ...
            Parenthesized(binary), Sp, Implies, Sp,
            Parenthesized(Seq(
                Parenthesized(parity), Sp, Land, Sp,
                Parenthesized(boundary))), Dot));
    }
    ...
    private static Formula ModFourObstructionFormula()
    {
        ...
        return Disp(Seq(
            Forall, Sp, a, Colon, Sp, SequenceType(), Comma, Sp,
            Forall, Sp, n, Colon, Sp, Naturals(), Comma, Sp,
            Parenthesized(hypotheses), Sp, Implies, Sp,
            Parenthesized(Seq(
                Parenthesized(divisibility), Sp, Land, Sp,
                Parenthesized(exclusion))), Dot));
    }
    ...
    private static Formula WitnessesFormula()
    {
        ...
        return Disp(Seq(
            thirteen, Sp, Land, Sp,
            four, Sp, Land, Sp,
            Parenthesized(nonBarkerWitness), Dot));
    }
    ...
    private static Formula Call(string name, params Formula[] arguments)
    {
        ...
        return Seq(
            Operatorname, Grp(F.Id(name)), Parenthesized(Seq([.. items])));
    }
