    ...
    : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Node("Nesting", "Nesting edges", NestingFormula(),
                "Two ordered pairs nest exactly when the endpoints of one lie strictly between "
    ...
    private static Formula PatternFormula(string name, bool crossing)
    {
        ...
        var first = crossing
            ...
            : And(LtOf(Fst(e), Fst(f)), LtOf(Snd(f), Snd(e)));
        var second = crossing
            ? And(LtOf(Fst(f), Fst(e)), And(LtOf(Fst(e), Snd(f)), LtOf(Snd(f), Snd(e))))
            : And(LtOf(Fst(f), Fst(e)), LtOf(Snd(e), Snd(f)));
