...
**Definition 1.5 (The length-thirteen Barker word).**
...
**Definition 1.6 (The length-four Barker word).**
...
**Definition 1.7 (A length-eight equal-correlation non-Barker word).**
...
**Theorem 1.8 (Finite witnesses for Barker and equal-correlation behavior).**
