...
**Theorem 1.3 (Actual coefficient checkpoint).**

$$fullpositivePaircoefficientcheckpoint$$

*Proof.* Machine-checked in Lean as `D5/S1/Words/Complexity/PositivePairs/Coefficients/PositivePairLeadingCoefficients.full_positivePair_coefficient_checkpoint` (`✓ std3`). ∎
...
- Truth anchor: `D5/S1/Words/Complexity/PositivePairs/Coefficients/PositivePairLeadingCoefficients.full_positivePair_coefficient_checkpoint`
