# Lower Growth of Actual Exact k-Decks
...
*Formalization.* `D5/S1/Words/Complexity/PositivePairExactDeckGrowth.exactKDeck` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/Complexity/PositivePairExactDeckGrowth.exactKDeckImage` (`✓ std3`).
...
*Proof.* Machine-checked in Lean as `D5/S1/Words/Complexity/PositivePairExactDeckGrowth.scatteredCount_eq_of_exactKDeck_eq` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Words/Complexity/PositivePairExactDeckGrowth.exactKDeck_eq_iff_cutoffMagnus_eq_of_common_length` (`✓ std3`). ∎
...
**Theorem 1.5 (Weighted-Lyndon lower growth for exact decks).**

$$actualexactKDeckImageweightedLyndonlowerbound$$

*Proof.* Machine-checked in Lean as `D5/S1/Words/Complexity/PositivePairExactDeckGrowth.actual_exactKDeckImage_weightedLyndon_lower_bound` (`✓ std3`). ∎
...
- Truth anchor: `D5/S1/Words/Complexity/PositivePairExactDeckGrowth.actual_exactKDeckImage_weightedLyndon_lower_bound`
- Truth anchor: `D5/S1/Words/Complexity/PositivePairExactDeckGrowth.exactKDeck`
- Truth anchor: `D5/S1/Words/Complexity/PositivePairExactDeckGrowth.exactKDeckImage`
- Truth anchor: `D5/S1/Words/Complexity/PositivePairExactDeckGrowth.exactKDeck_eq_iff_cutoffMagnus_eq_of_common_length`
- Truth anchor: `D5/S1/Words/Complexity/PositivePairExactDeckGrowth.scatteredCount_eq_of_exactKDeck_eq`
- Dependency: [D5/S1/Words/Complexity/PositivePairBallGrowth](PositivePairBallGrowth.md)
