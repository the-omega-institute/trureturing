...
internal sealed class ThueMorseReducedAbelianOddDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "This is Mathlib's List.destutter applied with the inequality relation "
                        + "on Boolean letters. It retains one letter from each maximal constant "
                        + "run and sends the empty list to the empty list."))),
                DescribeRole.Definition),
            Describe.Lean(
            ...
            Describe.Lean(
                ...
                DeclarationHandle.Create(
                    "D5/S1/Words/Complexity/ThueMorseReducedAbelianOdd.reducedAbelianComplexity_two"),
                H("Length two has three reduced abelian classes"),
                StatementSource.FromAuthor(Disp(Seq(Call("R", D(2)), Sp, Eq, Sp, D(3), Dot))),
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
    ...
    private static Formula RunCompressFormula()
    {
        ...
        Formula relation = Seq(
            Parenthesized(Seq(a, Comma, Sp, b, Colon, Sp, BoolType())),
            Sp, Mapsto, Sp, a, Sp, Neq, Sp, b);
        return Disp(Seq(
            Forall, Sp, word, InMacro, Sp, ListBoolType(), Comma, Sp,
            Call("runCompress", word), Sp, Eq, Sp,
            Apply(Seq(F.Id("List"), Dot, F.Id("destutter")), relation, word), Dot));
    }
