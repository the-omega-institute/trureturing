...
**Definition 1.2 (The Parikh vector after run reduction).**
...
**Definition 1.3 (Reduced abelian equivalence at a common length).**
...
**Definition 1.4 (The canonical code for a reduced abelian class).**
...
**Theorem 1.5 (Reduced Parikh equality is exactly code equality).**
...
**Definition 1.6 (Reduced abelian classes over all natural starts).**
...
**Definition 1.7 (Reduced abelian complexity).**
...
**Theorem 1.8 (Odd indices reflect to half length).**
...
**Theorem 1.9 (Power of two plus one has complexity three).**
