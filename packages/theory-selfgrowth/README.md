...
The current `departments/propose/main.lua` still uses the archaudit (forge/saga) pattern and is therefore **known-not-conformant** — kept as the design reference; rewrite to the minimal publishable-only form above.
