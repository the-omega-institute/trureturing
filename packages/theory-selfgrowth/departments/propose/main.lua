...
-- request; the #296 generation-scoped dedup + open-request exclusion bound output to one open
-- request at a time. github-proxy performs the actual `gh issue create`.
--
