...
- After any Lean, Scribe, theory-source, or `Meta/BACKFILL.yaml` change, discard the earlier projection and rerun the target. A stale or manually reconciled block is not publication evidence.
