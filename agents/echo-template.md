...
- Run `make echo-verify FILE=.echo-review.md BASE=origin/dev`; the base-owned required admission check verifies the PR-body copy and fails closed on a missing, stale, or byte-modified block.
