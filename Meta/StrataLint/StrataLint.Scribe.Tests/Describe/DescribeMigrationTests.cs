...
public sealed class DescribeMigrationTests
{
    ...
    [Fact]
    public void RepositoryMigrationHasOneHundredAndThirtyFourTypedNodesAndPreservesTwentyFourFormulaSlots()
    {
        ...
        Assert.Equal(98, report.NodeStats.ByProvenance["repo-derived"]);
