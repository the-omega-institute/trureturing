...
{
    [Fact]
    public void RepositoryMigrationHasThirtyTwoTypedNodesAndPreservesTwentyFourFormulaSlots()
    {
    ...
    public void DescribeReportVerbReturnsTheMachineQueryableLedger()
    {
        ...
        Assert.Equal(32, document.RootElement.GetProperty("node_stats").GetProperty("total").GetInt32());
