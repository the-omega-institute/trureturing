...
{
    [Fact]
    public void RepositoryMigrationHasOneHundredAndSevenTypedNodesAndPreservesTwentyFourFormulaSlots()
    {
    ...
    public void DescribeReportVerbReturnsTheMachineQueryableLedger()
    {
        ...
        Assert.Equal(107, document.RootElement.GetProperty("node_stats").GetProperty("total").GetInt32());
