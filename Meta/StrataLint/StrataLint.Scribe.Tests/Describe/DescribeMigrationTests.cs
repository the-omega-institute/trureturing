...
public sealed class DescribeMigrationTests
{
    ...
    [Fact]
    public void RepositoryMigrationHasOneHundredAndThirtySixTypedNodesAndPreservesTwentyFourFormulaSlots()
    {
        ...
        Assert.Equal(100, report.NodeStats.ByProvenance["repo-derived"]);
    ...
    public void DescribeReportVerbReturnsTheMachineQueryableLedger()
    {
        ...
        Assert.Equal(136, document.RootElement.GetProperty("node_stats").GetProperty("total").GetInt32());
