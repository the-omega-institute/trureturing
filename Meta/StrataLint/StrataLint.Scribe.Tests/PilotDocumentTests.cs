...
<<<<<<< HEAD
        Assert.Equal(55, census.ReceiptFreeDocumentGids.Count);
        Assert.Equal(41, census.ReceiptBoundDocumentGids.Count);
=======
        Assert.Equal(62, census.ReceiptFreeDocumentGids.Count);
