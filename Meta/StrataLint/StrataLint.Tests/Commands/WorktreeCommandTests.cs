...
public sealed class WorktreeCommandTests
{
    ...
    public void RootUsageListsWorktreeCommand()
    {
        ...
        Assert.Contains(
            "check|clean-lanes|coverage|cover-atom|digest-status|echo-verify|emit-formalization-receipt|ingest|golden-record|ledger-genesis|papergen|route|selftest|show-atom|topology|validate-blueprint-pins|worktree",
            console.Error);
