...
public sealed class WorktreeCommandTests
{
    ...
    public void RootUsageListsWorktreeCommand()
    {
        ...
        Assert.Contains(
            "check|clean-lanes|coverage|cover-atom|digest-status|echo-verify|emit-formalization-receipt|ingest|golden-record|lean-report-merge|ledger-genesis|papergen|route|select-tests|selftest|show-atom|topology|validate-blueprint-pins|worktree",
            console.Error);
