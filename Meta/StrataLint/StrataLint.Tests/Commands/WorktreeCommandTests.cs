...
public sealed class WorktreeCommandTests
{
    ...
    public void RootUsageListsWorktreeCommand()
    {
        ...
        Assert.Contains(
            "check|clean-lanes|coverage|cover-atom|digest-status|echo-verify|emit-formalization-receipt|ingest|golden-record|ledger-genesis|papergen|projection-closure|route|selftest|topology|validate-blueprint-pins|worktree",
            console.Error);
