...
def calculate(base, bank):
    ...
    core = module('j_depth_survival_core', base/'frontier/j_face_joint_selected_heads.py')
    ...
    j = module('j_depth_survival_j', base/'frontier/j_face_coupled_seven_heads.py')
    pair = module('j_depth_survival_pair', base/'frontier/j_face_retained135125_heads.py')
    depth = module('j_depth_survival_formula', base/'frontier/second_depth_seven_comparison.py')
    second = module('j_depth_survival_scanner', base/'frontier/j_face_second_depth_retained_heads.py')
    ...
    original = module('j_depth_survival_functions', base/'frontier/j_face_complete_survival_linear_heads.py')
...
def main():
    ...
    core = module('j_depth_survival_json', args.base/'frontier/j_face_joint_selected_heads.py')
    stored = json.loads(io.read_artifact_bytes(args.base/CERTIFICATE), object_pairs_hook=core.unique)
    codec = module('j_depth_survival_codec', args.base/'frontier/retained135_heavy_comparison.py')
