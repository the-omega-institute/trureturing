...
CERTIFICATE = 'certificates/source_norms/product_coupled_carrier_mass.json'
EARLY_LIMIT, SLOPE, FACE_MASS = F(3, 61), F(61, 360), F(53, 360)
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/carrier_mass_residual_bound.py': '751484c1029980b93a5fc4bb7f6990108d40789f06b3b88723311f901cc48b7a', 'certificates/source_norms/carrier_mass_residual_bound.json': '1ce320c2283c37f17c7c5fa09bcbc0692b67067f3296038c2034ded4eda3ac4b'}
...
def calculate(base):
    ...
    previous = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/carrier_mass_residual_bound.json'))
