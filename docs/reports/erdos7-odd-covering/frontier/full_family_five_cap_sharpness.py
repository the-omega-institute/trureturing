...
PINS = {
    ...
    'profile-notes/48-actual-source-compatibility-excludes-a-relaxed-mass-endpoint.md': 'f1919e46166ff701af789dafe498e7fe39bc620939937d0494ccf111f75076b4',
...
def calculate(base):
    ...
    source = module('full_family_cap_source', base/'frontier/source_mass_compatibility.py')
