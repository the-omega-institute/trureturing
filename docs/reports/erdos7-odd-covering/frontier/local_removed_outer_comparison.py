...
PINS = {
    ...
    'frontier/joint_mass_outer_comparison.py': '718b998ddd058c73e402354269d52d4172e5cac0532cc52270ba1571bb71affe',
    'certificates/source_norms/joint_mass_outer_comparison.json': '717ed440b7725caeb49ab673987a404697e378a60d084e9ee8fedf7756c51c90',
...
def calculate(base):
    ...
    prior_module = module('local_removed_prior', base/'frontier/joint_mass_outer_comparison.py')
