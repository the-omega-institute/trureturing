...
CERTIFICATE = 'certificates/source_norms/exact_tensor_numerator_reference.json'
PINS = {
    'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232',
    'frontier/exact_survival_comparison_boundary.py': 'e745dd3daea609c88ba99d36a78299991db390da7fed194061eec3b7d864fcbe',
    'certificates/source_norms/exact_survival_comparison_boundary.json': '5b291e7d481fed651bc3d20e2666a8a2ae25dda8a174625a888627b767cf6bb1',
...
def calculate(base):
    ...
    survival = read('certificates/source_norms/exact_survival_comparison_boundary.json')
    ...
    for name, pin in survival['source_sha256'].items():
        ...
        used[name] = pin
    require(used['certificates/source_norms/full_linear_carrier_frontier.json'] ==
            PINS['certificates/source_norms/full_linear_carrier_frontier.json'], 'Same49 comparison')
    source = module('tensor_numerator_source', base/'verify_joint_frontier.py')
    witness = module('tensor_numerator_witness', base/'frontier/exact_survival_comparison_boundary.py')
    schedule = module('tensor_numerator_schedule', base/'frontier/ap_schedule.py')
    fixed = module('tensor_numerator_fixed', base/'frontier/fixed_cost.py')
    ...
    old39 = read('certificates/source_norms/shared_source_deficits.json')
