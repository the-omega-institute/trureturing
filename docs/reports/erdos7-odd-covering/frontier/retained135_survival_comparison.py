...
CERTIFICATE = 'certificates/source_norms/retained135_survival_comparison.json'
PINS = {
    ...
    'certificates/source_norms/retained135_heavy_comparison.json': '38a2183142afe745de6f5a1b92b20f4f6c9a5084a959bf09d5b8ae6a1b579831',
...
def main():
    ...
    retained = module('retained135_survival_codec', args.base/'frontier/retained135_heavy_comparison.py')
