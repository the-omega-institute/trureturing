...
PINS = {
    ...
    'frontier/endpoint_square_numerator.py': 'cc1fb15acadf6eb0240ae76706d820d5a33008d6d16cf310bde74880cb889441',
    'certificates/source_norms/endpoint_square_numerator.json': '694608bda8790b5f8016195457e305b19f4a5036d2222bec66c9819d0c98cb66',
    'frontier/endpoint_square_coherent_head.py': '48e0fc190e049b9509bfcda7710726b99ae71eb9332c877bbab6941696a3e46e',
...
def calculate(base):
    ...
    linear = load(base, 'frontier/endpoint_linear_numerator.py', 'common_pure3_linear')
    square = load(base, 'frontier/endpoint_square_numerator.py', 'common_pure3_square')
    head = load(base, 'frontier/endpoint_square_coherent_head.py', 'common_pure3_head')
    old63 = json.loads((base/'certificates/source_norms/endpoint_square_coherent_head.json').read_text())
    old62 = json.loads((base/'certificates/source_norms/endpoint_square_numerator.json').read_text())
...
def main():
    ...
    if args.check:
        certificate = args.base/'certificates/source_norms/endpoint_square_common_pure3.json'
