...
CERTIFICATE = 'certificates/source_norms/endpoint_uniform_ratio.json'
PINS = {
    ...
    'frontier/endpoint_square_positive5.py': '9b705a68f4c5cbee813521e0b073e503f962ae84356dbea7b9e3e527345c672b',
    'certificates/source_norms/endpoint_square_positive5.json': '7264955e3004fc0e217e8608b1cd0681df73a8886585581bde65666150119600',
...
def calculate(base):
    ...
    square = read('certificates/source_norms/endpoint_square_positive5.json')
    ...
    schedule = module('uniform_ratio_schedule', base/'frontier/ap_schedule.py')
    fixed = module('uniform_ratio_fixed', base/'frontier/fixed_cost.py')
    majorant = module('uniform_ratio_majorant', base/'frontier/endpoint_numerator_common_costs.py')
    ...
    old49 = read('certificates/source_norms/full_linear_carrier_frontier.json')
    ...
    oQ = F(read('certificates/source_norms/shared_source_deficits.json')['source_profiles']['quadratic_tail_weight'])
