...
def calculate(base):
    ...
    numerator = read('certificates/source_norms/endpoint_numerator_common_costs.json')
    survival = read('certificates/source_norms/allocated_seven_thresholds.json')
    ...
    schedule = module('survival_scalar_schedule', base/'frontier/ap_schedule.py')
    fixed = module('survival_scalar_fixed', base/'frontier/fixed_cost.py')
    majorant = module('survival_scalar_majorant', base/'frontier/endpoint_numerator_common_costs.py')
    ...
    original46 = read('certificates/source_norms/joint_survival_carriers.json')
