...
CERTIFICATE='certificates/source_norms/j_face_exact_retained_factorial_head.json'
PINS={
 'frontier/j_face_joint_pair_factorial_heads.py':'0ec9429da53290028977f7c985df3938e3798a76accd348ce2aec362cb7b30d0',
 'certificates/source_norms/j_face_joint_pair_factorial_heads.json':'debba12ad306a8623c2420ead390af4714ae149738b16aa33adca875606893c9',
 'profile-notes/276-actual-retained-tail-pairs-strengthen-original-j-costs-and-square.md':'b447c335f033501aa00b198d22cf2c5573c7d88843df1e4028ac475f014d21b8'}
...
def inputs(base):
 source=module('exact_retained_source276',base/'frontier/j_face_joint_pair_factorial_heads.py')
...
def main():
 ...
 io=module('exact_retained_io',args.base/'certificate_io.py');core=module('exact_retained_json',args.base/'frontier/j_face_joint_selected_heads.py')
 ...
 codec=module('exact_retained_codec',args.base/'frontier/retained135_heavy_comparison.py')
