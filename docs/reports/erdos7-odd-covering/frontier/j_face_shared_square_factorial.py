...
def calculate(base):
    ...
    prior = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/j_face_coupled_seven_heads.json'))
    pins = dict(PINS)
    ...
    j = module('j_moment_source', base/'frontier/j_face_coupled_seven_heads.py')
