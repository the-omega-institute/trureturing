...
CERTIFICATE='certificates/source_norms/j_face_triple_pair_factorial_heads.json'
PINS={'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j_face_joint_pair_factorial_heads.py': '0ec9429da53290028977f7c985df3938e3798a76accd348ce2aec362cb7b30d0', 'certificates/source_norms/j_face_joint_pair_factorial_heads.json': 'debba12ad306a8623c2420ead390af4714ae149738b16aa33adca875606893c9', 'profile-notes/276-actual-retained-tail-pairs-strengthen-original-j-costs-and-square.md': 'b447c335f033501aa00b198d22cf2c5573c7d88843df1e4028ac475f014d21b8', 'frontier/j_face_triple_second_depth_heads.py': '4a9438236fc824cd1eb7142aa4714f8185cc139256254595e3243b8d9dc812db', 'certificates/source_norms/j_face_triple_second_depth_heads.json': '93294c91f6824368f91383f63917228a3a3b1a486a710c042655588a80531889', 'profile-notes/264-seven-retained-states-and-two-seven-depths-control-complete-j-heads.md': 'f2ace79a9ad70bb57b36f3fdd66e72552bff4787811f5d721fc1f79585b20c7f', 'frontier/j_face_pure_low_factorial_heads.py': '5750e2a0a8db8c480b25c561e98918734975bba8a5971ef8e2c996d32a6c3350', 'certificates/source_norms/j_face_pure_low_factorial_heads.json': 'e99836b81ca44bd2cb47947b51dc06b91da4438a163ffeb2e1d391bf1fc0375e', 'profile-notes/278-two-pure-factorial-observations-strengthen-the-j-source.md': '417cde04556d76096c26f02f7d9aff953809a2c283d344ba2cca63a4636ddcee'}
...
def inputs(base):
    source=module('triple_pair_source276',base/'frontier/j_face_joint_pair_factorial_heads.py')
    ...
    triple=module('triple_pair_model264',base/'frontier/j_face_triple_second_depth_heads.py')
    low=module('triple_pair_scanner278',base/'frontier/j_face_pure_low_factorial_heads.py')
    coherent=module('triple_pair_coherent258',base/'frontier/j_face_coherent_positive7_pairs.py')
...
def main():
    ...
    io=module('triple_pair_reader',args.base/'certificate_io.py');core=module('triple_pair_json',args.base/'frontier/j_face_joint_selected_heads.py')
    ...
    codec=module('triple_pair_codec',args.base/'frontier/retained135_heavy_comparison.py')
