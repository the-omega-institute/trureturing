...
CERTIFICATE = 'certificates/source_norms/whole_quadratic_same_source.json'
PINS = {
...
def calculate(base):
    ...
    for path, pin in previous['source_sha256'].items():
        ...
        used[path] = pin
    bridge = module('joint_source_bridge', base/'frontier/k_face_common_seven_hinges.py')
    cm = module('joint_source_common', base/'frontier/whole_cost_common_stop_loss.py')
    mm = module('joint_source_mean', base/'frontier/whole_cost_mean_stop_loss.py')
    fm = module('joint_source_factorial', base/'frontier/whole_factorial_same_head.py')
    qm = module('joint_source_quadratic', base/'frontier/whole_quadratic_same_head.py')
    mean = mm.MeanHead(bridge, read('certificates/source_norms/whole_face_stop_loss_generator.json'), cm)
    ...
    engine = module('joint_source_inventory', base/'frontier/source_barrier_saturation.py').Experiment(base)
