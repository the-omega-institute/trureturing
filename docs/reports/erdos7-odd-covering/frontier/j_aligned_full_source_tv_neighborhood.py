...
CERTIFICATE = Path('certificates/source_norms/j_aligned_full_source_tv_neighborhood.json')
INPUTS = (
    'certificates/source_norms/j_aligned_complete_moment_comparison.json',
    'certificates/source_norms/j_compact_source_neighborhood.json',
)
ANCHORS = (
    'profile-notes/18-actual-bb-kernels-with-fixed-old-second-moment-need-not-be-uniformly-continuous.md',
    ...
    'profile-notes/318-a-finite-aligned-source-neighborhood-keeps-j-below403.md',
)
