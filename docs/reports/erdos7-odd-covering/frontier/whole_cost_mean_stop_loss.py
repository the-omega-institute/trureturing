...
CERTIFICATE = 'certificates/source_norms/whole_cost_mean_stop_loss.json'
PINS = {
    'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232',
    'frontier/whole_cost_common_stop_loss.py': 'c202b24c6fcfc3f473f43550f7f5530783b0f4f27d47915e73f0b295c11c1900',
    'certificates/source_norms/whole_cost_common_stop_loss.json': 'e362df450b9e8f5ad6b8a478811498b4e4a3ec33bbb4b081fa5c3840db9af854',
...
def calculate(base):
    ...
    previous = read('certificates/source_norms/whole_face_second_factorial_tail.json')
    common = read('certificates/source_norms/whole_cost_common_stop_loss.json')
    forced = read('certificates/source_norms/endpoint_k_face_forced27.json')
    ...
    old_module = module('mean_stop_old', base/'frontier/whole_cost_common_stop_loss.py')
    bridge = module('mean_stop_bridge', base/'frontier/k_face_common_seven_hinges.py')
    parent = module('mean_stop_profile', base/'frontier/whole_face_stop_loss_generator.py')
    ...
    engine = module('mean_stop_engine', base/'frontier/source_barrier_saturation.py').Experiment(base)
    ...
    consumer = module('mean_stop_consumer', base/'frontier/vector_face_complete_ratio.py')
    majorant = module('mean_stop_majorant', base/'frontier/endpoint_numerator_common_costs.py')
