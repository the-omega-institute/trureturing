...
def calculate(base):
    ...
    full = load(base, 'frontier/full_absorbed_survival_hinges.py', 'attainment_full')
    actual = load(base, 'frontier/sharp_source_mass_endpoints.py', 'attainment_constructor')
