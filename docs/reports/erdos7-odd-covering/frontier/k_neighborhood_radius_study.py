...
CERTIFICATE = 'certificates/source_norms/k_neighborhood_radius_study.json'
PINS = {
    'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232',
    'frontier/uniform_complete_k_comparison.py': '916863ad05614bf6e81f110efec28b4bbaf562c9965267dce747b6b0f6342f2b',
...
class Study:
    ...
    def read(self, name):
        return json.loads(self.io.read_artifact_bytes(self.base/'certificates/source_norms'/(name+'.json')))

    def get(self, name):
        if name not in self.modules:
            self.modules[name] = module('radius_'+name, self.base/'frontier'/(name+'.py'))
