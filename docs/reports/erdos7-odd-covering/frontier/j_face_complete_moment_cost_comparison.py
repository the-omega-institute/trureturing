...
CERTIFICATE = 'certificates/source_norms/j_face_complete_moment_cost_comparison.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'verify_joint_frontier.py': 'a40fce0a5cb6a713dc8cb569b874d284b8dd66fb3f0a5e48fc2c69cb8fe286fe', 'frontier/source_barrier_saturation.py': '92076ee71a6be16655bbe5c2ac223db6502da1ab5c3553a7f83bb555dbbb8363', 'certificates/source_norms/retained135125_survival_comparison.json': 'b195a103f9a876209edf9a220d29327d212daafcf670128586c1b7d48ca1846d', 'frontier/j_face_coupled_seven_heads.py': 'd2794b380770dcd5529bacc0fb134d0e7ea82c26c572339b65e30c8222e24946', 'certificates/source_norms/j_face_coupled_seven_heads.json': '17fcfbc35fcb05f760973dc433a28862cb30dda0ab7d84f7ea9f6db90c2c8775', 'frontier/j_face_shared_square_factorial.py': 'ff44159c9765bcdc54139f0840ee984bd4d223647b6434b805e852519df570f6', 'certificates/source_norms/j_face_shared_square_factorial.json': '3624e60d5a7f5851450feac9005e228354ea157c7b08de24ab3c6fc042609d44', 'frontier/j_face_complete_survival_linear_heads.py': '5e33b604d7d093fc7c9ac5058aa89e7b8e4c892f1338f2273bd2af9fd5fb635c', 'certificates/source_norms/j_face_complete_survival_linear_heads.json': '28c3a2239df85056e7134f43793c24b054bea3390a0c72ce5c5d5c1202c60a9a', 'profile-notes/219-one-late-source-split-controls-complete-saturated-j-heads.md': '1ab67a37ff16722068d71e186f79619175dea1ba049d65deae7269ba1306c204', 'profile-notes/241-one-original-j-head-controls-complete-square-and-factorial-moments.md': '92bfc46b467c91fe6c332df159700ecc21eac264c4ec60edbcd290c3bdd7f8f1', 'profile-notes/242-the-complete-j-survival-and-linear-heads-retain-one-late-split.md': '98c9c4cccd69c8e8aca9f73bd937a92fefd14e323f7d7159d26121fc01d6f1c1'}
...
def inputs(base):
    ...
    docs = {name: read('certificates/source_norms/'+name+'.json') for name in SOURCES}
    pins = dict(PINS)
    for name, doc in docs.items():
        for path, pin in doc['source_sha256'].items():
            ...
            pins[path] = pin
    engine = module('j_moment_cost_inventory', base/'frontier/source_barrier_saturation.py').Experiment(base)
    ...
    original = read('certificates/source_norms/retained135125_survival_comparison.json')
    ...
    provider = module('j_moment_cost_heads', base/'frontier/j_face_complete_survival_linear_heads.py')
