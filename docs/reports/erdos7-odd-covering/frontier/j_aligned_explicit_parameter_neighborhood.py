...
CERTIFICATE = Path('certificates/source_norms/j_aligned_explicit_parameter_neighborhood.json')
SOURCE = 'certificates/source_norms/j_aligned_complete_moment_comparison.json'
ROWS = 'certificates/source_norms/j_aligned_source_row_transport.json'
RESTORED = 'certificates/source_norms/j_actual_rows_zero_restoration.json'
DEFINITIONS = 'certificates/source_norms/j_face_heavy_positive175189_complete_moment_cost_comparison.json'
ANCHORS = (
    'profile-notes/323-actual-aligned-source-and-row-transport.md',
    'profile-notes/324-complete-aligned-source-prefixes-and-tails-have-an-explicit-modulus.md',
    'profile-notes/311-imperfect-j-source-alignment-forces-a-sharp-sector-surplus.md',
    'profile-notes/312-an-aligned-j-source-has-a-complete-own-test-and-residual-deletion-interface.md',
    'profile-notes/317-the-complete-actual-aligned-j-comparison-crosses403.md',
    'frontier/j_aligned_source_row_transport.py',
    'frontier/j_aligned_retained375_heads.py',
    'frontier/j_aligned_quadratic_complete_heads.py',
    'frontier/j_explicit_actual_neighborhood.py',
    'frontier/retained135_heavy_comparison.py',
)
...
def inventory(base, source, rows, read, pins):
    prior = module('aligned_parameter_price_api', base/'frontier/j_explicit_actual_neighborhood.py')
    codec = module('aligned_parameter_dual_codec', base/'frontier/retained135_heavy_comparison.py')
    paths = sorted(p for p in source['source_sha256']
                   if p.startswith('certificates/source_norms/j_aligned_'))
    records, classified = [], []
    small = read('certificates/source_norms/j_aligned_joint_selected_heads.json')['model']
    supported = {
