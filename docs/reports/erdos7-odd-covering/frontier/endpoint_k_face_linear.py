...
PIN = 'e9d1eb6487f95874b2c577496b41083ff140138ef5a59d630144d1c72aae279a'
...
def calculate(base):
    name = 'frontier/endpoint_linear_neighborhood.py'
    ...
    saturation = prior.load(base, 'frontier/source_barrier_saturation.py', 'k_face_saturation')
...
def main():
    ...
    if args.check:
        require(json.loads((args.base/'certificates/source_norms/endpoint_k_face_linear.json').read_text()) == result, 'Canonical exact face certificate')
