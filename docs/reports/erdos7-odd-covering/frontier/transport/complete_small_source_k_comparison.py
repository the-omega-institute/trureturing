...
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'verify_joint_frontier.py': 'a40fce0a5cb6a713dc8cb569b874d284b8dd66fb3f0a5e48fc2c69cb8fe286fe', 'certificates/source_norms/complete_small_retained_heads.json': '00cfe371837071e330023af3158a02bcd810bef1af8c66be7b636b1d924c23b4', 'certificates/source_norms/retained-transport/legacy_retained_complete_head_transport.json': '61dc76b67cf59fab2b95615129f23a9d949d296d20375de6cf1952dca8e7c055', 'certificates/source_norms/retained-transport/small_source_square_factorial_transport.json': '39cf244e6c87850c472f6b4300f5fd59ebcd4a5c4252eab2dd213bfef33c5d8b', 'certificates/source_norms/uniform_complete_k_comparison.json': 'af2f8c326bcc9a99af6920ebc8152d68416bdc13fc7030ed1f2921f641d169dd', 'certificates/source_norms/uniform_ap_survival_denominator.json': 'd3beb15523a41e2437e995d5747bed3b9d39dcb113024cf4eb3b966fc0e571f9', 'certificates/source_norms/load_two_cost_remainders.json': '6163e7d984655c397c3b0eb3b30cffff65c875f90fe7849cdc2d5ec899d5db6b', 'certificates/source_norms/k_neighborhood_radius_1_50.json': '2da786ff4bec608fadd903f038891fa813dd75e37e00e41f4316ff7c46cf27ff', 'certificates/source_norms/carrier_mass_residual_bound.json': '1ce320c2283c37f17c7c5fa09bcbc0692b67067f3296038c2034ded4eda3ac4b', 'certificates/source_norms/retained-transport/retained135125_survival_comparison.json': '67d7003462bde8fa391245e76f226694cea286ab005d0404a7cfe4046453b797', 'certificates/source_norms/retained-transport/retained135125_heavy_comparison.json': '98195f65f9d5acc4a27b8275952488b928e5204c56871e9a41cf4f32cf0e4ff6', 'certificates/source_norms/retained-transport/retained_deletion_survival_comparison.json': 'cd553e5668eabaf49a186a97ac78ea07259840a55c90eb4d36b045a23c421fc9', 'certificates/source_norms/whole_quadratic_same_head.json': 'b77b50ff8961dcfafaefdb004b538a1a2409e69944f894048ae25b1ae0bede3a', 'frontier/complete_small_retained_heads.py': '41dc84e95552e8c4f388426211302247cdb64fa7c2d893e9224be00f35f0c6fb', 'frontier/transport/legacy_retained_complete_head_transport.py': 'fa076b2152872fc4564fbfbcf6d637ae54ddd8fac19332bce4d5ff38e6606f69', 'frontier/transport/small_source_square_factorial_transport.py': '833fa43a695e16ed6fa2654507e49f87db7017fd5f02eed0c4d78face676df3d', 'frontier/uniform_complete_k_comparison.py': '916863ad05614bf6e81f110efec28b4bbaf562c9965267dce747b6b0f6342f2b', 'frontier/uniform_ap_survival_denominator.py': '5d1da05fd2e805761d92bc2b0bdd698df9d463e782f299d0f5696fb73bd2d3a5', 'frontier/transport/load_two_cost_remainders.py': '420ccb62a1b10fc2cbab97df31274026ecb0d8067605750a7259b51d952ffd55', 'frontier/source_barrier_saturation.py': '92076ee71a6be16655bbe5c2ac223db6502da1ab5c3553a7f83bb555dbbb8363', 'frontier/carrier_mass_residual_bound.py': '751484c1029980b93a5fc4bb7f6990108d40789f06b3b88723311f901cc48b7a', 'frontier/k_neighborhood_radius_study.py': '41cbad92bacf1cd7b573afb48ecc0811fc0df05fe9a56cfa274d3f4fbb175682', 'profile-notes/106-the-actual-denominator-shares-the-carrier-mass-residual.md': '312e9ee488aef11709b910308e4540f43cb396a5572d6a10a8d0e864cebedb29', 'profile-notes/146-a-global-mass-floor-and-coupled-costs-expand-the-k-radius.md': '5e1e352c0f741e2f6f0de16043ef581c0176ff5ad40f1c59ea639827dff3a550', 'profile-notes/transport/202-eight-original-costs-have-an-exact-load-two-remainder.md': 'bf6c0cf2dee32fd2edef5ee6522a4e98ccc014c518735617b88314bd865313c5', 'profile-notes/transport/235-every-original-head-candidate-transports-on-a-positive-source-box.md': 'bdd7610e78704f98506beb05cc806aa043cf8b6eaefd614589eea2cc0f989640', 'profile-notes/transport/237-the-sixteen-legacy-heads-transport-with-their-survivor-cap-prices.md': '7903a4624bc107a56cca5a5903323d2c90afa70004e5ddaa4a1b0248ee2ca0ce', 'profile-notes/transport/238-the-shared-square-and-complete-factorial-bound-extend-to-the-small-source-box.md': 'ef82b3dbcf4271a583edbafd03e7e0101af23ceaca1afb8433e5618ab5984d21'}
...
def calculate(base):
    ...
    docs = {
        'complete_small_retained_heads': json.loads(io.read_artifact_bytes(base/'certificates/source_norms/complete_small_retained_heads.json')),
        'legacy_retained_complete_head_transport': json.loads(io.read_artifact_bytes(base/'certificates/source_norms/retained-transport/legacy_retained_complete_head_transport.json')),
        'small_source_square_factorial_transport': json.loads(io.read_artifact_bytes(base/'certificates/source_norms/retained-transport/small_source_square_factorial_transport.json')),
        'uniform_complete_k_comparison': json.loads(io.read_artifact_bytes(base/'certificates/source_norms/uniform_complete_k_comparison.json')),
        'uniform_ap_survival_denominator': json.loads(io.read_artifact_bytes(base/'certificates/source_norms/uniform_ap_survival_denominator.json')),
        'load_two_cost_remainders': json.loads(io.read_artifact_bytes(base/'certificates/source_norms/load_two_cost_remainders.json')),
        'k_neighborhood_radius_1_50': json.loads(io.read_artifact_bytes(base/'certificates/source_norms/k_neighborhood_radius_1_50.json')),
        'carrier_mass_residual_bound': json.loads(io.read_artifact_bytes(base/'certificates/source_norms/carrier_mass_residual_bound.json')),
        'retained135125_survival_comparison': json.loads(io.read_artifact_bytes(base/'certificates/source_norms/retained-transport/retained135125_survival_comparison.json')),
        'retained135125_heavy_comparison': json.loads(io.read_artifact_bytes(base/'certificates/source_norms/retained-transport/retained135125_heavy_comparison.json')),
        'retained_deletion_survival_comparison': json.loads(io.read_artifact_bytes(base/'certificates/source_norms/retained-transport/retained_deletion_survival_comparison.json')),
        'whole_quadratic_same_head': json.loads(io.read_artifact_bytes(base/'certificates/source_norms/whole_quadratic_same_head.json')),
    }
    pins = dict(PINS)
    ...
    identity_provider = load('transport/load_two_cost_remainders')
