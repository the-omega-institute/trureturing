...
CERTIFICATE = 'certificates/source_norms/three_layer_product_escape.json'
PINS = {
    ...
    'certificates/source_norms/joint_gap_denominator_escape.json': '1da26e786818cc6f2c4c89d04cc100fc1dea4637a3fe5554e4224c0807749fae',
    'frontier/joint_gap_denominator_escape.py': 'fd1febb46588bc7ffb9472e4741dcb3aae4a5411a3a9331afef7947b387f12de',
    'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232',
    'frontier/joint_gap_mass_escape.py': '8058e5be0d981249ff459548742c443fd65022a270b7b9cc127dfdcc6f61c467',
    'certificates/source_norms/joint_gap_mass_escape.json': '5bf609552f5e0973e5650c951307541b894f12ff1a37683eeb425cb9242b23f8',
...
def calculate(base):
    ...
    prior = module('joint_denominator_prior', base/'frontier/joint_gap_mass_escape.py')
    ...
    allocated = module('joint_denominator_allocated', base/'frontier/allocated_seven_thresholds.py')
    control = module('joint_denominator_control', base/'frontier/global_control_faces.py')
