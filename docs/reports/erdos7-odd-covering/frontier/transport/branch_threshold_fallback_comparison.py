...
CERTIFICATE = 'certificates/source_norms/branch_threshold_fallback_comparison.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/transport/branch_local_fallback_comparison.py': 'f2bf63edfa00a8c0c82b87b8f2b5e5966eee65ddc9285a95c43b09f9acd9bb05', 'certificates/source_norms/branch_local_fallback_comparison.json': 'fd29bdfeb6ce8f1071198c34934d0e1e716186acc810d9d082eec4ac87f1f172', 'verify_joint_frontier.py': 'a40fce0a5cb6a713dc8cb569b874d284b8dd66fb3f0a5e48fc2c69cb8fe286fe', 'verify_killed_core_continuity.py': '4dc984fd1f8554a4938b59f1fd74ec8851833c4d3b43f329b7cc306c9ad7c19e', 'frontier/ap_schedule_core.py': '365b6c1f9a70dff5378a7d3a73a06879ee6193fbc69a4ac68ecfed1972e95617', 'profile-notes/21-physical-and-killed-kernel-comparisons-at11-and13.md': '418e2a61be99cb3cd710111802ff34e3f1d34ef97d924ff9fa714743cf86a7ca', 'profile-notes/32-unequal-source-norms-sharpen-the-uniform357-input.md': 'aa95400dfbd29567dd5429a44476757f9db2365fa324ada7ffa1722ce62937c0', 'profile-notes/35-ap45-layout-costs-and-complete-core-tails.md': '69b81701e966910e69552f20f255f6a36bf345ea49cb684a46dd11f0148e3a26', 'profile-notes/37-three-original-five-events-strengthen-the-source.md': 'ce9408190300323db52ceb04d07eafd986b8e291b6e2538214fa6b6887bd8a9e'}
...
def calculate(base):
    ...
    provider = module('threshold_original', base/'frontier/transport/branch_local_fallback_comparison.py')
    original = provider.calculate(base)
    stored = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/branch_local_fallback_comparison.json'))
    ...
    core = module('threshold_original_core', base/'frontier/ap_schedule_core.py')
