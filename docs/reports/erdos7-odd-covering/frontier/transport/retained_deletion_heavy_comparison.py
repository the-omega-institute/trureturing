...
class RetainedDeletionHead:
    ...
    def __init__(self,base,bank=None,proposer=None):
        old=module('retained_allselected',base/'frontier/transport/all_selected_heavy_comparison.py').AllSelectedHead(base)
        ...
        self.increment=module('retained_increment',base/'frontier/transport/second_depth_seven_comparison.py').seven_increment
...
def calculate(base, bank=None, proposer=None):
    ...
    prior = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/all_selected_survival_comparison.json'))
    pins = dict(PINS)
