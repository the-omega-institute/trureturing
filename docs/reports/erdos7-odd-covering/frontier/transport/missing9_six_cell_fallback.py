...
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/transport/branch_threshold_fallback_comparison.py': '21eccb7fc6f4c1960d6a1d4a0bafdcf0a792be2a3c41f263a7b9fd6e9cbbe2aa', 'certificates/source_norms/branch_threshold_fallback_comparison.json': '8cff6e5b707cdc84560fbf73a62becd8fff494ada59fb92dd5cba6043206f1b2', 'verify_killed_core_continuity.py': '4dc984fd1f8554a4938b59f1fd74ec8851833c4d3b43f329b7cc306c9ad7c19e', 'profile-notes/32-unequal-source-norms-sharpen-the-uniform357-input.md': 'aa95400dfbd29567dd5429a44476757f9db2365fa324ada7ffa1722ce62937c0', 'profile-notes/35-ap45-layout-costs-and-complete-core-tails.md': '69b81701e966910e69552f20f255f6a36bf345ea49cb684a46dd11f0148e3a26', 'profile-notes/transport/236-the-last-missing9-branch-uses-a-better-ap-threshold.md': 'cc221ebb51b8ebe5727f12b7aa253637f15992dc48a7f796b3d081b1332528ff', 'problem-details/14-a-shared-parameter-improvement-for-arbitrary-three-prime-heights.md': 'b22079eb61c26a2bafd5310f075754ea1f78cca5582fc46f6dc75513e2d09b4d'}
ROOTS = (0, 0, 0, 1, 1, 1)
...
def calculate(base):
    ...
    pins = dict(PINS)
    previous = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/branch_threshold_fallback_comparison.json'))
    ...
    provider = module('six_cell_thresholds', base/'frontier/transport/branch_threshold_fallback_comparison.py')
