...
PINS = {
    ...
    'frontier/transport/retained135125_heavy_comparison.py': '5e7a8bdd7ee1e93afd3115c80a8792d0afbf035ac50be715cf69631b75c70ff5',
    'certificates/source_norms/retained-transport/retained135125_heavy_comparison.json': '98195f65f9d5acc4a27b8275952488b928e5204c56871e9a41cf4f32cf0e4ff6',
    ...
    'frontier/transport/load_two_cost_remainders.py': '420ccb62a1b10fc2cbab97df31274026ecb0d8067605750a7259b51d952ffd55',
    'certificates/source_norms/load_two_cost_remainders.json': '6163e7d984655c397c3b0eb3b30cffff65c875f90fe7849cdc2d5ec899d5db6b',
}
...
def calculate(base, bank=None, proposer=None):
    ...
    prior, laws, identities_cert = (read('retained-transport/retained135125_heavy_comparison'), read('retained-transport/retained135_survival_comparison'), read('load_two_cost_remainders'))
    pins = dict(PINS)
    ...
    load = lambda name: module('retained135125_survival_'+name, base/'frontier'/(name+'.py'))
    ...
    retained = load('transport/retained135125_heavy_comparison')
    ...
    return encode({'schema': 'erdos7-retained135125-survival-comparison-v1', 'source_sha256': pins,
        ...
        'rational_duals': load('transport/retained135_heavy_comparison').encode_dual_bank(duals, retained.NROWS, retained.NEQ), 'selected_policy': prior['selected_policy'],
...
def main():
    ...
    retained = module('retained135125_survival_codec', args.base/'frontier/transport/retained135125_heavy_comparison.py')
    exact = module('retained135125_survival_exact', args.base/'frontier/transport/retained135_heavy_comparison.py')
