...
def calculate(base):
    ...
    old, joint, jface, jnear, wide, low = (read('next_wide_source_union'), read('joint_gap_denominator_escape'), read('j-source/j_face_alignment'), read('j-source/j_source_labelwise_neighborhood'), read('extended_source_bridge_comparison'), read('wide_fresh_full_slot_source_comparison'))
    pins = dict(PINS)
    ...
    jprovider = load('j-source/j_source_labelwise_neighborhood')
