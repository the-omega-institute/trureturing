...
class JointQuadraticHead:
    ...
    def __init__(self, base, factorial_certificate, five_certificate):
        ...
        self.parent = load('transport/expanded_seven_pair_comparison').CoupledSevenHead(base)
