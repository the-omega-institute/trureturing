...
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/transport/pure_axis_shared_deletion_comparison.py': '9fc2cce3196fac8f82b55dd66dcae20624d2aeeea3a91be36296e6d2b7151430', 'certificates/source_norms/retained-transport/pure_axis_shared_deletion_comparison.json': 'f4e243a7d3f25273acefd33369a5389068a2b0c062f86be9c5eb3a97a3550679', 'frontier/whole_face_second_factorial_tail.py': '10a81457579172e28113d2a1e1646ac4f25ba1161c9fb8e927dcaf74a5928870', 'certificates/source_norms/whole_face_second_factorial_tail.json': '1cea4dcb2b7344fb48e4064d6d8df7ac38b9add92f732e9513f05a5b7fb66c2c', 'frontier/whole_factorial_same_head.py': '65def5c326c9da6dde7de1bfd91c241347aed825e37af8eeda17883dc091c205', 'frontier/k_face_complete_ratio.py': 'd856e5c2face117c993b7bd308903a3fb149293d254046f76b6ff5f42ec9b478', 'frontier/k_face_common_seven_hinges.py': '8cc4600c9b3f2f65a11820fcb2d0d6663c765c20765bbaf1ae0de6e883cefc97', 'profile-notes/128-the-complete-factorial-tail-retains-its-head-off-the-face.md': '9c070de9ab953772260c316b96846a874c5799449d0fa4baf72d90d6b33df4e3', 'profile-notes/75-forced27-and-complete-pure3-deletion-on-the-k-faces.md': 'cb071f6a7634a149296938b8da21e2c3573be66eb9bb476d3c5418e0fb02210f'}
...
def calculate(base):
    ...
    prior, tail_prior = read('retained-transport/pure_axis_shared_deletion_comparison'), read('whole_face_second_factorial_tail')
    pins = dict(PINS)
    ...
    load = lambda name: module('six_square_'+name, base/'frontier'/(name+'.py'))
