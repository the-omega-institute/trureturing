...
def main():
    ...
    spec = importlib.util.spec_from_file_location('retained135125_survival',
        args.base/'frontier/transport/retained135125_survival_comparison.py')
    helper = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(helper)
    io = helper.module('retained135125_survival_writer', args.base/'certificate_io.py')
    proposal = helper.module('retained135125_survival_proposal', args.base/'frontier/transport/propose_retained135_duals.py')
