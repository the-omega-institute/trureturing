...
PINS = {
    ...
    'certificates/source_norms/expanded_seven_quadratic_comparison.json': 'f33b13524b2563685237b816a7668766049ed9415f4731073c62ce7086484ee1',
}
...
class JointSelectedHead:
    def __init__(self, base, bank=None, proposer=None):
        self.depth = module('joint_selected_depth', base/'frontier/transport/second_depth_seven_comparison.py').SecondDepthSevenHead(base)
