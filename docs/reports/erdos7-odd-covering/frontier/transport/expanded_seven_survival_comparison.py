...
PINS = {
    ...
    'frontier/transport/expanded_seven_pair_comparison.py': 'a651711988f8adf20dfc27cba9665f25d0d5863cb310c26e2f4b7fc16bab1c29',
    'certificates/source_norms/expanded_seven_pair_comparison.json': '6d41632d57d45a3507abb8c95fdbbd09e12de08e635d261d583889a2872271ef',
    ...
    'frontier/whole_block_ap11_survival.py': '14151a59dde623f1273cc127f0d412457b3f3e400c513eacfc6b9dc41cef0681',
    'certificates/source_norms/whole_block_ap11_survival.json': 'd307f93d7def03b7ce4dd41dd2f202c6cdff9744df5470c36d99fc05ad87d195',
}
...
def calculate(base):
    ...
    load = lambda name: module('seven_survival_'+name, base/'frontier'/(name+'.py'))
    ...
    problem = load('transport/expanded_seven_pair_comparison').CoupledSevenHead(base)
