...
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/transport/joint_selected_source_comparison.py': 'ab18c0c4ac40af60f7c974393d82738ec4d762ccefa7f5efe61cf4b963b3673c', 'certificates/source_norms/joint_selected_source_comparison.json': '81ca26366a56753ff9a84c002c97ed9f4a0f2317fb6e2a858c25774c3283b07e', 'frontier/transport/joint_selected_survival_comparison.py': 'd5b7a09c5910047b6ab2da5db9dc819d1d36016d419de2f510dfa4beba6aef1f', 'certificates/source_norms/joint_selected_survival_comparison.json': '867ff5327002e8fd9226f2feac64eb80a6534df67fd3d898611b1000654d25a0'}
...
class AllSelectedHead:
    ...
    def __init__(self, base, bank=None, proposer=None):
        self.provider = module('all_selected_provider', base/'frontier/transport/joint_selected_source_comparison.py')
        ...
        prior = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/joint_selected_source_comparison.json'))
...
def calculate(base, bank=None, proposer=None):
    ...
    prior = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/joint_selected_survival_comparison.json'))
    pins = dict(PINS)
    ...
    require('frontier/transport/second_depth_seven_comparison.py' in pins, 'Pinned complete two-depth bridge')
