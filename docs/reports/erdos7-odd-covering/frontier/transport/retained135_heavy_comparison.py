...
def lp_class(base):
    parent = module('retained135_mask_lp', base/'frontier/transport/selected_deletion_mask_heavy_comparison.py')
...
def retained135_head_class(base):
    parent = module('retained135_head_parent', base/'frontier/transport/retained_deletion_heavy_comparison.py')
