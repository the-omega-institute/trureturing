...
CERTIFICATE = 'certificates/source_norms/selected_deletion_mask_heavy_comparison.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232',
        ...
        'frontier/transport/retained_deletion_survival_comparison.py': '53b0a39ae514dac880537ac5efb3d713250840ed320cdbf6fa06c610b9bfd582',
        'certificates/source_norms/retained-transport/retained_deletion_survival_comparison.json': 'cd553e5668eabaf49a186a97ac78ea07259840a55c90eb4d36b045a23c421fc9',
        'profile-notes/109-the-mean-and-all-hinges-share-one-original-test.md': '7721729fc324fc3d3c6850118acfb8793b072fee0d35495cac7d39571df5481e'}
...
def mask_head_class(base):
    parent = module('selected_mask_parent', base/'frontier/transport/retained_deletion_heavy_comparison.py')
    whole = module('selected_mask_whole', base/'frontier/transport/retained_deletion_survival_comparison.py')
...
def calculate(base, bank=None, proposer=None):
    ...
    load = lambda name: module('selected_mask_'+name, base/'frontier'/(name+'.py'))
    ...
    return encode({'schema': 'erdos7-selected-deletion-mask-heavy-comparison-v1', 'source_sha256': pins,
        ...
        'rational_dual_buckets': load('transport/retained_deletion_heavy_comparison').bucket_duals(retained),
...
def main():
    ...
    parent = module('selected_mask_bank', args.base/'frontier/transport/retained_deletion_heavy_comparison.py')
