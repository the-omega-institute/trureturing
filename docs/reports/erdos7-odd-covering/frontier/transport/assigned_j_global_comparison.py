...
CERTIFICATE = 'certificates/source_norms/assigned_j_global_comparison.json'
PINS = {
    'frontier/transport/expanded_bridge_global_comparison.py': '62dc7d73b064e323b1dd0fa696e04895d54a68e23b5efd885076974d4cd93d92',
    'certificates/source_norms/expanded_bridge_global_comparison.json': 'b592e71c36c2f5b8c65c24f3dbd8591cd24c84b843aebbd6e934c52ef9a02a63',
    'frontier/j-source/j_assigned_joint_error_reserve.py': '9ab75ad4b30ffcd129e9a2891004e178acac5fe5018819c596fa396a3949344f',
    'certificates/source_norms/j-source/j_assigned_joint_error_reserve.json': '06ad59532c614755fc5da1016ba2f1eac256a3144bae2165b918109e9119e9e3',
    'frontier/j-source/j_affine_global_comparison.py': '9cc90987a65405f7dc0f17896f66ec25a837bfc3086120b32c2639448e2198fe',
    'certificates/source_norms/j-source/j_affine_global_comparison.json': 'dc4ecad55d3c69775ab0742cc02d165fad43bd3e1fe046ab9c3e11ea01baf6af',
    'frontier/transport/expanded_bridge_residual_comparison.py': '5dbcbc38db1ece921f11234d43a8a2822fe235245401e0c1cb42fdc58fba6997',
    'certificates/source_norms/expanded_bridge_residual_comparison.json': '89d2c7f43c6023a3450acd912a86488380c68fa099a45824e8ddb2c38ce233f8',
    'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232',
    'frontier/j-source/j_aggregate_layer_global_comparison.py': '56a0f2e0d08d776b00d8cd85c44b4fce3e3743c87587ff9743698bbb4c14d761',
    'certificates/source_norms/j-source/j_aggregate_layer_global_comparison.json': '9a12a7cc79f73f1a46f160aab3192ad7ba0651d721ecf241432cc4b4d53c695a',
    'frontier/j-source/j_affine_margin_reserve.py': '9323404996dfe5e1981db3f734fa6efa13f07bbe1e89e9ecbbc06ef2cb602663',
    'certificates/source_norms/j-source/j_affine_margin_reserve.json': '8505a083c6a321a6eb2576b624e2a13d2a6aacc3520897912575c9d574abc523',
    'frontier/transport/wide_expanded_seven_survival.py': '5785b51245bd4962fcf890a16b53f0b3458b1ef1e46bea6a488e60c72d64b246',
    'certificates/source_norms/wide_expanded_seven_survival.json': '1aca616a305cfebaaae7b1b9d90570416bd3ae1a66618eed8253fe5db53fe117',
}
...
def calculate(base):
    ...
    old, joint, jface, jnear, wide, low, family = (read('j-source/j_aggregate_layer_global_comparison'), read('three_layer_product_escape'), read('j-source/j_face_alignment'), read('j-source/j_source_labelwise_neighborhood'), read('extended_source_bridge_comparison'), read('wide_fresh_full_slot_source_comparison'), read('j-source/j_assigned_joint_error_reserve'))
    ...
    jprovider = load('j-source/j_assigned_joint_error_reserve')
    ...
    enlarged_provider = load('transport/expanded_bridge_residual_comparison')
    ...
    reconstructed = load('transport/wide_expanded_seven_survival').original_numerator(study, enlarged)
