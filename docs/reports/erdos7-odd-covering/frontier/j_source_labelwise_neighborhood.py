...
CERTIFICATE = 'certificates/source_norms/j_source_labelwise_neighborhood.json'
PINS = {
    'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232',
    'frontier/j_face_alignment.py': 'bb4e3a82f954538aad042ef6940204947d7b7a5ef69b2ef2bd791d36466aa991',
    'frontier/j_face_surplus_transport.py': '93dddc43216b788b10f573baadf4d7c6934651c31f4d3bdfbaff2e86903ce4c3',
...
def calculate(base):
    ...
    face = module('j136_face', base/'frontier/j_face_alignment.py')
    ...
    surplus = module('j136_surplus', base/'frontier/j_face_surplus_transport.py')
