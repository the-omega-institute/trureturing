...
CERTIFICATE = 'certificates/source_norms/whole_cost_common_stop_loss.json'
PINS = {
    ...
    'certificates/source_norms/whole_face_ap11_survival.json': '6216e445c36a25bd1fa1cc62cee1f10695486e7d4cd1971b2652f82bdcf3464c',
}
SCALE = 5*7**7
TOTAL = SCALE*16200
...
def calculate(base):
    ...
    previous = read('certificates/source_norms/whole_face_ap11_survival.json')
    ...
    engine = module('common_cost_stop_engine', base/'frontier/source_barrier_saturation.py').Experiment(base)
    parent = module('common_cost_stop_parent', base/'frontier/whole_face_stop_loss_generator.py')
    bridge = module('common_cost_stop_bridge', base/'frontier/k_face_common_seven_hinges.py')
    ...
    consumer = module('common_cost_stop_consumer', base/'frontier/vector_face_complete_ratio.py')
    majorant = module('common_cost_stop_majorant', base/'frontier/endpoint_numerator_common_costs.py')
