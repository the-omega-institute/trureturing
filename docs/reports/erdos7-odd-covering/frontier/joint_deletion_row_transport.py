...
CERTIFICATE = 'certificates/source_norms/joint_deletion_row_transport.json'
PINS = {
    'frontier/selected_deletion_mask_row_transport.py': '76ba51e4fe596f245151bd0302480e3cf9c79bebbf698f09212bfd599aeac9c6',
...
def calculate(base):
    ...
    parent = read('certificates/source_norms/selected_deletion_mask_row_transport.json')
    ...
    e5 = module('joint_rows_e5', base/'frontier/selected_deletion_mask_row_transport.py')
    retained = module('joint_rows_retained', base/'frontier/retained135_heavy_comparison.py')
    prior = read('certificates/source_norms/retained135_heavy_comparison.json')
