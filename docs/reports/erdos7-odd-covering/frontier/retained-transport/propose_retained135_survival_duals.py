#!/usr/bin/env python3
"""Propose exact-checked retained135 survival duals and write their full consumer."""
import argparse
...
def main():
    ...
    spec = importlib.util.spec_from_file_location('retained135_survival',
        args.base/'frontier/retained-transport/retained135_survival_comparison.py')
    helper = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(helper)
    io = helper.module('retained135_survival_writer', args.base/'certificate_io.py')
    proposal = helper.module('retained135_survival_proposal', args.base/'frontier/retained-transport/propose_retained135_duals.py')
    ...
    print('WROTE: complete retained135 survival face='+str(float(F(result['comparison_upper'])))+'.')
