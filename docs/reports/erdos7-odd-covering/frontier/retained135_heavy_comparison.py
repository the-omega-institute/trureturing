...
PINS = {
    ...
    'certificates/source_norms/selected_deletion_mask_heavy_comparison.json': 'be846885e035c5157d058c641a95d042d85061b0c7a4c088ef157d8372bf8413',
...
def lp_class(base):
    parent = module('retained135_mask_lp', base/'frontier/selected_deletion_mask_heavy_comparison.py')
...
def retained135_head_class(base):
    parent = module('retained135_head_parent', base/'frontier/retained_deletion_heavy_comparison.py')
...
def calculate(base, bank=None, proposer=None):
    ...
    prior = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/selected_deletion_mask_heavy_comparison.json'))
    pins = dict(PINS)
    ...
    load = lambda name: module('retained135_'+name, base/'frontier'/(name+'.py'))
