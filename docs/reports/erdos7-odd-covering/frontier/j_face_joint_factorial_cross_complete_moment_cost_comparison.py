...
CERTIFICATE = 'certificates/source_norms/j_face_joint_factorial_cross_complete_moment_cost_comparison.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j_face_shifted_factorial_complete_moment_cost_comparison.py': 'd5684462d899e210e93f587258572fa057ea15cebfe3f7fe2b61fa4ba82809ac', 'certificates/source_norms/j_face_shifted_factorial_complete_moment_cost_comparison.json': '5d4c086baa6ff17441e7a79e76b3433db42c1173d016385f92ffdaf5cb297222', 'profile-notes/271-three-shifted-factorial-costs-improve-the-complete-j-comparison.md': '13c6a5ecadc778e9e703c73453ffbc0b1c66305e657611768e17b12fd723d92c', 'frontier/j_face_joint_factorial_cross_heads.py': 'b0e93b347fdd030a4006187333a2aab6c2d876ab79bde24931b40ac33c451cf1', 'certificates/source_norms/j_face_joint_factorial_cross_heads.json': '39b9a9596e18080f6b942c6f6a3fc0b0afb367264b8f23affdf51085eedf921e', 'profile-notes/272-joint-raw-and-survivor-crosses-strengthen-three-original-j-costs.md': '0c24c3ebda3eea927c88be69d963afd314130c72402aee20b13058f74497bb75'}
...
def inputs(base):
    ...
    prior_module = module('joint_factorial_cross_j_envelope_previous', base/'frontier/j_face_shifted_factorial_complete_moment_cost_comparison.py')
    ...
    old = read('j_face_shifted_factorial_complete_moment_cost_comparison')
    heads = read('j_face_joint_factorial_cross_heads')
    pins = dict(data['pins'])
