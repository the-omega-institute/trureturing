...
def calculate(base):
    ...
    linear = load(base, 'frontier/endpoint_linear_numerator.py', 'endpoint_square_linear')
    old_endpoint = json.loads((base/'certificates/source_norms/endpoint_linear_numerator.json').read_text())
    ...
    old = json.loads((base/'certificates/source_norms/exact_survival_comparison_boundary.json').read_text())
    ...
    constructor = load(base, 'frontier/sharp_source_mass_endpoints.py', 'endpoint_square_constructor')
...
def main():
    ...
    if args.check:
        certificate = args.base/'certificates/source_norms/endpoint_square_numerator.json'
