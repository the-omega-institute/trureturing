...
CERTIFICATE = 'certificates/source_norms/j_aligned_source_row_transport.json'
INPUTS = (
    'certificates/source_norms/j_actual_rows_zero_restoration.json',
    'certificates/source_norms/j_aligned_retained375_heavy553_heads.json',
    'certificates/source_norms/j_aligned_retained375_h4_heads.json',
    'certificates/source_norms/j_aligned_quadratic_complete_heads.json',
)
