...
PINS = {
    ...
    'certificates/source_norms/full_family_five_cap_sharpness.json': '9b72338b3a13ee4097f896678e7cf1273a3d35c807b48587db34f403c8cc2bd4',
    ...
    'profile-notes/75-forced27-and-complete-pure3-deletion-on-the-k-faces.md': 'cb071f6a7634a149296938b8da21e2c3573be66eb9bb476d3c5418e0fb02210f',
}
SLOTS = ('P', 'A', 'B', 'Q', 'H')
...
def actual_crt(base):
    source = module('pure_five_source', base/'frontier/source_mass_compatibility.py')
    repack = module('pure_five_repack', base/'frontier/full_family_five_cap_sharpness.py')
    N, labels = 3, []
...
def calculate(base):
    ...
    repack = module('pure_five_joint_repack', base/'frontier/full_family_five_cap_sharpness.py')
    pins = dict(PINS)
    for path, pin in repack.PINS.items():
        ...
        pins[path] = pin
    for path in ('frontier/full_family_five_cap_sharpness.py', 'certificates/source_norms/full_family_five_cap_sharpness.json'):
