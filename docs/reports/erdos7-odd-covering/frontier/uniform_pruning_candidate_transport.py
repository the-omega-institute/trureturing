...
def evaluate(a,j,d,R,G,N=None):
    ...
    depth=module('pruning_api_depth',base/'frontier/second_depth_seven_comparison.py')
...
def calculate(base):
    ...
    depth=module('pruning_rows_depth',base/'frontier/second_depth_seven_comparison.py')
