...
CERTIFICATE = 'certificates/source_norms/pure_three_root_spill.json'
PINS = {
    ...
    'frontier/pure_three_projected_defect.py': '2f2350b69e7d7857c4679db05c94be8227aa128d6af1f6fb060c31f6dbc83183',
}
...
def calculate(base):
    ...
    constructor = module('root_spill_constructor', base/'frontier/sharp_source_mass_endpoints.py')
    parent = module('root_spill_parent', base/'frontier/source_cost_endpoint_attainment.py')
    projection = module('root_spill_projection119', base/'frontier/pure_three_projected_defect.py')
    tail = module('root_spill_tail66', base/'frontier/endpoint_linear_neighborhood.py')
    sigma_checks = []
