...
CERTIFICATE = 'certificates/source_norms/broad_marked_identity_global.json'
PINS = {
...
def calculate(base):
    ...
    current = read('certificates/source_norms/global_k_face_gain.json')
    ...
    schedule = module('marked_global_schedule', base/'frontier/ap_schedule.py')
    fixed = module('marked_global_fixed', base/'frontier/fixed_cost.py')
    carrier = module('marked_global_carrier', base/'frontier/full_linear_carrier_frontier.py')
