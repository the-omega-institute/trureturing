...
def calculate(base, bank):
    ...
    joint = module('j_ap_joint', base/'frontier/j_face_joint_selected_heads.py')
    previous = module('j_ap_previous', base/'frontier/j_face_complete_survival_linear_heads.py')
    ...
    j = module('j_ap_source', base/'frontier/j_face_coupled_seven_heads.py')
...
def main():
    ...
    joint = module('j_ap_joint_json', args.base/'frontier/j_face_joint_selected_heads.py')
