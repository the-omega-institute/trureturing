...
class SecondDepthJHead:
    def __init__(self,base,j,core,pair,depth,prior244,prior251,bank=None,proposer=None):
        ...
        self.codec=module('j_depth_codec',base/'frontier/retained135_heavy_comparison.py')
...
def calculate(base,bank=None,proposer=None):
    ...
    io=module('j_depth_io',base/'certificate_io.py');core=module('j_depth_core244',base/'frontier/j_face_joint_selected_heads.py')
    ...
    j=module('j_depth_source',base/'frontier/j_face_coupled_seven_heads.py');pair=module('j_depth_pair',base/'frontier/j_face_retained135125_heads.py')
    depth=module('j_depth_formula',base/'frontier/second_depth_seven_comparison.py')
...
def main():
    ...
    io=module('j_depth_read',args.base/'certificate_io.py');core=module('j_depth_json',args.base/'frontier/j_face_joint_selected_heads.py')
    stored=json.loads(io.read_artifact_bytes(args.base/CERTIFICATE),object_pairs_hook=core.unique)
    codec=module('j_depth_read_codec',args.base/'frontier/retained135_heavy_comparison.py')
