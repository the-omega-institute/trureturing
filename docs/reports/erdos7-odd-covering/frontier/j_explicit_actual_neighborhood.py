...
CERTIFICATE = 'certificates/source_norms/j_explicit_actual_neighborhood.json'
TARGET = 'certificates/source_norms/j_face_heavy_positive175189_complete_moment_cost_comparison.json'
RESTORATION = 'certificates/source_norms/j_actual_rows_zero_restoration.json'
HEAVY = 'certificates/source_norms/j_face_retained375_heavy_heads.json'
...
PINS = {
    ...
    TARGET: '5d746cc187d5b5cfb3b9eec0a02cfa6e9b55fe3dd8a61b51882c529c9fdb5505',
    RESTORATION: '0cbe26c0a20ff91ed94a0fe52ce5c0ad6d89ff89435f6babbdb2ea1786f3c010',
    'frontier/retained135_heavy_comparison.py': '62ab2a4c37da0846132412cc9c9cea464f51ec8548e2257188bdad9a843d13eb',
    'frontier/j_face_coupled_seven_heads.py': 'd2794b380770dcd5529bacc0fb134d0e7ea82c26c572339b65e30c8222e24946',
    'frontier/joint_selected_source_comparison.py': '68ac25a9801c1ea946bad2780ed2fda457737bd3bdeeb99da91df642a2745055',
    'frontier/retained_deletion_heavy_comparison.py': '294fe1254ce3209a072e6bf462d00d4e106e5b1e987d911ff786736370062d75',
    'frontier/j_face_joint_selected_heads.py': '01033d19b43910a667954005342d2a03fe57dd6f621bf319398cfdb77ec821ec',
    'frontier/j_actual_rows_zero_restoration.py': '1f26034aaf89ce28f4acddeab715112a4a60c1fd6256215b5246dfa18a3116cb',
}
...
def map_small_model(small, base):
    j = module('j_inventory_source_tables', base/'frontier/j_face_coupled_seven_heads.py')
    raw = module('j_inventory_raw', base/'frontier/joint_selected_source_comparison.py')
    retained = module('j_inventory_retained', base/'frontier/retained_deletion_heavy_comparison.py')
    core = module('j_inventory_core', base/'frontier/j_face_joint_selected_heads.py')
...
def price_inventory(base, source, restored, pins, read):
    codec = module('actual_neighborhood_codec', base/'frontier/retained135_heavy_comparison.py')
