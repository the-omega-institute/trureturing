...
CERTIFICATE = 'certificates/source_norms/budgeted_coefficient_source_transport.json'
...
PINS = {
    ...
    'frontier/full_slot_radius_source_comparison.py': 'f94ed615e691e293c14c018e4bb49e2c82a8cc4895ffd684c5c3fd34bdfcd3ae',
    'certificates/source_norms/full_slot_radius_source_comparison.json': 'dedcaee41dee0caf461767991e6103b007c005afc09cf58cfa709c13314228a4',
    'certificates/source_norms/full_slot_radius_source_heads.json': '109f850ab3256f3e122bd6ff579815b4156b8a49394aebe987c4fff872e639e7',
    'frontier/transported_source_complete_comparison.py': 'f1ae240968de56400d9a49b5220c05291b744d4557fbdd939daec58dda587a4c',
}
...
def calculate(base):
    ...
    prior = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/full_slot_radius_source_comparison.json'))
    scanned = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/full_slot_radius_source_heads.json'))
    pins = dict(PINS)
