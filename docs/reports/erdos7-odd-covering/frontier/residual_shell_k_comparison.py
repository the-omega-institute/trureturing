...
CERTIFICATE = 'certificates/source_norms/residual_shell_k_comparison.json'
HEAD_CERTIFICATE = 'certificates/source_norms/residual_shell_original_heads.json'
PINS = {
    HEAD_CERTIFICATE: 'a84d8f711ff9804cb0acda36da3c20b6b27bb04c12e477bb5490a058dc820d45',
    ...
    'frontier/seven_pair_source_prices.py': '1b558b27b43ed376c8079ca4d58c85e1d4767c1804b70add48bfa8c31e75c6bc',
...
def calculate(base, rescan=False):
    ...
    study = module('residual_shell_study', base/'frontier/k_neighborhood_radius_study.py').Study(base)
