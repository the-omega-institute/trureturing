...
def calculate(base):
    ...
    linear = load(base, 'frontier/endpoint_linear_numerator.py', 'coherent_head_linear')
    square = load(base, 'frontier/endpoint_square_numerator.py', 'coherent_head_square')
    old_linear = json.loads((base/'certificates/source_norms/endpoint_linear_numerator.json').read_text())
    old_square = json.loads((base/'certificates/source_norms/endpoint_square_numerator.json').read_text())
...
def main():
    ...
    if args.check:
        certificate = args.base/'certificates/source_norms/endpoint_square_coherent_head.json'
