...
def calculate(base,bank,seed_rows):
    ...
    io=module('joint_cross_io',base/'certificate_io.py');core=module('joint_cross_core244',base/'frontier/j_face_joint_selected_heads.py')
    ...
    j=module('joint_cross_j',base/'frontier/j_face_coupled_seven_heads.py');pair=module('joint_cross_pair',base/'frontier/j_face_retained135125_heads.py')
    depth=module('joint_cross_depth',base/'frontier/second_depth_seven_comparison.py');second=module('joint_cross_second',base/'frontier/j_face_second_depth_retained_heads.py')
    moment=module('joint_cross_moment',base/'frontier/j_face_shared_square_factorial.py');shift=module('joint_cross_shift',base/'frontier/j_face_shifted_factorial_quadratic_heads.py')
...
def main():
    ...
    io=module('joint_cross_reader',args.base/'certificate_io.py');core=module('joint_cross_json',args.base/'frontier/j_face_joint_selected_heads.py')
    ...
    if args.write:
        ...
        codec=module('joint_cross_codec',args.base/'frontier/retained135_heavy_comparison.py')
