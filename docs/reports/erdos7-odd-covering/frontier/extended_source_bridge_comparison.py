...
CERTIFICATE = 'certificates/source_norms/extended_source_bridge_comparison.json'
HEAD_CERTIFICATE = 'certificates/source_norms/extended_source_bridge_heads.json'
...
def calculate(base, scan=False, write_heads=False):
    ...
    study = module('source_bridge_study', base/'frontier/k_neighborhood_radius_study.py').Study(base)
