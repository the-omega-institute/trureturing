...
CERTIFICATE = 'certificates/source_norms/endpoint_joint_geometry_ratio.json'
PINS = {
    ...
    "certificates/source_norms/endpoint_numerator_common_costs.json": "17d0112f63920986cbce7c2811f98095ca603fe16d58cf81ebb07709b4598e80",
    "frontier/endpoint_complete_deletion_ratio.py": "30ac2a01d97fa220f0bda429513993c6cf94b800ef1bbce9eb2b7268a1a7ea83",
    "certificates/source_norms/endpoint_complete_deletion_ratio.json": "862592ecdc06d432dce8c75c37f1580046c001de8ccbb11c03bc88c2043fee9d",
    "frontier/endpoint_survival_scalar_barrier.py": "a8794c867885defcb9664bcb26e2c1f53919af04e830c1d4488a4e803515df2c",
    ...
    "frontier/endpoint_linear_joint15_25_75.py": "33b7ef26c277f025b523f8d08c850c395531c7a5dc81adef1dc457a453bc8159",
    "certificates/source_norms/endpoint_linear_joint15_25_75.json": "7b7efb68189e1851fcfcc5f7c05cbb7d067178ec80c4280d9f31b23a4b1b51ce",
    "frontier/endpoint_square_complete_pure3_deletion.py": "87a751764332e64656fd96d371088133ff0a889b38a21620d496b806790d0ec2",
    "certificates/source_norms/endpoint_square_complete_pure3_deletion.json": "d235e7e315ebe60fbd284ee657ab956c6f2137c982c756084fb31bf120e7a61b",
...
def calculate(base):
    ...
    prior = read('certificates/source_norms/endpoint_numerator_common_costs.json')
    old = read('certificates/source_norms/endpoint_complete_deletion_ratio.json')
    survival = read('certificates/source_norms/endpoint_survival_scalar_barrier.json')
    geometry = read('certificates/source_norms/endpoint_linear_joint15_25_75.json')
    square = read('certificates/source_norms/endpoint_square_complete_pure3_deletion.json')
    hinge = read('certificates/source_norms/endpoint_h5_common_seven_head.json')
    ...
    schedule = module('complete_deletion_ratio_schedule', base/'frontier/ap_schedule.py')
    fixed = module('complete_deletion_ratio_fixed', base/'frontier/fixed_cost.py')
    majorant = module('complete_deletion_ratio_majorants', base/'frontier/endpoint_numerator_common_costs.py')
