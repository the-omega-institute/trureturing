...
CERTIFICATE = 'certificates/source_norms/source_dependent_outer_comparison.json'
PINS = {
...
def calculate(base):
    ...
    predecessor = module('source_outer_previous', base/'frontier/shared_slot_gap_global.py')
    ...
    packing = module('source_outer_packing', base/'frontier/shared_slot_defect_polytope.py')
