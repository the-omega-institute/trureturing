...
def calculate(base):
    ...
    for name, pin in ((
            'frontier/verify_allocated_seven_thresholds.py', current53['verifier_sha256']), (
    ...
    require(current53['source_sha256']['certificates/source_norms/full_linear_carrier_frontier.json'] ==
            PINS['certificates/source_norms/full_linear_carrier_frontier.json'], 'Same fixed49 comparison')
    parent = module('ceiling_actual_attainment', base/'frontier/source_cost_endpoint_attainment.py')
    ...
    constructor = parent.load(base, 'frontier/sharp_source_mass_endpoints.py', 'ceiling_constructor')
