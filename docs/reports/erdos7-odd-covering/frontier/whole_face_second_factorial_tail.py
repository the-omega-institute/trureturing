...
def calculate(base):
    ...
    previous = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/whole_cost_common_stop_loss.json'))
    for path, pin in previous['source_sha256'].items():
        ...
        used[path] = pin
    square = module('factorial_tail_square', base/'frontier/k_face_complete_ratio.py')
    bridge = module('factorial_tail_head', base/'frontier/k_face_common_seven_hinges.py')
    ...
    schedule = module('factorial_tail_schedule', base/'frontier/ap_schedule.py')
    fixed = module('factorial_tail_fixed', base/'frontier/fixed_cost.py')
    ...
    consumer = module('factorial_tail_consumer', base/'frontier/vector_face_complete_ratio.py')
    majorant = module('factorial_tail_majorant', base/'frontier/endpoint_numerator_common_costs.py')
