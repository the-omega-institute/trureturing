...
PINS = {
    ...
    'frontier/extended_source_bridge_comparison.py': '456958ef19219777b3683cf0efff78ae9b0406cbe56cd51aada212056956d66c',
}
...
def calculate(base):
    ...
    retained = module('e5_row_retained', base/'frontier/retained135_heavy_comparison.py')
