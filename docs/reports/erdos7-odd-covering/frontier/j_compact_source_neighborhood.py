...
CERTIFICATE = 'certificates/source_norms/j_compact_source_neighborhood.json'
SOURCE = 'certificates/source_norms/j_face_heavy_positive175189_complete_moment_cost_comparison.json'
SOURCE_SHA256 = '5d746cc187d5b5cfb3b9eec0a02cfa6e9b55fe3dd8a61b51882c529c9fdb5505'
ANCHORS = (
    ...
    'profile-notes/130-the-whole-j-face-forces-source-anti-alignment.md',
    'profile-notes/219-one-late-source-split-controls-complete-saturated-j-heads.md',
    'profile-notes/264-seven-retained-states-and-two-seven-depths-control-complete-j-heads.md',
    'profile-notes/288-retaining375-strengthens-the-complete-j-survival-hinge.md',
    'profile-notes/296-joint-positive175189-strengthens-the-complete-j-survival-hinge.md',
    'profile-notes/298-retaining375-certifies-the-complete-heavy-cost.md',
    'profile-notes/299-the-complete-saturated-j-comparison-crosses403.md',
)
