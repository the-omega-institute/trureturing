...
CERTIFICATE='certificates/source_norms/j_face_joint_positive175189_survival_heads.json'
...
def make_problem(B):
 ...
 base=load('frontier/j_face_retained375_survival_heads');data=base.make_extended_model(B);old=data['lp']
...
def main():
 ...
 io=module('joint175189_reader',args.base/'certificate_io.py');codec=module('joint175189_codec',args.base/'frontier/retained135_heavy_comparison.py')
