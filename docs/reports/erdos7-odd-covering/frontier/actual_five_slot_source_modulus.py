...
CERTIFICATE = 'certificates/source_norms/actual_five_slot_source_modulus.json'
CELLS = (0, 3, 1, 4, 7)
SLOTS = (1, 2, 3, 0, 4)
ROOT = (0, 0, 1, 1, 1)
...
def calculate(base):
    ...
    constructor = module('slot_modulus_source_labels', base/'frontier/source_mass_compatibility.py')
    actual = module('slot_modulus_actual', base/'frontier/complete_off_face_cost.py')
    finite = module('slot_modulus_finite', base/'frontier/finite_source_face_transport.py')
    source = module('slot_modulus_source', base/'verify_joint_frontier.py')
    mean = module('slot_modulus_mean', base/'frontier/joint_deep_mean_transport.py')
