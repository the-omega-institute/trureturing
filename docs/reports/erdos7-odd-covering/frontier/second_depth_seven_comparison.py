...
class SecondDepthSevenHead:
    ...
    def __init__(self, base):
        self.parent = module('second_depth_parent', base/'frontier/expanded_seven_pair_comparison.py').CoupledSevenHead(base)
