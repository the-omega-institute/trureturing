...
PROVIDER='frontier/j_aligned_joint_selected_heads.py'
BASE_CERTIFICATE='certificates/source_norms/j_aligned_joint_selected_heads.json'
...
def main():
 parser=argparse.ArgumentParser(description=__doc__);parser.add_argument('--base',type=Path,default=Path(__file__).resolve().parents[1]);parser.add_argument('--certificate',type=Path)
