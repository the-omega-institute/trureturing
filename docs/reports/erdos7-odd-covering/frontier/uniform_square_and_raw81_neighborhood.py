...
def calculate(base):
    ...
    denominator = module('square_raw81_denominator', base/'frontier/uniform_ap_survival_denominator.py')
    uniform = module('square_raw81_uniform', base/'frontier/uniform_k_neighborhood_cost.py')
    quadratic = module('square_raw81_quadratic', base/'frontier/uniform_quadratic_cost_portfolio.py')
    factorial = module('square_raw81_factorial', base/'frontier/complete_off_face_factorial_tail.py')
    tails = module('square_raw81_tails', base/'frontier/complete_off_face_omitted_tails.py')
