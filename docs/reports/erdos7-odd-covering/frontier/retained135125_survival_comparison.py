...
CERTIFICATE = 'certificates/source_norms/retained135125_survival_comparison.json'
PINS = {
...
def main():
    ...
    retained = module('retained135125_survival_codec', args.base/'frontier/retained135125_heavy_comparison.py')
    exact = module('retained135125_survival_exact', args.base/'frontier/retained135_heavy_comparison.py')
