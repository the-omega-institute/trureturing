...
CERTIFICATE = 'certificates/source_norms/vector_marked_source.json'
PINS = {
    ...
    'certificates/source_norms/broad_weighted_identity_source.json': 'e81e64cf6861998f1e6a108e3bebebb40d3f2b278f583f55513772fc33777030',
...
def calculate(base):
    ...
    saturation = module('vector_marker_engine', base/'frontier/source_barrier_saturation.py')
    engine = saturation.Experiment(base)
    broad = module('vector_marker_source', base/'frontier/broad_weighted_identity_source.py')
    full = module('vector_marker_old', base/'frontier/full_linear_carrier_frontier.py')
