...
PREVIOUS = 'certificates/source_norms/survival_hinge_deficit.json'
PREVIOUS_PIN = 'a81892ca70b51a8402c67ffca901c7acf57fa993b9deeccf0037b6eaaec70ff8'
PREVIOUS_VERIFIER = 'frontier/verify_survival_hinge_deficit.py'
PREVIOUS_VERIFIER_PIN = 'b6b80b99c728382e5e3f34fbc07e3ae8a2655d0e3777b03db2307e0422db9843'
LOCAL_PINS = {
    'frontier/absorbed_survival_hinges.py': '03b4d8d9c80470946ce4bfd44cd40a07c241f6c22058952fc59b88c71e1d7e10',
    'frontier/absorbed_survival_consumer.py': 'd47a9e4ccaec3d277899830f92aaaf1e9cc736bb628165aa6547c3521a8f9f53',
}
...
def main():
    ...
    require(set(LOCAL_PINS) == {'frontier/absorbed_survival_hinges.py',
                               'frontier/absorbed_survival_consumer.py'}, 'Complete current helper pins')
    ...
    helper = load('absorption', 'frontier/absorbed_survival_hinges.py')
    consumer = load('consumer', 'frontier/absorbed_survival_consumer.py')
