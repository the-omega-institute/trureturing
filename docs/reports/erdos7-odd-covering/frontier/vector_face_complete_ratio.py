...
LINEAR = 'certificates/source_norms/vector_marked_face.json'
QUADRATIC = 'certificates/source_norms/quadratic_vector_marked_source.json'
PINS = {
    'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232',
    'frontier/vector_marked_face.py': '7cd633743b83af3fff73b28b765ec5e9e12d753789db8339c7fd722d15bdc8b7',
    LINEAR: 'e720af09ec258566a14e9f6bb34c8903130748332ac54dc8233dc25d85f707b0',
    'frontier/quadratic_vector_marked_source.py': '22932298c0efb4886fdc35a583642b56e08b2bbb88e399ec82a619e51e42860c',
    QUADRATIC: '21d1d5042ae8cf64d01cfd4055237d2078c15c2fc40105d2aa4b06d47be47acd',
...
def calculate(base):
    ...
    old = read('certificates/source_norms/k_face_complete_ratio.json')
    previous = read('certificates/source_norms/k_face_surviving_tail_ratio.json')
    linear = read(LINEAR)
    ...
    for record in (old, previous, linear, quadratic):
        for path, pin in record['source_sha256'].items():
            ...
            used[path] = pin
    engine = module('vector_ratio_engine', base/'frontier/source_barrier_saturation.py').Experiment(base)
    for path, pin in engine.pins.items():
        require(path in used and used[path] == pin, 'Every engine input is already pinned')
    source = engine.source
    majorant = module('vector_ratio_majorants', base/'frontier/endpoint_numerator_common_costs.py')
