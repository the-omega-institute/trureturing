...
CERTIFICATE = 'certificates/source_norms/quadratic_marked_global.json'
PINS = {
    'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232',
    'frontier/product_escape_global.py': '0c71d26f5710b7721bb07d20c596840e6a81f8bfcdad35355b196b55514a621d',
    'certificates/source_norms/product_escape_global.json': 'e8433887c2c64fda7c4fb901ce642d76fafc62aff1cbb87fe4f0eb75308c8596',
}
...
def calculate(base):
    ...
    previous = read('certificates/source_norms/product_escape_global.json')
    ...
    linear = read('certificates/source_norms/weighted_marker_global.json')
    quadratic = read('certificates/source_norms/retained_quadratic_tests.json')
    frontier = read('certificates/source_norms/full_linear_carrier_frontier.json')
    ...
    schedule = module('quadratic_marker_schedule', base/'frontier/ap_schedule.py')
    fixed = module('quadratic_marker_fixed', base/'frontier/fixed_cost.py')
    layout = module('quadratic_marker_layout', base/'frontier/layout_gap.py')
