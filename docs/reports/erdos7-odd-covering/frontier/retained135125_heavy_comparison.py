...
PINS = {
    ...
    'frontier/retained135_survival_comparison.py': 'f45fd2108230cba367dcc5c4a4ec45428e4c7d0da363754d270aa44286208526',
    'certificates/source_norms/retained135_survival_comparison.json': '36b64444720bde32253a32dae36f73c2f6100b7bc6eb151d82c68cb852bc6c15',
}
...
def lp_class(base):
    parent = module('pair135125_masks', base/'frontier/selected_deletion_mask_heavy_comparison.py')
    exact = module('pair135125_exact', base/'frontier/retained135_heavy_comparison.py')
...
def retained_pair_head_class(base):
    parent = module('pair135125_head_parent', base/'frontier/retained_deletion_heavy_comparison.py')
...
def calculate(base, bank=None, proposer=None):
    ...
    prior = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/retained135_survival_comparison.json'))
    pins = dict(PINS)
...
def main():
    ...
    exact = module('pair135125_codec', args.base/'frontier/retained135_heavy_comparison.py')
