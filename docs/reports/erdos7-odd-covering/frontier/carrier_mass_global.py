...
PINS = {
    ...
    'frontier/shared_root_global.py': '7534f7c1d535fd49f2d0c94e207306cfb5ea4473436355e580769be298aefab0',
    'certificates/source_norms/shared_root_global.json': '255107512c1ab1849258ce47ddf01f3b6ff131389da1e2a77fc3138f895e8771',
...
def calculate(base):
    ...
    for prior in (previous, mass):
        for path, pin in prior['source_sha256'].items():
            ...
            used[path] = pin
    old_module = module('carrier_global_previous', base/'frontier/shared_root_global.py')
    require(encode(old_module.calculate(base)) == previous, 'Recompute all46 complete cost choices and their common budget')
    mass_module = module('carrier_global_mass', base/'frontier/carrier_mass_residual_bound.py')
