...
FRONTIER_PIN = '237ed11241550037c69c855742d3f6e0a3a9c362ae2a861a173d3450e32375c0'
ROOT = (0, 0, 1, 1, 1)
...
def calculate(base):
    ...
    constructor = load(base, 'frontier/sharp_source_mass_endpoints.py', 'endpoint_linear_constructor')
    ...
    raw = io.read_artifact_bytes(base/'certificates/source_norms/full_linear_carrier_frontier.json')
...
def main():
    ...
    if args.check:
        certificate = args.base/'certificates/source_norms/endpoint_linear_numerator.json'
