...
LOCAL_PINS = {'frontier/ap_schedule.py': '40b6138fc9d0fc1d540880e8a4abb1933d1dcd1b2c5dbf54646008c3f2e62b9f', 'frontier/ap_schedule_core.py': '365b6c1f9a70dff5378a7d3a73a06879ee6193fbc69a4ac68ecfed1972e95617', 'certificates/ap_schedule_norms.json': '7cbb82bb2ea8691136fe74779632ffb821f78dd3b0c498ea1625f84a3866d9d8'}
...
def main():
    ...
    fixed = module('ap_schedule_fixed', src / 'frontier/fixed_cost.py')
    layout = module('ap_schedule_layout', src / 'frontier/layout_gap.py')
    ...
    core = module('ap_schedule_core', base / 'frontier/ap_schedule_core.py')
    math = module('ap_schedule_math', base / 'frontier/ap_schedule.py')
