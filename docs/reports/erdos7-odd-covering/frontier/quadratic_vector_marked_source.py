...
PINS = {
    ...
    'frontier/quadratic_marked_global.py': 'ebe3aa4369a2df360984f30d01c1724fad18de6650afd1560a985fb88f4ee7f2',
    'certificates/source_norms/quadratic_marked_global.json': '98068892b2b23baa27724b9f48c13c1ff153b11018cb8465f7cdef7dbbd7f6f5',
...
def calculate(base):
    ...
    predecessors = [json.loads(io.read_artifact_bytes(base/path)) for path in (
        'certificates/source_norms/vector_marked_source.json',
        'certificates/source_norms/quadratic_marked_global.json')]
    for predecessor in predecessors:
        for path, pin in predecessor['source_sha256'].items():
            ...
            used[path] = pin
    saturation = module('quadratic_vector_engine', base/'frontier/source_barrier_saturation.py')
    engine = saturation.Experiment(base)
    broad = module('quadratic_vector_source', base/'frontier/broad_weighted_identity_source.py')
    vector = module('quadratic_vector_geometry', base/'frontier/vector_marked_source.py')
    full = module('quadratic_vector_old', base/'frontier/full_linear_carrier_frontier.py')
    ...
    old84 = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/k_face_complete_ratio.json'))
    comparison84 = []
