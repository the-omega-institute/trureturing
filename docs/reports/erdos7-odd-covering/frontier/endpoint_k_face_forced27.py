...
def calculate(base):
    ...
    old = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/endpoint_k_face_linear.json'))
    ...
    constructor = module('forced27_actual398', base/'frontier/source_mass_compatibility.py')
