...
def calculate(base):
    ...
    parent = module('off_tail_parent', base/'frontier/source_cost_endpoint_attainment.py')
    source = parent.load(base, 'verify_joint_frontier.py', 'off_tail_source')
    constructor = parent.load(base, 'frontier/sharp_source_mass_endpoints.py', 'off_tail_constructor')
