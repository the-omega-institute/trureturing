...
PREVIOUS = 'certificates/source_norms/retained_quadratic_tests.json'
PREVIOUS_PIN = 'cfcac117e8988e6b3e37dfde961e6f35cb64a05aab700c09297424dadd534e29'
PREVIOUS_VERIFIER = 'frontier/verify_retained_quadratic_tests.py'
PREVIOUS_VERIFIER_PIN = '2ba3c805a4cad11c9a004782e8104c01f7a8c0f9bf06058f8f80da55e772d31f'
LOCAL_PINS = {
    'frontier/shared_source_deficits.py': 'e836b66691213273f272db6bd992f202897fda6bcf336551ab50f41c9a55e883',
    'frontier/shared_source_consumer.py': '02642a68c8e1c351988f654081757e3b6594cfa4411eabea267593d3658aebf5',
    'frontier/shared_linear_refinement.py': '2150065bb9eb9369847cf399e9f14b78406b4aecfaa2da10ea2d00eff8d0fe7e',
...
def main():
    ...
    fixed = module('shared_source_fixed', src/'frontier/fixed_cost.py')
    layout = module('shared_source_layout', src/'frontier/layout_gap.py')
    ap = module('shared_source_ap', src/'frontier/ap_schedule.py')
    core = module('shared_source_core', src/'frontier/ap_schedule_core.py')
    kc = module('shared_source_kc', src/'verify_killed_core_continuity.py')
    old = module('shared_source_old', src/'frontier/retained_five_tests.py')
    helper = module('shared_source_profiles', base/'frontier/shared_source_deficits.py')
    consumer = module('shared_source_consumer', base/'frontier/shared_source_consumer.py')
    refine = module('shared_source_linear_refinement', base/'frontier/shared_linear_refinement.py')
    square = module('shared_source_square_barrier', base/'frontier/shared_square_barrier.py')
    ...
    preceding_source = read('certificates/source_norms/retained_five_tests.json')
