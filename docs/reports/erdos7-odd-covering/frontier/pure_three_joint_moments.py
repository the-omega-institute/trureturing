...
CERTIFICATE = 'certificates/source_norms/pure_three_joint_moments.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/pure_five_joint_factorial_comparison.py': '59f1249babac906dd00a2ce705ffa7fde4059821a64a3abd1e08b2bb5a95a6c8', 'certificates/source_norms/pure_five_joint_factorial_comparison.json': 'e782284c98d552237eff46d106bec9cfb5061d6334544da0c99ad5c27c677425', 'frontier/complete_off_face_omitted_tails.py': '0dc92761c65f6729dfe45770b02dae327d5ddfa1d4b0a79dcc45fb9deb8b81f8', 'profile-notes/125-the-complete-off-face-omitted-tails-recover-every-face-constant.md': 'cbe1fc88855354bd58e7a11ff22574bd8f9f9f94dceb57612c3ac8b1d943df17', 'profile-notes/75-forced27-and-complete-pure3-deletion-on-the-k-faces.md': 'cb071f6a7634a149296938b8da21e2c3573be66eb9bb476d3c5418e0fb02210f', 'frontier/uniform_square_and_raw81_neighborhood.py': '999fcf90320c04e21de34a7228d00fc8f9682318e9054bf0502d67a23e0285fc'}
ROOT = (0, 0, 1, 1, 1)
FIRST = (F(7, 90), F(7, 90))
...
def calculate(base):
    ...
    prior = read('certificates/source_norms/pure_five_joint_factorial_comparison.json')
    pins = dict(PINS)
    ...
    load = lambda name: module('three_joint_'+name, base/'frontier'/(name+'.py'))
