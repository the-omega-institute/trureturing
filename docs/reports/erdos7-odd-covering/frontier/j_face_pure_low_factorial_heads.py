...
def inputs(base):
    source=module('pure_low_source276',base/'frontier/j_face_joint_pair_factorial_heads.py')
    ...
    previous=module('pure_low_comparison277',base/'frontier/j_face_joint_pair_factorial_complete_moment_cost_comparison.py')
...
def main():
    ...
    io=module('pure_low_io',args.base/'certificate_io.py');core=module('pure_low_json',args.base/'frontier/j_face_joint_selected_heads.py')
    ...
    codec=module('pure_low_codec',args.base/'frontier/retained135_heavy_comparison.py')
