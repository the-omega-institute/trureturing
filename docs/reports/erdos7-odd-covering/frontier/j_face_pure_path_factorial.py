...
def calculate(base):
    ...
    j = module('j_path_source', base/'frontier/j_face_coupled_seven_heads.py')
    moment = module('j_path_moment', base/'frontier/j_face_shared_square_factorial.py')
