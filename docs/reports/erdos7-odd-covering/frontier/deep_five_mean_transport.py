...
def calculate(base):
    ...
    parent = module('deep_five_parent', base/'frontier/source_cost_endpoint_attainment.py')
    source = parent.load(base, 'verify_joint_frontier.py', 'deep_five_source')
    constructor = parent.load(base, 'frontier/sharp_source_mass_endpoints.py', 'deep_five_constructor')
