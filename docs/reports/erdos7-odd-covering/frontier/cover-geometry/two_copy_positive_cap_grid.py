"""Exact positive-integer PA cap grid, with complete geometric tails.
Stage thresholds range over 1..4, 1..5, 1..7, 1..8; queries over 1..8.
The four anchor corners define the uniform certificate objective."""
...
for ts in product(range(1,5),range(1,6),range(1,8),range(1,9)):
    count+=1;rows=[]
    for u,v in corners:
