...
p.add_argument('--cpp',type=Path,default=Path(__file__).with_name('row0_column1_full_layout_independent.cpp'))
p.add_argument('--witness',type=Path,default=Path(__file__).with_name('row0_column1_full_leaf_pair_library_interval_certificate.json'))
...
ck('field_witness_roles',w['square7_roles']==[0,1,5])
