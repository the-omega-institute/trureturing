...
static void readinput(const char* path){
 ...
 if(std::string(magic.data(),14)!="E7ROOTONEINTV1")throw std::runtime_error("wrong schema");
...
int main(int argc,char**argv){try{
 ...
 i128 den=i128(58400)*in.hs*in.cs;if(250*best<=7*den)throw std::runtime_error("target lower bound7/250 failed");
 std::cout<<"{\"schema\":\"root-one-all-star-fixedpoint-v1\",\"denominator\":\""<<dec(den)<<"\",\"gate_lower_numerator\":\""<<dec(best)<<"\",\"independent_edge_lower_numerator\":\""<<dec(independent)<<"\",\"columns\":[";
 ...
 std::cout<<"],\"strict_target\":\"7/250\",\"passed\":true}\n";return 0;
