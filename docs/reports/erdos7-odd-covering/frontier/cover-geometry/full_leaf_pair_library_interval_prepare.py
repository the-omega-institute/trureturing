...
WITNESS_PIN='4f64080de7056488b7299992ce8da2b7615410e8ddccc597ade50b323bff470d'
raw=(args.directory/WITNESS_NAME).read_bytes();ck('field_library_pin',sha256(raw).hexdigest()==WITNESS_PIN)
