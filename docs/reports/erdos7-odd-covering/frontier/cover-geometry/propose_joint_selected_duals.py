#!/usr/bin/env python3
"""Propose rational dual certificates; canonical verification uses no SciPy.
...
def main():
    ...
    spec = importlib.util.spec_from_file_location('joint_selected', args.base/'frontier/source-budgets/joint_selected_source_comparison.py')
    ...
    result = module.calculate(args.base, proposer=propose)
