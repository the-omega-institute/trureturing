#!/usr/bin/env python3
"""Propose complete J triple-retained second-depth duals, with exact full-column verification."""
import argparse
...
def main():
    ...
    core=load('j_depth_propose_core',args.base/'frontier/j-geometry/j_face_triple_second_depth_heads.py')
    ...
    bank=None if args.seed is None else json.loads(args.seed.read_text())
    result=core.calculate(args.base,bank=bank,proposer=propose)
    ...
    print('WROTE all three complete triple-retained second-depth J heads',flush=True)
