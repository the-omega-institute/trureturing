...
INPUT=args.certificate or BASE/'mixed_split_zero_support_bound_certificate.json'
...
zdata=json.loads((BASE/'finite_height_qualitative_pair.json').read_text());validzero=set(map(tuple,zdata['full_capacity35_edges']))
...
theta_prior=json.loads((BASE/'mixed_split_four_point_bound.json').read_text())
