...
def summarize(directory, manifest, result, producer, checker):
    ...
    return dict(
        schema='column1-full-five-live-leaf-two-field-cover-v1',
        status='PASS', new_lean_verification=False,
        scope='All ten 9qs central roles independently in live leaves 0,1,2,4,5; '
              'fixed low pure phases/nulls/central15/square7 roles (1,1,5), all 50 retained '
        ...
        square7_roles=[1,1,5],orbit_keys=manifest['orbit_keys'],families=manifest['families'],computed_corner_count=20, represented_corner_count=95,
...
def main():
    ...
    preparer = source_dir / 'column1_full_leaf_pair_library_interval_prepare.py'
    checker = source_dir / 'column1_full_leaf_pair_library_interval_checker.cpp'
