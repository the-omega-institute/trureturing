...
CERTIFICATE='certificates/source_norms/j_face_retained375_heavy_heads.json'
...
def inputs(B):
    provider=module('heavy375_current288',B/'frontier/j_face_retained375_survival_heads.py')
    ...
    for path in ('frontier/j_face_retained375_survival_heads.py','certificates/source_norms/j_face_retained375_survival_heads.json'):
    ...
    second=module('heavy375_current_second',B/'frontier/j_face_second_depth_retained_heads.py')
