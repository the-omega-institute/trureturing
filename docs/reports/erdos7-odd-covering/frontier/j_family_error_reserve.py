...
CERTIFICATE = 'certificates/source_norms/j_family_error_reserve.json'
PINS = {
    'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232',
    'frontier/j_source_labelwise_neighborhood.py': '368387f01f2090ca13fdcaac242b1a30904e0f10e2e72b0168e28c60ec17eeec',
    'certificates/source_norms/j_source_labelwise_neighborhood.json': '339c206dda7c321bc0de3cab85125d7e36ef06d15c56a23e7668428324a4677b',
    'certificates/source_norms/j_face_alignment.json': '6874e71b0846d973fedd330f5a8a54bfa457b2cdfe896943db407b8d89bec611',
    'certificates/source_norms/j_face_surplus_transport.json': '2c64303053c544e0f5ef9aab5f4d56c6a9f75e2ab88efe347bfb88ca4a3c3a28',
}
...
def calculate(base):
    ...
    prior = read('certificates/source_norms/j_source_labelwise_neighborhood.json')
    face = read('certificates/source_norms/j_face_alignment.json')
    surplus = read('certificates/source_norms/j_face_surplus_transport.json')
    pins = dict(PINS)
    ...
    original = module('j197_original', base/'frontier/j_source_labelwise_neighborhood.py')
