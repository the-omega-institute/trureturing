...
PINS = {'frontier/j_face_retained375_survival_heads.py': 'c5d2e171d97d3d21e1b95373e2731c13d067808537c856658e17129ff9ec5c2b', 'certificates/source_norms/j_face_retained375_survival_heads.json': 'f5e328aee9f52b8cfb57149766e9e95d73d3f865722b050bed594abeb826f224', 'profile-notes/288-retaining375-strengthens-the-complete-j-survival-hinge.md': '471e21713ee2ced6488fe0c3385450594f80fb1ba771e86ae1e8a7d723d9474f', 'frontier/j_face_second_depth_survival_heads.py': '50b38041246981a05e7a304cec8e71b73ad5be2fb19a6a139fb867217ef9da15', 'certificates/source_norms/j_face_second_depth_survival_heads.json': '6275a57036beab1b6018c3c33b774b3e024346957797af1ac0865d1200bd0d9e', 'profile-notes/266-two-original-ap11-blocks-use-the-complete-second-depth-interface.md': '82c9719d3c14a29bdebfdb36551ae820057c5b715d2099a46c1251f1c39b3c63'}
...
def inputs(B):
    ...
    core=module('retained375_ap11_core',B/'frontier/j_face_joint_selected_heads.py')
    ...
    provider=module('retained375_ap11_model288',B/'frontier/j_face_retained375_survival_heads.py')
    ...
    second=module('retained375_ap11_second',B/'frontier/j_face_second_depth_retained_heads.py')
...
def main():
    ...
    io=module('retained375_ap11_read',args.base/'certificate_io.py');core=module('retained375_ap11_json',args.base/'frontier/j_face_joint_selected_heads.py')
    codec=module('retained375_ap11_codec',args.base/'frontier/retained135_heavy_comparison.py')
