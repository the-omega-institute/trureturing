...
DEFAULT_PROOF='profile-notes/329-a-finite-whole-j-neighborhood-covers-high-surplus.md'
DEFAULT_CERTIFICATE='certificates/source_norms/j_whole_face_high_rho_finite_guard.json'
...
def whole_face_account(base,io,src):
    inv=json.loads(io.read_artifact_bytes(base/'certificates/source_norms/j_aligned_complete_moment_comparison.json'),object_pairs_hook=io._unique)
