...
CERTIFICATE = 'certificates/source_norms/joint_concentration_loss_budget.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/monotone_product_carrier_mass.py': '4e8dd576a31b445445502e1bd089151919822e70cf57d3a473d4dc29d5f62747', 'frontier/carrier_mass_residual_bound.py': '751484c1029980b93a5fc4bb7f6990108d40789f06b3b88723311f901cc48b7a'}
...
def calculate(base):
    ...
    algebra = module('joint_loss_polynomials', base/'frontier/monotone_product_carrier_mass.py')
