...
CONSUMER = 'certificates/source_norms/j_aligned_explicit_parameter_neighborhood.json'
DEFAULT_PROOF = 'profile-notes/326-finite-original-label-tests-preserve-the-explicit-aligned-source-guard.md'
DEFAULT_CERTIFICATE = 'certificates/source_norms/j_aligned_source_guard_truncation.json'
ANCHORS = (
    ...
    'profile-notes/325-an-explicit-aligned-parameter-neighborhood-keeps-the-complete-comparison-below400.md',
    'frontier/j_aligned_explicit_parameter_neighborhood.py',
)
