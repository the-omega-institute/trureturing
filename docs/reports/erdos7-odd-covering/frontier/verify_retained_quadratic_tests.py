...
PREVIOUS = 'certificates/source_norms/retained_five_tests.json'
PREVIOUS_PIN = '3fac691eb1f3081ab54559a0c396a88abd244efc73e4b6ca1875753a50b8dbc4'
PREVIOUS_VERIFIER = 'frontier/verify_retained_five_tests.py'
PREVIOUS_VERIFIER_PIN = '920dd25084bb7670149e7c23ad5057b408326a4c937ce69630ca3889b4ca5f23'
HELPER = 'frontier/retained_quadratic_tests.py'
HELPER_PIN = '712cf9a4adab36feff0a2ed8b64e6b721e22bcbfa2eb26fede154f049d06f670'
INPUTS = 'certificates/source_norms/retained_quadratic_inputs.json'
...
def main():
    ...
    fixed = module('retained_quadratic_fixed', src/'frontier/fixed_cost.py')
    layout = module('retained_quadratic_layout', src/'frontier/layout_gap.py')
    ap = module('retained_quadratic_ap', src/'frontier/ap_schedule.py')
    core = module('retained_quadratic_core', src/'frontier/ap_schedule_core.py')
    kc = module('retained_quadratic_kc', src/'verify_killed_core_continuity.py')
    previous_math = module('retained_quadratic_previous', src/'frontier/retained_five_tests.py')
