...
CERTIFICATE = 'certificates/source_norms/active_irredundant_star_all_heights.json'
SOURCE = 'certificates/source_norms/scalar19_capacity_star_obstruction.json'
