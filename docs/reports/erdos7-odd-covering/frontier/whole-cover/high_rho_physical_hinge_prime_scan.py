...
DEFAULT_PROOF='profile-notes/whole-cover/331-complete-physical-hinges-continue-finite-sources-through43.md'
DEFAULT_CERTIFICATE='certificates/source_norms/high_rho_physical_hinge_prime_scan.json'
...
def calculate(base,proof):
    ...
    h330=module('hingeprime_330',base/'frontier/whole-cover/high_rho_survival_through29.py')
    parent_path=base/'certificates/source_norms/j-source/j_whole_face_high_rho_finite_guard.json'
    ...
    parent_proof=base/'profile-notes/j-source/329-a-finite-whole-j-neighborhood-covers-high-surplus.md'
    parent_producer=base/'frontier/j-source/j_whole_face_high_rho_finite_guard.py'
    ...
    paths=[base/'certificate_io.py',base/'verify_joint_frontier.py',parent_path,parent_proof,parent_producer,
           base/'frontier/whole-cover/high_rho_survival_through29.py',base/'profile-notes/whole-cover/330-a-finite-high-surplus-source-survives-through29.md',
           base/'profile-notes/j-source/302-a-positive-actual-source-neighborhood-keeps-j-below403.md',
           base/'profile-notes/j-source/311-imperfect-j-source-alignment-forces-a-sharp-sector-surplus.md',
