...
DEFAULT_PROOF='profile-notes/whole-cover/330-a-finite-high-surplus-source-survives-through29.md'
...
SOURCE='certificates/source_norms/j-source/j_whole_face_high_rho_finite_guard.json'
...
def calculate(base,source,proof):
    ...
    pins={pin_key(p):sha256(io.read_artifact_bytes(p)).hexdigest() for p in (
        ...
        base/'profile-notes/j-source/303-the-same-law-gamma19-scalar-comparison-needs-joint-observations.md',
