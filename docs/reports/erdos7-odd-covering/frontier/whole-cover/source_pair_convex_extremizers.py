...
DEFAULT_PROOF = 'profile-notes/whole-cover/338-simultaneous-convex-extremizers-can-have-disjoint-high-load-regions.md'
...
SOURCES = (
    ...
    'profile-notes/whole-cover/333-variable-full-haar-thresholds-retain-more-survivor-mass.md',
)
