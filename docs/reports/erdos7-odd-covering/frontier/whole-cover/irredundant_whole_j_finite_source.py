...
DEFAULT_PROOF = 'profile-notes/whole-cover/339-irredundant-source-seven-labels-bound-the-actual-surplus.md'
...
def calculate(base, proof, N):
    ...
    existing = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/j-source/j_whole_face_high_rho_finite_guard.json'),object_pairs_hook=io._unique)
    if N == 12:
    ...
    paths = ('certificate_io.py','verify_joint_frontier.py',
             ...
             'profile-notes/j-source/329-a-finite-whole-j-neighborhood-covers-high-surplus.md',
             'certificates/source_norms/j-source/j_whole_face_high_rho_finite_guard.json')
