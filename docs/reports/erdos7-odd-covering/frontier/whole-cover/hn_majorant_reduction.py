...
def calculate(base):
    head_program = base/'frontier/whole-cover/irredundant_whole_j_finite_source.py'
    head_proof = base/'profile-notes/whole-cover/339-irredundant-source-seven-labels-bound-the-actual-surplus.md'
