...
DEFAULT_PROOF='profile-notes/whole-cover/333-variable-full-haar-thresholds-retain-more-survivor-mass.md'
DEFAULT_CERTIFICATE='certificates/source_norms/high_rho_full_haar_thresholds.json'
DEFAULT_SOURCE='certificates/source_norms/j-source/j_whole_face_high_rho_finite_guard.json'
...
def calculate(base,source,proof):
    ...
    source_proof=base/'profile-notes/j-source/329-a-finite-whole-j-neighborhood-covers-high-surplus.md'
    source_producer=base/'frontier/j-source/j_whole_face_high_rho_finite_guard.py'
    ...
    reference_proof=base/'profile-notes/whole-cover/331-complete-physical-hinges-continue-finite-sources-through43.md'
    reference_producer=base/'frontier/whole-cover/high_rho_physical_hinge_prime_scan.py'
