...
CERTIFICATE='certificates/source_norms/j_face_generalized_factorial_heads.json'
PINS={'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j_face_shifted_factorial_quadratic_heads.py': '3e2f3a41381ca394dedc6f7153e0130511a0bbcd7c79e2b5f7ec1ab5e24a7ba5', 'certificates/source_norms/j_face_shifted_factorial_quadratic_heads.json': 'f5ea510ce818af5fa12db9830953d596a8a63a68b1db048930b457aeac684a0d', 'profile-notes/270-shifted-factorial-heads-strengthen-three-original-j-quadratic-costs.md': 'b547ea231ecfc53581c19b7b299b90a5f7b5ac2e00de754ee0de611ec147ee44', 'frontier/j_face_joint_factorial_cross_heads.py': 'b0e93b347fdd030a4006187333a2aab6c2d876ab79bde24931b40ac33c451cf1', 'certificates/source_norms/j_face_joint_factorial_cross_heads.json': '39b9a9596e18080f6b942c6f6a3fc0b0afb367264b8f23affdf51085eedf921e', 'profile-notes/272-joint-raw-and-survivor-crosses-strengthen-three-original-j-costs.md': '0c24c3ebda3eea927c88be69d963afd314130c72402aee20b13058f74497bb75', 'frontier/j_face_joint_factorial_cross_complete_moment_cost_comparison.py': 'c44ddf9bee8c4e2030dc5b69f44e8ea13060010e85429b190265294442c938d2', 'certificates/source_norms/j_face_joint_factorial_cross_complete_moment_cost_comparison.json': 'c83c5129a411188164ce6d110534b3eee4ac393ff7ccb23f2b1f9a997fa2db84', 'profile-notes/273-joint-factorial-crosses-improve-the-complete-j-comparison.md': '2db2f38c09214b9a26173c1d109c31204d51f148fa802cc7b4b9f83fe9001ea8'}
TARGETS=((48,3),(49,2))
...
def calculate(base,bank,seed_rows):
    ...
    io=module('generalized_io',base/'certificate_io.py');core=module('generalized_core',base/'frontier/j_face_joint_selected_heads.py')
    ...
    j=module('generalized_j',base/'frontier/j_face_coupled_seven_heads.py');pair=module('generalized_pair',base/'frontier/j_face_retained135125_heads.py')
    depth=module('generalized_depth',base/'frontier/second_depth_seven_comparison.py');second=module('generalized_second',base/'frontier/j_face_second_depth_retained_heads.py')
    moment=module('generalized_moment',base/'frontier/j_face_shared_square_factorial.py');shift=module('generalized_shift',base/'frontier/j_face_shifted_factorial_quadratic_heads.py')
...
def main():
    ...
    io=module('generalized_reader',args.base/'certificate_io.py');core=module('generalized_json',args.base/'frontier/j_face_joint_selected_heads.py')
    ...
    codec=module('generalized_codec',args.base/'frontier/retained135_heavy_comparison.py')
