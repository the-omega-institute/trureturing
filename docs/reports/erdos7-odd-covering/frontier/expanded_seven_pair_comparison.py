...
class CoupledSevenHead:
    ...
    def __init__(self, base):
        self.base = base
        load = lambda name: module('seven_pair_'+name, base/'frontier'/(name+'.py'))
        io = module('seven_pair_io', base/'certificate_io.py')
        profile = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/whole_face_stop_loss_generator.json'))
...
def calculate(base):
    ...
    load = lambda name: module('seven_pair_consumer_'+name, base/'frontier'/(name+'.py'))
