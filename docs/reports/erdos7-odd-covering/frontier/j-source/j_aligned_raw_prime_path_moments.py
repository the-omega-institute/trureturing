...
CERTIFICATE='certificates/source_norms/j-source/j_aligned_raw_prime_path_moments.json'
def module(n,p):
...
def calculate(B):
 provider=module('aligned_raw313',B/'frontier/j-source/j_aligned_joint_selected_heads.py')
 d=provider.strengthen(provider.build_source(B,'aligned_raw_moments'))
 j,io=d['j'],d['io']
 source313=json.loads(io.read_artifact_bytes(B/'certificates/source_norms/j-source/j_aligned_joint_selected_heads.json'),object_pairs_hook=io._unique)
 ...
 for path in ('frontier/j-source/j_aligned_joint_selected_heads.py','certificates/source_norms/j-source/j_aligned_joint_selected_heads.json','frontier/j-source/j_face_shared_square_factorial.py','frontier/j-source/j_face_raw_prime_path_pairs.py','frontier/j-source/j_face_coherent_positive7_pairs.py','frontier/j-source/j_face_joint_retained_square.py','frontier/complete_off_face_factorial_tail.py'):
  pins[path]=sha256(io.read_artifact_bytes(B/path)).hexdigest()
 mom=module('aligned_raw_mom241',B/'frontier/j-source/j_face_shared_square_factorial.py')
 paths=module('aligned_raw_paths265',B/'frontier/j-source/j_face_raw_prime_path_pairs.py')
 tails=module('aligned_raw_tails128',B/'frontier/complete_off_face_factorial_tail.py')
 previous=module('aligned_raw_pairs258',B/'frontier/j-source/j_face_coherent_positive7_pairs.py')
 headmod=module('aligned_raw_head245',B/'frontier/j-source/j_face_joint_retained_square.py')
