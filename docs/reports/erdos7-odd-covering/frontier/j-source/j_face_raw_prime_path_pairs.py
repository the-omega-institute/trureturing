...
PINS={'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j-source/j_face_coherent_positive7_pairs.py': 'f84967f769452ee854be277694a28ce3fd9642cd6f01153e4888008dcb6e7dbd', 'certificates/source_norms/j-source/j_face_coherent_positive7_pairs.json': 'f6c958daf1cb450fecc67f57b1dc42877dd5548f2a22504e8a1f66ab8c887a28', 'profile-notes/j-source/258-independent-positive-seven-depths-share-one-complete-raw-source.md': '98635664883838cce644c9fc87f65736b6ecb4cbef9169f9d1a7a734658cb826', 'frontier/j-source/j_face_pure_path_square.py': 'f128a419ee8dd12fc16b98cc11d0bd77a4d51da5af61c20b5c004487822bb3ba', 'profile-notes/j-source/253-two-complete-prime-path-blocks-sharpen-the-j-square.md': 'f23d3e22ad39eb40f81882ba3f15a24e0f9de41b290aa5e41c7150b6c886125e'}
...
def calculate(base):
    ...
    io=module('raw_path_io',base/'certificate_io.py');previous=module('raw_path_previous',base/'frontier/j-source/j_face_coherent_positive7_pairs.py')
    ...
    j=module('raw_path_source',base/'frontier/j-source/j_face_coupled_seven_heads.py');moment=module('raw_path_moment',base/'frontier/j-source/j_face_shared_square_factorial.py');joint=module('raw_path_head',base/'frontier/j-source/j_face_joint_retained_square.py');tails=module('raw_path_tails',base/'frontier/complete_off_face_factorial_tail.py')
...
def main():
    ...
    result=calculate(args.base);io=module('raw_path_writer',args.base/'certificate_io.py');old=module('raw_path_json',args.base/'frontier/j-source/j_face_coherent_positive7_pairs.py')
