...
CERTIFICATE = 'certificates/source_norms/j-source/j_explicit_actual_neighborhood.json'
TARGET = 'certificates/source_norms/j-source/j_face_heavy_positive175189_complete_moment_cost_comparison.json'
RESTORATION = 'certificates/source_norms/j-source/j_actual_rows_zero_restoration.json'
HEAVY = 'certificates/source_norms/j-source/j_face_retained375_heavy_heads.json'
...
PINS = {
    ...
    TARGET: 'c9fe551e579b5d9e669efb961903244521da90ba18ef26c6ebb19c3308f6a775',
    RESTORATION: 'a972dec79adc0fa6e45c7a167790975eab99f8c2b8de6fc4642917843158ecb4',
    'frontier/transport/retained135_heavy_comparison.py': 'f9bef9ef1d78395ca57da56e64e7ab218e6b45bd49de91adfafddd2220d61907',
    'frontier/j-source/j_face_coupled_seven_heads.py': '740d2656fc47a056c4f8ea2ca13e024784b96794ac364b21a91c89024cfc9587',
    'frontier/transport/joint_selected_source_comparison.py': 'ab18c0c4ac40af60f7c974393d82738ec4d762ccefa7f5efe61cf4b963b3673c',
    'frontier/transport/retained_deletion_heavy_comparison.py': '3283d6a9fbd0863ab2c8a22042b2b4e2bec8feeff24f3bf94a86e77e0a86ce1c',
    'frontier/j-source/j_face_joint_selected_heads.py': '4b244d4008d7cfe0025888192b8ed8a412a8f51509133d0b04208bcd6b47ad2c',
    'frontier/j-source/j_actual_rows_zero_restoration.py': 'b50e968e671cd1f14364b1c58d515e2b56b8443b8a66050695a18385c55c7148',
}
...
def map_small_model(small, base):
    j = module('j_inventory_source_tables', base/'frontier/j-source/j_face_coupled_seven_heads.py')
    raw = module('j_inventory_raw', base/'frontier/transport/joint_selected_source_comparison.py')
    retained = module('j_inventory_retained', base/'frontier/transport/retained_deletion_heavy_comparison.py')
    core = module('j_inventory_core', base/'frontier/j-source/j_face_joint_selected_heads.py')
...
def price_inventory(base, source, restored, pins, read):
    codec = module('actual_neighborhood_codec', base/'frontier/transport/retained135_heavy_comparison.py')
