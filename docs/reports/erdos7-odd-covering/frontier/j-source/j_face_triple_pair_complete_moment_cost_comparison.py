...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_triple_pair_complete_moment_cost_comparison.json'
PINS = {'frontier/j-source/j_face_second_cofactor_complete_moment_cost_comparison.py': '70135278fdc1640d4b9e29b00598e72141e73242cda8d3cfd6e5b75ba977ac63', 'certificates/source_norms/j-source/j_face_second_cofactor_complete_moment_cost_comparison.json': '218a360cdf7d96d5a66a76d75556be1fd5d715db5d60db3261499f0678e6a191', 'profile-notes/j-source/281-second-depth-cofactors-improve-the-complete-j-comparison.md': 'a8077c29191777a091621515770feda50149a0e1be92183171c0d0ac6510c64e', 'frontier/j-source/j_face_triple_pair_factorial_heads.py': '08ef924528e9331c85033df20a1731e74c2a8191436375a490ecca3ac89a629e', 'certificates/source_norms/j-source/j_face_triple_pair_factorial_heads.json': 'cec974fc637ee57304f1b612c2a58a311ef677eb5a227279bf145279967cf5d1', 'profile-notes/j-source/282-seven-retained-old-labels-strengthen-the-complete-j-moments.md': '1f11dc95e3c705a5932b63db86503af0bcbbfb8b9597abd0e58d75081d1b5d39'}
...
def inputs(base):
    ...
    prior=module('triple_pair_comparison281',base/'frontier/j-source/j_face_second_cofactor_complete_moment_cost_comparison.py')
    ...
    old=read('j-source/j_face_second_cofactor_complete_moment_cost_comparison');heads=read('j-source/j_face_triple_pair_factorial_heads')
    pins=dict(data['pins'])
