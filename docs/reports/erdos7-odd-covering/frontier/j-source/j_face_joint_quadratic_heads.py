...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_joint_quadratic_heads.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j-source/j_face_joint_selected_heads.py': '4b244d4008d7cfe0025888192b8ed8a412a8f51509133d0b04208bcd6b47ad2c', 'certificates/source_norms/j-source/j_face_joint_selected_heads.json': '434cd2865b3a61e19ecba395787420bc45d5c4b1da6a6831e93675109ef07a97', 'frontier/j-source/j_face_shared_square_factorial.py': 'a1c0eadad11cc55fb6faea96942465a89ade2bff95394f01ed47e83bc0bfd99d', 'certificates/source_norms/j-source/j_face_shared_square_factorial.json': '3dc47204d75eb3ed31658205918d7101adcab7138be1c77b075726d7b6155751', 'frontier/j-source/j_face_joint_complete_moment_cost_comparison.py': '1813e5a88ddbfa1e63250d8b6da5e99cbf26d0ad768a3eec5fbd5b8e174e593b', 'certificates/source_norms/j-source/j_face_joint_complete_moment_cost_comparison.json': '0d541ec224303be93fc997910b81f407b839931af9a62bc5bb3c191712563f7a', 'frontier/whole_quadratic_same_head.py': 'd447341c1887a1be5aae4ce46aa3405f594617929d7c8aa776a4b6032668d7a2', 'profile-notes/j-source/241-one-original-j-head-controls-complete-square-and-factorial-moments.md': 'b9726fccc26ee5962840dd9653e9a03e13a7119d1cbeac2708f2e61e17b4526a', 'profile-notes/j-source/244-three-complete-j-heads-share-raw-survivor-and-marked-deletion.md': 'd8c7038d7b2bd5ebc22fbd0f96c5443b88a282883d0efb252380a87810074f4a', 'profile-notes/j-source/246-the-joint-j-heads-and-square-improve-the-complete-cost-comparison.md': '307cfc05d509d0410dc051831c8e5be372c36feaaf1e84ef569d60f3dab35891'}
...
class JointQuadraticJHead:
    def __init__(self, base, moments, joint_certificate, bank=None, proposer=None):
        self.j = module('j_quadratic_source', base/'frontier/j-source/j_face_coupled_seven_heads.py')
        self.joint = module('j_quadratic_retained', base/'frontier/j-source/j_face_joint_selected_heads.py')
        moment = module('j_quadratic_moment', base/'frontier/j-source/j_face_shared_square_factorial.py')
...
def calculate(base, bank=None, proposer=None):
    ...
    moments, joint, prior = (read('j-source/j_face_shared_square_factorial'), read('j-source/j_face_joint_selected_heads'), read('j-source/j_face_joint_complete_moment_cost_comparison'))
    pins = dict(PINS)
