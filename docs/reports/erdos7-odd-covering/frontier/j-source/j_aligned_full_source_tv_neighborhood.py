...
CERTIFICATE = Path('certificates/source_norms/j-source/j_aligned_full_source_tv_neighborhood.json')
INPUTS = (
    'certificates/source_norms/j-source/j_aligned_complete_moment_comparison.json',
    'certificates/source_norms/j-source/j_compact_source_neighborhood.json',
)
ANCHORS = (
    ...
    'profile-notes/j-source/318-a-finite-aligned-source-neighborhood-keeps-j-below403.md',
)
