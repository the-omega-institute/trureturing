...
def calculate(base):
    ...
    original,factorial,square,quadratic = (read('j-source/j_face_shared_square_factorial'), read('j-source/j_face_pure_path_factorial'), read('j-source/j_face_pure_path_square'), read('j-source/j_face_joint_quadratic_heads'))
    pins = dict(PINS)
    ...
    j = module('j_coherent7_source',base/'frontier/j-source/j_face_coupled_seven_heads.py')
    moment = module('j_coherent7_moment',base/'frontier/j-source/j_face_shared_square_factorial.py')
    joint = module('j_coherent7_head',base/'frontier/j-source/j_face_joint_retained_square.py')
