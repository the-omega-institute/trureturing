...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_second_depth_survival_complete_moment_cost_comparison.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j-source/j_face_second_depth_complete_moment_cost_comparison.py': '49029e6ff680ee1c5dfbe1ab39084bb59ab01b6ee953c70f6cb484a4351a988f', 'certificates/source_norms/j-source/j_face_second_depth_complete_moment_cost_comparison.json': '450b63e5db83cbc517cf6323648ec5a45d9d43597fe80ec480b9891eaef1c569', 'profile-notes/j-source/262-a-second-seven-depth-improves-the-full-j-comparison.md': 'bfa2b7b51eba25cfe162be30d271280069a915a185a676a347215cd6b1094fe6', 'frontier/j-source/j_face_second_depth_survival_heads.py': '48333ca27f560c2634ab3a7cfbb872190064fc0616aa545907f887f2570db39e', 'certificates/source_norms/j-source/j_face_second_depth_survival_heads.json': '9f27cf25cfd8bfa17fdf4222a742c2f6cf3395ba5a6351f7a8a416985198cf32', 'profile-notes/j-source/266-two-original-ap11-blocks-use-the-complete-second-depth-interface.md': '1f0c372f829f6cb1827f3ded01cb5e1b1d545955e5257c9699a99e7833dcd9f7'}
...
def inputs(base):
    ...
    prior_module = module('second_depth_survival_j_envelope_previous', base/'frontier/j-source/j_face_second_depth_complete_moment_cost_comparison.py')
    ...
    old = read('j-source/j_face_second_depth_complete_moment_cost_comparison')
    heads = read('j-source/j_face_second_depth_survival_heads')
    pins = dict(data['pins'])
