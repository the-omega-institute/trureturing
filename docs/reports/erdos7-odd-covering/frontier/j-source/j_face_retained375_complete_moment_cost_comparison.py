...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_retained375_complete_moment_cost_comparison.json'
PINS = {'frontier/j-source/j_face_four_pure_hinge_complete_moment_cost_comparison.py': '97a4811f25da54faa1eab4b12f711a4681c3f813086fca967b8081af8ec5e2d4', 'certificates/source_norms/j-source/j_face_four_pure_hinge_complete_moment_cost_comparison.json': '318da9a494de6c2e606d0e684a93441312e9ad4c3fa91c97178b87745d7afc06', 'profile-notes/j-source/287-four-pure-hinges-improve-the-complete-j-comparison.md': '7b4305f50d64d21b92af3b59e33cc38dac45200a7f19a37acf32d67b0f968646', 'frontier/j-source/j_face_retained375_survival_heads.py': '4229d9cc7248987ae1ff5fd04f674af37b2f7b3c3820e9101428bab3cec493dc', 'certificates/source_norms/j-source/j_face_retained375_survival_heads.json': '1aa84f59e967f07b290343f0f6ded7ac4df7041068a15d372f88c6ffb7e501ce', 'profile-notes/j-source/288-retaining375-strengthens-the-complete-j-survival-hinge.md': '69147427bcfdf28e74263a611345c6142c6185ab600f2bafd3a8eb5840c0f3b7'}
...
def inputs(base):
    ...
    prior=module('retained375_comparison287',base/'frontier/j-source/j_face_four_pure_hinge_complete_moment_cost_comparison.py')
    ...
    old=read('j-source/j_face_four_pure_hinge_complete_moment_cost_comparison')
    heads=read('j-source/j_face_retained375_survival_heads')
    pins=dict(data['pins'])
