...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_exact_seven_factorial_complete_moment_cost_comparison.json'
PINS = {'frontier/j-source/j_face_retained375_ap11_complete_moment_cost_comparison.py': '033d46937f16e209d446209c20d8311ed6e11a3a36c7e35f1173e0050b39af72', 'certificates/source_norms/j-source/j_face_retained375_ap11_complete_moment_cost_comparison.json': '5bba9f6a09a4a3d23408962a0af12d0d141a2434cd91179c371bc5ab10e9e0e2', 'profile-notes/j-source/293-the-retained375-ap11-head-improves-the-complete-j-comparison.md': '92de407b345e26404f307ea914bc464e6f2a0556ef928f93c2c0d3c96b7c4f53', 'frontier/j-source/j_face_exact_seven_retained_factorial_head.py': 'a4bdb3ac52398cca1cfbc5414018c33e4fb3d0f3ad181974c468231393684836', 'certificates/source_norms/j-source/j_face_exact_seven_retained_factorial_head.json': 'fe8379ccd801151159e9c4a5123b9d0632e8a78b33bca664b58a2d7c3a5c9076', 'profile-notes/j-source/294-exact-seven-retained-head-and-slope-sharpen-the-complete-j-factorial.md': 'ec60d33192764cfeb164e6b339b4792b068e02486c35984d87e02d79c734bffb'}
...
def inputs(base):
    ...
    prior=module('exact_seven_comparison293',base/'frontier/j-source/j_face_retained375_ap11_complete_moment_cost_comparison.py')
    ...
    old=read('j-source/j_face_retained375_ap11_complete_moment_cost_comparison')
    heads=read('j-source/j_face_exact_seven_retained_factorial_head');pins=dict(data['pins'])
