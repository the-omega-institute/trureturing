...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_four_pure_hinge_complete_moment_cost_comparison.json'
PINS = {'frontier/j-source/j_face_exact_retained_factorial_complete_moment_cost_comparison.py': 'ea1c0d12cbbec7a9cd98d3408f5b689d491cf04c468776af31156580f953b25d', 'certificates/source_norms/j-source/j_face_exact_retained_factorial_complete_moment_cost_comparison.json': '2872babe2b1ab75544d38f621203859b7c84988f5fe1b38f109dd7e907ebbff3', 'profile-notes/j-source/285-exact-retained-head-and-slope-improve-the-complete-j-comparison.md': '4ce9e4a2d62bacea2436ae487210a255cc113f740ea8662b48d176b210b4789d', 'frontier/j-source/j_face_four_pure_hinge_heads.py': '9ed1a1eb1f919914f8223cf99329bbef174d90270b1e4147139f5f3b85cf6c67', 'certificates/source_norms/j-source/j_face_four_pure_hinge_heads.json': '47d234129ea10544460ed95ea172d0d566166788786a6e5325d2081c1166f05c', 'profile-notes/j-source/286-four-pure-hinges-strengthen-the-complete-j-source.md': '09b407e5e8fba32d00a72cf9c32e37e320c776c09a501274ed515f28b98c071c'}
...
def inputs(base):
    ...
    prior=module('pure_hinge_comparison285',base/'frontier/j-source/j_face_exact_retained_factorial_complete_moment_cost_comparison.py')
    ...
    old=read('j-source/j_face_exact_retained_factorial_complete_moment_cost_comparison')
    heads=read('j-source/j_face_four_pure_hinge_heads')
    pins=dict(data['pins'])
