...
def calculate(base):
    ...
    j = module('joint_j_source', base/'frontier/j-source/j_face_coupled_seven_heads.py')
    moment = module('joint_j_moments', base/'frontier/j-source/j_face_shared_square_factorial.py')
