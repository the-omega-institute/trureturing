...
def make_lp(base, j, original):
 old = original
 exact = module("j_pair_exact_dual", base/"frontier/transport/retained135_heavy_comparison.py")
...
def calculate(base,bank=None,proposer=None):
    ...
    core=module('j_pair_core244',base/'frontier/j-source/j_face_joint_selected_heads.py')
    ...
    prior,original=read('j-source/j_face_joint_selected_heads'),read('j-source/j_face_coupled_seven_heads')
    pins=dict(PINS)
    ...
    j=module('j_pair_source',base/'frontier/j-source/j_face_coupled_seven_heads.py')
    ...
    codec=module('j_pair_dual_codec',base/'frontier/transport/retained135_heavy_comparison.py')
...
def main():
    ...
    core=module('j_pair_json',args.base/'frontier/j-source/j_face_joint_selected_heads.py')
    stored=json.loads(io.read_artifact_bytes(args.base/CERTIFICATE),object_pairs_hook=core.unique)
    codec=module('j_pair_read_dual_codec',args.base/'frontier/transport/retained135_heavy_comparison.py')
