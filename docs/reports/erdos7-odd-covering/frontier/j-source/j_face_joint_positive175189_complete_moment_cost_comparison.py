...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_joint_positive175189_complete_moment_cost_comparison.json'
PINS = {'frontier/j-source/j_face_exact_seven_factorial_complete_moment_cost_comparison.py': '904bcba77e3d5232f54c8337b77d4c61235a14e49dd06bd6e70a9e0b63ecb9ee', 'certificates/source_norms/j-source/j_face_exact_seven_factorial_complete_moment_cost_comparison.json': '65275ebc52c7b9c45e59fdd9350c7bc3702367ab68d6885fdc2b5155e2ea52fc', 'profile-notes/j-source/295-the-exact-seven-factorial-head-improves-the-complete-j-comparison.md': 'd1961dd1e1a55796efc2b40a2878366f076084709b8bc7a5767e8504d632621a', 'frontier/j-source/j_face_joint_positive175189_survival_heads.py': '40bee064efabe029dc3a5e0ed555e14dacc0261796a869cb4baec47fff745e5a', 'certificates/source_norms/j-source/j_face_joint_positive175189_survival_heads.json': '6a8c5e880ef7026ec231a6ddd57d5c678b9a1e9244ce0bd0acc1492651e26c11', 'profile-notes/j-source/296-joint-positive175189-strengthens-the-complete-j-survival-hinge.md': '5f0543de796b13530f2cae3f268665c5a1c83325af563bfb0787efd0521b51e3'}
...
def inputs(base):
    ...
    prior=module('joint_positive175189_comparison295',base/'frontier/j-source/j_face_exact_seven_factorial_complete_moment_cost_comparison.py')
    ...
    old=read('j-source/j_face_exact_seven_factorial_complete_moment_cost_comparison')
    heads=read('j-source/j_face_joint_positive175189_survival_heads');pins=dict(data['pins'])
