...
def inputs(base):
    ...
    docs = {name: read('certificates/source_norms/j-source/'+name+'.json') for name in SOURCES}
    pins = dict(PINS)
    ...
    provider = module('j_moment_cost_heads', base/'frontier/j-source/j_face_complete_survival_linear_heads.py')
