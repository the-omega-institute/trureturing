...
def inputs(B):
    ...
    core=module('retained375_ap11_core',B/'frontier/j-source/j_face_joint_selected_heads.py')
    read=lambda n:json.loads(io.read_artifact_bytes(B/'certificates/source_norms'/(n+'.json')),object_pairs_hook=core.unique)
    p288=read('j-source/j_face_retained375_survival_heads');p266=read('j-source/j_face_second_depth_survival_heads')
    pins=dict(PINS)
    ...
    provider=module('retained375_ap11_model288',B/'frontier/j-source/j_face_retained375_survival_heads.py')
    ...
    p264=read('j-source/j_face_triple_second_depth_heads')
    ...
    second=module('retained375_ap11_second',B/'frontier/j-source/j_face_second_depth_retained_heads.py')
...
def main():
    ...
    io=module('retained375_ap11_read',args.base/'certificate_io.py');core=module('retained375_ap11_json',args.base/'frontier/j-source/j_face_joint_selected_heads.py')
    codec=module('retained375_ap11_codec',args.base/'frontier/transport/retained135_heavy_comparison.py')
