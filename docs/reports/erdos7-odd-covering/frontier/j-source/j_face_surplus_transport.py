...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_surplus_transport.json'
PINS = {
...
def calculate(base):
    ...
    constructor = module('j_surplus_constructor', base/'frontier/sharp_source_mass_endpoints.py')
