...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_joint_complete_moment_cost_comparison.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j-source/j_face_complete_moment_cost_comparison.py': 'a23f810a74c181109fa015021ba47d43344934cffde999230294ddafc8dbea90', 'certificates/source_norms/j-source/j_face_complete_moment_cost_comparison.json': 'ec95fd198817e07921bfa5820ca480292dc1c28b48ec65a5c5c915b53bc25ef1', 'frontier/j-source/j_face_joint_selected_heads.py': '4b244d4008d7cfe0025888192b8ed8a412a8f51509133d0b04208bcd6b47ad2c', 'certificates/source_norms/j-source/j_face_joint_selected_heads.json': '434cd2865b3a61e19ecba395787420bc45d5c4b1da6a6831e93675109ef07a97', 'frontier/j-source/j_face_joint_retained_square.py': '201c771c42af3f979eb6271152285ca2c250430a42de3ea7122d0f5c383b58a8', 'certificates/source_norms/j-source/j_face_joint_retained_square.json': 'f99a644a80049cd10278e27000b486927a96a0bf9c22c08c9da4f6c9a8081c4d', 'profile-notes/j-source/243-all-original-j-costs-have-exact-moment-envelopes-and-a-method-boundary.md': '18aa7ed452e43aae67ec1c56a964eca18c058e12e678edbb45bcb430516ce8f2', 'profile-notes/j-source/245-the-actual-j-survivor-mass-and-h-column-sharpen-the-complete-square.md': 'f2623f36d5ffbf88014517bfb77fce964e2b603ed8711333a6823412f275b4ef'}
...
def inputs(base):
    ...
    previous = module('joint_j_envelope_previous', base/'frontier/j-source/j_face_complete_moment_cost_comparison.py')
    ...
    old = read('j-source/j_face_complete_moment_cost_comparison')
    heads, square = read('j-source/j_face_joint_selected_heads'), read('j-source/j_face_joint_retained_square')
    original_heads = read('j-source/j_face_coupled_seven_heads')
