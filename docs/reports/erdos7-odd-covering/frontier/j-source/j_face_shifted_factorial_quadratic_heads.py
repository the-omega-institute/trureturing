...
CERTIFICATE='certificates/source_norms/j-source/j_face_shifted_factorial_quadratic_heads.json'
PINS={'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j-source/j_face_second_depth_retained_heads.py': '68aa156b9b1dae28a0f8e3fb728f67fd206b626db750429b7d97500aea7724c2', 'certificates/source_norms/j-source/j_face_second_depth_retained_heads.json': '6f8e8a51ba0a93a43e92d93ae78ed3bdc12130e45bf65ada8a42b961113365c3', 'profile-notes/j-source/256-a-second-seven-depth-sharpens-the-complete-retained-j-heads.md': '7d5a1682763f9f1441817deb5d7359349c7d0230a0fe62c8064e1412a8e25d08', 'frontier/j-source/j_face_raw_prime_path_pairs.py': '36c4aa22fd8f6f4f2bee83830732b4204c7ff6cbb3752afd4c7651ebac136eb6', 'certificates/source_norms/j-source/j_face_raw_prime_path_pairs.json': '105f51d319fb0393d2e34eb3d19529b29ba6003b63d81d9d34ef7f4b55596587', 'profile-notes/j-source/265-complete-raw-prime-paths-improve-the-positive-seven-pair-block.md': 'cc91751095a08bf950d5acfc4b5f76cd04b48d7b2b7a190468c61a91a233d9a0', 'frontier/j-source/j_face_triple_raw_path_complete_moment_cost_comparison.py': '631f9b1381738db660166b9183c07b9cde6fe4e34d801061f229d2e7ba7f230e', 'certificates/source_norms/j-source/j_face_triple_raw_path_complete_moment_cost_comparison.json': '99032bc2917344db5c67e3561797868225f893f7d9e3102dc37c26423f307d12', 'frontier/whole_quadratic_same_head.py': 'd447341c1887a1be5aae4ce46aa3405f594617929d7c8aa776a4b6032668d7a2'}
INDICES=(41,47,48)
...
def calculate(base,bank,seed_rows):
    ...
    io=module('shifted_io',base/'certificate_io.py');core=module('shifted_core244',base/'frontier/j-source/j_face_joint_selected_heads.py')
    ...
    prior244,prior251,source256,source265,comparison=(read('j-source/j_face_joint_selected_heads'), read('j-source/j_face_retained135125_heads'), read('j-source/j_face_second_depth_retained_heads'), read('j-source/j_face_raw_prime_path_pairs'), read('j-source/j_face_triple_raw_path_complete_moment_cost_comparison'))
    pins=dict(PINS)
    ...
    j=module('shifted_source',base/'frontier/j-source/j_face_coupled_seven_heads.py');pair=module('shifted_pair',base/'frontier/j-source/j_face_retained135125_heads.py')
    depth=module('shifted_depth_formula',base/'frontier/transport/second_depth_seven_comparison.py');second=module('shifted_scanner',base/'frontier/j-source/j_face_second_depth_retained_heads.py')
    moment=module('shifted_moments',base/'frontier/j-source/j_face_shared_square_factorial.py');quad=module('shifted_expansion',base/'frontier/whole_quadratic_same_head.py')
    inventory=module('shifted_inventory',base/'frontier/source_barrier_saturation.py');engine=inventory.Experiment(base)
...
def main():
    ...
    io=module('shifted_reader',args.base/'certificate_io.py');core=module('shifted_json',args.base/'frontier/j-source/j_face_joint_selected_heads.py')
    if args.write:
        ...
        codec=module('shifted_codec',args.base/'frontier/transport/retained135_heavy_comparison.py')
