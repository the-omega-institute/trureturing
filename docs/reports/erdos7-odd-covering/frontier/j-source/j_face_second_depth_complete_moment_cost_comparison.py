...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_second_depth_complete_moment_cost_comparison.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j-source/j_face_raw_square_complete_moment_cost_comparison.py': '98b5eb415f5595be18d3785e9f01bd3284cd56966309a860e73c0af4dd73cf6c', 'certificates/source_norms/j-source/j_face_raw_square_complete_moment_cost_comparison.json': 'e7ec15111e1f8a3b756f3ece42a7f954835e63ceeb0ae37a9ba24dfcc16fe9d9', 'profile-notes/j-source/259-one-complete-raw-source-pair-bound-improves-the-full-j-comparison.md': '768ca756430bf586fe38c237950b32efbbd98d970a884cbd07bad765e3f5e3fb', 'frontier/j-source/j_face_second_depth_retained_heads.py': '68aa156b9b1dae28a0f8e3fb728f67fd206b626db750429b7d97500aea7724c2', 'certificates/source_norms/j-source/j_face_second_depth_retained_heads.json': '6f8e8a51ba0a93a43e92d93ae78ed3bdc12130e45bf65ada8a42b961113365c3', 'profile-notes/j-source/256-a-second-seven-depth-sharpens-the-complete-retained-j-heads.md': '7d5a1682763f9f1441817deb5d7359349c7d0230a0fe62c8064e1412a8e25d08'}
...
def inputs(base):
    ...
    prior_module = module('second_depth_j_envelope_previous', base/'frontier/j-source/j_face_raw_square_complete_moment_cost_comparison.py')
    ...
    old = read('j-source/j_face_raw_square_complete_moment_cost_comparison')
    heads = read('j-source/j_face_second_depth_retained_heads')
    pins = dict(data['pins'])
