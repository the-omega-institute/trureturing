...
CERTIFICATE='certificates/source_norms/j-source/j_face_exact_retained_factorial_head.json'
PINS={
 'frontier/j-source/j_face_joint_pair_factorial_heads.py':'323a21c1a77cb8030be4e860f69e2c42882c4c749259797f4c04e3e249aaa993',
 'certificates/source_norms/j-source/j_face_joint_pair_factorial_heads.json':'503746ba3ecb18cce6255c74414a8e416e3331edc1fd4b8befff283b3faec9df',
 'profile-notes/j-source/276-actual-retained-tail-pairs-strengthen-original-j-costs-and-square.md':'b2c05708f6be7b6404052e504369148505736859b021ec72679cad7ebdc70a8c'}
...
def inputs(base):
 source=module('exact_retained_source276',base/'frontier/j-source/j_face_joint_pair_factorial_heads.py')
...
def main():
 ...
 io=module('exact_retained_io',args.base/'certificate_io.py');core=module('exact_retained_json',args.base/'frontier/j-source/j_face_joint_selected_heads.py')
 ...
 codec=module('exact_retained_codec',args.base/'frontier/transport/retained135_heavy_comparison.py')
