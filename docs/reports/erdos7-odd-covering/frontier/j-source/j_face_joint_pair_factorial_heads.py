...
PINS={'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j-source/j_face_generalized_factorial_heads.py': '2f72e4846ec7755585602ec801400289302503211d87d1c2a0506d447a7429ee', 'certificates/source_norms/j-source/j_face_generalized_factorial_heads.json': '95df26743561df015c6a50023521261aafdcdabc25b4ffe2101c5cbf6e054623', 'profile-notes/j-source/274-generalized-factorial-thresholds-strengthen-two-original-j-costs.md': '6c60b8ddff1c1d978636cb6bd183cabbbbc23fdb6769db84791aaf71b508674d', 'frontier/j-source/j_face_generalized_factorial_complete_moment_cost_comparison.py': 'a5ec3d454ed3bd32e421b8e3cf02850095ad92a20c5c352493b9ec992e2577f3', 'certificates/source_norms/j-source/j_face_generalized_factorial_complete_moment_cost_comparison.json': 'fe405af2da19e9f9445aab41cdc9130e9e0b2cbdada18fc3efa819bcf38d3826', 'profile-notes/j-source/275-generalized-factorial-observations-improve-the-complete-j-comparison.md': 'cd259f91d6f3b47f919481605e5a7c1672058ac8bbcfd1fad4ee7643c8ef5182', 'frontier/j-source/j_face_raw_prime_path_pairs.py': '36c4aa22fd8f6f4f2bee83830732b4204c7ff6cbb3752afd4c7651ebac136eb6', 'certificates/source_norms/j-source/j_face_raw_prime_path_pairs.json': '105f51d319fb0393d2e34eb3d19529b29ba6003b63d81d9d34ef7f4b55596587', 'profile-notes/j-source/265-complete-raw-prime-paths-improve-the-positive-seven-pair-block.md': 'cc91751095a08bf950d5acfc4b5f76cd04b48d7b2b7a190468c61a91a233d9a0'}
...
def inputs(base):
    ...
    io=module('joint_pair_io',base/'certificate_io.py');core=module('joint_pair_core',base/'frontier/j-source/j_face_joint_selected_heads.py')
    ...
    prior244,prior251,source258,source265,source274,comparison=(read('j-source/j_face_joint_selected_heads'), read('j-source/j_face_retained135125_heads'), read('j-source/j_face_coherent_positive7_pairs'), read('j-source/j_face_raw_prime_path_pairs'), read('j-source/j_face_generalized_factorial_heads'), read('j-source/j_face_generalized_factorial_complete_moment_cost_comparison'))
    pins=dict(PINS)
    ...
    j=module('joint_pair_j',base/'frontier/j-source/j_face_coupled_seven_heads.py');pair=module('joint_pair_retained',base/'frontier/j-source/j_face_retained135125_heads.py')
    depth=module('joint_pair_depth',base/'frontier/transport/second_depth_seven_comparison.py');second=module('joint_pair_second',base/'frontier/j-source/j_face_second_depth_retained_heads.py')
    moment=module('joint_pair_moment',base/'frontier/j-source/j_face_shared_square_factorial.py');shift=module('joint_pair_shift',base/'frontier/j-source/j_face_shifted_factorial_quadratic_heads.py')
    generalized=module('joint_pair_generalized',base/'frontier/j-source/j_face_generalized_factorial_heads.py')
    ...
    raw_paths=module('joint_pair_raw_paths',base/'frontier/j-source/j_face_raw_prime_path_pairs.py')
    joint=module('joint_pair_head',base/'frontier/j-source/j_face_joint_retained_square.py')
    coherent=module('joint_pair_coherent',base/'frontier/j-source/j_face_coherent_positive7_pairs.py')
...
def main():
    ...
    io=module('joint_pair_reader',args.base/'certificate_io.py');core=module('joint_pair_json',args.base/'frontier/j-source/j_face_joint_selected_heads.py')
    ...
    codec=module('joint_pair_codec',args.base/'frontier/transport/retained135_heavy_comparison.py')
