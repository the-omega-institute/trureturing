...
def build(base):
 source=module('aligned375_original288',base/'frontier/j-source/j_face_retained375_survival_heads.py');d=source.make_extended_model(base)
...
def coefficients(base,name):
 ...
 prior=json.loads(io.read_artifact_bytes(base/'certificates/source_norms/j-source/j_face_coupled_seven_heads.json'),object_pairs_hook=io._unique)
