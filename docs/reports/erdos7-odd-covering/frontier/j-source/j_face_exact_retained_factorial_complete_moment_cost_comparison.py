...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_exact_retained_factorial_complete_moment_cost_comparison.json'
PINS = {'frontier/j-source/j_face_triple_pair_complete_moment_cost_comparison.py': '1377c85a9e48cb0b9aa0c57cebacc5fdda05d8fb3735b93d2d965292d5613c61', 'certificates/source_norms/j-source/j_face_triple_pair_complete_moment_cost_comparison.json': '75bff1f96efb1dcfee0b687c67425eb94d3603a7cf3a1a3394c28aaa246f5f40', 'profile-notes/j-source/283-seven-retained-old-labels-improve-the-complete-j-comparison.md': '3cfb62258684351c5011042bf6e63c6b71336b20b130e81b35d56856e1f491c0', 'frontier/j-source/j_face_exact_retained_factorial_head.py': '9b0771ef3004955019241135e79740f07771369a7da1052d20b122c1797b0799', 'certificates/source_norms/j-source/j_face_exact_retained_factorial_head.json': '1738b1fe9276a0b3014bc783fdf210804c3f3c108a19af27497fa94aee494f90', 'profile-notes/j-source/284-exact-retained-head-and-slope-sharpen-the-complete-j-factorial.md': 'bdc09c5f1ceb7b9f92640c3f45b191b45b8fec9812267b5b327609b9ddbcdc3e'}
...
def inputs(base):
    ...
    prior=module('exact_retained_comparison283',base/'frontier/j-source/j_face_triple_pair_complete_moment_cost_comparison.py')
    ...
    old=read('j-source/j_face_triple_pair_complete_moment_cost_comparison')
    heads=read('j-source/j_face_exact_retained_factorial_head')
    pins=dict(data['pins'])
