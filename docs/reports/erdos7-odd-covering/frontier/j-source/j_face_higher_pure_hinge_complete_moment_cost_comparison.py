...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_higher_pure_hinge_complete_moment_cost_comparison.json'
PINS = {'frontier/j-source/j_face_retained375_complete_moment_cost_comparison.py': '2e62c298a73e0b16ef733eaf4243ea87c5b3f64c1e7fa08013f43a77e3ec7c00', 'certificates/source_norms/j-source/j_face_retained375_complete_moment_cost_comparison.json': '8244aa0a393d1983d0b2610bb3bd75a7721fedc31a4a41dc1401a69e407a3f26', 'profile-notes/j-source/289-retaining375-improves-the-complete-j-comparison.md': '057be4bf68cc1012c1f233b4a675360a07a6553a46886a84510d7c991db9e9f9', 'frontier/j-source/j_face_higher_pure_hinge_heads.py': 'f388683fd5c8ae9e0632e504bab8c50d967a9ecc5076242f8fda3c416fd3d084', 'certificates/source_norms/j-source/j_face_higher_pure_hinge_heads.json': '18bf323ed3c28a49f3cf430f438a03ae5168007dde754b6cf9e6579ddec5ee49', 'profile-notes/j-source/290-two-higher-pure-hinges-strengthen-the-complete-j-source.md': 'd2ab3e3fc3e3becf27b53802daeb3f898ee9a297e0481406d5f23cb099a11054'}
...
def inputs(base):
    ...
    prior=module('higher_hinge_comparison289',base/'frontier/j-source/j_face_retained375_complete_moment_cost_comparison.py')
    ...
    old=read('j-source/j_face_retained375_complete_moment_cost_comparison')
    heads=read('j-source/j_face_higher_pure_hinge_heads')
    pins=dict(data['pins'])
