...
THRESHOLDS=(2,3)
PINS={'frontier/j-source/j_face_joint_pair_factorial_heads.py': '323a21c1a77cb8030be4e860f69e2c42882c4c749259797f4c04e3e249aaa993', 'certificates/source_norms/j-source/j_face_joint_pair_factorial_heads.json': '503746ba3ecb18cce6255c74414a8e416e3331edc1fd4b8befff283b3faec9df', 'profile-notes/j-source/276-actual-retained-tail-pairs-strengthen-original-j-costs-and-square.md': 'b2c05708f6be7b6404052e504369148505736859b021ec72679cad7ebdc70a8c', 'frontier/j-source/j_face_joint_pair_factorial_complete_moment_cost_comparison.py': 'fb833a2a2d19c9e97c407ac1f2a9a438de09f357e791f2e3cf353312b5a5e97d', 'certificates/source_norms/j-source/j_face_joint_pair_factorial_complete_moment_cost_comparison.json': 'a7b6639d73e6cc52d59857209233ba35b8a5592f6a2283de9c20d810afd99671', 'profile-notes/j-source/277-actual-retained-pairs-improve-the-complete-j-comparison.md': '2cd4609852b1f1018905fd84f02a833ed24d878648bb14712e60d2f693b8003e'}
...
def inputs(base):
    source=module('pure_low_source276',base/'frontier/j-source/j_face_joint_pair_factorial_heads.py')
    ...
    heads=read('j-source/j_face_joint_pair_factorial_heads');comparison=read('j-source/j_face_joint_pair_factorial_complete_moment_cost_comparison')
    pins=dict(data['pins'])
    ...
    previous=module('pure_low_comparison277',base/'frontier/j-source/j_face_joint_pair_factorial_complete_moment_cost_comparison.py')
...
def main():
    ...
    io=module('pure_low_io',args.base/'certificate_io.py');core=module('pure_low_json',args.base/'frontier/j-source/j_face_joint_selected_heads.py')
    ...
    codec=module('pure_low_codec',args.base/'frontier/transport/retained135_heavy_comparison.py')
