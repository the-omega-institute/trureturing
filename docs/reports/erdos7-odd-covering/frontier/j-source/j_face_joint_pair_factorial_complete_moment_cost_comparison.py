...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_joint_pair_factorial_complete_moment_cost_comparison.json'
PINS = {'frontier/j-source/j_face_generalized_factorial_complete_moment_cost_comparison.py': 'a5ec3d454ed3bd32e421b8e3cf02850095ad92a20c5c352493b9ec992e2577f3', 'certificates/source_norms/j-source/j_face_generalized_factorial_complete_moment_cost_comparison.json': 'fe405af2da19e9f9445aab41cdc9130e9e0b2cbdada18fc3efa819bcf38d3826', 'profile-notes/j-source/275-generalized-factorial-observations-improve-the-complete-j-comparison.md': 'cd259f91d6f3b47f919481605e5a7c1672058ac8bbcfd1fad4ee7643c8ef5182', 'frontier/j-source/j_face_joint_pair_factorial_heads.py': '323a21c1a77cb8030be4e860f69e2c42882c4c749259797f4c04e3e249aaa993', 'certificates/source_norms/j-source/j_face_joint_pair_factorial_heads.json': '503746ba3ecb18cce6255c74414a8e416e3331edc1fd4b8befff283b3faec9df', 'profile-notes/j-source/276-actual-retained-tail-pairs-strengthen-original-j-costs-and-square.md': 'b2c05708f6be7b6404052e504369148505736859b021ec72679cad7ebdc70a8c'}
...
def inputs(base):
    ...
    prior_module = module('joint_pair_factorial_j_envelope_previous', base/'frontier/j-source/j_face_generalized_factorial_complete_moment_cost_comparison.py')
    ...
    old = read('j-source/j_face_generalized_factorial_complete_moment_cost_comparison')
    heads = read('j-source/j_face_joint_pair_factorial_heads')
    pins = dict(data['pins'])
