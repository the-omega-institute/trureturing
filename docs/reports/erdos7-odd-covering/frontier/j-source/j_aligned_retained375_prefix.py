...
aligned=module('aligned375_prefix_actual',B/'frontier/j-source/j_aligned_joint_selected_heads.py')
...
depth=module('aligned375_prefix_two_depth',B/'frontier/transport/second_depth_seven_comparison.py');trip=module('aligned375_prefix_affine_min',B/'frontier/j-source/j_face_triple_second_depth_heads.py')
