...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_coupled_seven_heads.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j-source/j_face_alignment.py': 'a784f2de6cb88d9b6ae8cdce4d2fe7ad513354ea9d9971999df6cf1c781309eb', 'certificates/source_norms/j-source/j_face_alignment.json': '6874e71b0846d973fedd330f5a8a54bfa457b2cdfe896943db407b8d89bec611', 'profile-notes/j-source/130-the-whole-j-face-forces-source-anti-alignment.md': '8691917a65ffd00f27dd3e81deb07717cc7b012be5fb1cc5a8337f9da0a66990', 'frontier/k_face_common_seven_hinges.py': '8cc4600c9b3f2f65a11820fcb2d0d6663c765c20765bbaf1ae0de6e883cefc97', 'profile-notes/transport/201-two-more-seven-labels-and-selected-intersections-control-both-heavy-costs.md': '2e78cd791bbbfbbe3ffbcb2be6845e02fdbbe2bbd17e06b9e7151e3ddd23cb5d'}
ROOT = (0, 0, 1, 1, 1)
ETA = (F(1, 18),)+(F(1, 9),)*4
...
def calculate(base):
    ...
    face = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/j-source/j_face_alignment.json'))
    pins = dict(PINS)
