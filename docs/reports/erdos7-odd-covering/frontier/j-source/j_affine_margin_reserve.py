...
CERTIFICATE = 'certificates/source_norms/j-source/j_affine_margin_reserve.json'
PINS = {
    'certificates/source_norms/j-source/j_family_error_reserve.json': '47c7a26d7a9268b3dc569c98a2eb95c4dd78912a13a8bd312ad7671cf1ff527f',
    ...
    'frontier/j-source/j_family_error_reserve.py': '26f0b731e49d9adbf42d7779a35727299af6b0f63b9539dac957f9ea1785beaa',
    ...
    'profile-notes/j-source/130-the-whole-j-face-forces-source-anti-alignment.md': '8691917a65ffd00f27dd3e81deb07717cc7b012be5fb1cc5a8337f9da0a66990',
    ...
    'profile-notes/j-source/197-the-whole-j-reserve-keeps-each-original-family-error.md': '7fc55210d865aafb8f6f9e490f7cafd11fd746c0218858e4abfd928acc2d043c',
}
B = (2, 3, 1, 1, 1)
C = (1, 2, 2, 2, 2)
...
def calculate(base):
    ...
    family = module('j_affine_family', base/'frontier/j-source/j_family_error_reserve.py')
    prior = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/j-source/j_family_error_reserve.json'))
    pins = dict(PINS)
