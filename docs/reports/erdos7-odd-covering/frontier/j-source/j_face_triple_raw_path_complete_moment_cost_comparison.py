...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_triple_raw_path_complete_moment_cost_comparison.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j-source/j_face_second_depth_survival_complete_moment_cost_comparison.py': '3614a0fdea5284c161b83620efeeb09155f866aa36f740c0a6645f8f9f18ed47', 'certificates/source_norms/j-source/j_face_second_depth_survival_complete_moment_cost_comparison.json': 'bff4c6deb07df70d6c209bb8ce56590b801aacd21219183860cd05efd68fc4d6', 'profile-notes/j-source/267-two-second-depth-survival-bounds-improve-the-full-j-comparison.md': '24bf3c4019fedd32a02c2120a1cfa3603304456ef5a6160243d1ac466f68babc', 'frontier/j-source/j_face_triple_second_depth_heads.py': 'c6c1f5dc4a06a9a16bb6291abaea28e08a3c7fb776edfff55e226bb723954f3a', 'certificates/source_norms/j-source/j_face_triple_second_depth_heads.json': '28efda83f17bffed4a75f49448820c118ee300a4515f807aa4fd677bc3ea8743', 'profile-notes/j-source/264-seven-retained-states-and-two-seven-depths-control-complete-j-heads.md': '7eadaa5f36996f8afc2af013fba2d83d27b7e581ebf667507f67483d5169550a', 'frontier/j-source/j_face_raw_prime_path_pairs.py': '36c4aa22fd8f6f4f2bee83830732b4204c7ff6cbb3752afd4c7651ebac136eb6', 'certificates/source_norms/j-source/j_face_raw_prime_path_pairs.json': '105f51d319fb0393d2e34eb3d19529b29ba6003b63d81d9d34ef7f4b55596587', 'profile-notes/j-source/265-complete-raw-prime-paths-improve-the-positive-seven-pair-block.md': 'cc91751095a08bf950d5acfc4b5f76cd04b48d7b2b7a190468c61a91a233d9a0'}
...
def inputs(base):
    ...
    prior_module = module('triple_raw_path_j_envelope_previous', base/'frontier/j-source/j_face_second_depth_survival_complete_moment_cost_comparison.py')
    ...
    old = read('j-source/j_face_second_depth_survival_complete_moment_cost_comparison')
    heads, paths = read('j-source/j_face_triple_second_depth_heads'), read('j-source/j_face_raw_prime_path_pairs')
    previous_pairs = read('j-source/j_face_coherent_positive7_pairs')
    pins = dict(data['pins'])
