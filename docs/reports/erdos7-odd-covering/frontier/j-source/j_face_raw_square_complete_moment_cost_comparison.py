...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_raw_square_complete_moment_cost_comparison.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j-source/j_face_retained_pair_complete_moment_cost_comparison.py': '6278ed544dda667794f54c47e491bd1ebca12f1906d89be4019d7177b66277e0', 'certificates/source_norms/j-source/j_face_retained_pair_complete_moment_cost_comparison.json': '2e6252cd45a6236067f2ef177b5af657173377523b12fe395f81a407d18d1daf', 'profile-notes/j-source/254-retained-original-heads-and-prime-path-square-improve-the-complete-j-comparison.md': 'f2f2ee896bb5ca4d04d075332e874ed5966392a3dfc36ad326c7461a24fc6b50', 'frontier/j-source/j_face_coherent_positive7_pairs.py': 'f84967f769452ee854be277694a28ce3fd9642cd6f01153e4888008dcb6e7dbd', 'certificates/source_norms/j-source/j_face_coherent_positive7_pairs.json': 'f6c958daf1cb450fecc67f57b1dc42877dd5548f2a22504e8a1f66ab8c887a28', 'profile-notes/j-source/258-independent-positive-seven-depths-share-one-complete-raw-source.md': '98635664883838cce644c9fc87f65736b6ecb4cbef9169f9d1a7a734658cb826'}
...
def inputs(base):
    ...
    prior_module = module('raw_square_j_envelope_previous', base/'frontier/j-source/j_face_retained_pair_complete_moment_cost_comparison.py')
    ...
    old = read('j-source/j_face_retained_pair_complete_moment_cost_comparison')
    source = read('j-source/j_face_coherent_positive7_pairs')
    pins = dict(data['pins'])
