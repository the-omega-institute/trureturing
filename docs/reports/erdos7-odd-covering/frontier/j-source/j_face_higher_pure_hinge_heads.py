...
def inputs(base):
    ...
    core=module('pure_hinge_core244',base/'frontier/j-source/j_face_joint_selected_heads.py')
    read=lambda n:json.loads(io.read_artifact_bytes(base/'certificates/source_norms'/(n+'.json')),object_pairs_hook=core.unique)
    prior244,prior251,prior256,prior264=(read('j-source/j_face_joint_selected_heads'), read('j-source/j_face_retained135125_heads'), read('j-source/j_face_second_depth_retained_heads'), read('j-source/j_face_triple_second_depth_heads'))
    pins=dict(PINS)
    ...
    j=module('pure_hinge_affine',base/'frontier/j-source/j_face_coupled_seven_heads.py')
    pair=module('pure_hinge_pair',base/'frontier/j-source/j_face_retained135125_heads.py')
    depth=module('pure_hinge_depth',base/'frontier/transport/second_depth_seven_comparison.py')
    triple=module('pure_hinge_triple264',base/'frontier/j-source/j_face_triple_second_depth_heads.py')
...
def main():
    ...
    io=module('pure_hinge_read_io',args.base/'certificate_io.py');core=module('pure_hinge_read_json',args.base/'frontier/j-source/j_face_joint_selected_heads.py')
    ...
    codec=module('pure_hinge_read_codec',args.base/'frontier/transport/retained135_heavy_comparison.py')
