...
CERTIFICATE='certificates/source_norms/j-source/j_face_generalized_factorial_heads.json'
PINS={'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j-source/j_face_shifted_factorial_quadratic_heads.py': '061736246987ea1e13481ed095915678d65038d23873691c65dc876111e11922', 'certificates/source_norms/j-source/j_face_shifted_factorial_quadratic_heads.json': 'a2005948bba60c68937a16c5d098c250384db3cb4762eb0d68151d6a9d5c2236', 'profile-notes/j-source/270-shifted-factorial-heads-strengthen-three-original-j-quadratic-costs.md': '86985ea0e016707ae868c82e8ada987c1491b75fd52e85e29752a4fd7ab55c3e', 'frontier/j-source/j_face_joint_factorial_cross_heads.py': 'ecdc89af4c5228693f3aa17211b5d13836c5f58e9f436e05b42e768527d84aba', 'certificates/source_norms/j-source/j_face_joint_factorial_cross_heads.json': 'ed567355b0475ab7f5712dca3fda30866638452efaab1bfbcadab5f3e7f33fdb', 'profile-notes/j-source/272-joint-raw-and-survivor-crosses-strengthen-three-original-j-costs.md': '410ff46a80f194974fb03f0bbf9c5b1aa6d5fccfdf4fa668d69b5c9d4f7364fe', 'frontier/j-source/j_face_joint_factorial_cross_complete_moment_cost_comparison.py': 'acb6844a1be1f260f9f9c42ae93f2bb457bcc892ebe84af8462f6c3831fb077b', 'certificates/source_norms/j-source/j_face_joint_factorial_cross_complete_moment_cost_comparison.json': 'c4bf89095799c9658d37f978acdff0e57cc2b57a67987eddf71b9e02ba860f4e', 'profile-notes/j-source/273-joint-factorial-crosses-improve-the-complete-j-comparison.md': '0de38a8be85d0dcbc0f12db543afaf0172c4b5f148d0a54f81e6f2cfb80444a9'}
TARGETS=((48,3),(49,2))
...
def calculate(base,bank,seed_rows):
    ...
    io=module('generalized_io',base/'certificate_io.py');core=module('generalized_core',base/'frontier/j-source/j_face_joint_selected_heads.py')
    ...
    prior244,prior251,source270,source272,comparison,source265=(read('j-source/j_face_joint_selected_heads'), read('j-source/j_face_retained135125_heads'), read('j-source/j_face_shifted_factorial_quadratic_heads'), read('j-source/j_face_joint_factorial_cross_heads'), read('j-source/j_face_joint_factorial_cross_complete_moment_cost_comparison'), read('j-source/j_face_raw_prime_path_pairs'))
    pins=dict(PINS)
    ...
    j=module('generalized_j',base/'frontier/j-source/j_face_coupled_seven_heads.py');pair=module('generalized_pair',base/'frontier/j-source/j_face_retained135125_heads.py')
    depth=module('generalized_depth',base/'frontier/transport/second_depth_seven_comparison.py');second=module('generalized_second',base/'frontier/j-source/j_face_second_depth_retained_heads.py')
    moment=module('generalized_moment',base/'frontier/j-source/j_face_shared_square_factorial.py');shift=module('generalized_shift',base/'frontier/j-source/j_face_shifted_factorial_quadratic_heads.py')
    quad=module('generalized_quad',base/'frontier/whole_quadratic_same_head.py');inventory=module('generalized_inventory',base/'frontier/source_barrier_saturation.py')
...
def main():
    ...
    io=module('generalized_reader',args.base/'certificate_io.py');core=module('generalized_json',args.base/'frontier/j-source/j_face_joint_selected_heads.py')
    ...
    codec=module('generalized_codec',args.base/'frontier/transport/retained135_heavy_comparison.py')
