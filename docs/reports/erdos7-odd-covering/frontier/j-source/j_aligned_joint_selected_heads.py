...
def build_source(base,namespace='aligned_source_provider'):
 ...
 j=module(namespace+'_bridge',base/'frontier/j-source/j_face_coupled_seven_heads.py')
 ...
 return {'io':io,'j':j,'head':head,'actual_source_mass':F(1,4),'actual_survivor_mass':F(413,2700),
  ...
  'source_sha256':{p:sha256(io.read_artifact_bytes(base/p)).hexdigest()for p in('frontier/j-source/j_face_coupled_seven_heads.py','frontier/k_face_common_seven_hinges.py')},
...
def build_joint(base,data):
 ...
 rawmod=module('aligned_joint_raw',base/'frontier/transport/joint_selected_source_comparison.py')
 ret=module('aligned_joint_retained',base/'frontier/transport/retained_deletion_heavy_comparison.py')
 joint=module('aligned_joint_scan',base/'frontier/j-source/j_face_joint_selected_heads.py')
...
CERTIFICATE='certificates/source_norms/j-source/j_aligned_joint_selected_heads.json'
ORIGINAL='certificates/source_norms/j-source/j_face_heavy_positive175189_complete_moment_cost_comparison.json'
SOURCES=('certificate_io.py','frontier/j-source/j_face_coupled_seven_heads.py','frontier/k_face_common_seven_hinges.py',
 'frontier/transport/joint_selected_source_comparison.py','frontier/transport/retained_deletion_heavy_comparison.py','frontier/j-source/j_face_joint_selected_heads.py',
 ORIGINAL,'profile-notes/j-source/312-an-aligned-j-source-has-a-complete-own-test-and-residual-deletion-interface.md',
 'certificates/source_norms/j-source/j_aligned_own_test_interface.json',
