...
CERTIFICATE = 'certificates/source_norms/j-source/j_face_second_cofactor_complete_moment_cost_comparison.json'
PINS = {'frontier/j-source/j_face_pure_low_factorial_complete_moment_cost_comparison.py': '921514550569b304e2a74206b33324b00c9c2453c4229d1d95d15435366e934c', 'certificates/source_norms/j-source/j_face_pure_low_factorial_complete_moment_cost_comparison.json': 'd616e44fa99d3f7ce43c174b293fae202c3e6f2d58fef1684377b7c357562978', 'profile-notes/j-source/279-two-pure-factorial-observations-improve-the-complete-j-comparison.md': '9411bda2b722ea90fa29c0a2e55146c4bcb1d329e201ab9a3511d78effa95508', 'frontier/j-source/j_face_second_cofactor_survival_heads.py': '08716687e87dec28abb26decabad8247a209f2163a78c2d1f537426295de23bb', 'certificates/source_norms/j-source/j_face_second_cofactor_survival_heads.json': '25ec9b985f8efe62f43651bf03f916ab4879874c244a1ff4a2b13281bd4c4e7b', 'profile-notes/j-source/280-second-depth-cofactors-sharpen-the-complete-j-survival-hinge.md': '0a436f77d9679c4b877782642ee808653668164a43f57a83f54922f8b52b5e75'}
...
def inputs(base):
    ...
    prior=module('second_cofactor_comparison279',base/'frontier/j-source/j_face_pure_low_factorial_complete_moment_cost_comparison.py')
    ...
    old=read('j-source/j_face_pure_low_factorial_complete_moment_cost_comparison')
    heads=read('j-source/j_face_second_cofactor_survival_heads')
    pins=dict(data['pins'])
