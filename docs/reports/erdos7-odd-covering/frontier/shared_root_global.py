...
PINS = {
    ...
    'frontier/fractional_deep_global.py': 'c1b84f5985c9981d6507486c19bb0001bba9589715b17ef50dd49bc1855bc3ee',
    'certificates/source_norms/fractional_deep_global.json': 'bee262ceb02af4833962ac3851daf5f25d78919719d1f23cc993cd8bc7702494',
}
...
def calculate(base):
    ...
    generic_module = module('shared_root_generic', base/'frontier/shared_root_imbalance_payment.py')
