...
def inputs(base):
    ...
    core=module('pure_hinge_core244',base/'frontier/j_face_joint_selected_heads.py')
    ...
    j=module('pure_hinge_affine',base/'frontier/j_face_coupled_seven_heads.py')
    pair=module('pure_hinge_pair',base/'frontier/j_face_retained135125_heads.py')
    depth=module('pure_hinge_depth',base/'frontier/second_depth_seven_comparison.py')
    triple=module('pure_hinge_triple264',base/'frontier/j_face_triple_second_depth_heads.py')
...
def main():
    ...
    io=module('pure_hinge_read_io',args.base/'certificate_io.py');core=module('pure_hinge_read_json',args.base/'frontier/j_face_joint_selected_heads.py')
    ...
    codec=module('pure_hinge_read_codec',args.base/'frontier/retained135_heavy_comparison.py')
