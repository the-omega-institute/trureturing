...
CERTIFICATE='certificates/source_norms/j_face_exact_seven_retained_factorial_head.json'
PINS={'frontier/j_face_triple_pair_factorial_heads.py': 'e026baecf5ab82b7758c26c19ad79b7b3b2c9480e121c854b7f03035ee990124', 'certificates/source_norms/j_face_triple_pair_factorial_heads.json': '9659a13167404df2aaa28a57b77e852e68d0884a43a47b2c5b3c408297f97eed', 'profile-notes/282-seven-retained-old-labels-strengthen-the-complete-j-moments.md': '2f3add302f48397de2f8a0a1f7dad51d6419ea066b36fc97e73c3a5054aaf249', 'frontier/j_face_exact_retained_factorial_head.py': 'f5b1f9291a56e284339b71d00872cd77e9c817c11e56630f0e87e75d68b971be', 'certificates/source_norms/j_face_exact_retained_factorial_head.json': 'ee49d11a11a7703a714eaafbdce8eeadbf7e5b869f0cbd8fcede96522d08647e', 'profile-notes/284-exact-retained-head-and-slope-sharpen-the-complete-j-factorial.md': '520fccbefb599bf5dd8a5a8ca9ed487f46ed8d829b0e0c1eba5c50a54fa314ec'}
...
def inputs(base):
 source=module('exact_seven_source282',base/'frontier/j_face_triple_pair_factorial_heads.py')
 exact=module('exact_seven_source284',base/'frontier/j_face_exact_retained_factorial_head.py')
...
def main():
 p=argparse.ArgumentParser(description=__doc__);p.add_argument('--base',type=Path,default=Path(__file__).resolve().parents[1])
 ...
 io=module('exact_seven_io',args.base/'certificate_io.py');core=module('exact_seven_json',args.base/'frontier/j_face_joint_selected_heads.py')
 ...
 codec=module('exact_seven_codec',args.base/'frontier/retained135_heavy_comparison.py')
