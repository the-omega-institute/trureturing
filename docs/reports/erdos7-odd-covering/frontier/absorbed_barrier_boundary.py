...
CERTIFICATE41 = 'certificates/source_norms/survival_hinge_deficit.json'
CERTIFICATE43 = 'certificates/source_norms/full_absorbed_survival_hinges.json'
PINS = {
    ...
    CERTIFICATE41: 'a81892ca70b51a8402c67ffca901c7acf57fa993b9deeccf0037b6eaaec70ff8',
    CERTIFICATE43: '3b9ac3f0a8ce3b5e11c5f32165c713cd8307f7bf09f0d49426a5f719a18fcef7',
}
ROOT = (0, 0, 1, 1, 1)
...
def calculate(base):
    ...
    fixed = module('absorbed_boundary_fixed', base/'frontier/fixed_cost.py')
    square = module('absorbed_boundary_square', base/'frontier/shared_square_barrier.py')
