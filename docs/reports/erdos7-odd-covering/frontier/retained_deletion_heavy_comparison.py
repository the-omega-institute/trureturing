...
CERTIFICATE = 'certificates/source_norms/retained_deletion_heavy_comparison.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/all_selected_survival_comparison.py': '563e82d4c289b9bf4906a64c4d4506e04ba6e6b9188434dfd040924c0cacc25a', 'certificates/source_norms/all_selected_survival_comparison.json': 'ec392f3eed2d12347ef028fe454e98e51bb2e8599ff844e4a329ec723092158d'}
...
class RetainedDeletionHead:
    ...
    def __init__(self,base,bank=None,proposer=None):
        old=module('retained_allselected',base/'frontier/all_selected_heavy_comparison.py').AllSelectedHead(base)
        ...
        self.increment=module('retained_increment',base/'frontier/second_depth_seven_comparison.py').seven_increment
