...
CERTIFICATE = 'certificates/source_norms/seven_pair_source_prices.json'
PINS = {
    'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232',
    'frontier/exposed_concentration_prices.py': 'f88ed116c813369618282d26d854047cab4b974e72ddd51520a6439eb6cde0cc',
...
def calculate(base):
    ...
    prices = module('pair_exposed', base/'frontier/exposed_concentration_prices.py')
    exposed = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/exposed_concentration_prices.json'))
    require(prices.calculate(base) == exposed, 'Exact independently verified156 exposed-price predecessor')
    previous = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/wide_k_signed_tail_comparison.json'))
    ...
    factorial = module('pair_original_series', base/'frontier/complete_off_face_factorial_tail.py')
    algebra = module('pair_source_polynomial', base/'frontier/monotone_product_carrier_mass.py')
    ...
    simple = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/uniform_single_hinge_cost_portfolio.json'))
