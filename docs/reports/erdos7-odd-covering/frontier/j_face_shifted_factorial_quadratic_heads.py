...
CERTIFICATE='certificates/source_norms/j_face_shifted_factorial_quadratic_heads.json'
PINS={'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j_face_second_depth_retained_heads.py': '02cca63e4ea4dd3771d6212351186e92e3743df171ad78ea613219b688733957', 'certificates/source_norms/j_face_second_depth_retained_heads.json': 'e9bc7201404e9c70bce6b1614b9ebe9db53e03429bfd6d0f7468679017b86c3d', 'profile-notes/256-a-second-seven-depth-sharpens-the-complete-retained-j-heads.md': 'f1f9ef68d15df741b23c880d877d3afe1e2fc6435490d0702da53b43f3a17a3b', 'frontier/j_face_raw_prime_path_pairs.py': '63563f4034949eeb4cb7c5b9bc4b4d19174939a682c60993a0a54a85a2bf651a', 'certificates/source_norms/j_face_raw_prime_path_pairs.json': '93b616897af512407e827a5b2fffacc1986261bd3dbadb71426603c837a44fd2', 'profile-notes/265-complete-raw-prime-paths-improve-the-positive-seven-pair-block.md': '33f2c477c72f36123ce1c0e44e169c10a2349c88c1d5382b7b208d2d1b93849b', 'frontier/j_face_triple_raw_path_complete_moment_cost_comparison.py': 'bd550c530fcb5c5a62209a6552902e75fb5453c19c72fa61ecf963fe2162a48b', 'certificates/source_norms/j_face_triple_raw_path_complete_moment_cost_comparison.json': '9780db28c918bebf7b5afab2d73fcffa125e2feb70bc4a43364763c794d387cf', 'frontier/whole_quadratic_same_head.py': 'd447341c1887a1be5aae4ce46aa3405f594617929d7c8aa776a4b6032668d7a2'}
INDICES=(41,47,48)
...
def calculate(base,bank,seed_rows):
    ...
    io=module('shifted_io',base/'certificate_io.py');core=module('shifted_core244',base/'frontier/j_face_joint_selected_heads.py')
    ...
    j=module('shifted_source',base/'frontier/j_face_coupled_seven_heads.py');pair=module('shifted_pair',base/'frontier/j_face_retained135125_heads.py')
    depth=module('shifted_depth_formula',base/'frontier/second_depth_seven_comparison.py');second=module('shifted_scanner',base/'frontier/j_face_second_depth_retained_heads.py')
    moment=module('shifted_moments',base/'frontier/j_face_shared_square_factorial.py');quad=module('shifted_expansion',base/'frontier/whole_quadratic_same_head.py')
...
def main():
    ...
    io=module('shifted_reader',args.base/'certificate_io.py');core=module('shifted_json',args.base/'frontier/j_face_joint_selected_heads.py')
    if args.write:
        ...
        codec=module('shifted_codec',args.base/'frontier/retained135_heavy_comparison.py')
