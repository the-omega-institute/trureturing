...
CERTIFICATE = 'certificates/source_norms/pure_axis_joint_square_comparison.json'
PINS = {
    ...
    'certificates/source_norms/pure_three_joint_factorial_comparison.json': '7b564052f48c7537a651e66152d876625590c4c6f293888783ddf52b4302fe91',
    'frontier/pure_axis_cross_sharpness.py': 'f8bcc4453d6820d1ca09368cfa1dca16dace9897ac94e28e2b9e7a5e17285a06',
    'certificates/source_norms/pure_axis_cross_sharpness.json': 'c64797b8d866fad577fa51741aa76937ff051004fc0b32c2717acaaee1edfe52',
    ...
    'profile-notes/128-the-complete-factorial-tail-retains-its-head-off-the-face.md': '9c070de9ab953772260c316b96846a874c5799449d0fa4baf72d90d6b33df4e3',
}
...
def calculate(base):
    ...
    load = lambda name: module('axis_joint_'+name, base/'frontier'/(name+'.py'))
