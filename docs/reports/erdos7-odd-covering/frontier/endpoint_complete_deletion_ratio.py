...
CERTIFICATE = 'certificates/source_norms/endpoint_complete_deletion_ratio.json'
PINS = {
    ...
    "frontier/endpoint_uniform_ratio.py": "01b04bb7ac52312ab899b41f5554952aec6d773d1274de61e66a62c06500a0e5",
    ...
    "frontier/endpoint_linear_complete_pure3_deletion.py": "ee5128c888a2b6aa4da69e1a4e400cd6f04f1442ec1787079cf48061821543b5",
    "certificates/source_norms/endpoint_linear_complete_pure3_deletion.json": "12c26bbc7bc9409437d86637e42ad4c7c92e314396c2e04e13b816e3cb4f5482"
}
...
def calculate(base):
    ...
    old = read('certificates/source_norms/endpoint_uniform_ratio.json')
    survival = read('certificates/source_norms/endpoint_survival_scalar_barrier.json')
    geometry = read('certificates/source_norms/endpoint_linear_complete_pure3_deletion.json')
