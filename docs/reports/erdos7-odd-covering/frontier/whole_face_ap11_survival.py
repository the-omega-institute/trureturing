...
CERTIFICATE = 'certificates/source_norms/whole_face_ap11_survival.json'
PINS = {
...
def calculate(base):
    ...
    previous = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/whole_face_stop_loss_generator.json'))
