...
CERTIFICATE = 'certificates/source_norms/shared_root_imbalance_payment.json'
PINS = {
...
def calculate(base):
    ...
    previous = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/tied_root_deep_payment.json'))
    for path, pin in previous['source_sha256'].items():
        ...
        used[path] = pin
    generic = module('shared_root_previous', base/'frontier/tied_root_deep_payment.py')
