...
def old_face_caps(base):
    ...
    allocated = module('k_hinge_old_allocated', base/'frontier/allocated_seven_thresholds.py')
...
def calculate(base):
    ...
    previous = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/endpoint_k_face_linear.json'))
