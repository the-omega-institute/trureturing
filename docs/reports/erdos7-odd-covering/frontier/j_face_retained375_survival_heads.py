...
def make_extended_model(B):
    ...
    io=load('certificate_io');triple=load('frontier/j_face_triple_second_depth_heads');core=load('frontier/j_face_joint_selected_heads')
    j=load('frontier/j_face_coupled_seven_heads');pair=load('frontier/j_face_retained135125_heads');depth=load('frontier/second_depth_seven_comparison');codec=load('frontier/retained135_heavy_comparison')
...
def calculate(B,bank,seed):
    ...
    oldpath='certificates/source_norms/j_face_second_cofactor_survival_heads.json'
...
def main():
    ...
    io=module('retained375_read',args.base/'certificate_io.py');codec=module('retained375_codec',args.base/'frontier/retained135_heavy_comparison.py')
