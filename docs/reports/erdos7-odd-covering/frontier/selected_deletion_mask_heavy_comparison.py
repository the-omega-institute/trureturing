...
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232',
        ...
        'frontier/retained_deletion_survival_comparison.py': '0d56bf5eadba26f34b6164dd371669945df2486ca0c11e3590726851d78e0d9a',
        'certificates/source_norms/retained_deletion_survival_comparison.json': '4357687d465da4827c160195fcd83e9efd0a7c52aa39d15e9443cf5d8960bd07',
...
def mask_head_class(base):
    parent = module('selected_mask_parent', base/'frontier/retained_deletion_heavy_comparison.py')
    whole = module('selected_mask_whole', base/'frontier/retained_deletion_survival_comparison.py')
...
def calculate(base, bank=None, proposer=None):
    ...
    prior = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/retained_deletion_survival_comparison.json'))
    pins = dict(PINS)
...
def main():
    ...
    parent = module('selected_mask_bank', args.base/'frontier/retained_deletion_heavy_comparison.py')
