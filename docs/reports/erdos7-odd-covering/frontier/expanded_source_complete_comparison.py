...
CERTIFICATE = 'certificates/source_norms/expanded_source_complete_comparison.json'
HEAD_CERTIFICATE = 'certificates/source_norms/expanded_source_original_heads.json'
...
def calculate(base, scan=False, write_heads=False):
    ...
    study = module('expanded_study', base/'frontier/k_neighborhood_radius_study.py').Study(base)
