...
CERTIFICATE = 'certificates/source_norms/finite_source_face_transport.json'
PINS = {
...
def calculate(base):
    ...
    old = module('finite_transport_capacity', base/'frontier/broad_weighted_identity_source.py')
    source = module('finite_transport_source', base/'verify_joint_frontier.py')
    face = module('finite_transport_face', base/'frontier/k_face_common_seven_hinges.py')
