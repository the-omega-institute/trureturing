...
CERTIFICATE = 'certificates/source_norms/shared_slot_gap_global.json'
PINS = {
    'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232',
    'frontier/carrier_mass_global.py': 'e8c3e38833a489c9ee4f45c542d13e00db34be0508ceca1fecf3084342f1860b',
    'certificates/source_norms/carrier_mass_global.json': '163e3c41bba73362700301426a1c73d4f9b32b3a5ed4d12b72f8f53d6ffd1789',
    'frontier/shared_slot_defect_polytope.py': '1a446fff159409f550589f55e74ca34176773abf4192c20098a4e15aff87956b',
    'certificates/source_norms/shared_slot_defect_polytope.json': '72fb2a937f662f244edd0830d430c69f16c82d244e94f01181dfb87f4bff6e45',
}
...
def calculate(base):
    ...
    read = lambda name: json.loads(io.read_artifact_bytes(base/'certificates/source_norms'/name))
    used = dict(PINS)
    ...
    for prior in (previous, packing):
        for path, pin in prior['source_sha256'].items():
            ...
            used[path] = pin
    predecessor = module('slot_gap_previous_global', base/'frontier/carrier_mass_global.py')
    require(encode(predecessor.calculate(base)) == previous, 'All previous complete branches and original46 choices reconstruct')
    gap_module = module('slot_gap_interface', base/'frontier/shared_slot_defect_polytope.py')
    ...
    penalty_module = module('slot_gap_deep_interface', base/'frontier/shared_root_imbalance_payment.py')
