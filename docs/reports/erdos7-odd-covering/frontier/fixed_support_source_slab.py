...
class Slab:
    def __init__(self, base):
        ...
        self.vector = module('slab_vector', base/'frontier/vector_marked_source.py')
        self.broad = module('slab_broad', base/'frontier/broad_weighted_identity_source.py')
        self.full = module('slab_full', base/'frontier/full_linear_carrier_frontier.py')
        self.engine = module('slab_engine', base/'frontier/source_barrier_saturation.py').Experiment(base)
        ...
        self.original = json.loads(self.io.read_artifact_bytes(base/'certificates/source_norms/whole_quadratic_same_head.json'))
...
def complete_inner_comparison(base, slab):
    ...
    path = 'certificates/source_norms/residual_shell_k_comparison.json'
