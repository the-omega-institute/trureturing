...
CERTIFICATE = 'certificates/source_norms/j_face_coupled_seven_heads.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j_face_alignment.py': 'bb4e3a82f954538aad042ef6940204947d7b7a5ef69b2ef2bd791d36466aa991', 'certificates/source_norms/j_face_alignment.json': '6874e71b0846d973fedd330f5a8a54bfa457b2cdfe896943db407b8d89bec611', 'profile-notes/130-the-whole-j-face-forces-source-anti-alignment.md': 'a57717f7d0432a2d0365d85b4fa471729e52630fff2be75aafe6b3c4e4db7db7', 'frontier/k_face_common_seven_hinges.py': '8cc4600c9b3f2f65a11820fcb2d0d6663c765c20765bbaf1ae0de6e883cefc97', 'profile-notes/201-two-more-seven-labels-and-selected-intersections-control-both-heavy-costs.md': 'b364509b1de6829c57707e8ffbfff33a41b4a62115ea56c2a5fe27bde331ba1b'}
ROOT = (0, 0, 1, 1, 1)
ETA = (F(1, 18),)+(F(1, 9),)*4
...
class SaturatedJCoupledSevenHead:
    ...
    def __init__(self, base):
        self.base = base
        self.bridge = module('j_seven_common', base/'frontier/k_face_common_seven_hinges.py')
...
def calculate(base):
    ...
    face = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/j_face_alignment.json'))
    pins = dict(PINS)
    for path, pin in face['source_sha256'].items():
        require(path not in pins or pins[path] == pin, 'Consistent original J source '+path)
        pins[path] = pin
    engine = module('j_seven_inventory', base/'frontier/source_barrier_saturation.py').Experiment(base)
