...
DEFAULT_PROOF='profile-notes/337-fixed-original-groups-retain-the-complete-count-law.md'
...
def calculate(base,source,reference,proof):
    ...
    parent_proof=base/'profile-notes/333-variable-full-haar-thresholds-retain-more-survivor-mass.md'
    parent_producer=base/'frontier/high_rho_full_haar_thresholds.py'
    reference_proof=base/'profile-notes/335-original-ap-blocks-sharpen-the-fixed-full-haar-account.md'
    reference_producer=base/'frontier/high_rho_original_ap_blocks.py'
    ...
    paths=[base/'certificate_io.py',base/'verify_joint_frontier.py',source,reference,parent_proof,parent_producer,
           ...
           base/'profile-notes/329-a-finite-whole-j-neighborhood-covers-high-surplus.md']
    def key(p):
