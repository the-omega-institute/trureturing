...
CERTIFICATE = 'certificates/source_norms/complete_retained_row_transport.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/retained_pair_row_transport.py': 'c1c1a3f651da91fb2ea17abbff9b6d35b0ab3abccfb3a1b652321b8f31734666', 'certificates/source_norms/retained_pair_row_transport.json': 'f0c91c34e15cf46e6df19697dd86f67299db4b8800593b4df72ff4573aaa7135', 'frontier/retained135125_survival_comparison.py': 'e4fef06040f20b50668ff7bb6c0220ddf68916eb96b2a5d03a48ceef18f4409e', 'certificates/source_norms/retained135125_survival_comparison.json': 'b195a103f9a876209edf9a220d29327d212daafcf670128586c1b7d48ca1846d'}
...
def calculate(base):
    ...
    parent, heavy, survival = [read('certificates/source_norms/'+name+'.json') for name in (
