...
CERTIFICATE = 'certificates/source_norms/broad_weighted_identity_source.json'
PINS = {
    ...
    'frontier/broad_clipped_identity.py': '9e43ddcb201a7486e419d84c17afd45781b4ae4e182a55d30b7cb9d069999ba0',
    'certificates/source_norms/broad_clipped_identity.json': 'cb60f68598001f35fcb3793113803ac174d61198bd6877682b497e7aa1cdda20',
}
ROOT = (0, 0, 1, 1, 1)
...
def calculate(base):
    ...
    clipped = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/broad_clipped_identity.json'))
    source = module('weighted_source_parent', base/'verify_joint_frontier.py')
    old = module('weighted_source_old', base/'frontier/endpoint_linear_neighborhood.py')
