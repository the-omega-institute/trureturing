...
def calculate(base):
    ...
    prior = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/j_face_shared_square_factorial.json'))
    pins = dict(PINS)
    ...
    j = module('joint_j_source', base/'frontier/j_face_coupled_seven_heads.py')
    moment = module('joint_j_moments', base/'frontier/j_face_shared_square_factorial.py')
