...
CERTIFICATE = 'certificates/source_norms/j_face_pure_path_square.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/j_face_joint_retained_square.py': '7f4bcecb86c0cdb53b06f4b338366324d61a6acd13a1c566645ccfc0cf34f7f0', 'certificates/source_norms/j_face_joint_retained_square.json': '7d32a00575385a0af956ada8f89f4c2cf92fe723855ff5695262ebf29be15504', 'profile-notes/245-the-actual-j-survivor-mass-and-h-column-sharpen-the-complete-square.md': '9d1888a68947501b2dfb0de0c8245167de09038f64925db3850b33e232cd1146', 'frontier/j_face_pure_path_factorial.py': 'ef4062f3cd04312c1b0eeac382322cb20acae341c491dabb04275a09af537ebd', 'certificates/source_norms/j_face_pure_path_factorial.json': '918a8fa5098b875fc763054e7e57e9cbc9eee7e92933dd6e5c791545dc7a6682', 'profile-notes/248-the-complete-j-factorial-tail-retains-both-prime-paths.md': '887edf92604bcacf87219f73da2bfa9dca290196055cc2da62aff3a169b2f0ed'}
...
def calculate(base):
    ...
    j = module('j_path_square_source', base/'frontier/j_face_coupled_seven_heads.py')
    moment = module('j_path_square_moment', base/'frontier/j_face_shared_square_factorial.py')
    joint = module('j_path_square_joint', base/'frontier/j_face_joint_retained_square.py')
    path_provider = module('j_path_square_caps', base/'frontier/j_face_pure_path_factorial.py')
