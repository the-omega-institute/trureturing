...
def calculate(base):
    ...
    uniform = module('denominator_uniform', base/'frontier/uniform_k_neighborhood_cost.py')
    portfolio = module('denominator_portfolio', base/'frontier/uniform_mean_cost_portfolio.py')
    cost = module('denominator_cost', base/'frontier/complete_off_face_cost.py')
    ...
    finite = module('denominator_finite', base/'frontier/finite_source_face_transport.py')
    affine = module('denominator_affine', base/'frontier/shared_budget_affine_tail.py')
    mean = module('denominator_mean', base/'frontier/joint_deep_mean_transport.py')
    source = module('denominator_source', base/'verify_joint_frontier.py')
    capacity = module('denominator_capacity', base/'frontier/broad_weighted_identity_source.py')
    old = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/whole_block_mean_survival.json'))
