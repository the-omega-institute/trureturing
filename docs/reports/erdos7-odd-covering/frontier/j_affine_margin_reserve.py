...
CERTIFICATE = 'certificates/source_norms/j_affine_margin_reserve.json'
PINS = {
    'certificates/source_norms/j_family_error_reserve.json': '677aad190299f87b36cf2c9bef1c5045d564e56c2effac66a13e4381351274d9',
    ...
    'profile-notes/66-explicit-linear-endpoint-neighborhood.md': 'e072e749c8e10df6953333ef1bf7d911459573d85ab2d61a41ce95d8aeaf70ae',
    'profile-notes/130-the-whole-j-face-forces-source-anti-alignment.md': 'a57717f7d0432a2d0365d85b4fa471729e52630fff2be75aafe6b3c4e4db7db7',
    'profile-notes/136-a-whole-j-source-neighborhood-has-a-complete-labelwise-bound.md': '137aacdd1de6890568edc6d0490fe00c7df41e2c1ff35f95c7732d79829e3806',
    'profile-notes/197-the-whole-j-reserve-keeps-each-original-family-error.md': 'a3c36cf3ee5951e205edfe1cfc7ad0b1e1ae42798fe3726af154e4f7157b0c21',
}
B = (2, 3, 1, 1, 1)
C = (1, 2, 2, 2, 2)
...
def calculate(base):
    ...
    family = module('j_affine_family', base/'frontier/j_family_error_reserve.py')
    prior = json.loads(io.read_artifact_bytes(base/'certificates/source_norms/j_family_error_reserve.json'))
    pins = dict(PINS)
    ...
    original = module('j_affine_original', base/'frontier/endpoint_linear_neighborhood.py')
