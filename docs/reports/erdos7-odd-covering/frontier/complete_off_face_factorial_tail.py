...
CERTIFICATE = 'certificates/source_norms/complete_off_face_factorial_tail.json'
PINS = {
...
def calculate(base):
    ...
    finite = module('off_factorial_finite', base/'frontier/finite_source_face_transport.py')
    tails = module('off_factorial_tails', base/'frontier/complete_off_face_omitted_tails.py')
    source = module('off_factorial_source', base/'verify_joint_frontier.py')
    actual = module('off_factorial_actual', base/'frontier/complete_off_face_cost.py')
    old = module('off_factorial_face', base/'frontier/whole_factorial_same_head.py')
    bridge = module('off_factorial_bridge', base/'frontier/k_face_common_seven_hinges.py')
