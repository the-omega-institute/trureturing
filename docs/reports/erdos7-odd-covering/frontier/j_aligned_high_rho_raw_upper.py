...
CERTIFICATE='certificates/source_norms/j_aligned_high_rho_raw_upper.json'
DEFAULT_PROOF='profile-notes/328-complete-raw-costs-cover-the-high-surplus-aligned-face.md'
INVENTORY='certificates/source_norms/j_aligned_complete_moment_comparison.json'
SOURCE_PROOFS=(
