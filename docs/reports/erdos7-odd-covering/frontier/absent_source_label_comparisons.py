...
CERTIFICATE = 'certificates/source_norms/absent_source_label_comparisons.json'
PINS = {
    'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232',
    'frontier/ineffective15_complete_source_comparison.py': '281216133e01aadfa51a456a41865322ae24fc223fe4dafb2f4aa361ddefb475',
}
...
def calculate(base):
    ...
    previous = module('absent_source_complete_provider',
                      base/'frontier/ineffective15_complete_source_comparison.py')
