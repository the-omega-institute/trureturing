...
CERTIFICATE = 'certificates/source_norms/pure_axis_cross_sharpness.json'
PINS = {'certificate_io.py': '287582353eeb0674f4e80530ebf268228b023f6088d14c819488a56111d0b232', 'frontier/source_mass_compatibility.py': 'f65f0be22b250ab94d7da847a45b49c39355c15499f9cde8f18f267ca3365645', 'frontier/full_family_five_cap_sharpness.py': '4360371e55370eab6dfb897e6106ed60c98ac386bcaf01ebb3bc9f80a742184b', 'certificates/source_norms/full_family_five_cap_sharpness.json': '9b72338b3a13ee4097f896678e7cf1273a3d35c807b48587db34f403c8cc2bd4', 'frontier/k_face_complete_ratio.py': 'd856e5c2face117c993b7bd308903a3fb149293d254046f76b6ff5f42ec9b478', 'certificates/source_norms/k_face_complete_ratio.json': '7041b3c1b2d61e2063c2c97f89daccbd65b75b444a296bbc8badf4b8ffa8e426', 'frontier/pure_three_joint_moments.py': '05df2100e129d169fa98e150d7b5dd61d10717c71d7821480d9d891f72fef2a9', 'certificates/source_norms/pure_three_joint_moments.json': '1f8e018505011e916527377cd976ffe724324f840ac5bf662330c4c5ff3cfeee', 'frontier/pure_five_joint_moments.py': '0895f2e289cfbdf93acbe9576495213d789cba5d57123b15169753b1c26f81b4', 'certificates/source_norms/pure_five_joint_moments.json': '00a8a7fd730b61d5c20ba0212f955df96264a348fffd1eca2ca1ea59f7c78e95'}
...
def calculate(base):
    ...
    source = module('axis_cross_source', base/'frontier/source_mass_compatibility.py')
    repacked = module('axis_cross_repack', base/'frontier/full_family_five_cap_sharpness.py')
    square = module('axis_cross_square', base/'frontier/k_face_complete_ratio.py')
    three = module('axis_cross_three', base/'frontier/pure_three_joint_moments.py')
    five = module('axis_cross_five', base/'frontier/pure_five_joint_moments.py')
