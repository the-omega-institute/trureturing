...
CERTIFICATE = 'certificates/source_norms/fresh_full_slot_source_comparison.json'
HEAD_CERTIFICATE = 'certificates/source_norms/fresh_full_slot_source_heads.json'
