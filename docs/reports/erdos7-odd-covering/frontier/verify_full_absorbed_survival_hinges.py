...
PREVIOUS = 'certificates/source_norms/absorbed_survival_hinges.json'
PREVIOUS_PIN = 'fd0b0803e8adf197beca896dc0667230be5ba30765eefe39dd9633b554535edc'
PREVIOUS_VERIFIER = 'frontier/verify_absorbed_survival_hinges.py'
PREVIOUS_VERIFIER_PIN = 'f38ea3bb39fc3f8dacb8fffa3cd2072afdb5e8baf02778be2190f4970efbaaf9'
LOCAL_PINS = {
    'frontier/full_absorbed_survival_hinges.py': '3c5b0ba6df9c11bbba8a9b1a31824b504072e4659a2f0a9aa8348a0fe9e8e79d',
    'frontier/full_absorbed_survival_consumer.py': '29dd25c3d3b4216b69f2a6bf597ec4fbbbcd41146c1ba0248a18e8ff515b1935',
}
CERTIFICATE = 'certificates/source_norms/full_absorbed_survival_hinges.json'
...
def main():
    ...
    require(set(LOCAL_PINS) == {'frontier/full_absorbed_survival_hinges.py',
                               'frontier/full_absorbed_survival_consumer.py'}, 'Complete current helper pins')
    ...
    consumer39 = load('consumer39', 'frontier/shared_source_consumer.py')
    hinge25 = load('hinge25', 'frontier/survival_hinge_deficit.py')
    consumer41 = load('consumer41', 'frontier/survival_hinge_consumer.py')
    absorption42 = load('absorption42', 'frontier/absorbed_survival_hinges.py')
    consumer42 = load('consumer42', 'frontier/absorbed_survival_consumer.py')
    helper = load('absorption', 'frontier/full_absorbed_survival_hinges.py')
    consumer = load('consumer', 'frontier/full_absorbed_survival_consumer.py')
