...
The [helper](../frontier/retained_deletion_heavy_comparison.py),
[proposal program](../frontier/propose_retained_deletion_duals.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/retained_deletion_heavy_comparison.py --check
```
