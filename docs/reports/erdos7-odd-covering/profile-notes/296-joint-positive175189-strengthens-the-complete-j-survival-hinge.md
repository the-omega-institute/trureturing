...
The [checker](../frontier/j_face_joint_positive175189_survival_heads.py)
and [certificate](../certificates/source_norms/j_face_joint_positive175189_survival_heads.json)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j_face_joint_positive175189_survival_heads.py --check
```
