...
The [checker](../frontier/endpoint_complete_deletion_ratio.py) consumes
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/endpoint_complete_deletion_ratio.py --check
```
