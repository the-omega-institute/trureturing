[Index](../../marked_head_profile.md) · [Previous complete comparison](199-one-six-label-head-controls-the-square-and-both-complete-crosses.md) · [Original complete hinge bridge](../065-128/98-a-complete-stop-loss-profile-strengthens-the-whole-face-comparison.md) · [Same mean and hinges](../065-128/109-the-mean-and-all-hinges-share-one-original-test.md)
...
The [helper](../../frontier/comparison-bounds/expanded_seven_pair_comparison.py) exposes
...
The [certificate](../../certificates/source_norms/comparison-bounds/expanded_seven_pair_comparison.json)
stores both complete scans, the exact source pins and the full consumer.

```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/comparison-bounds/expanded_seven_pair_comparison.py --check
```
