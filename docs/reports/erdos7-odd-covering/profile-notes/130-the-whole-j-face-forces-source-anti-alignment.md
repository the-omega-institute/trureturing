...
[j_face_alignment.py](../frontier/j_face_alignment.py) checks the
complete sums, six slot tables, nine affine source witnesses and an
existing actual height3 off-diagonal construction. Its
[certificate](../certificates/source_norms/j_face_alignment.json) retains
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j_face_alignment.py --check
```
