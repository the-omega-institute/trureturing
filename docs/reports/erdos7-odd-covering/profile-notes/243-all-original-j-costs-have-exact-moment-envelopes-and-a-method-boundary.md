...
- [Complete J moment consumer](../frontier/j_face_complete_moment_cost_comparison.py)
- [Rational envelopes and moment witnesses](../certificates/source_norms/j_face_complete_moment_cost_comparison.json)
