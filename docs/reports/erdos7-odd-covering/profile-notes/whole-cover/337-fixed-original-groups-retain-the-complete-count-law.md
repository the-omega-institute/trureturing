...
The [portable exact helper](../../frontier/whole-cover/high_rho_fixed_original_groups.py)
provides the reusable fixed_group_centered operator and the fixed
all-prior instance. The [canonical certificate](../../certificates/source_norms/high_rho_fixed_original_groups.json)
...
```sh
python3 -I -S -O docs/reports/erdos7-odd-covering/frontier/whole-cover/high_rho_fixed_original_groups.py --check
```
