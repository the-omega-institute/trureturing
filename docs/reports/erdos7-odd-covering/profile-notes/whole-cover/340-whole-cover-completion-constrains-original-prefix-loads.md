...
The [finite check](../../frontier/whole-cover/original_prefix_completion.py), using
...
```sh
python3 -I -S -O docs/reports/erdos7-odd-covering/frontier/whole-cover/original_prefix_completion.py
```
