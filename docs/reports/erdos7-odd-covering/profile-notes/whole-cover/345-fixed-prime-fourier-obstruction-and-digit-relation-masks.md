...
The [standalone program](../../frontier/whole-cover/original_digit_relation_masks.py)
...
```sh
python3 -I -S -O docs/reports/erdos7-odd-covering/frontier/whole-cover/original_digit_relation_masks.py
python3 -I -S -O docs/reports/erdos7-odd-covering/frontier/whole-cover/original_digit_relation_masks.py --prime 11 --depth 1
```
