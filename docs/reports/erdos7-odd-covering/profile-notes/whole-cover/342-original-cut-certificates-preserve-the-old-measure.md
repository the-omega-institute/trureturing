...
The [standalone checker](../../frontier/whole-cover/original_cut_weighting.py) reconstructs
...
```sh
python3 -I -S -O docs/reports/erdos7-odd-covering/frontier/whole-cover/original_cut_weighting.py
python3 -I -S -O docs/reports/erdos7-odd-covering/frontier/whole-cover/original_cut_weighting.py --current-prime 11 --heights 1 2 --bias-height 2
```
