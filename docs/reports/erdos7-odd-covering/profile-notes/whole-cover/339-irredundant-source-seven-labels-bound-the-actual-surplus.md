[Index](../../marked_head_profile.md) · [Actual carrier mixture](../46-one-forbidden-carrier-mixture-strengthens-survival.md) · [Actual source measures](../48-actual-source-compatibility-excludes-a-relaxed-mass-endpoint.md) · [Whole-J source neighborhood](../j-source/329-a-finite-whole-j-neighborhood-covers-high-surplus.md)
...
Use [302's normalized chart](../j-source/302-a-positive-actual-source-neighborhood-keeps-j-below403.md):
the surviving mod9 cells are(0,3,1,4,7), with ROOT=(0,0,1,1,1).
The concentration argument in [71](../71-global-j-k-control-faces-and-exact-escape-gaps.md)
...
[benchmark helper](../../frontier/whole-cover/irredundant_whole_j_finite_source.py)
