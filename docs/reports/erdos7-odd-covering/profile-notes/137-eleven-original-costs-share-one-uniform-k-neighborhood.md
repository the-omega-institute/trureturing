[Index](../marked_head_profile.md) · [Adopted original mean costs](109-the-mean-and-all-hinges-share-one-original-test.md) · [Complete AP11 blocks](111-each-ap11-block-shares-its-mean-and-curvature.md) · [Single residual supports](127-complete-tail-supports-restore-one-shared-convex-budget.md) · [Uniform first consumer](134-one-complete-cost-is-uniform-on-a-nonzero-k-neighborhood.md)
...
[uniform_mean_cost_portfolio.py](../frontier/uniform_mean_cost_portfolio.py)
and its
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/uniform_mean_cost_portfolio.py --check
```
