[Index](../marked_head_profile.md) · [Actual carrier mixture](46-one-forbidden-carrier-mixture-strengthens-survival.md) · [Actual source measures](48-actual-source-compatibility-excludes-a-relaxed-mass-endpoint.md) · [Whole-J source neighborhood](329-a-finite-whole-j-neighborhood-covers-high-surplus.md)
...
Use [302's normalized chart](302-a-positive-actual-source-neighborhood-keeps-j-below403.md):
