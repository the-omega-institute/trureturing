...
[source_cost_endpoint_attainment.py](../frontier/source_cost_endpoint_attainment.py)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/source_cost_endpoint_attainment.py
```
