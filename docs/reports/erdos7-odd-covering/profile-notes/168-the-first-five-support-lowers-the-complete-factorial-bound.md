[Index](../marked_head_profile.md) · [Original factorial head](112-the-factorial-tail-retains-one-compatible-original-head.md) · [Joint pure-five moments](164-the-pure-five-first-and-second-moments-have-a-sharp-joint-envelope.md)
...
Run the result and its canonical check with
    ...
    python3 -I -O docs/reports/erdos7-odd-covering/frontier/pure_five_joint_factorial_comparison.py --write
    python3 -I -O docs/reports/erdos7-odd-covering/frontier/pure_five_joint_factorial_comparison.py --check

The data artifact is
[the complete joint-factorial certificate](../certificates/source_norms/pure_five_joint_factorial_comparison.json).
