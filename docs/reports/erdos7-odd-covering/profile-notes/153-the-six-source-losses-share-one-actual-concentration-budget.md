[Index](../marked_head_profile.md) · [Original concentration](106-the-actual-denominator-shares-the-carrier-mass-residual.md) · [Signed product mass](150-signed-source-monotonicity-strengthens-the-product-mass-bound.md) · [Complete raw prices](140-ten-adopted-quadratic-costs-share-a-uniform-source-neighborhood.md)
...
The [helper](../frontier/joint_concentration_loss_budget.py) exports
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/joint_concentration_loss_budget.py --check
```
