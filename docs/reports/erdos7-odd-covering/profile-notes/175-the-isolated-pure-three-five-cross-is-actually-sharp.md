...
The [helper](../frontier/pure_axis_cross_sharpness.py) checks
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/pure_axis_cross_sharpness.py --check
```
