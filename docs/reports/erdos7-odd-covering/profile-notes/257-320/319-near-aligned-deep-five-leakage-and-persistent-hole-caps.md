[Index](../../marked_head_profile.md) · [Actual virtual measure](../001-064/57-common-deleted-measure-coupling.md) · [Sharp aligned surplus](311-imperfect-j-source-alignment-forces-a-sharp-sector-surplus.md) · [Complete adjusted ledger](312-an-aligned-j-source-has-a-complete-own-test-and-residual-deletion-interface.md) · [Endpoint quadratic observations](316-complete-quadratic-observations-on-the-actual-aligned-source.md)
