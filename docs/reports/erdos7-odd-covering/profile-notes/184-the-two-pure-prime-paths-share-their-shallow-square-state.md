[Index](../marked_head_profile.md) · [Sharp isolated cross](175-the-isolated-pure-three-five-cross-is-actually-sharp.md) · [Pure-three moments](171-the-pure-three-path-has-a-joint-complete-moment-bound.md) · [Pure-five moments](164-the-pure-five-first-and-second-moments-have-a-sharp-joint-envelope.md) · [Current complete face comparison](174-the-pure-three-factorial-tail-retains-its-original-head.md) · [Actual source domination](128-the-complete-factorial-tail-retains-its-head-off-the-face.md)
...
The [helper](../frontier/pure_axis_joint_square_comparison.py)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/pure_axis_joint_square_comparison.py --check
```
