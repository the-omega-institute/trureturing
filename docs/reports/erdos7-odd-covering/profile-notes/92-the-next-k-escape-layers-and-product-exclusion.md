...
A compact [gap dictionary](../certificates/source_norms/k_signed_gap_dictionary.json)
...
The [checker](../frontier/k_next_escape_layers.py) verifies the
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/k_next_escape_layers.py --check
```
