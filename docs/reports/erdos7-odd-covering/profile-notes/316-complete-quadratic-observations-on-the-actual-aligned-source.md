...
The [source helper](../frontier/j_aligned_quadratic_sharp_source.py), [complete checker](../frontier/j_aligned_quadratic_complete_heads.py), and [certificate](../certificates/source_norms/j_aligned_quadratic_complete_heads.json) retain1827 final covering nodes and1695 used rational duals. The full check verifies23,643,207 column inequalities. Each of the six observations covers3,125,000,000 original containing choices. The canonical split directory is part of the certificate.

```sh
python3 -I -S -O docs/reports/erdos7-odd-covering/frontier/j_aligned_quadratic_complete_heads.py --check
```
