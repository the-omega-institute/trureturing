...
The [helper](../frontier/expanded_seven_quadratic_comparison.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/expanded_seven_quadratic_comparison.py --check
```
