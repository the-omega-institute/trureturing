...
[shared_budget_affine_tail.py](../frontier/shared_budget_affine_tail.py)
...
The [certificate](../certificates/source_norms/shared_budget_affine_tail.json)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/shared_budget_affine_tail.py --check
```
