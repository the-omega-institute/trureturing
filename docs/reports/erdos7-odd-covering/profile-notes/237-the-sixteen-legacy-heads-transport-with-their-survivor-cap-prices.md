...
The [helper](../frontier/legacy_retained_complete_head_transport.py)
and [certificate](../certificates/source_norms/legacy_retained_complete_head_transport.json)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/legacy_retained_complete_head_transport.py --check
```
