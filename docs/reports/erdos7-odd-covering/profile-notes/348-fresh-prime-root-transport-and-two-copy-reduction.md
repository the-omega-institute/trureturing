...
The [exact rational checker](../frontier/multiplicity_two_sieve.py)
...
The [prime-flat constructor](../frontier/p_flat_constructor.py) implements
...
The [fresh-root constructor](../frontier/fresh_root_constructor.py)
...
The [composition check](../frontier/fresh_root_composition_check.py)
...
The [old-q memory constructor](../frontier/old_q_memory_construct.py)
