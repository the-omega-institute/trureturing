...
the [portable helper](../frontier/j_aligned_full_source_tv_neighborhood.py) and its [canonical certificate](../certificates/source_norms/j_aligned_full_source_tv_neighborhood.json), with canonical source reading
...
```sh
python3 -I -S -O docs/reports/erdos7-odd-covering/frontier/j_aligned_full_source_tv_neighborhood.py --check
```
