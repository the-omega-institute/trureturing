[Index](../marked_head_profile.md) · [Original vector theorem](91-cell-vector-markers-retain-the-selected-deep-deletion.md) · [Jensen obstruction](159-the-optimized-heavy-margin-fails-late-factor-jensen.md) · [Complete comparison](157-a-signed-tail-comparison-covers-the-one-over-twenty-seven-neighborhood.md)
...
The [helper](../frontier/fixed_support_source_slab.py) evaluates both
...
[certificate](../certificates/source_norms/fixed_support_source_slab.json).
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/fixed_support_source_slab.py --check
python3 -I -O docs/reports/erdos7-odd-covering/frontier/fixed_support_source_slab.py --check-inner
```
