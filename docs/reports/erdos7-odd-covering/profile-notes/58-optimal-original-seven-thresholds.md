...
The [checker](../frontier/optimal_seven_thresholds.py) and
[exact data](../certificates/source_norms/optimal_seven_thresholds.json)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/optimal_seven_thresholds.py
```
