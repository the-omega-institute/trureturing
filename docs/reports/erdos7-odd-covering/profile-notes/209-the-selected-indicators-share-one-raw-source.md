...
The [canonical helper](../frontier/joint_selected_source_comparison.py)
...
[proposal generator](../frontier/propose_joint_selected_duals.py)
exists for regenerating numerical suggestions followed by exact repair.

```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/joint_selected_source_comparison.py --check
```
