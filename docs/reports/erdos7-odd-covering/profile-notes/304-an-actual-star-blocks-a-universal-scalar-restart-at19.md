...
The [companion](../frontier/scalar19_capacity_star_obstruction.py) consumes
...
The [result](../certificates/source_norms/scalar19_capacity_star_obstruction.json)
retains exact rational intervals and controls.

```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/scalar19_capacity_star_obstruction.py --check
```
