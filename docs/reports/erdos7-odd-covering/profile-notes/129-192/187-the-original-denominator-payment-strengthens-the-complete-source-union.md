...
The [helper](../../frontier/source-budgets/joint_gap_denominator_global_comparison.py)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/source-budgets/joint_gap_denominator_global_comparison.py --check
```
