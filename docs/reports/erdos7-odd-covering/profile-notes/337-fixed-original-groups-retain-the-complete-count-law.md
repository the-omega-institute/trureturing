...
The [portable exact helper](../frontier/high_rho_fixed_original_groups.py)
...
```sh
python3 -I -S -O docs/reports/erdos7-odd-covering/frontier/high_rho_fixed_original_groups.py --check
```
