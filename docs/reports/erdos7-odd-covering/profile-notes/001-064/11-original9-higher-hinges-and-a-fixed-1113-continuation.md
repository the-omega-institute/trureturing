[Index](../../marked_head_profile.md) · [Previous](10-separating-an-original-saturated-test-from-its-higher-labels.md) · [Next](12-complete-original-low-test-anchoring-at-arbitrary-prime-power-heights.md)

<a id="original9-higher-hinges-and-a-fixed-1113-continuation"></a>
...
as in[SH22--SH24](07-a-common-weighted-low-layout-and-a-nonnegative-tail-correction.md#a-direct-threshold-two-correction-and-simultaneous-bounds).

<a id="fixed-original-classes-and-the-complete-first-moment-tail"></a>
...
<a id="one-actual-two-prime-consumer"></a>
#### One actual two-prime consumer

Apply the existing[SH25 consumer](07-a-common-weighted-low-layout-and-a-nonnegative-tail-correction.md#a-same-law-two-prime-consumer) with
...
<a id="why-the-resulting-square-bound-does-not-restart-scalar-t6-at17"></a>
#### Why the resulting square bound does not restart scalar T6 at17

The existing[joint-load transfer(T6)](../../problem-details/08-arbitrary-head-transfer-by-the-joint-load-invariant.md#arbitrary-head-transfer-by-the-joint-load-invariant)
...
<a id="pg1-joint-final-root-floor-and-whole-cost-transfer-through-1113"></a>
...
<a id="a-shared-row-probability-crosses-a-uniform-profile-separation"></a>
...
<a id="an-affine-separation-for-the-uniform-sufficient-criterion"></a>
...
<a id="a-positive-row-law-satisfying-both-signed-criteria"></a>
...
<a id="original-label-support-transport-and-replay"></a>
...
<a id="pg1-signed-original-root-floor-for-the-second-whole-cost"></a>
