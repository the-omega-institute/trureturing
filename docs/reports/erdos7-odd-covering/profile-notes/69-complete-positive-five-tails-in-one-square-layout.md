[Index](../marked_head_profile.md) · [Endpoint source](59-endpoint-linear-source-deletion-bound.md) · [Original pair caps](62-endpoint-square-from-cylinder-intersections.md) · [Common pure3 head](64-one-zero-seven-layout-and-complete-pure-three-tails.md)
...
The [checker](../frontier/endpoint_square_positive5.py) reconstructs
...
[certificate](../certificates/source_norms/endpoint_square_positive5.json)
records the exact table, budgets and rational comparison slack.

```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/endpoint_square_positive5.py --check
```
