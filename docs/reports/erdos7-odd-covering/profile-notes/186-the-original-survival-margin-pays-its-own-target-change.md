[Index](../marked_head_profile.md) · [Original allocated survival](53-allocated-seven-thresholds-sharpen-actual-survival.md) · [Original joint table](71-global-j-k-control-faces-and-exact-escape-gaps.md) · [Joint source-mass interpolation](183-the-original-signed-gap-retains-its-own-mass-through-interpolation.md)
...
The [helper](../frontier/joint_gap_denominator_escape.py) freshly
reconstructs all original allocated survival margins on each run.
The [certificate](../certificates/source_norms/joint_gap_denominator_escape.json)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/joint_gap_denominator_escape.py --check
```
