[Index](../marked_head_profile.md) · [Original endpoint mean](59-endpoint-linear-source-deletion-bound.md) · [Scalar survival boundary](67-exact-endpoint-survival-and-its-scalar-boundary.md) · [Complete pure3 deletion on the K faces](75-forced27-and-complete-pure3-deletion-on-the-k-faces.md)
...
The [checker](../frontier/endpoint_linear_complete_pure3_deletion.py)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/endpoint_linear_complete_pure3_deletion.py --check
```
