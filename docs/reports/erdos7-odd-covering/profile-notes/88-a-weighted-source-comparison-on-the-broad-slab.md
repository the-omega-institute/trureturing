...
The [checker](../frontier/broad_weighted_identity_source.py) and its
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/broad_weighted_identity_source.py --check
```
