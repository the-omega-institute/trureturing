...
The [exact certificate](../certificates/source_norms/j_whole_face_high_rho_finite_guard.json) is regenerated by the [standard-library checker](../frontier/j_whole_face_high_rho_finite_guard.py):

```sh
python3 -I -S -O docs/reports/erdos7-odd-covering/frontier/j_whole_face_high_rho_finite_guard.py --check
```
