[Index](../marked_head_profile.md) · [Whole-face source projection](106-the-actual-denominator-shares-the-carrier-mass-residual.md) · [Finite source operator](116-signed-face-duals-transport-one-shared-finite-source.md) · [Packing budget](117-the-actual-slot-defects-share-a-stronger-packing-polytope.md) · [Complete tails](125-the-complete-off-face-omitted-tails-recover-every-face-constant.md) · [Fixed affine supports](127-complete-tail-supports-restore-one-shared-convex-budget.md) · [Corrected source modulus](133-unchanged-source-budgets-can-move-the-best-five-slot.md)
...
[uniform_k_neighborhood_cost.py](../frontier/uniform_k_neighborhood_cost.py)
and its
[certificate](../certificates/source_norms/uniform_k_neighborhood_cost.json)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/uniform_k_neighborhood_cost.py --check
```
