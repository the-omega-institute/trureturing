...
The [helper](../frontier/pure_five_complete_face_comparison.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/pure_five_complete_face_comparison.py --check
```
