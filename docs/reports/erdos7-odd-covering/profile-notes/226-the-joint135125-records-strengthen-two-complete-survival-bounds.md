...
The [helper](../frontier/retained135125_survival_comparison.py)
uses225's model, complete scan and exact column checker. The
[proposal program](../frontier/propose_retained135125_survival_duals.py)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/retained135125_survival_comparison.py --check
```
