...
The [helper](../frontier/j_face_generalized_factorial_heads.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j_face_generalized_factorial_heads.py --check
```
