[Index](../marked_head_profile.md) · [Previous joint square](184-the-two-pure-prime-paths-share-their-shallow-square-state.md) · [Complete deep-three deletion](75-forced27-and-complete-pure3-deletion-on-the-k-faces.md) · [Actual pointwise source domination](128-the-complete-factorial-tail-retains-its-head-off-the-face.md)
...
The [helper](../frontier/pure_axis_shared_deletion_comparison.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/pure_axis_shared_deletion_comparison.py --check
```
