...
[`frontier/deeper_absorption_credit.py`](../frontier/deeper_absorption_credit.py):

```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/deeper_absorption_credit.py
```
