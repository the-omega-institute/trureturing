...
The [helper](../frontier/joint_deletion_row_transport.py) checks the
...
The [certificate](../certificates/source_norms/joint_deletion_row_transport.json)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/joint_deletion_row_transport.py --check
```
