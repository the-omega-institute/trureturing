...
The [helper](../frontier/expanded_seven_pair_comparison.py) exposes
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/expanded_seven_pair_comparison.py --check
```
