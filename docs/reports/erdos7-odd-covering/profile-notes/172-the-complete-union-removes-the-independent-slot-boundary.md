...
The [helper](../frontier/full_slot_union_outer_comparison.py)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/full_slot_union_outer_comparison.py --check
```
