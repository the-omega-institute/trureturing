[Index](../marked_head_profile.md) · [Complete omitted tails](125-the-complete-off-face-omitted-tails-recover-every-face-constant.md) · [Shared affine budget](127-complete-tail-supports-restore-one-shared-convex-budget.md)
...
[exhaustive_shared_tail_cost.py](../frontier/exhaustive_shared_tail_cost.py)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/exhaustive_shared_tail_cost.py --check
```
