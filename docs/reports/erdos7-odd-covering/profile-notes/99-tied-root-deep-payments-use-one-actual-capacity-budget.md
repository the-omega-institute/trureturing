...
[tied_root_deep_payment.py](../frontier/tied_root_deep_payment.py).
...
The certificate
[tied_root_deep_payment.json](../certificates/source_norms/tied_root_deep_payment.json)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/tied_root_deep_payment.py --output docs/reports/erdos7-odd-covering/certificates/source_norms/tied_root_deep_payment.json
```

Verify with:

```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/tied_root_deep_payment.py --check
```
