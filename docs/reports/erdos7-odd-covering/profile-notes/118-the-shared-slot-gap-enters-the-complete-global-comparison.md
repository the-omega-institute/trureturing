...
`frontier/shared_slot_gap_global.py` reconstructs107 and117, recomputes
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/shared_slot_gap_global.py --check
```
