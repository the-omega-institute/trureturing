...
The [helper](../frontier/extended_source_bridge_comparison.py),
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/extended_source_bridge_comparison.py --check
```
