...
The [helper](../../frontier/transport/second_depth_seven_comparison.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/transport/second_depth_seven_comparison.py --check
```
