[Index](../../marked_head_profile.md) · [Complete preceding comparison](206-the-second-seven-depth-improves-the-first-complete-ap11-block.md) · [Expanded seven interface](201-two-more-seven-labels-and-selected-intersections-control-both-heavy-costs.md) · [Complete factorial head](../174-the-pure-three-factorial-tail-retains-its-original-head.md) · [Exact original-cost identities](202-eight-original-costs-have-an-exact-load-two-remainder.md)
...
The [helper](../../frontier/transport/expanded_seven_quadratic_comparison.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/transport/expanded_seven_quadratic_comparison.py --check
```
