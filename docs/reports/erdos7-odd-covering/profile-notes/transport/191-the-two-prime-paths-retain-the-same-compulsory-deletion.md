...
The [helper](../../frontier/transport/pure_axis_shared_deletion_comparison.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/transport/pure_axis_shared_deletion_comparison.py --check
```
