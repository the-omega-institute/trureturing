...
The [helper](../../frontier/transport/selected_deletion_mask_row_transport.py)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/transport/selected_deletion_mask_row_transport.py --check
```
