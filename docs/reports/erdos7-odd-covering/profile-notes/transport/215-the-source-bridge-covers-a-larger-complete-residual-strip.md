[Index](../../marked_head_profile.md) · [Original source bridge](195-the-complete-source-comparison-extends-beyond-the-old-radius-domain.md) · [Global affine comparison](../j-source/213-the-affine-j-reserve-enters-the-complete-global-comparison.md)
...
```sh
python3 docs/reports/erdos7-odd-covering/frontier/transport/expanded_bridge_residual_comparison.py --check
```
