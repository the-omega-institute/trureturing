...
The [helper](../../frontier/transport/three_layer_global_comparison.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/transport/three_layer_global_comparison.py --check
```
