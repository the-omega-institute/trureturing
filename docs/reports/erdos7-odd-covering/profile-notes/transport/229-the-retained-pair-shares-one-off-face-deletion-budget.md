...
The [helper](../../frontier/transport/retained_pair_row_transport.py) and its
[certificate](../../certificates/source_norms/retained-transport/retained_pair_row_transport.json)
provide the joint2493-row data:

```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/transport/retained_pair_row_transport.py --check
```
