...
The [helper](../../frontier/transport/load_two_cost_remainders.py) and its
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/transport/load_two_cost_remainders.py --check
```
