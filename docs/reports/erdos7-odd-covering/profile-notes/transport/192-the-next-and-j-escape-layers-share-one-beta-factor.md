[Index](../../marked_head_profile.md) · [Original three layers](../92-the-next-k-escape-layers-and-product-exclusion.md) · [Paired denominator](../186-the-original-survival-margin-pays-its-own-target-change.md) · [Square-root exclusion](190-the-square-root-product-exclusion-sharpens-the-complete-source-union.md)
...
The [helper](../../frontier/transport/three_layer_product_escape.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/transport/three_layer_product_escape.py --check
```
