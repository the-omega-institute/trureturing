...
The [helper](../../frontier/transport/legacy_retained_complete_head_transport.py)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/transport/legacy_retained_complete_head_transport.py --check
```
