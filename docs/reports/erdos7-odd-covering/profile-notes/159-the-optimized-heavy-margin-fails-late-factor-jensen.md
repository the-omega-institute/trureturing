[Index](../marked_head_profile.md) · [Global mass-floor bridge](146-a-global-mass-floor-and-coupled-costs-expand-the-k-radius.md) · [Original vector marker](../frontier/vector_marked_source.py)
...
The [helper](../frontier/heavy_margin_vertex_obstruction.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/heavy_margin_vertex_obstruction.py --check
```
