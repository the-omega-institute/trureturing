...
[The checker](../frontier/endpoint_square_numerator.py) reconstructs
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/endpoint_square_numerator.py --check
```

The [certificate](../certificates/source_norms/endpoint_square_numerator.json)
