[Index](../marked_head_profile.md) · [Original full factorial partition](128-the-complete-factorial-tail-retains-its-head-off-the-face.md) · [Joint pure-five block](168-the-first-five-support-lowers-the-complete-factorial-bound.md) · [Joint pure-three moments](171-the-pure-three-path-has-a-joint-complete-moment-bound.md)
...
The [helper](../frontier/pure_three_joint_factorial_comparison.py)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/pure_three_joint_factorial_comparison.py --check
```
