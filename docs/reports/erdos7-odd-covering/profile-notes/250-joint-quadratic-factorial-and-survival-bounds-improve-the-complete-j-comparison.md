...
The [consumer](../frontier/j_face_combined_complete_moment_cost_comparison.py)
and [certificate](../certificates/source_norms/j_face_combined_complete_moment_cost_comparison.json)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j_face_combined_complete_moment_cost_comparison.py --check
```
