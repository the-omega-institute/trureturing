...
The [helper](../frontier/exposed_concentration_prices.py) exports this
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/exposed_concentration_prices.py --check
```
