...
The [helper](../frontier/square_root_product_escape_comparison.py)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/square_root_product_escape_comparison.py --check
```
