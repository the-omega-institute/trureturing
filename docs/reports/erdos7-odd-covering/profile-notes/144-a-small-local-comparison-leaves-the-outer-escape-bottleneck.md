[Index](../marked_head_profile.md) · [Complete global comparison](118-the-shared-slot-gap-enters-the-complete-global-comparison.md) · [Actual denominator](107-carrier-mass-and-the-shared-residual-improve-global-k.md) · [Earlier template ceiling](76-exact-capacity-of-the-current-neighborhood-globalization.md)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/local_to_global_escape_capacity.py --check
```
