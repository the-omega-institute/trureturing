...
The [helper](../frontier/capped_slot_outer_comparison.py) reconstructs
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/capped_slot_outer_comparison.py --check
```
