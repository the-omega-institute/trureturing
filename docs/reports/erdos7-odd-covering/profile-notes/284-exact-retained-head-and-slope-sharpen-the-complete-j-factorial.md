...
The [helper](../frontier/j_face_exact_retained_factorial_head.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j_face_exact_retained_factorial_head.py --check
```
