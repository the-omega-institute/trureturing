...
[whole_quadratic_same_head.py](../frontier/whole_quadratic_same_head.py)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/whole_quadratic_same_head.py --check
```
