[Index](../marked_head_profile.md) · [Complete original local comparison](145-all-fifty-two-costs-give-a-complete-uniform-k-comparison.md) · [Actual carrier mass](106-the-actual-denominator-shares-the-carrier-mass-residual.md) · [Two heavy costs](142-both-heavy-vector-controllers-have-a-uniform-source-radius.md)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/k_neighborhood_radius_study.py --delta 1/50 --check --output docs/reports/erdos7-odd-covering/certificates/source_norms/k_neighborhood_radius_1_50.json
python3 -I -O docs/reports/erdos7-odd-covering/frontier/k_neighborhood_radius_study.py --delta 1/27 --denominator-only --check --output docs/reports/erdos7-odd-covering/certificates/source_norms/k_neighborhood_radius_obstruction_1_27.json
```
