...
The [helper](../frontier/expanded_seven_linear_comparison.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/expanded_seven_linear_comparison.py --check
```
