[Index](../../marked_head_profile.md) · [Whole J source](130-the-whole-j-face-forces-source-anti-alignment.md) · [One J source split](219-one-late-source-split-controls-complete-saturated-j-heads.md) · [Complete factorial partition](../128-the-complete-factorial-tail-retains-its-head-off-the-face.md) · [Shared square](../transport/199-one-six-label-head-controls-the-square-and-both-complete-crosses.md)
...
The [helper](../../frontier/j-source/j_face_shared_square_factorial.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j-source/j_face_shared_square_factorial.py --check
```
