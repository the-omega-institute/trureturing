[Index](../../marked_head_profile.md) · [Original identity formula](../66-explicit-linear-endpoint-neighborhood.md) · [Whole J face](130-the-whole-j-face-forces-source-anti-alignment.md) · [Complete family errors](197-the-whole-j-reserve-keeps-each-original-family-error.md)
...
The [helper](../../frontier/j-source/j_affine_margin_reserve.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j-source/j_affine_margin_reserve.py --check
```
