[Index](../../marked_head_profile.md) · [Complete J moments](241-one-original-j-head-controls-complete-square-and-factorial-moments.md) · [Actual J source](130-the-whole-j-face-forces-source-anti-alignment.md) · [Arbitrary J head corrections](219-one-late-source-split-controls-complete-saturated-j-heads.md)
...
The [helper](../../frontier/j-source/j_face_joint_retained_square.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j-source/j_face_joint_retained_square.py --check
```
