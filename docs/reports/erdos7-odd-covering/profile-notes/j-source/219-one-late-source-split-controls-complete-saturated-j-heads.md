[Index](../../marked_head_profile.md) · [Whole J source](130-the-whole-j-face-forces-source-anti-alignment.md) · [Complete seven bridge](../transport/201-two-more-seven-labels-and-selected-intersections-control-both-heavy-costs.md)
...
```sh
python3 docs/reports/erdos7-odd-covering/frontier/j-source/j_face_coupled_seven_heads.py --check
```
