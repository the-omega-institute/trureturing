...
The [consumer](../../frontier/j-source/j_face_retained_pair_complete_moment_cost_comparison.py)
and [certificate](../../certificates/source_norms/j-source/j_face_retained_pair_complete_moment_cost_comparison.json)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j-source/j_face_retained_pair_complete_moment_cost_comparison.py --check
```
