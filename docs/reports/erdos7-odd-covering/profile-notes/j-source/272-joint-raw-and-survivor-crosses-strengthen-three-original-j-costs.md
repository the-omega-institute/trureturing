...
The [helper](../../frontier/j-source/j_face_joint_factorial_cross_heads.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j-source/j_face_joint_factorial_cross_heads.py --check
```
