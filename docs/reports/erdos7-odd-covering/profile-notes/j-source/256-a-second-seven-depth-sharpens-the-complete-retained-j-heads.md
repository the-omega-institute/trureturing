[Index](../../marked_head_profile.md) · [Same retained J source](251-two-retained-original-tests-sharpen-the-complete-j-heads.md) · [General two-depth bridge](../transport/204-a-second-seven-depth-strengthens-both-complete-heavy-costs.md) · [Original J profiles and complete caps](219-one-late-source-split-controls-complete-saturated-j-heads.md)
...
The [helper](../../frontier/j-source/j_face_second_depth_retained_heads.py),
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j-source/j_face_second_depth_retained_heads.py --check
```
