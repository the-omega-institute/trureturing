...
The [checker](../../frontier/j-source/j_face_shifted_factorial_quadratic_heads.py)
and [certificate](../../certificates/source_norms/j-source/j_face_shifted_factorial_quadratic_heads.json)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j-source/j_face_shifted_factorial_quadratic_heads.py --check
```
