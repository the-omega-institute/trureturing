[Index](../../marked_head_profile.md) · [Actual source-row transport](323-actual-aligned-source-and-row-transport.md) · [Original prefix modulus](307-original-j-prefixes-and-complete-tails-have-an-explicit-modulus.md) · [Original quadratic modulus](308-complete-j-quadratic-tails-have-an-explicit-modulus.md)
