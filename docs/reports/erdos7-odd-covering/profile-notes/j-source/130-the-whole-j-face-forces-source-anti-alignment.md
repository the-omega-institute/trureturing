[Index](../../marked_head_profile.md) · [Actual endpoints](../50-sharp-source-survival-endpoints.md) · [Common deletion](../57-common-deleted-measure-coupling.md) · [J/K faces](../71-global-j-k-control-faces-and-exact-escape-gaps.md)
...
[j_face_alignment.py](../../frontier/j-source/j_face_alignment.py) checks the
complete sums, six slot tables, nine affine source witnesses and an
existing actual height3 off-diagonal construction. Its
[certificate](../../certificates/source_norms/j-source/j_face_alignment.json) retains
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j-source/j_face_alignment.py --check
```
