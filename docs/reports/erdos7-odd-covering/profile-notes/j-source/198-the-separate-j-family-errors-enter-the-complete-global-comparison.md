[Index](../../marked_head_profile.md) · [Separate complete family errors](197-the-whole-j-reserve-keeps-each-original-family-error.md) · [Complete J replacement](../transport/196-the-actual-j-reserve-crosses-the-paired-table-capacity.md)
...
The [helper](../../frontier/j-source/j_family_global_comparison.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j-source/j_family_global_comparison.py --check
```
