...
The [canonical helper](../../frontier/j-source/j_face_pure_path_square.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j-source/j_face_pure_path_square.py --check
```
