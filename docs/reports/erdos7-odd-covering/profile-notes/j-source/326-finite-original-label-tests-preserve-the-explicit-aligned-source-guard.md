[Index](../../marked_head_profile.md) · [Explicit aligned guard](325-an-explicit-aligned-parameter-neighborhood-keeps-the-complete-comparison-below400.md) · [Exact tail calculator](../../frontier/j-source/j_aligned_source_guard_truncation.py)
...
The [numerical companion](../../frontier/j-source/j_aligned_source_guard_truncation.py) accepts
...
```sh
python3 -I -S -O docs/reports/erdos7-odd-covering/frontier/j-source/j_aligned_source_guard_truncation.py --check
```

The [canonical certificate](../../certificates/source_norms/j-source/j_aligned_source_guard_truncation.json)
