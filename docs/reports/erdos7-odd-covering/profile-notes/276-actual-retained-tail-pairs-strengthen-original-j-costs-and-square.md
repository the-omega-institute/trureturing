...
The [helper](../frontier/j_face_joint_pair_factorial_heads.py) and
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j_face_joint_pair_factorial_heads.py --check
```
