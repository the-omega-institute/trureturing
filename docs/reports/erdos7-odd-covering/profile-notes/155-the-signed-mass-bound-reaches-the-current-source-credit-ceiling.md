...
The [helper](../frontier/joint_mass_outer_comparison.py) reconstructs
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/joint_mass_outer_comparison.py --check
```
