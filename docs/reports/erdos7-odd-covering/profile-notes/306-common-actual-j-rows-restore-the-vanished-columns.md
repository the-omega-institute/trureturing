...
The [exact checker](../frontier/j_actual_rows_zero_restoration.py) constructs
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/j_actual_rows_zero_restoration.py --check
```
