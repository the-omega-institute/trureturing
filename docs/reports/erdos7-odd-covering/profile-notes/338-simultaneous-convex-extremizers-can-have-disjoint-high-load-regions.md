...
The [helper](../frontier/source_pair_convex_extremizers.py) reconstructs
...
```sh
python3 -I -S -O docs/reports/erdos7-odd-covering/frontier/source_pair_convex_extremizers.py --check
```
