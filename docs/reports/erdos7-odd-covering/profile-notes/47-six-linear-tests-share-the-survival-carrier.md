...
[joint_linear_carriers.py](../frontier/joint_linear_carriers.py), with
[verify_joint_linear_carriers.py](../frontier/verify_joint_linear_carriers.py)
...
The [logical certificate](../certificates/source_norms/joint_linear_carriers.json)
has SHA256 `3c1ccbe0a79dfe5c3b01424b1fd615999a162b5b7df2451936f554b3517a2385`.
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/verify_joint_linear_carriers.py --check
```
