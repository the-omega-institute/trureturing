...
[whole_cost_mean_stop_loss.py](../frontier/whole_cost_mean_stop_loss.py),
with [certificate](../certificates/source_norms/whole_cost_mean_stop_loss.json).
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/whole_cost_mean_stop_loss.py --check
```
