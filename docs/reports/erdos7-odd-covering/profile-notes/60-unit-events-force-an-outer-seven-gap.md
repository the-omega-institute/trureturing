...
The [exact checker](../frontier/finite_outer_jensen_compatibility.py)
and [data](../certificates/source_norms/finite_outer_jensen_compatibility.json)
...
```sh
python3 -I -O docs/reports/erdos7-odd-covering/frontier/finite_outer_jensen_compatibility.py
```
