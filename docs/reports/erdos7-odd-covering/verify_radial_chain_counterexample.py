...
def main():
    ...
    parser.add_argument('--certificate', type=Path, default=HERE / 'radial_chain_counterexample_certificate.json')
    ...
    if args.write:
        ...
        certificate = json.loads(args.certificate.read_text(), object_pairs_hook=unique)
