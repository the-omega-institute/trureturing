...
[certificate](joint_source_normalization_certificate.json). Independent
...
its entire [certificate](budgeted_mask_square_certificate.json), including
...
[certificate](high_seven_density_bridge_certificate.json). It supports
