[Index](../../../../Problems/erdos-7-odd-covering-systems.md) · [Previous](01-current-bounds-and-comparisons.md) · [Next](03-adaptive-kernels-lower-the-unrestricted-cutoff-to-19.md)
...
<a id="independent-finite-lcm-exclusion-through-11486474"></a>
...
The [exact verifier](../verify_lcm_10000_bridge.py)
...
[fixed certificate](../certificates/lcm_10000_bridge_certificate.json)
...
unbounded. The [exact verifier](../verify_star_block_obstruction.py)
...
<a id="unrestricted-tails-from-the-5040-odd-heads"></a>
