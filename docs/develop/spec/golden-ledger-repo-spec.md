...
├── Meta/{StrataLint, split.py, papergen, bookgen, sweep, domains.yaml}
...
## 11.21 回填溯源清单(消化完整性)
`Meta/BACKFILL.yaml`:两输入源(《周长账》166 版、《GICT v3.2》)之**逐条归宿表**——每条 6.x/27.x/定理/常数 ↦ {F 之 GID | B | C | 拒收(理由)};CI 校验无悬空条目(SL-016)。**"库消化文档"之完整性由此可审:一条都不许静默丢。**
